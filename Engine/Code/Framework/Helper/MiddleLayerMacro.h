...
#define ENGINE_MIDDLE_LAYER_MANAGER_DEFINE(namespaceName,className,moduleName) \
		...
		{ FRAMEWORK_CLASS_IS_VALID_CONST_0; return impl->GetMiddleLayerInterface(System::EnumCastUnderlying(className##MiddleLayer::moduleName)); }
...
#define ENGINE_MIDDLE_LAYER_CHILD_COMPONENTS_DEFINE(namespaceName,className,parentName,moduleName) \
		...
		{ FRAMEWORK_CLASS_IS_VALID_CONST_0; return impl->GetMiddleLayerInterface(System::EnumCastUnderlying(parentName##MiddleLayer::moduleName)); }
