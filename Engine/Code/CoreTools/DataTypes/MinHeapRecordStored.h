...
namespace CoreTools
{
    ...
    public:
        ...
        ~MinHeapRecordStored();
        MinHeapRecordStored(const MinHeapRecordStored&) = default;
        MinHeapRecordStored& operator=(const MinHeapRecordStored&) = default;
        MinHeapRecordStored(MinHeapRecordStored&&) = default;
        MinHeapRecordStored& operator=(MinHeapRecordStored&&) = default;
