...
std::shared_ptr<const AncientBooks::CategoryMappingType> AncientBooks::GenusBase::GetCategory(MAYBE_UNUSED const AncientBooksContainer& csvContainer) const
{
    USER_CLASS_IS_VALID_CONST_9;
...
std::shared_ptr<const AncientBooks::GenusMappingType> AncientBooks::GenusBase::GetFather(MAYBE_UNUSED const AncientBooksContainer& csvContainer) const
{
    USER_CLASS_IS_VALID_CONST_9;
