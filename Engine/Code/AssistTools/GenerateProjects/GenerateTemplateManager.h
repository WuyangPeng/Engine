...
///
///	标准：std:c++20
///	引擎版本：0.9.0.12 (2022/04/28 18:47)
...
ASSIST_TOOLS_PERFORMANCE_UNSHARED_EXPORT_IMPL(GenerateTemplateManagerImpl);
...
namespace AssistTools
{
    ...
    {
    public:
        PERFORMANCE_UNSHARED_TYPE_DECLARE(GenerateTemplateManager);
