...
DatabaseGenerateServerBaseTesting::YearEntityTesting::YearEntityTesting(const OStreamShared& stream, const AncientBooksContainer& ancientBooksContainer)
...
void DatabaseGenerateServerBaseTesting::YearEntityTesting::DoRunUnitTest()
{
...
void DatabaseGenerateServerBaseTesting::YearEntityTesting::MainTest()
{
    ASSERT_NOT_THROW_EXCEPTION_0(InitEnvironmentTest);
    ASSERT_NOT_THROW_EXCEPTION_0(DatabaseFlushTest);
}

void DatabaseGenerateServerBaseTesting::YearEntityTesting::InitEnvironmentTest()
{
...
void DatabaseGenerateServerBaseTesting::YearEntityTesting::DatabaseFlushTest()
{
