...
void Rendering::CameraModelDirectionVectorConstantTesting
	::MainTest()
{ 
	...
	::InitTest()
{
	...
	const CameraModelDirectionVectorConstant secondShaderFloat;
	...
	CameraModelDirectionVectorConstant thirdShaderFloat;
