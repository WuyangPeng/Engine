...
DatabaseGenerateServerBaseTesting::ArticleEntityTesting::ArticleEntityTesting(const OStreamShared& stream, const ArticleContainer& articleContainer)
    : ParentType{ stream }, articleContainer{ articleContainer }
{
    DATABASE_GENERATE_SERVER_CORE_SELF_CLASS_IS_VALID_1;
}

CLASS_INVARIANT_PARENT_IS_VALID_DEFINE(DatabaseGenerateServerBaseTesting, ArticleEntityTesting)

void DatabaseGenerateServerBaseTesting::ArticleEntityTesting::SelectOneTest(DatabaseFlush& databaseFlush)
{
    auto index = 0;
...
void DatabaseGenerateServerBaseTesting::ArticleEntityTesting::SelectAllTest(DatabaseFlush& databaseFlush)
{
...
void DatabaseGenerateServerBaseTesting::ArticleEntityTesting::SelectAllSizeTest(const DatabaseFlush& databaseFlush)
{
    const auto database = databaseFlush.SelectAll(ArticleEntity::GetSelectAll(databaseFlush.GetWrappersStrategy()),
                                                  ArticleEntity::GetDatabaseFieldContainer());
...
void DatabaseGenerateServerBaseTesting::ArticleEntityTesting::SetEntity(ArticleEntity& articleEntity, const Article& article)
{
...
void DatabaseGenerateServerBaseTesting::ArticleEntityTesting::DoSelectOneTest(DatabaseFlush& databaseFlush, const Article& article)
{
...
void DatabaseGenerateServerBaseTesting::ArticleEntityTesting::DoSelectAllTest(DatabaseFlush& databaseFlush, const Article& article, const EntityContainer& entityContainer)
{
...
void DatabaseGenerateServerBaseTesting::ArticleEntityTesting::EqualTest(const Article& article, const EntityContainer& entityContainer)
{
    const auto result = entityContainer.find(article.GetId());
