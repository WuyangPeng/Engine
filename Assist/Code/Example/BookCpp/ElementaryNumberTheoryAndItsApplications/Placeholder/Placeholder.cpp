...
ElementaryNumberTheoryAndItsApplications::Placeholder::Placeholder() noexcept
{
    ELEMENTARY_NUMBER_THEORY_AND_ITS_APPLICATIONS_SELF_CLASS_IS_VALID_9;
}

CLASS_INVARIANT_STUB_DEFINE(ElementaryNumberTheoryAndItsApplications, Placeholder)
