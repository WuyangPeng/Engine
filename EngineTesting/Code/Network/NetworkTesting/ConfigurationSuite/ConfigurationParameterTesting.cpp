...
void Network::ConfigurationParameterTesting
	::MainTest()
{
...
void Network::ConfigurationParameterTesting
	::ParameterTest()
{
	TestingType configurationParameter{};
	...
	ASSERT_UNEQUAL_DO_NOT_USE_MESSAGE(parameter.find(SYSTEM_TEXT("3")), parameter.end());
