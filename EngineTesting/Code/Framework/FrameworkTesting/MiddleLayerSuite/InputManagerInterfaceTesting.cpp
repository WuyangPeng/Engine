...
{
    InputManagerInterface middleLayer{ MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") } };
...
void Framework::InputManagerInterfaceTesting::SetPhysicalModellingManagerExceptionTest()
{
    ...
    const auto physicalModellingManager = std::make_shared<InputManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
...
void Framework::InputManagerInterfaceTesting::SetMessageManagerExceptionTest()
{
    ...
    const auto messageManager = std::make_shared<InputManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
...
void Framework::InputManagerInterfaceTesting::SetEventManagerExceptionTest()
{
    ...
    const auto eventManager = std::make_shared<InputManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
...
void Framework::InputManagerInterfaceTesting::SetResourceManagerExceptionTest()
{
    ...
    const auto resourceManager = std::make_shared<InputManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
...
void Framework::InputManagerInterfaceTesting::SetAudioManagerExceptionTest()
{
    ...
    const auto audioManager = std::make_shared<InputManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
...
void Framework::InputManagerInterfaceTesting::SetRenderingManagerExceptionTest()
{
    ...
    const auto renderingManager = std::make_shared<InputManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
...
void Framework::InputManagerInterfaceTesting::SetGUIManagerExceptionTest()
{
    ...
    const auto guiManager = std::make_shared<InputManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
