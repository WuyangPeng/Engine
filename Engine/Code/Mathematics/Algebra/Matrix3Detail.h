...
Mathematics::Matrix3<Real>
	...
	:m_Entry{ member00, Real{},Real{},Real{}, member11, Real{},Real{}, Real{}, member22 }
{
	MATHEMATICS_SELF_CLASS_IS_VALID_9;
}
	...
	::MakeIdentity()
{
	...
	m_Entry(2,0) = Real{ };
	m_Entry(2,1) = Real{ };
	m_Entry(2,2) = AlgebraTraits::UnitValue;
}
	...
	::ExtractAngle() const
{
	...
	auto cosValue = static_cast<Real>(0.5) * (trace -  AlgebraTraits::UnitValue);
	...
	if (Math::sm_ZeroTolerance < angle)
	{
		...
		else
		{
			...
			if (m_Entry(1,1) <= m_Entry(0,0) && m_Entry(2,2) <= m_Entry(0,0))
			{
				...
				// r00是最大对角线条款
				auto axisX = (static_cast<Real>(0.5) * Math::Sqrt(AlgebraTraits::UnitValue + m_Entry(0,0) - m_Entry(1,1) - m_Entry(2,2)));
			...
			else if(m_Entry(0,0) < m_Entry(1,1) && m_Entry(2,2) <= m_Entry(1,1))
			{
				...
				// r11是最大对角线条款
				auto axisY = (static_cast<Real>(0.5) * Math::Sqrt(AlgebraTraits::UnitValue	+ m_Entry(1,1) - m_Entry(0,0) - m_Entry(2,2)));
			 ...
			 {
				// r22是最大对角线条款
				auto axisZ = (static_cast<Real>(0.5) * Math::Sqrt(AlgebraTraits::UnitValue+ m_Entry(2,2) - m_Entry(0,0) - m_Entry(1,1)));
	...
	::ExtractEulerXYZ() const
{
	...
	if (m_Entry(0,2) < AlgebraTraits::UnitValue - Math::sm_ZeroTolerance)
	{
		if (-AlgebraTraits::UnitValue + Math::sm_ZeroTolerance < m_Entry(0,2))
		{
			// y_angle = asin(r02)
			...
			return Euler{ ExtractEulerResultType::Unique ,ExtractEulerResultOrder::XYZ ,xAngle,yAngle,zAngle,Real{},Real{},Real{} };
		}
		else
		{
			// y_angle = -pi/2
			...
			return Euler(ExtractEulerResultType::Difference,ExtractEulerResultOrder::XYZ,xAngle,yAngle,zAngle, Real{}, Real{}, Real{});
		}
	}
	else
	{
		...
		return Euler{ ExtractEulerResultType::Sum,ExtractEulerResultOrder::XYZ,xAngle,yAngle,zAngle, Real{}, Real{}, Real{} };
	}
}
	...
	::ExtractEulerXZY() const
{
	...
	if (m_Entry(0,1) < AlgebraTraits::UnitValue - Math::sm_ZeroTolerance)
	{
		if (-AlgebraTraits::UnitValue + Math::sm_ZeroTolerance < m_Entry(0,1))
		{
			// z_angle = asin(-r01)
			...
			return Euler(ExtractEulerResultType::Unique, ExtractEulerResultOrder::XZY, xAngle, yAngle, zAngle, Real{}, Real{}, Real{});
		}
		else
		{
			// z_angle = +pi/2
			...
			return Euler{ ExtractEulerResultType::Difference,ExtractEulerResultOrder::XZY,xAngle,yAngle,zAngle,Real{},Real{},Real{} };
		}
	}
	else
	{
		...
		return Euler{ ExtractEulerResultType::Sum,ExtractEulerResultOrder::XZY,xAngle,yAngle,zAngle,Real{},Real{},Real{} };
	}
}
	...
	::ExtractEulerYXZ() const
{
	...
	if (m_Entry(1,2) < AlgebraTraits::UnitValue - Math::sm_ZeroTolerance)
	{
		if (-AlgebraTraits::UnitValue + Math::sm_ZeroTolerance < m_Entry(1,2))
		{
			// x_angle = asin(-r12)
			...
			return Euler{ ExtractEulerResultType::Unique,ExtractEulerResultOrder::YXZ,xAngle,yAngle,zAngle,Real{},Real{},Real{} };
		}
		else
		{
			// x_angle = +pi/2
			...
			return Euler{ ExtractEulerResultType::Difference,ExtractEulerResultOrder::YXZ,xAngle,yAngle,zAngle,Real{},Real{},Real{} };
		}
	}
	else
	{
		...
		return Euler{ ExtractEulerResultType::Sum,ExtractEulerResultOrder::YXZ,xAngle,yAngle,zAngle,Real{},Real{},Real{} };
	}
}
	...
	::ExtractEulerYZX() const
{
	...
	if (m_Entry(1,0) < AlgebraTraits::UnitValue - Math::sm_ZeroTolerance)
	{
		if (-AlgebraTraits::UnitValue + Math::sm_ZeroTolerance < m_Entry(1,0))
		{
			// z_angle = asin(r10)
			...
			return Euler{ ExtractEulerResultType::Unique,ExtractEulerResultOrder::YZX,xAngle,yAngle,zAngle,Real{},Real{},Real{} };
		}
		else
		{
			// z_angle = -pi/2
			...
			return Euler{ ExtractEulerResultType::Difference,ExtractEulerResultOrder::YZX,xAngle,yAngle,zAngle,Real{},Real{},Real{} };
		}
	}
	else
	{
		...
		return Euler{ ExtractEulerResultType::Sum,ExtractEulerResultOrder::YZX,xAngle,yAngle,zAngle,Real{},Real{},Real{} };
	}
}
	...
	::ExtractEulerZXY() const
{
	...
	if (m_Entry(2,1) < AlgebraTraits::UnitValue - Math::sm_ZeroTolerance)
	{
		if (-AlgebraTraits::UnitValue + Math::sm_ZeroTolerance < m_Entry(2,1))
		{
			// x_angle = asin(r21)
			...
			return Euler{ ExtractEulerResultType::Unique,ExtractEulerResultOrder::ZXY,xAngle,yAngle,zAngle,Real{},Real{},Real{} };
		}
		else
		{
			// x_angle = -pi/2
			...
			return Euler{ ExtractEulerResultType::Difference,ExtractEulerResultOrder::ZXY,xAngle,yAngle,zAngle,Real{},Real{},Real{} };
		}
	}
	else
	{
		...
		return Euler{ ExtractEulerResultType::Sum,ExtractEulerResultOrder::ZXY,xAngle,yAngle,zAngle,Real{},Real{},Real{} };
	}
} 
	...
	::ExtractEulerZYX() const
{
	...
	if (m_Entry(2,0) < AlgebraTraits::UnitValue - Math::sm_ZeroTolerance)
	{
		if (-AlgebraTraits::UnitValue + Math::sm_ZeroTolerance < m_Entry(2,0))
		{
			// y_angle = asin(-r20)
			...
			return Euler{ ExtractEulerResultType::Unique,ExtractEulerResultOrder::ZYX,xAngle,yAngle,zAngle,Real{},Real{},Real{} };
		}
		else
		{		
			...
			return Euler{ ExtractEulerResultType::Difference,ExtractEulerResultOrder::ZYX,xAngle,yAngle,zAngle,Real{},Real{},Real{} };
		}
	}
	else
	{	
		...
		return Euler{ ExtractEulerResultType::Sum,ExtractEulerResultOrder::ZYX,xAngle,yAngle,zAngle,Real{},Real{},Real{} };
	}
} 
	...
	::ExtractEulerXYX() const
{
	...
	if (m_Entry(0,0) < AlgebraTraits::UnitValue - Math::sm_ZeroTolerance)
	{
		if (-AlgebraTraits::UnitValue + Math::sm_ZeroTolerance < m_Entry(0,0))
		{
			// y_angle  = acos(r00)
			...
			return Euler{ ExtractEulerResultType::Unique,ExtractEulerResultOrder::XYX,x0Angle,yAngle,Real{}, x1Angle,Real{},Real{} };
		...
		{		
			...
			return Euler{ ExtractEulerResultType::Difference,ExtractEulerResultOrder::XYX,x0Angle,yAngle,Real{}, x1Angle,Real{},Real{} };
		}
	}
	else
	{		
		...
		return Euler{ ExtractEulerResultType::Sum,ExtractEulerResultOrder::XYX,x0Angle,yAngle,Real{}, x1Angle,Real{},Real{} };
	}
}
	...
	::ExtractEulerXZX() const
{
	...
	if (m_Entry(0,0) < AlgebraTraits::UnitValue - Math::sm_ZeroTolerance)
	{
		if (-AlgebraTraits::UnitValue + Math::sm_ZeroTolerance < m_Entry(0,0))
		{
			...
			return Euler{ ExtractEulerResultType::Unique,ExtractEulerResultOrder::XZX,x0Angle,Real{}, zAngle, x1Angle,Real{},Real{} };
		}
		else
		{		
			...
			return Euler{ ExtractEulerResultType::Difference,ExtractEulerResultOrder::XZX,x0Angle,Real{}, zAngle, x1Angle,Real{},Real{} };
		}
	}
	else
	{		
		...
		return Euler{ ExtractEulerResultType::Sum,ExtractEulerResultOrder::XZX,x0Angle,Real{}, zAngle, x1Angle,Real{},Real{} };
	}
} 
	...
	::ExtractEulerYXY() const
{
	...
	if (m_Entry(1,1) < AlgebraTraits::UnitValue - Math::sm_ZeroTolerance)
	{
		if (-AlgebraTraits::UnitValue + Math::sm_ZeroTolerance < m_Entry(1,1))
		{			
			...
			return Euler{ ExtractEulerResultType::Unique,ExtractEulerResultOrder::YXY,xAngle, y0Angle, Real{}, Real{}, y1Angle,Real{} };
		}
		else
		{		
			...
			return Euler{ ExtractEulerResultType::Difference,ExtractEulerResultOrder::YXY,xAngle, y0Angle, Real{}, Real{}, y1Angle,Real{} };
		}
	}
	else
	{		
		...
		return Euler{ ExtractEulerResultType::Sum,ExtractEulerResultOrder::YXY,xAngle, y0Angle, Real{}, Real{}, y1Angle,Real{} };
	}
} 
	...
	::ExtractEulerYZY() const
{
	...
	if (m_Entry(1,1) < AlgebraTraits::UnitValue - Math::sm_ZeroTolerance)
	{
		...
		{			
			...
			return Euler{ ExtractEulerResultType::Unique,ExtractEulerResultOrder::YZY,Real{}, y0Angle, zAngle, Real{}, y1Angle,Real{} };
		...
		{		
			...
			return Euler{ ExtractEulerResultType::Difference,ExtractEulerResultOrder::YZY,Real{}, y0Angle, zAngle, Real{}, y1Angle,Real{} };
		}
	}
	else
	{		
		...
		return Euler{ ExtractEulerResultType::Sum,ExtractEulerResultOrder::YZY,Real{}, y0Angle, zAngle, Real{}, y1Angle,Real{} };
	}
} 
	...
	::ExtractEulerZXZ() const
{
	...
	if (m_Entry(2,2) < AlgebraTraits::UnitValue - Math::sm_ZeroTolerance)
	{
		if (-AlgebraTraits::UnitValue + Math::sm_ZeroTolerance < m_Entry(2,2))
		{			
			// x_angle  = acos(r22)
			...
			return Euler{ ExtractEulerResultType::Unique,ExtractEulerResultOrder::ZXZ,xAngle, Real{}, z0Angle, Real{}, Real{}, z1Angle };
		}
		else
		{		
			...
			return Euler{ ExtractEulerResultType::Difference,ExtractEulerResultOrder::ZXZ,xAngle, Real{}, z0Angle, Real{}, Real{}, z1Angle };
		}
	}
	else
	{		
		...
		return Euler{ ExtractEulerResultType::Sum,ExtractEulerResultOrder::ZXZ,xAngle, Real{}, z0Angle, Real{}, Real{}, z1Angle };
	}
}  
	...
	::ExtractEulerZYZ() const
{
	...
	if (m_Entry(2,2) < AlgebraTraits::UnitValue - Math::sm_ZeroTolerance)
	{
		...
		{			
			...
			return Euler{ ExtractEulerResultType::Unique,ExtractEulerResultOrder::ZYZ,Real{}, yAngle, z0Angle, Real{}, Real{}, z1Angle };		 
		}
		else // r22 = -1
		{		
			...
			return Euler{ ExtractEulerResultType::Difference,ExtractEulerResultOrder::ZYZ,Real{}, yAngle, z0Angle, Real{}, Real{}, z1Angle };
		}
	}
	else // r22 = +1
	{		
		...
		return Euler{ ExtractEulerResultType::Sum,ExtractEulerResultOrder::ZYZ,Real{}, yAngle, z0Angle, Real{}, Real{}, z1Angle };
	}
}  
