...
namespace Mathematics
{
	...
	public:
		...
		// Projections.
                static void GetProjection(const Vector3D<Real>& axis, const Vector3D<Real> segment[2], Real& imin, Real& imax) noexcept;
		...
		// Configurations.
                static void GetConfiguration(const Vector3D<Real>& axis, const Vector3D<Real> segment[2], IntersectorConfiguration<Real>& cfg) noexcept;
		...
		static bool Test(const Vector3D<Real>& axis, const Vector3D<Real>& velocity, Real min0, Real max0, Real min1, Real max1, Real tmax, Real& tfirst, Real& tlast) noexcept;
		...
		static bool Find(const Vector3D<Real>& axis, const Vector3D<Real>& velocity, const IntersectorConfiguration<Real>& cfg0Start, const IntersectorConfiguration<Real>& cfg1Start,
                                 Real tmax, int& side, IntersectorConfiguration<Real>& cfg0Final, IntersectorConfiguration<Real>& cfg1Final, Real& tfirst, Real& tlast) noexcept;
	};
}
