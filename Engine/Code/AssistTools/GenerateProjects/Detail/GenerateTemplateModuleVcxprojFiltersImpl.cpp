...
///
///	标准：std:c++20
///	引擎版本：0.9.0.12 (2022/04/29 11:16)
...
const System::String AssistTools::GenerateTemplateModuleVcxprojFiltersImpl::extension{ SYSTEM_TEXT(".vcxproj.filters"s) };

AssistTools::GenerateTemplateModuleVcxprojFiltersImpl::GenerateTemplateModuleVcxprojFiltersImpl(const System::String& templateFileName, const System::String& solutionName, const System::String& moduleName)
    : ParentType{ templateFileName, extension }, solutionName{ solutionName }, moduleName{ moduleName }
{
...
void AssistTools::GenerateTemplateModuleVcxprojFiltersImpl::GenerateTo(const System::String& resourceDirectory, const System::String& newSolutionName, const System::String& newModuleName) const
{
    ASSIST_TOOLS_CLASS_IS_VALID_CONST_1;

    VariableType newVariable{ { solutionName, newSolutionName }, { moduleName, newModuleName } };
