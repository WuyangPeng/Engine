...
void AssistTools::GenerateTestingTemplateEngineDirectoryTesting
    ::MainTest()
{
	ASSERT_NOT_THROW_EXCEPTION_0(GenerateToTest);
	ASSERT_NOT_THROW_EXCEPTION_0(SolutionExistTest);

	ASSERT_NOT_THROW_EXCEPTION_1(ModuleExistTest, SYSTEM_TEXT(""));
	ASSERT_NOT_THROW_EXCEPTION_1(ModuleExistTest, SYSTEM_TEXT("MiddleLayer")); 
	ASSERT_NOT_THROW_EXCEPTION_1(ModuleExistTest, SYSTEM_TEXT("Core"));
}
...
void AssistTools::GenerateTestingTemplateEngineDirectoryTesting
	::ModuleExistTest(const System::String& managerName)
{
...
void AssistTools::GenerateTestingTemplateEngineDirectoryTesting
	::VcxprojExistTest(const System::String& managerName)
{
	const System::String newIncludeName(SYSTEM_TEXT("GameTemplateInclude"));
	...
	int projectNameCount = GetContentFindCount(fullName, GetSolutionName());
	int includeNameCount = GetContentFindCount(fullName, newIncludeName);
	int testingIncludeNameCount = GetContentFindCount(fullName, mewTestingIncludeName);
	int moduleNameCount = GetContentFindCount(fullName, managerName);
	int debugLibNameCount = GetContentFindCount(fullName, newDebugLibName);
	int releaseLibNameCount = GetContentFindCount(fullName, newReleaseLibName);
...
void AssistTools::GenerateTestingTemplateEngineDirectoryTesting
	::VcxprojFiltersExistTest(const System::String& managerName)
{ 
	const System::String projectName(SYSTEM_TEXT("ProjectName"));
	const System::String moduleName(SYSTEM_TEXT("ModuleName"));
...
void AssistTools::GenerateTestingTemplateEngineDirectoryTesting
	::LogJsonExistTest(const System::String& managerName)
{
	const System::String projectName(SYSTEM_TEXT("ProjectName"));
...
void AssistTools::GenerateTestingTemplateEngineDirectoryTesting
	::TestingJsonExistTest(const System::String& managerName)
{
	const System::String configurationDirectory(SYSTEM_TEXT("Configuration"));
	const System::String createDirectory(GetExportDirectory() + GetTesting() + GetForwardSlash() + GetEngineDirectory());
	const System::String fullDirectory(createDirectory + GetForwardSlash() + GetSolutionName() + GetTesting() + GetForwardSlash() + GetSolutionName() + managerName + GetTesting());
...
void AssistTools::GenerateTestingTemplateEngineDirectoryTesting
	::EnvironmentVariableExistTest(const System::String& managerName)
{
	const System::String configurationDirectory(SYSTEM_TEXT("Configuration"));
	const System::String createDirectory(GetExportDirectory() + GetTesting() + GetForwardSlash() + GetEngineDirectory());
	const System::String fullDirectory(createDirectory + GetForwardSlash() + GetSolutionName() + GetTesting() + GetForwardSlash() + GetSolutionName() + managerName + GetTesting());
