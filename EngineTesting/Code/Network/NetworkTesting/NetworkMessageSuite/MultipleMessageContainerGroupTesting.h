...
namespace Network
{
    class MultipleMessageContainerGroupTesting final : public CoreTools::UnitTest
    {
    public:
        using ClassType = MultipleMessageContainerGroupTesting;
        using ParentType = UnitTest;

    public:
        explicit MultipleMessageContainerGroupTesting(const OStreamShared& stream);
