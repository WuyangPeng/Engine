...
DatabaseGenerateServerCoreTesting::CharacterConvertTesting::CharacterConvertTesting(const OStreamShared& stream, const AncientBooksContainer& ancientBooksContainer)
...
void DatabaseGenerateServerCoreTesting::CharacterConvertTesting::DoRunUnitTest()
{
...
void DatabaseGenerateServerCoreTesting::CharacterConvertTesting::MainTest()
{
    ASSERT_NOT_THROW_EXCEPTION_0(InitEnvironmentTest);
    ASSERT_NOT_THROW_EXCEPTION_0(DatabaseFlushTest);
}

void DatabaseGenerateServerCoreTesting::CharacterConvertTesting::InitEnvironmentTest()
{
...
void DatabaseGenerateServerCoreTesting::CharacterConvertTesting::DatabaseFlushTest()
{
