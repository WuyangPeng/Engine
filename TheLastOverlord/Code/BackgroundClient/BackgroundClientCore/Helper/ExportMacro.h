...
#ifndef BACKGROUND_CLIENT_CORE_HELPER_EXPORT_MACRO_H
#define BACKGROUND_CLIENT_CORE_HELPER_EXPORT_MACRO_H
...
#endif  // BACKGROUND_CLIENT_CORE_HELPER_EXPORT_MACRO_H