...
Rendering::TypedBuffer::TypedBuffer(const std::string& name, int numElements, int elementSize, bool createStorage)
    : ParentType{ name, numElements, elementSize, GraphicsObjectType::TypedBuffer, createStorage }
{
    RENDERING_SELF_CLASS_IS_VALID_9;
}

Rendering::TypedBuffer::TypedBuffer(const std::string& name, int numElements, int elementSize, const StorageType& storage)
    : ParentType{ name, numElements, elementSize, storage, GraphicsObjectType::TypedBuffer }
{
    RENDERING_SELF_CLASS_IS_VALID_9;
}
