...
Network::BoostMainManagerUseMultiContextTesting
	::BoostMainManagerUseMultiContextTesting(const OStreamShared& osPtr)
...
void Network::BoostMainManagerUseMultiContextTesting
	::MainTest()
{
