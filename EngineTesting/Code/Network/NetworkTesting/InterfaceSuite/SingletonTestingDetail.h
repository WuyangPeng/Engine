...
void Network::SingletonTesting
	::ACESingletonTest(Test* test, typename Test::TestFunction function)
{
...
template<typename Test>
void Network::SingletonTesting
	::BoostSingletonTest(Test* test, typename Test::TestFunction function)
{
...
template<typename Test>
void Network::SingletonTesting
	::ThreadsBoostSingletonTest(Test* test, typename Test::TestFunction function)
{
...
template<typename Test>
void Network::SingletonTesting
	::MultiContextBoostSingletonTest(Test* test, typename Test::TestFunction function)
{
...
template<typename Test>
void Network::SingletonTesting
	::NetworkSingletonTest(Test* test, typename Test::TestFunction function)
{
...
template<typename Test>
void Network::SingletonTesting
	::SocketSingletonTest(Test* test, typename Test::TestFunction function)
{
...
template<typename Test>
void Network::SingletonTesting
	::NullSingletonTest(Test* test, typename Test::TestFunction function)
{
