...
namespace AncientBooks
{
    ...
    public:
        ...
        NODISCARD virtual std::shared_ptr<const CategoryMappingType> GetCategory(MAYBE_UNUSED const AncientBooksContainer& csvContainer) const;

        NODISCARD virtual System::String GetName() const;

        NODISCARD virtual int GetFather() const noexcept;
        NODISCARD virtual std::shared_ptr<const GenusMappingType> GetFather(MAYBE_UNUSED const AncientBooksContainer& csvContainer) const;
