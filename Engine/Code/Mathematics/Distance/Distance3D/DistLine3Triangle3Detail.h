...
// ◊˜’ﬂ£∫≈ÌŒ‰—Ù£¨≈ÌÍ ∂˜£¨≈ÌÍ ‘Û
// 
// “˝«Ê∞Ê±æ£∫0.0.0.2 (2019/07/11 13:34)
	...
	::GetSquared() const
{
    ...
    {		
		auto center = (Real{0.5})*(mTriangle.GetVertex(i0) + mTriangle.GetVertex(i1));
