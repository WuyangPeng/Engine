...
#ifndef DATABASE_GENERATE_MIDDLE_LAYER_GUI_MIDDLE_LAYER_GUI_H
#define DATABASE_GENERATE_MIDDLE_LAYER_GUI_MIDDLE_LAYER_GUI_H
...
{
    class DATABASE_GENERATE_MIDDLE_LAYER_DEFAULT_DECLARE GUIManager final : public Framework::GUIManagerInterface
    {
    public:
...
#endif  // DATABASE_GENERATE_MIDDLE_LAYER_GUI_MIDDLE_LAYER_GUI_H
