...
Network::SingletonTesting
	::SingletonTesting(const OStreamShared& osPtr)
	:ParentType{ osPtr }, m_Port{ 8141 }, m_HostName{ "127.0.0.1" }
{
	m_Port += GetEngineeringOffsetValue();
...
const Network::ConfigurationStrategy Network::SingletonTesting
	::GetACEServerConfigurationStrategy(int increase) const
{
	...
	return ConfigurationStrategy{ WrappersStrategy::ACE, ConnectStrategy::TCP, ServerStrategy::Iterative,
								  ...
								  subStrategy, ConfigurationParameter{}, SocketSendMessage::Default, m_HostName, m_Port + increase };
}

const Network::ConfigurationStrategy Network::SingletonTesting
	::GetBoostServerConfigurationStrategy(int increase) const
{
	ConfigurationSubStrategy subStrategy;
...
const Network::ConfigurationStrategy Network::SingletonTesting
	::GetBoostFixedServerConfigurationStrategy(int increase) const
{
	ConfigurationSubStrategy subStrategy;

	return ConfigurationStrategy{ WrappersStrategy::Boost, ConnectStrategy::TCP, ServerStrategy::Iterative,
								  MessageStrategy::Fixed, ParserStrategy::LittleEndian, OpenSSLStrategy::Default,
								  subStrategy, ConfigurationParameter{}, SocketSendMessage::Default, m_HostName, m_Port + increase };
}

const Network::ConfigurationStrategy Network::SingletonTesting
	::GetBoostClientConfigurationStrategy(int increase) const
{
	ConfigurationSubStrategy subStrategy;
...
const Network::ConfigurationStrategy Network::SingletonTesting
	::GetBoostFixedClientConfigurationStrategy(int increase) const
{
	ConfigurationSubStrategy subStrategy;
...
const Network::ConfigurationStrategy Network::SingletonTesting
	::GetThreadsBoostServerConfigurationStrategy(int increase) const
{
	ConfigurationSubStrategy subStrategy;
...
const Network::ConfigurationStrategy Network::SingletonTesting
	::GetMultiContextBoostServerConfigurationStrategy(int increase) const
{
	ConfigurationSubStrategy subStrategy;
...
const Network::ConfigurationStrategy Network::SingletonTesting
	::GetNetworkServerConfigurationStrategy(int increase) const
{
	ConfigurationSubStrategy subStrategy;
...
const Network::ConfigurationStrategy Network::SingletonTesting
	::GetNullServerConfigurationStrategy(int increase) const
{
	ConfigurationSubStrategy subStrategy;
...
const Network::ConfigurationStrategy Network::SingletonTesting
	::GetSocketServerConfigurationStrategy(int increase) const
{
	ConfigurationSubStrategy subStrategy;
...
int Network::SingletonTesting
	::GetPort() const noexcept
{
	return m_Port;
}

const std::string Network::SingletonTesting
	::GetHostName() const
{
	return m_HostName;
}
