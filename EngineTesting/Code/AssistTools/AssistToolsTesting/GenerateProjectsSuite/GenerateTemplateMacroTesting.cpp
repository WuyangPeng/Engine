...
void AssistTools::GenerateTemplateMacroTesting
    ::MainTest()
{
	ASSERT_NOT_THROW_EXCEPTION_0(GenerateToTest);
	ASSERT_NOT_THROW_EXCEPTION_2(DefaultGenerateToTest, SYSTEM_TEXT("GameTemplateExportMacroH.txt"), SYSTEM_TEXT("ExportMacro"));
	ASSERT_NOT_THROW_EXCEPTION_2(DefaultGenerateToTest, SYSTEM_TEXT("GameTemplateManagerClassInvariantMacroH.txt"), GetSolutionName() + SYSTEM_TEXT("InputManagerClassInvariantMacro"));
	ASSERT_NOT_THROW_EXCEPTION_2(DefaultGenerateToTest, SYSTEM_TEXT("GameTemplateManagerCustomAssertMacroH.txt"), GetSolutionName() + SYSTEM_TEXT("InputManagerCustomAssertMacro"));
	ASSERT_NOT_THROW_EXCEPTION_2(DefaultGenerateToTest, SYSTEM_TEXT("GameTemplateMacroH.txt"), SYSTEM_TEXT("Macro"));
	ASSERT_NOT_THROW_EXCEPTION_2(DefaultGenerateToTest, SYSTEM_TEXT("GameTemplateMacroFwdH.txt"), SYSTEM_TEXT("MacroFwd"));
	ASSERT_NOT_THROW_EXCEPTION_2(DefaultGenerateToTest, SYSTEM_TEXT("GameTemplateUserMacroH.txt"), SYSTEM_TEXT("UserMacro")); 
}
...
void AssistTools::GenerateTemplateMacroTesting
	::DefaultGenerateToTest(const System::String& testFileName, const System::String& resultName)
{	
	const System::String newProjectName(GetSolutionName() + SYSTEM_TEXT("InputManager"));
