...
System::String CoreTools::CSVGenerateImpl::GenerateHeaderGuard() const
{
    ...
    auto content = SYSTEM_TEXT("#ifndef "s) + headerGuard + g_NewlineCharacter;

    content += SYSTEM_TEXT("#define "s) + headerGuard + g_NewlineCharacter;
...
System::String CoreTools::CSVGenerateImpl::GenerateNameSpace() const
{
    ...
    return SYSTEM_TEXT("namespace "s) + csvHead.GetNameSpace() + g_NewlineCharacter + g_FunctionBeginBrackets.data();
}
...
System::String CoreTools::CSVGenerateImpl::GenerateHeaderGuardEndif() const
{
    ...
    return SYSTEM_TEXT("#endif  // "s) + headerGuard + g_NewlineCharacter;
}
