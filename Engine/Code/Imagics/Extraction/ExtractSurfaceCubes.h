...
namespace Imagics
{
	...
	public:
		...
		void ExtractContour (float level, std::vector<Mathematics::Vector3F>& vertices, std::vector<Mathematics::TriangleKey>& triangles);
	...
	protected:
		...
		public:
			...
			void Insert (int i, const Mathematics::Vector3F& P);
			void Insert (int i0, int i1);
			void RemoveTriangles (std::vector<Mathematics::Vector3F>& vertices, std::vector<Mathematics::TriangleKey>& triangles);
		...
		Mathematics::Vector3F GetGradient(Mathematics::Vector3F P) noexcept;
