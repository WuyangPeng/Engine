...
void Rendering::AlphaStateImpl
	::SetBlendEnabled(bool blendEnabled)
{
...
Rendering::AlphaStateFlags::SourceBlendMode Rendering::AlphaStateImpl
	::GetSourceBlend() const
{
	RENDERING_CLASS_IS_VALID_CONST_1;
...
void Rendering::AlphaStateImpl
	::SetSourceBlend(AlphaStateFlags::SourceBlendMode mode)
{
	RENDERING_CLASS_IS_VALID_1;
...
Rendering::AlphaStateFlags::DestinationBlendMode Rendering::AlphaStateImpl
	::GetDestinationBlend() const
{
	RENDERING_CLASS_IS_VALID_CONST_1;
...
void Rendering::AlphaStateImpl
	::SetDestinationBlend(AlphaStateFlags::DestinationBlendMode mode)
{
	RENDERING_CLASS_IS_VALID_1;
...
void Rendering::AlphaStateImpl
	::SetCompareEnabled(bool compareEnabled)
{
	RENDERING_CLASS_IS_VALID_1;
...
Rendering::AlphaStateFlags::CompareMode Rendering::AlphaStateImpl
	::GetCompare() const
{
	RENDERING_CLASS_IS_VALID_CONST_1;
...
void Rendering::AlphaStateImpl
	::SetCompare(AlphaStateFlags::CompareMode mode)
{
	RENDERING_CLASS_IS_VALID_1;
...
float Rendering::AlphaStateImpl
	::GetReference() const
{
	RENDERING_CLASS_IS_VALID_CONST_1;
...
const Rendering::AlphaStateImpl::Colour Rendering::AlphaStateImpl
...
void Rendering::AlphaStateImpl
	::SetConstantColor(const Colour& color)
{
	RENDERING_CLASS_IS_VALID_1;
	...
	::SaveState(WriteFileManager& manager) const
{
	...
	auto blendEnabled = (m_BlendEnabled ? 1 : 0);
	auto srcBlend = System::EnumCastUnderlying(m_SourceBlend);
	auto dstBlend = System::EnumCastUnderlying(m_DestinationBlend);
	auto compareEnabled = (m_CompareEnabled ? 1 : 0);
	auto compare = System::EnumCastUnderlying(m_Compare);
	auto reference = m_Reference;
	auto constantColor = m_ConstantColor;
