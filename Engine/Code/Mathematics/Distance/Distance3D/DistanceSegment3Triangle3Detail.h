...
Mathematics::DistanceSegment3Triangle3<Real>
	::DistanceSegment3Triangle3(const Segment3& rkSegment, const Triangle3& rkTriangle)
	:ParentType{}, mSegment{ rkSegment }, mTriangle{ rkTriangle }
{
}

template <typename Real>
const Mathematics::Segment3<Real>& Mathematics::DistanceSegment3Triangle3<Real>
	::GetSegment() const
{
	return mSegment;
}
...
template <typename Real>
const Mathematics::Triangle3<Real>& Mathematics::DistanceSegment3Triangle3<Real>
	::GetTriangle() const
{
	return mTriangle;
}
...
template <typename Real>
typename const Mathematics::DistanceSegment3Triangle3<Real>::DistanceResult Mathematics::DistanceSegment3Triangle3<Real>
	::GetSquared() const
{
	...
	::GetSquared(Real t, const Vector3D& lhsVelocity, const Vector3D& rhsVelocity) const
{
	...
	return DistanceSegment3Triangle3<Real>{ movedSeg, movedTriangle }.GetSquared();
}

template <typename Real>
Real Mathematics::DistanceSegment3Triangle3<Real>
