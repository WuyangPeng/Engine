...
bool Mathematics::ContScribeCircle3Sphere3<Real>::Circumscribe(const Vector3<Real>& v0, const Vector3<Real>& v1, const Vector3<Real>& v2, const Vector3<Real>& v3, Sphere3<Real>& sphere)
{
    ...
    const typename LinearSystem<Real>::Matrix3 a{ typename LinearSystem<Real>::Vector3Type{ e10.GetX(), e10.GetY(), e10.GetZ() },
                                                  typename LinearSystem<Real>::Vector3Type{ e20.GetX(), e20.GetY(), e20.GetZ() },
                                                  typename LinearSystem<Real>::Vector3Type{ e30.GetX(), e30.GetY(), e30.GetZ() } };

    const typename LinearSystem<Real>::Vector3Type b{ Math<Real>::GetRational(1, 2) * Vector3Tools<Real>::GetLengthSquared(e10),
...
bool Mathematics::ContScribeCircle3Sphere3<Real>::Inscribe(const Vector3<Real>& v0, const Vector3<Real>& v1, const Vector3<Real>& v2, const Vector3<Real>& v3, Sphere3<Real>& sphere)
{
    ...
    const typename LinearSystem<Real>::Matrix3 a{ typename LinearSystem<Real>::Vector3Type{ n1.GetX() - n0.GetX(), n1.GetY() - n0.GetY(), n1.GetZ() - n0.GetZ() },
                                                  typename LinearSystem<Real>::Vector3Type{ n2.GetX() - n0.GetX(), n2.GetY() - n0.GetY(), n2.GetZ() - n0.GetZ() },
                                                  typename LinearSystem<Real>::Vector3Type{ n3.GetX() - n0.GetX(), n3.GetY() - n0.GetY(), n3.GetZ() - n0.GetZ() } };

    const typename LinearSystem<Real>::Vector3Type b{ Math<Real>::GetValue(0),
