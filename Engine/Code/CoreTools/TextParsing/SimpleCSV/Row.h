...
namespace CoreTools
{
    namespace SimpleCSV
    {
        ...
        public:
            ...
            NODISCARD static RowSharedPtr CreateRow(const ConstXMLDocumentSharedPtr& document, const XMLNode& rowNode, SharedStringsSharedPtr sharedStrings);
        ...
        public:
            explicit Row(const ConstXMLDocumentSharedPtr& document, MAYBE_UNUSED RowCreate cellCreate);
