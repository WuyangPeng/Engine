...
void Mathematics::StaticTestIntersectorSegment3Box3<Real>::Test()
{
    ...
    awdu[0] = MathType::FAbs(Vector3Tools::DotProduct(segment.GetDirection(), box.GetAxis(0)));
    addu[0] = MathType::FAbs(Vector3Tools::DotProduct(diff, box.GetAxis(0)));
    ...
    awdu[1] = MathType::FAbs(Vector3Tools::DotProduct(segment.GetDirection(), box.GetAxis(1)));
    addu[1] = MathType::FAbs(Vector3Tools::DotProduct(diff, box.GetAxis(1)));
    ...
    awdu[2] = MathType::FAbs(Vector3Tools::DotProduct(segment.GetDirection(), box.GetAxis(2)));
    addu[2] = MathType::FAbs(Vector3Tools::DotProduct(diff, box.GetAxis(2)));
