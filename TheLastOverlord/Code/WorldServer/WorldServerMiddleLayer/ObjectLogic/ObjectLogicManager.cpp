...
///
///	标准：std:c++20
///	最后的霸王版本：0.9.0.12 (2023/06/17 15:12)
...
WorldServerMiddleLayer::ObjectLogicManager::ObjectLogicManager(Framework::MiddleLayerPlatform middleLayerPlatform, const Framework::EnvironmentDirectory& environmentDirectory)
