...
const std::string Network::MessageSourceTesting
	::sm_StringValue{ "StringValue" };

Network::MessageSourceTesting
	::MessageSourceTesting(const OStreamShared& osPtr)
...
void Network::MessageSourceTesting
	::MainTest()
{
...
Network::MessageBufferSharedPtr Network::MessageSourceTesting
	::CreateTargetMessageBuffer(ParserStrategy parserStrategy) const
{
...
void Network::MessageSourceTesting
	::IncrementBytesProcessedTest(ParserStrategy parserStrategy)
{
	auto buffer = CreateTargetMessageBuffer(parserStrategy);
...
void Network::MessageSourceTesting
	::MessageTargetWriteBool(MessageTarget& messageTarget) const
{
...
void Network::MessageSourceTesting
	::MessageTargetWriteEnum(MessageTarget& messageTarget, ParserStrategy parserStrategy) const
{
...
void Network::MessageSourceTesting
	::MessageTargetWriteInt16(MessageTarget& messageTarget) const
{
...
void Network::MessageSourceTesting
	::MessageTargetWriteString(MessageTarget& messageTarget) const
{
...
void Network::MessageSourceTesting
	::MessageTargetWriteVector(MessageTarget& messageTarget) const
{
...
void Network::MessageSourceTesting
	::ReadBoolTest(TestingType& messageSource)
{
...
void Network::MessageSourceTesting
	::ReadEnumTest(ParserStrategy parserStrategy, TestingType& messageSource)
{
...
void Network::MessageSourceTesting
	::ReadInt16Test(TestingType& messageSource)
{
...
void Network::MessageSourceTesting
	::ReadStringTest(TestingType& messageSource)
{
...
void Network::MessageSourceTesting
	::ReadVectorTest(TestingType& messageSource)
{
