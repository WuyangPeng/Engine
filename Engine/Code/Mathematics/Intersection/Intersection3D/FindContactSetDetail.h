...
Mathematics::FindContactSet<Real>::FindContactSet(const Vector3D<Real> segment[2], const Triangle3<Real>& triangle, int side, const IntersectorConfiguration<Real>& segCfg, const IntersectorConfiguration<Real>& triCfg,
...
std::array<    Vector3D<Real>,3> triFinal { triangle.GetVertex(0) + tfirst * triVelocity,
    ...
    if (side == IntersectorConfiguration<Real>::LEFT)  // tri on left of seg
    {
        ...
        {
            ColinearSegmentTriangle(segFinal, triFinal.data(), quantity, P);
        }
    }
...
template <typename Real>
Mathematics::FindContactSet<Real>::FindContactSet(const Vector3D<Real> segment[2], const Box3<Real>& box, int side, const IntersectorConfiguration<Real>& segCfg, const IntersectorConfiguration<Real>& boxCfg,
...
template <typename Real>
Mathematics::FindContactSet<Real>::FindContactSet(const Triangle3<Real>& triangle, const Box3<Real>& box, int side, const IntersectorConfiguration<Real>& triCfg, const IntersectorConfiguration<Real>& boxCfg,
                                                  const Vector3D<Real>& triVelocity, const Vector3D<Real>& boxVelocity, Real tfirst, int& quantity, Vector3D<Real>* P)
{
    // Move the triangle to its new position.
    std::array<Vector3D<Real>, 3> triFinal{ triangle.GetVertex(0) + tfirst * triVelocity, triangle.GetVertex(1) + tfirst * triVelocity, triangle.GetVertex(2) + tfirst * triVelocity };
    ...
    if (side == IntersectorConfiguration<Real>::LEFT)
    {
        ...
        else  // triCfg.mMap == IntersectorConfiguration<Real>::m3
        {
            if (boxCfg.mMap == IntersectorConfiguration<Real>::m2_2)
            {
                ...
                boxSeg[0] = GetPointFromIndex(bIndex[6], boxFinal);
                boxSeg[1] = GetPointFromIndex(bIndex[7], boxFinal);
                ColinearSegmentTriangle(boxSeg, triFinal.data(), quantity, P);
            }
            else
            {
                ...
                boxFace[2] = GetPointFromIndex(bIndex[6], boxFinal);
                boxFace[3] = GetPointFromIndex(bIndex[7], boxFinal);
                CoplanarTriangleRectangle(triFinal.data(), boxFace, quantity, P);
            }
        }
    }
    else  // side == RIGHT
...
template <typename Real>
Mathematics::FindContactSet<Real>::FindContactSet(const Box3<Real>& box0, const Box3<Real>& box1, int side, const IntersectorConfiguration<Real>& box0Cfg, const IntersectorConfiguration<Real>& box1Cfg,
...
template <typename Real>
void Mathematics::FindContactSet<Real>::ColinearSegments(const Vector3D<Real> segment0[2], const Vector3D<Real> segment1[2], int& quantity, Vector3D<Real>* P)
{
...
template <typename Real>
void Mathematics::FindContactSet<Real>::SegmentThroughPlane(const Vector3D<Real> segment[2], const Vector3D<Real>& planeOrigin, const Vector3D<Real>& planeNormal, int& quantity, Vector3D<Real>* P)
{
    quantity = 1;
...
template <typename Real>
void Mathematics::FindContactSet<Real>::SegmentSegment(const Vector3D<Real> segment0[2], const Vector3D<Real> segment1[2], int& quantity, Vector3D<Real>* P)
{
...
template <typename Real>
void Mathematics::FindContactSet<Real>::ColinearSegmentTriangle(const Vector3D<Real> segment[2], const Vector3D<Real> triangle[3], int& quantity, Vector3D<Real>* P)
{
    ...
    const std::array< Vector3D<Real>,3> side{ triangle[1] - triangle[0], triangle[2] - triangle[1], triangle[0] - triangle[2] };
...
template <typename Real>
void Mathematics::FindContactSet<Real>::CoplanarSegmentRectangle(const Vector3D<Real> segment[2], const Vector3D<Real> rectangle[4], int& quantity, Vector3D<Real>* P)
{
    // The potential intersection is initialized to the line segment and then
...
template <typename Real>
void Mathematics::FindContactSet<Real>::CoplanarTriangleRectangle(const Vector3D<Real> triangle[3], const Vector3D<Real> rectangle[4], int& quantity, Vector3D<Real>* P)
{
...
template <typename Real>
void Mathematics::FindContactSet<Real>::CoplanarRectangleRectangle(const Vector3D<Real> rectangle0[4], const Vector3D<Real> rectangle1[4], int& quantity, Vector3D<Real>* P)
{
