...
DatabaseGenerateServerCoreTesting::CountryConvertTesting::CountryConvertTesting(const OStreamShared& stream, const AncientBooksContainer& ancientBooksContainer)
...
void DatabaseGenerateServerCoreTesting::CountryConvertTesting::DoRunUnitTest()
{
...
void DatabaseGenerateServerCoreTesting::CountryConvertTesting::MainTest()
{
    ASSERT_NOT_THROW_EXCEPTION_0(InitEnvironmentTest);
    ASSERT_NOT_THROW_EXCEPTION_0(DatabaseFlushTest);
}

void DatabaseGenerateServerCoreTesting::CountryConvertTesting::InitEnvironmentTest()
{
...
void DatabaseGenerateServerCoreTesting::CountryConvertTesting::DatabaseFlushTest()
{
