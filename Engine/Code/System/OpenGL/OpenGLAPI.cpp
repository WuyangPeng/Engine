...
void System::GetGlIntegerv(OpenGLQuery name, OpenGLInt* params) noexcept
{
    glGetIntegerv(EnumCastUnderlying(name), params);
}

void System::GetGlBooleanv(OpenGLQuery name, OpenGLBoolean* params) noexcept
{
    glGetBooleanv(EnumCastUnderlying(name), params);
}

void System::GetGlFloatv(OpenGLQuery name, OpenGLFloat* params) noexcept
{
    glGetFloatv(EnumCastUnderlying(name), params);
}

void System::GetGlDoublev(OpenGLQuery name, OpenGLDouble* params) noexcept
{
...
void System::GlEnablePositionArray(OpenGLInt size, OpenGLData type, OpenGLSize stride, const OpenGLVoid* pointer) noexcept
{
...
void System::GlEnableNormalArray(OpenGLInt size, OpenGLData type, OpenGLSize stride, const OpenGLVoid* pointer) noexcept
{
...
void System::GlEnableTangentArray(OpenGLInt size, OpenGLData type, OpenGLSize stride, const OpenGLVoid* pointer) noexcept
{
...
void System::GlEnableBinormalArray(OpenGLInt size, OpenGLData type, OpenGLSize stride, const OpenGLVoid* pointer) noexcept
{
...
void System::GlEnableTextureArray(int index, OpenGLInt size, OpenGLData type, OpenGLSize stride, const OpenGLVoid* pointer) noexcept
{
...
void System::GlEnableColorArray(OpenGLInt size, OpenGLData type, OpenGLSize stride, const OpenGLVoid* pointer) noexcept
{
    glEnableClientState(EnumCastUnderlying(ClientState::ColorArray));
    glColorPointer(size, EnumCastUnderlying(type), stride, pointer);
}

void System::GlEnableSecondaryColorArray(OpenGLInt size, OpenGLData type, OpenGLSize stride, const OpenGLVoid* pointer) noexcept
{
...
void System::GlEnableBlendIndicesArray(OpenGLInt size, OpenGLData type, OpenGLSize stride, OpenGLVoid* pointer) noexcept
{
...
void System::GlEnableBlendWeightArray(OpenGLInt size, OpenGLData type, OpenGLSize stride, OpenGLVoid* pointer) noexcept
{
...
void System::GlEnableFogCoordArray(OpenGLInt size, OpenGLData type, OpenGLSize stride, const OpenGLVoid* pointer) noexcept
{
#if 1
...
void System::GlEnablePSizeArray(OpenGLInt size, OpenGLData type, OpenGLSize stride, const OpenGLVoid* pointer) noexcept
{
...
void System::GlDisablePositionArray() noexcept
{
    glDisableClientState(EnumCastUnderlying(ClientState::VertexArray));
}

void System::GlDisableNormalArray() noexcept
{
#ifdef SYSTEM_USE_OPENGL2_NORMAL_ATTRIBUTES
...
void System::GlDisableBlendWeightArray() noexcept
{
    if (IsExistsGlArbVertexBlend() == ExistsOpenGLExtensions::Exists)
    {
...
void System::GlDisableFogCoordArray() noexcept
{
#if 1
...
void System::GlDisablePSizeArray() noexcept
{
    glDisableVertexAttribArray(EnumCastUnderlying(AttributeUsage::Psize));
}

System::OpenGLUInt System::GlBufferData(int numBytes, OpenGLUInt usage) noexcept
{
    OpenGLUInt buffer{ 0 };
...
System::OpenGLUInt System::GlDeleteBuffers(OpenGLUInt buffer) noexcept
{
...
void System::GlBindBuffer(OpenGLUInt buffer) noexcept
{
    glBindBuffer(EnumCastUnderlying(BindBuffer::ArrayBuffer), buffer);
}

System::OpenGLVoid* System::GetGlMapBuffer(OpenGLUInt buffer, OpenGLUInt usage) noexcept
{
    glBindBuffer(EnumCastUnderlying(BindBuffer::ArrayBuffer), buffer);
...
void System::SetGlUnmapBuffer(OpenGLUInt buffer) noexcept
{
    glBindBuffer(EnumCastUnderlying(BindBuffer::ArrayBuffer), buffer);
...
System::OpenGLUInt System::GlElementBufferData(int numBytes, OpenGLUInt usage) noexcept
{
    OpenGLUInt buffer{ 0 };
...
System::OpenGLUInt System::GlDeleteElementBuffers(OpenGLUInt buffer) noexcept
{
    glDeleteBuffers(1, &buffer);
...
void System::GlBindElementBuffer(OpenGLUInt buffer) noexcept
{
    glBindBuffer(EnumCastUnderlying(BindBuffer::ElementArrayBuffer), buffer);
}

System::OpenGLVoid* System::GlMapElementBuffer(OpenGLUInt buffer, OpenGLUInt usage) noexcept
{
    glBindBuffer(EnumCastUnderlying(BindBuffer::ElementArrayBuffer), buffer);
...
void System::GlUnmapElementBuffer(OpenGLUInt buffer) noexcept
{
    glBindBuffer(EnumCastUnderlying(BindBuffer::ElementArrayBuffer), buffer);
...
System::OpenGLUInt System::GlPixelUnpackBufferData(int numBytes, OpenGLUInt usage) noexcept
{
    OpenGLUInt buffer{ 0 };
...
System::OpenGLUInt System::GlDeletePixelUnpackBuffers(OpenGLUInt buffer) noexcept
{
    glDeleteBuffers(1, &buffer);
...
System::OpenGLVoid* System::GlMapPixelUnpackBuffer(OpenGLUInt buffer, OpenGLUInt usage) noexcept
{
    glBindBuffer(EnumCastUnderlying(BindBuffer::PixelUnpackBuffer), buffer);
...
void System::GlBindPixelUnpackBuffer(OpenGLUInt buffer) noexcept
{
    glBindBuffer(EnumCastUnderlying(BindBuffer::PixelUnpackBuffer), buffer);
}

void System::GlUnmapPixelUnpackBuffer() noexcept
{
    glUnmapBuffer(EnumCastUnderlying(BindBuffer::PixelUnpackBuffer));
}

System::OpenGLUInt System::GlGenTextures() noexcept
{
...
void System::GlTexImage1D(OpenGLUInt level, TextureInternalFormat internalformat, OpenGLSize width, TextureFormat format, OpenGLData type) noexcept
{
...
void System::GlTexSubImage1D(OpenGLUInt level, OpenGLSize width, TextureFormat format, OpenGLData type, const OpenGLVoid* pixels) noexcept
{
...
void System::GlTexImage2D(OpenGLEnum target, OpenGLUInt level, TextureInternalFormat internalformat, OpenGLSize width, OpenGLSize height, TextureFormat format, OpenGLData type, const OpenGLVoid* pixels) noexcept
{
...
void System::GlCompressedTexImage2D(OpenGLEnum target, OpenGLUInt level, TextureInternalFormat internalformat, OpenGLSize width, OpenGLSize height, OpenGLSize imageSize) noexcept
{
    glCompressedTexImage2D(target, level, EnumCastUnderlying(internalformat), width, height, 0, imageSize, nullptr);
}

void System::GetGlTexImage3D(OpenGLUInt level, TextureInternalFormat internalformat, OpenGLSize width, OpenGLSize height, OpenGLSize depth, TextureFormat format, OpenGLData type) noexcept
{
...
void System::GlTexSubImage3D(OpenGLUInt level, OpenGLSize width, OpenGLSize height, OpenGLSize depth, TextureFormat format, OpenGLData type, const OpenGLVoid* pixels) noexcept
{
...
System::OpenGLUInt System::GlDeleteTextures(OpenGLUInt texture) noexcept
{
...
void System::SetGlActiveTexture(OpenGLUInt texture) noexcept
{
    return glActiveTexture(texture);
}

void System::GlTexSubImage2D(OpenGLEnum target, OpenGLUInt level, OpenGLSize width, OpenGLSize height, TextureFormat format, OpenGLData type, const OpenGLVoid* pixels) noexcept
{
    glTexSubImage2D(target, level, 0, 0, width, height, EnumCastUnderlying(format), EnumCastUnderlying(type), pixels);
}

void System::GlCompressedTexSubImage2D(OpenGLEnum target, OpenGLUInt level, OpenGLSize width, OpenGLSize height, TextureInternalFormat internalformat, OpenGLSize imageSize, const OpenGLVoid* data) noexcept
{
    glCompressedTexSubImage2D(target, level, 0, 0, width, height, EnumCastUnderlying(internalformat), imageSize, data);
}

System::OpenGLUInt System::GlGenFramebuffers() noexcept
{
...
System::OpenGLUInt System::GlDeleteFramebuffers(OpenGLUInt frameBuffer) noexcept
{
...
void System::BindColorTexture(OpenGLUInt colorTextures, bool hasMipmaps) noexcept
{
...
void System::AttachTextureToFramebuffer(OpenGLUInt drawBuffers, OpenGLUInt colorTextures) noexcept
{
    glFramebufferTexture2DEXT(GL_FRAMEBUFFER_EXT, drawBuffers, EnumCastUnderlying(TextureTarget::Texture2D), colorTextures, 0);
}

System::CheckFrambufferStatus System::GlCheckFramebufferStatus() noexcept
{
    return UnderlyingCastEnum<CheckFrambufferStatus>(glCheckFramebufferStatusEXT(GL_FRAMEBUFFER_EXT));
}

void System::GlBindFramebuffer(OpenGLUInt frameBuffer) noexcept
{
    glBindFramebufferEXT(GL_FRAMEBUFFER_EXT, frameBuffer);
}

void System::GetGlDrawBuffers(OpenGLSize n, const OpenGLEnum* bufs) noexcept
{
...
void System::SetGlGenerateMipmap(TextureTarget target, OpenGLUInt texture) noexcept
{
    glBindTexture(EnumCastUnderlying(target), texture);
    glGenerateMipmapEXT(EnumCastUnderlying(target));
}

void System::SetGlReadBuffer(OpenGLEnum mode) noexcept
{
    glReadBuffer(mode);
}

void System::GlReadPixels(OpenGLSize width, OpenGLSize height, TextureFormat format, OpenGLData type, OpenGLVoid* pixel) noexcept
{
