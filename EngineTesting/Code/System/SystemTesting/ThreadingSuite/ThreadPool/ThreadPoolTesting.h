...
#ifndef SYSTEM_THREADING_SUITE_THREAD_POOL_TESTING_H
#define SYSTEM_THREADING_SUITE_THREAD_POOL_TESTING_H
...
namespace System
{
	class ThreadPoolTesting : public CoreTools::UnitTest
	{
	public:
		UNIT_TEST_SUBCLASS_COMPLETE_DECLARE(ThreadPoolTesting);
...
#endif // SYSTEM_THREADING_SUITE_THREAD_POOL_TESTING_H