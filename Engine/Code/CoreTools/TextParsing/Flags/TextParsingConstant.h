...
namespace CoreTools::TextParsing
{
    ...
    constexpr auto gEqualSignChar = SYSTEM_TEXT('=');
    ...
    constexpr System::StringView gEnumIdDescribe{ SYSTEM_TEXT("id") };
    constexpr System::StringView gIoStream{ SYSTEM_TEXT("iostream") };
    constexpr System::StringView gEnumNameDescribe{ SYSTEM_TEXT("name") };
    ...
    constexpr System::StringView gRightBracket{ SYSTEM_TEXT(")\n") };
    ...
    constexpr System::StringView gMap{ SYSTEM_TEXT("#include <map>\n") };
    constexpr System::StringView gDeque{ SYSTEM_TEXT("#include <deque>\n") };
    constexpr System::StringView gMemory{ SYSTEM_TEXT("#include <memory>\n") };
    constexpr System::StringView gVector{ SYSTEM_TEXT("#include <vector>\n") };
    constexpr System::StringView gAlgorithm{ SYSTEM_TEXT("#include <algorithm>\n") };
    constexpr System::StringView gFilesystem{ SYSTEM_TEXT("#include <filesystem>\n") };
    constexpr System::StringView gIoStreamInclude{ SYSTEM_TEXT("#include <iostream>\n") };
    constexpr System::StringView gUnorderedMap{ SYSTEM_TEXT("#include <unordered_map>\n") };
    ...
    constexpr System::StringView gLogMacroMacro{ SYSTEM_TEXT("#include \"CoreTools/Helper/LogMacro.h\"\n") };
    ...
    constexpr System::StringView gOriginalMap{ SYSTEM_TEXT("map") };
    ...
    constexpr System::StringView gOriginalUnorderedMap{ SYSTEM_TEXT("unordered_map") };
    ...
    constexpr System::StringView gConst{ SYSTEM_TEXT("const ") };
    ...
    constexpr System::StringView gKey{ SYSTEM_TEXT("(int key) noexcept") };
    ...
    constexpr System::StringView gUnique{ SYSTEM_TEXT("auto iter = std::ranges::unique(") };
    ...
    constexpr System::StringView gFunction{ SYSTEM_TEXT(".end(), [](const auto& lhs, const auto& rhs) noexcept {\n") };
