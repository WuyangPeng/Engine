...
Network::TestIntMessage
	::TestIntMessage(int64_t messageID)
...
Network::TestIntMessage
	::TestIntMessage(LoadConstructor value, int64_t messageID) noexcept
	: ParentType{ value,messageID }, m_IntValue{ 0 }
{
	NETWORK_SELF_CLASS_IS_VALID_9;
}

void Network::TestIntMessage
