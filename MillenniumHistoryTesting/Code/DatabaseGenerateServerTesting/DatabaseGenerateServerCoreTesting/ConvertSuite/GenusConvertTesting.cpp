...
DatabaseGenerateServerCoreTesting::GenusConvertTesting::GenusConvertTesting(const OStreamShared& stream, const AncientBooksContainer& ancientBooksContainer)
...
void DatabaseGenerateServerCoreTesting::GenusConvertTesting::DoRunUnitTest()
{
...
void DatabaseGenerateServerCoreTesting::GenusConvertTesting::MainTest()
{
    ASSERT_NOT_THROW_EXCEPTION_0(InitEnvironmentTest);
    ASSERT_NOT_THROW_EXCEPTION_0(DatabaseFlushTest);
}

void DatabaseGenerateServerCoreTesting::GenusConvertTesting::InitEnvironmentTest()
{
...
void DatabaseGenerateServerCoreTesting::GenusConvertTesting::DatabaseFlushTest()
{
