...
#if !defined(MATHEMATICS_EXPORT_TEMPLATE) || defined(MATHEMATICS_INCLUDED_POLYNOMIAL_FIT3_POWERS_ACHIEVE)

    #include "PolynomialFit3PowersAchieve.h"

#endif  //  !defined(MATHEMATICS_EXPORT_TEMPLATE) || defined(MATHEMATICS_INCLUDED_POLYNOMIAL_FIT3_POWERS_ACHIEVE)
