...
bool AssistTools::ObjLoader
	::GetMaterialLibrary(const string& path, const vector<string>& tokens)
{
    if (tokens[0] == "mtllib")
    {
        if (tokens.size() == 1)
...
bool AssistTools::ObjLoader
	::GetDefaultGroup(const vector<string>& tokens)
{
    if (tokens[0] == "g")
    {
        if (tokens.size() == 1)
...
bool AssistTools::ObjLoader
	::GetPosition(const vector<string>& tokens)
{
    if (tokens[0] == "v")
    {
        if (tokens.size() < 4)
...
bool AssistTools::ObjLoader
	::GetTCoord(const vector<string>& tokens)
{
    if (tokens[0] == "vt")
    {
        if (tokens.size() < 3)
...
bool AssistTools::ObjLoader
	::GetNormal(const vector<string>& tokens)
{
    if (tokens[0] == "vn")
    {
        if (tokens.size() < 4)
...
bool AssistTools::ObjLoader
	::GetGroup(const vector<string>& tokens)
{
    if (tokens[0] == "g")
    {
        if (tokens.size() == 1)
...
bool AssistTools::ObjLoader
	::GetMaterialAndMesh(const vector<string>& tokens)
{
    if (tokens[0] == "usemtl")
    {
        if (tokens.size() == 1)
...
bool AssistTools::ObjLoader
	::GetFace(const vector<string>& tokens)
{
    if (tokens[0] == "f")
    {
        if (tokens.size() < 4)
