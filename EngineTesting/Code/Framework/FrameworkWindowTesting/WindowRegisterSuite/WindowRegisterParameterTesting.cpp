...
Framework::WindowRegisterParameterTesting
	::WindowRegisterParameterTesting(const OStreamShared& stream, HInstance instance)
...
bool Framework::WindowRegisterParameterTesting
	...
	::DefaultTest()
{
	...
	ASSERT_ENUM_EQUAL(parameter.GetStyle(), System::WindowClassStyle::CommonUse);
...
void Framework::WindowRegisterParameterTesting
	::FullyTest()
{
	const auto styles = System::WindowClassStyle::CommonUse | System::WindowClassStyle::NoClose;
