...
///
///	标准：std:c++20
///	引擎辅助版本：0.9.0.4 (2023/03/17 15:25)
...
{
    class ARTIFICIAL_INTELLIGENCE_HIDDEN_DECLARE ArtificialIntelligenceCopyUnsharedMacroImpl final
    {
    public:
        using ClassType = ArtificialIntelligenceCopyUnsharedMacroImpl;

    public:
        explicit ArtificialIntelligenceCopyUnsharedMacroImpl(int count) noexcept;
