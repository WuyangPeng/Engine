...
// ◊˜’ﬂ£∫≈ÌŒ‰—Ù£¨≈ÌÍ ∂˜£¨≈ÌÍ ‘Û
// 
// “˝«Ê∞Ê±æ£∫0.0.0.2 (2019/07/10 16:30)
...
namespace Mathematics
{
	...
	class DistSegment3Triangle3 : public DistanceBase<Real,Vector3D<Real> >
	{
	public:
		using ClassType = DistSegment3Triangle3<Real>;
	...
	public:
		DistSegment3Triangle3 (const Segment3& segment,const Triangle3& triangle);
	...
	using DistSegment3Triangle3f = DistSegment3Triangle3<float>;
	using DistSegment3Triangle3d = DistSegment3Triangle3<double>;
}
