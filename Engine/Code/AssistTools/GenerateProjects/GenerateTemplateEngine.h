...
ASSIST_TOOLS_EXPORT_SHARED_PTR(GenerateTemplateEngineImpl);
...
{ 
	...
	{
	public:
		PERFORMANCE_UNSHARE_CLASSES_TYPE_DECLARE(GenerateTemplateEngine);
	...
	private:
		IMPL_TYPE_DECLARE(GenerateTemplateEngine);
	};
}
