...
#define IMAGICS_EXAMPLE_ClOSE_BEGIN (0x01)

#define CLOSE_USE_IMAGICS_EXAMPLE (IMAGICS_EXAMPLE_ClOSE_BEGIN)

#define IMAGICS_EXAMPLE_ClOSE_END CLOSE_USE_IMAGICS_EXAMPLE
...
#if !defined(COMPILE_IMAGICS_EXAMPLE_CLOSE) || (COMPILE_IMAGICS_EXAMPLE_CLOSE & CLOSE_USE_IMAGICS_EXAMPLE) != CLOSE_USE_IMAGICS_EXAMPLE

#endif  // !defined(COMPILE_IMAGICS_EXAMPLE_CLOSE) || (COMPILE_IMAGICS_EXAMPLE_CLOSE & CLOSE_USE_IMAGICS_EXAMPLE) != CLOSE_USE_IMAGICS_EXAMPLE
