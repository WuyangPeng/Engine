...
template <typename Real>
const Mathematics::Line2<Real> Mathematics::StaticTestIntersectorLine2Segment2<Real>::GetLine() const noexcept
{
...
template <typename Real>
const Mathematics::Segment2<Real> Mathematics::StaticTestIntersectorLine2Segment2<Real>::GetSegment() const noexcept
{
    MATHEMATICS_CLASS_IS_VALID_CONST_1;
