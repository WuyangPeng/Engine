...
#ifndef MATHEMATICS_NUMERICAL_ANALYSIS_SINGULAR_VALUE_DECOMPOSITION_GTE_H
#define MATHEMATICS_NUMERICAL_ANALYSIS_SINGULAR_VALUE_DECOMPOSITION_GTE_H
...
//
// Timing on an Intel (Real) Core (TM) i7-3930K CPU @ 3.20 GHZ (in seconds)
// for NxN matrices:
//
...
namespace Mathematics
{
	...
	private:
		...
		// replacement entries:  Real(index0,index0) = cs, Real(index0,index1) = sn,
		// Real(index1,index0) = -sn, and Real(index1,index1) = cs.  If N is the
	...
	using SingularValueDecompositionGTEf = SingularValueDecompositionGTE<float>;
	using SingularValueDecompositionGTEd = SingularValueDecompositionGTE<double>;
}

#endif // MATHEMATICS_NUMERICAL_ANALYSIS_SINGULAR_VALUE_DECOMPOSITION_GTE_H
