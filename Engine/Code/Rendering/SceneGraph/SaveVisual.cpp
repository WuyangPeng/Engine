...
{
	RENDERING_ASSERTION_0(visual.GetConstVertexFormat() != nullptr, "VertexFormatÊÇ¿ÕÖ¸Õë£¡");
    RENDERING_ASSERTION_0(visual.GetConstVertexBuffer() != nullptr, "VertexBufferÊÇ¿ÕÖ¸Õë£¡");
