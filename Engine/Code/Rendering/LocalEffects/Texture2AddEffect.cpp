...
Rendering::Texture2AddEffect
	::Texture2AddEffect ()
{
    VertexShaderSmartPointer vshader{ std::make_shared < VertexShader>("Wm5.Texture2Add", 3, 3, 1, 0) };
	...
	PixelShaderSmartPointer pshader{ std::make_shared<PixelShader>("Wm5.Texture2Add",2, 1, 0, 2) };
