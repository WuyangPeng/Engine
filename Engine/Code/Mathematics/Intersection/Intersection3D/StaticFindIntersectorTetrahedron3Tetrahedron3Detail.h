	...
	std::vector<Tetrahedron3>& inside)
{
    ...
    if (positive == 3)
    {
        ...
        {
            invCDiff = (Math::GetValue(1))/(C[pos[i]] - C[neg[0]]);
            w0 = -C[neg[0]]*invCDiff;
            w1 = +C[pos[i]]*invCDiff;
    ...
    else if (positive == 2)
    {
        if (negative == 2)
        {
            ...
            {
                invCDiff = (Math::GetValue(1))/(C[pos[i]] - C[neg[1]]);
                w0 = -C[neg[1]]*invCDiff;
                w1 = +C[pos[i]]*invCDiff;
    ...
    else if (positive == 1)
    {
        if (negative == 3)
        {
            ...
            for (i = 0; i < negative; ++i)
            {
                invCDiff = (Math::GetValue(1))/(C[pos[0]] - C[neg[i]]);
                w0 = -C[neg[i]]*invCDiff;
                w1 = +C[pos[0]]*invCDiff;
        ...
        {
            // +-00
            invCDiff = (Math::GetValue(1))/(C[pos[0]] - C[neg[0]]);
            w0 = -C[neg[0]]*invCDiff;
            w1 = +C[pos[0]]*invCDiff;
