...
Framework::RenderingManagerInterfaceTest::RenderingManagerInterfaceTest(MiddleLayerPlatform middleLayerPlatform, const EnvironmentDirectory& environmentDirectory)
