...
void Network::BoostSockAcceptorAsynchronousTesting
	::MainTest()
{
...
void Network::BoostSockAcceptorAsynchronousTesting
	::AsynchronousAccept(const TestingTypeSharedPtr& sockAcceptor, AcceptFunction acceptFunction)
{
...
void Network::BoostSockAcceptorAsynchronousTesting
	::AsynchronousAcceptNoUseAddress(const TestingTypeSharedPtr& sockAcceptor, const TestSocketManagerSharedPtr& testSocketManager)
{
	auto configurationStrategy = GetBoostClientConfigurationStrategy(GetRealOffset());
...
void Network::BoostSockAcceptorAsynchronousTesting
	::AsynchronousAcceptUseAddress(const TestingTypeSharedPtr& sockAcceptor, const TestSocketManagerSharedPtr& testSocketManager)
{
	auto configurationStrategy = GetBoostClientConfigurationStrategy(GetRealOffset());
