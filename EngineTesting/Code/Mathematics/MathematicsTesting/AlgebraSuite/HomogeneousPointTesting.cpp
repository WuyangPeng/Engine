...
void Mathematics::HomogeneousPointTesting
	::MainTest()
{
...
void Mathematics::HomogeneousPointTesting
	::ConstructionTest()
{
	FloatHomogeneousPoint firstPoint;
	...
	FloatHomogeneousPoint secondPoint(firstPoint);
	...
	DoubleHomogeneousPoint thirdPoint(3.0,5.0,6.0,7.0);
...
void Mathematics::HomogeneousPointTesting
	::AccessTest()
{
	FloatHomogeneousPoint firstPoint(1.0f,2.0f,0.0f,4.0f);
...
// 	ASSERT_APPROXIMATE(*(firstPoint.GetCoordinate() + 3),4.0f,1e-8f);
	...
	const DoubleHomogeneousPoint secondPoint(5.0,1.0,3.0,2.0);
...
{
	FloatHomogeneousPoint firstPoint(1.0f,2.0f,0.0f,4.0f);
	const FloatHomogeneousPoint secondPoint;
