...
template<typename E, typename T>
Network::MessageContainer<E, T>
	::MessageContainer(const MessageType& messageType)
...
template<typename E, typename T>
bool Network::MessageContainer<E, T>
...
template<typename E, typename T>
void Network::MessageContainer<E, T>
...
template<typename E, typename T>
int Network::MessageContainer<E, T>
...
template<typename E, typename T>
T Network::MessageContainer<E, T>
