...
void Rendering::TrianglesFanTesting::InitTest()
{
...
void Rendering::TrianglesFanTesting::CopyTest()
{
    // 	VisualSharedPtr firstTrianglesFan = LoadVisual::CreateFromFile(SYSTEM_TEXT("Resource/SceneGraphSuite/TrianglesFan.trv"));
    //
    // 	ASSERT_EQUAL(firstTrianglesFan->GetNumControllers(), 0);
...
void Rendering::TrianglesFanTesting::TransformTest()
{
    // 	VisualSharedPtr firstTrianglesFan = LoadVisual::CreateFromFile(SYSTEM_TEXT("Resource/SceneGraphSuite/TrianglesFan.trv"));
    //
...
void Rendering::TrianglesFanTesting::StreamTest()
{
    // 	VisualSharedPtr firstTrianglesFan = LoadVisual::CreateFromFile(SYSTEM_TEXT("Resource/SceneGraphSuite/TrianglesFan.trv"));
    //
...
void Rendering::TrianglesFanTesting::FileTest()
{
...
void Rendering::TrianglesFanTesting::UpdateModelSpaceTest()
{
    // 	VisualSharedPtr firstTrianglesFan =
    // 		LoadVisual::CreateFromFile(SYSTEM_TEXT("Resource/SceneGraphSuite/TrianglesFan.trv"));
    //
