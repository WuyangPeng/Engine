...
namespace Mathematics
{
    ...
    class MATHEMATICS_TEMPLATE_DEFAULT_DECLARE StaticTestIntersectorRay2Segment2 : public StaticIntersector<Real, Vector2>
    {
    public:
    ...
    public:
        StaticTestIntersectorRay2Segment2(const Ray2Type& ray, const Segment2Type& segment, const Real dotThreshold = MathType::GetZeroTolerance(), const Real intervalThreshold = MathType::GetValue(0));
