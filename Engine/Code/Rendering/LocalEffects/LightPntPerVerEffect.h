...
namespace Rendering
{
	class  LightPntPerVerEffect : public VisualEffect
	{
	public:
	...
	CORE_TOOLS_STREAM_REGISTER(LightPntPerVerEffect);
	CORE_TOOLS_SUBCLASS_SMART_POINTER_DECLARE(Fourth, LightPntPerVerEffect);
