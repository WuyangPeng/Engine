...
CORE_TOOLS_STATIC_OBJECT_FACTORY_DEFINE(Rendering, SpotLightEffect);
CORE_TOOLS_FACTORY_DEFINE(Rendering, SpotLightEffect);

Rendering::SpotLightEffect::SpotLightEffect(ProgramFactory& factory,
...
CLASS_INVARIANT_PARENT_IS_VALID_DEFINE(Rendering, SpotLightEffect)

Rendering::SpotLightEffect::SpotLightEffect(LoadConstructor loadConstructor)
    : ParentType{ loadConstructor }
{
    RENDERING_SELF_CLASS_IS_VALID_9;
}

void Rendering::SpotLightEffect::UpdateMaterialConstant()
{
...
void Rendering::SpotLightEffect::UpdateLightingConstant()
{
    RENDERING_CLASS_IS_VALID_9;
...
void Rendering::SpotLightEffect::UpdateGeometryConstant()
{
    RENDERING_CLASS_IS_VALID_9;
