...
namespace AncientBooks
{
    ...
    private:
        ...
        System::String dynasticTitle;  // 庙号
        std::vector<System::String> dynasticTitleAlias;  // 庙号别名
        System::String posthumousTitle;  // 谥号
        std::vector<System::String> posthumousTitleAlias;  // 谥号别名
        int beginYear;  // 继位年
        int beginMonth;  // 继位月
