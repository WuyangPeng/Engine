...
DatabaseGenerateCoreTesting::CalendarConvertTesting::CalendarConvertTesting(const OStreamShared& stream, CalendarContainer calendarContainer)
    : ParentType{ stream }, calendarContainer{ std::move(calendarContainer) }
{
