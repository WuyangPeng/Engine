...
namespace Mathematics
{
    ...
    public:
        StaticTestIntersectorLine2Segment2(const Line2Type& line, const Segment2Type& segment, const Real dotThreshold = MathType::GetZeroTolerance(), const Real intervalThreshold = MathType::GetValue(0));
