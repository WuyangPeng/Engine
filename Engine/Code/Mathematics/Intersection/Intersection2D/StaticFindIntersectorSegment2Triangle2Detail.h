...
Mathematics::StaticFindIntersectorSegment2Triangle2<Real>::StaticFindIntersectorSegment2Triangle2(const Segment2Type& segment, const Triangle2Type& triangle, const Real dotThreshold)
