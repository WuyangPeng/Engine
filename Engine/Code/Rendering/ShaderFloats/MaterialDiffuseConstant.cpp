...
Rendering::MaterialDiffuseConstant::MaterialDiffuseConstant(const MaterialSharedPtr& material)
    : ParentType{ material }
{
...
Rendering::ShaderFloatSharedPtr Rendering::MaterialDiffuseConstant::Clone() const
{
