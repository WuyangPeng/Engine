...
{
    class GAME_CLIENT_MIDDLE_LAYER_DEFAULT_DECLARE EventManager final : public Framework::EventManagerInterface
    {
    public:
...
#endif  // GAME_CLIENT_MIDDLE_LAYER_EVENT_EVENT_MANAGER_H
