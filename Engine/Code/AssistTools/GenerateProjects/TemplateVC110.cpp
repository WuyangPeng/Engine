...
void AssistTools::TemplateVC110
...
void AssistTools::TemplateVC110
	::GenerateWgl (const char* projectName)
{
    char prefix[128];
...
const char* AssistTools::TemplateVC110
	::msDx9ProjectLines[NUM_PROJECT_LINES] =
{
...
const char* AssistTools::TemplateVC110
	::msWglProjectLines[NUM_PROJECT_LINES] =
{
"?<?xml version=\"1.0\" encoding=\"utf-8\"?>",
"<Project DefaultTargets=\"Build\" ToolsVersion=\"4.0\" xmlns=\"http://schemas.microsoft.com/developer/msbuild/2003\">",
"  <ItemGroup Label=\"ProjectConfigurations\">",
...
const char* AssistTools::TemplateVC110
	::msFilterLines[NUM_FILTER_LINES] =
{
"?<?xml version=\"1.0\" encoding=\"utf-8\"?>",
