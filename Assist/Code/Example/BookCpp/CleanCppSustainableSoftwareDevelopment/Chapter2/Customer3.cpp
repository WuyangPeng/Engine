...
CLASS_INVARIANT_STUB_DEFINE(BookAdvanced::CleanCppSustainableSoftwareDevelopment, Customer3)

void BookAdvanced::CleanCppSustainableSoftwareDevelopment::Customer3::Save(MAYBE_UNUSED DataAccessObject& dataAccessObject) noexcept
{
