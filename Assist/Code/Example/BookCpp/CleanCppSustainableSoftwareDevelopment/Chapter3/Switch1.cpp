...
CLASS_INVARIANT_STUB_DEFINE(BookAdvanced::CleanCppSustainableSoftwareDevelopment, Switch1)

BookAdvanced::CleanCppSustainableSoftwareDevelopment::Switch1::Switch1(Lamp1& lamp) noexcept
    : lamp(lamp)
{
    CLEAN_CPP_SUSTAINABLE_SOFTWARE_DEVELOPMENT_SELF_CLASS_IS_VALID_9;
}

void BookAdvanced::CleanCppSustainableSoftwareDevelopment::Switch1::Toggle() noexcept
{
