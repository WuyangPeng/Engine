...
#ifndef DATABASE_TESTING_DATABASE_ENTITY_CODE_GENERATION_SUITE_H
#define DATABASE_TESTING_DATABASE_ENTITY_CODE_GENERATION_SUITE_H
...
#endif  // DATABASE_TESTING_DATABASE_ENTITY_CODE_GENERATION_SUITE_H