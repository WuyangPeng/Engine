...
Mathematics::StaticTestIntersectorHalfspace3Box3<Real>::StaticTestIntersectorHalfspace3Box3(const Plane3Type& halfspace, const Box3Type& box, const Real epsilon)
