...
OutputCSVTesting::Input3Container::Input3Container(const CSVContent& csvContent)
    : input3{}
{
    Parsing(csvContent);
...
void OutputCSVTesting::Input3Container::Parsing(const CSVContent& csvContent)
{
...
void OutputCSVTesting::Input3Container::Load(const CSVContent& csvContent)
{
...
void OutputCSVTesting::Input3Container::Unique()
{
