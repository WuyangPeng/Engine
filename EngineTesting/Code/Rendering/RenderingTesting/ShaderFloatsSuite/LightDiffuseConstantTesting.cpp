...
///
///	标准：std:c++20
///	引擎测试版本：0.9.0.12 (2023/06/12 15:19)
...
Rendering::LightDiffuseConstantTesting::LightDiffuseConstantTesting(const OStreamShared& stream)
    : ParentType{ stream }
{
    RENDERING_SELF_CLASS_IS_VALID_1;
}

CLASS_INVARIANT_PARENT_IS_VALID_DEFINE(Rendering, LightDiffuseConstantTesting)

void Rendering::LightDiffuseConstantTesting::DoRunUnitTest()
{
...
void Rendering::LightDiffuseConstantTesting::InitTest()
{
...
void Rendering::LightDiffuseConstantTesting::CopyTest()
{
    std::default_random_engine generator;
    const std::uniform_real<float> firstFloatRandomDistribution(-100.0f, 100.0f);
    std::uniform_real<float> secondFloatRandomDistribution(0.0f, 1.0f);
...
void Rendering::LightDiffuseConstantTesting::StreamTest() noexcept
{
}

void Rendering::LightDiffuseConstantTesting::UpdateTest() noexcept
{
}
