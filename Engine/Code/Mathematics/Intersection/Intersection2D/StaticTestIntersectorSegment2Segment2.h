...
namespace Mathematics
{
    ...
    public:
        StaticTestIntersector(const Segment2Type& lhsSegment, const Segment2Type& rhsSegment, const Real dotThreshold = MathType::GetZeroTolerance(), const Real intervalThreshold = MathType::GetValue(0));
