...
void CoreTools::AssertTestNullptrTesting::AssertNullptrMessageTest()
{
    ...
    ASSERT_EQUAL_NULL_PTR_USE_MESSAGE(ptr, "测试");

    auto value = 0;
    ptr = &value;

    ASSERT_UNEQUAL_NULL_PTR_USE_MESSAGE(ptr, "测试");
}
...
void CoreTools::AssertTestNullptrTesting::AssertNullptrFailureThrowTest()
{
    ...
    ASSERT_EQUAL_NULL_PTR_FAILURE_THROW(ptr, "测试");

    auto value = 0;
    ptr = &value;

    ASSERT_UNEQUAL_NULL_PTR_FAILURE_THROW(ptr, "测试");
}
