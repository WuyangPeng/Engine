...
#if !defined(MATHEMATICS_EXPORT_TEMPLATE) || defined(MATHEMATICS_INCLUDED_DYNAMIC_STATIC_INTERSECTOR_TRIANGLE2_TRIANGLE2_ACHIEVE)

    #include "StaticFindIntersectorTriangle2Triangle2Achieve.h"

#endif  // !defined(MATHEMATICS_EXPORT_TEMPLATE) || defined(MATHEMATICS_INCLUDED_DYNAMIC_STATIC_INTERSECTOR_TRIANGLE2_TRIANGLE2_ACHIEVE)
