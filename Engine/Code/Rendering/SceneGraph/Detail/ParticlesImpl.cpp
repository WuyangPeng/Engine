...
Rendering::ParticlesImpl ::ParticlesImpl()
...
const Rendering::ParticlesImpl::APoint
    Rendering::ParticlesImpl ::GetPosition(int index) const
{
    RENDERING_CLASS_IS_VALID_CONST_1;
...
void Rendering::ParticlesImpl ::SetSizeAdjust(float sizeAdjust)
{
    RENDERING_CLASS_IS_VALID_1;
...
void Rendering::ParticlesImpl ::SetNumActive(int numActive)
{
    RENDERING_CLASS_IS_VALID_1;
