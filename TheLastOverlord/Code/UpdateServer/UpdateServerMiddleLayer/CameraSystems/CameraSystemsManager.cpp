...
///
///	标准：std:c++20
///	最后的霸王版本：0.8.0.12 (2022/07/29 17:19)
...
UpdateServerMiddleLayer::CameraSystemsManager::CameraSystemsManager(Framework::MiddleLayerPlatform middleLayerPlatform, const Framework::EnvironmentDirectory& environmentDirectory)
