...
CLASS_INVARIANT_STUB_DEFINE(BookAdvanced::CleanCppSustainableSoftwareDevelopment, Lamp1)

void BookAdvanced::CleanCppSustainableSoftwareDevelopment::Lamp1::On() noexcept
{
...
void BookAdvanced::CleanCppSustainableSoftwareDevelopment::Lamp1::Off() noexcept
{
    CLEAN_CPP_SUSTAINABLE_SOFTWARE_DEVELOPMENT_CLASS_IS_VALID_9;
