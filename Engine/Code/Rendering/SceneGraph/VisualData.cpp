...
Rendering::VisualData ::VisualData(VisualPrimitiveType type)
    : m_Type{ type }, m_VertexFormat{}, m_VertexBuffer{}, m_IndexBuffer{}
{
    RENDERING_SELF_CLASS_IS_VALID_9;
}

Rendering::VisualData ::VisualData(VisualPrimitiveType type, const VertexFormatSharedPtr& vertexformat, const VertexBufferSharedPtr& vertexbuffer, const IndexBufferSharedPtr& indexbuffer)
...
void Rendering::VisualData ::SetPrimitiveType(VisualPrimitiveType type)
{
...
const char* Rendering::VisualData ::GetVertexBufferReadOnlyData() const
{
    RENDERING_CLASS_IS_VALID_CONST_9;
...
int Rendering::VisualData ::GetVertexFormatStride() const
{
    RENDERING_CLASS_IS_VALID_CONST_9;
...
int Rendering::VisualData ::GetVertexBufferNumElements() const
{
    RENDERING_CLASS_IS_VALID_CONST_9;
...
bool Rendering::VisualData ::IsVertexSharedPtrValid() const
{
    RENDERING_CLASS_IS_VALID_CONST_9;
...
Rendering::IndexBufferSharedPtr Rendering::VisualData ::GetIndexBuffer()
{
...
Rendering::VertexBufferSharedPtr Rendering::VisualData ::GetVertexBuffer()
{
    RENDERING_CLASS_IS_VALID_9;
...
Rendering::ConstIndexBufferSharedPtr Rendering::VisualData ::GetConstIndexBuffer() const
{
    RENDERING_CLASS_IS_VALID_CONST_9;
...
void Rendering::VisualData ::SetIndexBuffer(const IndexBufferSharedPtr& indexbuffer)
{
    RENDERING_CLASS_IS_VALID_9;
...
Rendering::ConstVertexBufferSharedPtr Rendering::VisualData ::GetConstVertexBuffer() const
{
    RENDERING_CLASS_IS_VALID_CONST_9;
...
void Rendering::VisualData ::SetVertexBuffer(const VertexBufferSharedPtr& vertexbuffer)
{
    RENDERING_CLASS_IS_VALID_9;
...
Rendering::VertexFormatSharedPtr Rendering::VisualData ::GetVertexFormat()
{
    RENDERING_CLASS_IS_VALID_9;
...
void Rendering::VisualData ::SetVertexFormat(const VertexFormatSharedPtr& vertexformat)
{
    RENDERING_CLASS_IS_VALID_9;
...
int Rendering::VisualData ::GetStreamingSize() const
{
    RENDERING_CLASS_IS_VALID_CONST_9;
