...
namespace AncientBooks
{
    ...
    public:
        ...
        NODISCARD virtual std::shared_ptr<const VersionMappingType> GetVersion(MAYBE_UNUSED const AncientBooksContainer& csvContainer) const;

        NODISCARD virtual int GetChapter() const noexcept;
        NODISCARD virtual std::shared_ptr<const ChapterMappingType> GetChapter(MAYBE_UNUSED const AncientBooksContainer& csvContainer) const;
