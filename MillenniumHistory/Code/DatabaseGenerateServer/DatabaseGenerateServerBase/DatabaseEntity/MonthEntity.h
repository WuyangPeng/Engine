...
#ifndef DATABASE_ENTITY_MONTH_ENTITY_H
#define DATABASE_ENTITY_MONTH_ENTITY_H
...
{
    class MonthEntity final : public Database::DatabaseEntity
    {
    public:
        using ClassType = MonthEntity;
    ...
    public:
        NODISCARD static MonthEntity Create(const BasisDatabaseManager& entity, WrappersStrategy wrappersStrategy, Database::Traits::ParamType::Int32 id);
        explicit MonthEntity(const BasisDatabaseManager& entity);
        MonthEntity(WrappersStrategy wrappersStrategy, Database::Traits::ParamType::Int32 id);
    ...
    private:
        static constexpr std::string_view databaseName{ "month" };
...
#endif  // DATABASE_ENTITY_MONTH_ENTITY_H