...
#define ASSERT_EQUAL_DO_NOT_USE_MESSAGE(lhs, rhs) \
    ASSERT_EQUAL_DO_NOT_USE_MESSAGE_DETAIL((lhs), (rhs), (false))

#define ASSERT_EQUAL_DO_NOT_USE_MESSAGE_FAILURE_THROW(lhs, rhs) \
    ASSERT_EQUAL_DO_NOT_USE_MESSAGE_DETAIL((lhs), (rhs), (true))
...
#define ASSERT_UNEQUAL_DO_NOT_USE_MESSAGE(lhs, rhs) \
    ASSERT_UNEQUAL_DO_NOT_USE_MESSAGE_DETAIL((lhs), (rhs), (false))

#define ASSERT_UNEQUAL_DO_NOT_USE_MESSAGE_FAILURE_THROW(lhs, rhs) \
    ASSERT_UNEQUAL_DO_NOT_USE_MESSAGE_DETAIL((lhs), (rhs), (true))
