...
CLASS_INVARIANT_PARENT_IS_VALID_DEFINE(Database, RedisDatabaseFlushTesting)

void Database::RedisDatabaseFlushTesting::DoRunUnitTest()
{
    ASSERT_NOT_THROW_EXCEPTION_0(MainTest);
}

void Database::RedisDatabaseFlushTesting::MainTest()
{
...
void Database::RedisDatabaseFlushTesting::ChangeDatabaseTest()
{
    ...
    const ConfigurationStrategy configurationStrategy{ WrappersStrategy::Redis, "43.139.123.106", 7501, "tcretest", "admin", "TCRE", true, 10, 1000, 500, 1, flagsOption, stringOption, booleanOption, intOption, sslOption, dbMapping };
    ...
    ::DatabaseEntity::Chapter chapter{ WrappersStrategy::Redis, userId };
...
void Database::RedisDatabaseFlushTesting::DeleteDatabaseTest()
{
    const ConfigurationStrategy::FlagsOption flagsOption{};
    const ConfigurationStrategy::StringOption stringOption{};
    const ConfigurationStrategy::BooleanOption booleanOption{};
    ...
    const ::DatabaseEntity::Chapter chapter{ WrappersStrategy::Redis, userId };

    mysqlConnectorDatabaseFlush.ChangeDatabase(userId, chapter.GetDelete());
}

void Database::RedisDatabaseFlushTesting::SelectOneTest()
{
    const ConfigurationStrategy::FlagsOption flagsOption{};
    const ConfigurationStrategy::StringOption stringOption{};
    const ConfigurationStrategy::BooleanOption booleanOption{};
    ...
    const auto database = mysqlConnectorDatabaseFlush.SelectOne(::DatabaseEntity::Chapter::GetSelect(WrappersStrategy::Redis, userId),
...
void Database::RedisDatabaseFlushTesting::SelectAllTest()
{
    const ConfigurationStrategy::FlagsOption flagsOption{};
    const ConfigurationStrategy::StringOption stringOption{};
    const ConfigurationStrategy::BooleanOption booleanOption{};
    ...
    const auto database = mysqlConnectorDatabaseFlush.SelectAll(::DatabaseEntity::Chapter::GetSelect(WrappersStrategy::Redis, userId),
                                                                ::DatabaseEntity::Chapter::GetDatabaseFieldContainer());
