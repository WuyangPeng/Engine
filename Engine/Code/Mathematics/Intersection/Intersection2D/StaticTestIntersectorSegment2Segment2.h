...
namespace Mathematics
{
    ...
    class MATHEMATICS_TEMPLATE_DEFAULT_DECLARE StaticTestIntersectorSegment2Segment2 : public StaticIntersector<Real, Vector2D>
    {
    public:
    ...
    using FloatStaticTestIntersectorSegment2Segment2 = StaticTestIntersectorSegment2Segment2<float>;
    using DoubleStaticTestIntersectorSegment2Segment2 = StaticTestIntersectorSegment2Segment2<double>;
}
