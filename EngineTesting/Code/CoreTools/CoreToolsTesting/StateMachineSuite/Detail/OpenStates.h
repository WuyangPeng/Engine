...
#ifndef CORE_TOOLS_STATE_MACHINE_SUITE_OPEN_STATES_H
#define CORE_TOOLS_STATE_MACHINE_SUITE_OPEN_STATES_H
...
namespace CoreTools
{
    class OpenStates final : public State<PlayerEntity>
    {
    public:
        using ClassType = OpenStates;
...
#endif  // CORE_TOOLS_STATE_MACHINE_SUITE_OPEN_STATES_H