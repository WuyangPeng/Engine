...
namespace Mathematics
{
    ...
    public: using Math = Math<Real>;
        ...
        BSplineRectangle(int numUCtrlPoints, int numVCtrlPoints, Vector3<Real>** ctrlPoint, int uDegree, int vDegree, bool uLoop, bool vLoop, bool uOpen, bool vOpen);

        // (OU,ON) or (PU,ON)
        BSplineRectangle(int numUCtrlPoints, int numVCtrlPoints, Vector3<Real>** ctrlPoint, int uDegree, int vDegree, bool uLoop, bool vLoop, bool uOpen, Real* vKnot);

        // (ON,OU) or (ON,PU)
        BSplineRectangle(int numUCtrlPoints, int numVCtrlPoints, Vector3<Real>** ctrlPoint, int uDegree, int vDegree, bool uLoop, bool vLoop, Real* uKnot, bool vOpen);

        // (ON,ON)
        BSplineRectangle(int numUCtrlPoints, int numVCtrlPoints, Vector3<Real>** ctrlPoint, int uDegree, int vDegree, bool uLoop, bool vLoop, Real* uKnot, Real* vKnot);
        ...
        Vector3<Real> GetControlPoint(int uIndex, int vIndex) const noexcept;
        ...
        // to 0.  Any inputs larger than 1 are clamped to 1.
          Vector3<Real> P(Real u, Real v) const override;
          Vector3<Real> PU(Real u, Real v) const override;
          Vector3<Real> PV(Real u, Real v) const override;
          Vector3<Real> PUU(Real u, Real v) const override;
          Vector3<Real> PUV(Real u, Real v) const override;
          Vector3<Real> PVV(Real u, Real v) const override;
