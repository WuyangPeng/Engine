...
ASSIST_TOOLS_PERFORMANCE_UNSHARED_EXPORT_IMPL(GenerateTemplateModuleVcxprojFiltersImpl);
...
namespace AssistTools
{
    ...
    {
    public:
        PERFORMANCE_UNSHARED_TYPE_DECLARE(GenerateTemplateModuleVcxprojFilters);
