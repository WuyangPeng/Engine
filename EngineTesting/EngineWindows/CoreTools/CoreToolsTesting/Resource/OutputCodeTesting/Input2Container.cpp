...
OutputCSVTesting::Input2Container::Input2Container(const CoreTools::CSVContent& csvContent)
    : input2{}
{
    Parsing(csvContent);
...
void OutputCSVTesting::Input2Container::Parsing(const CoreTools::CSVContent& csvContent)
{
    ...
    {
        LOG_SINGLETON_ENGINE_APPENDER(Warn, User,  SYSTEM_TEXT("input2表存在重复主键。"), CoreTools::LogAppenderIOManageSign::TriggerAssert);
