...
CsvOutput::Input2Container::ConstInput2SharedPtr CsvOutput::Input2Container::GetFirstInput2(Function function) const
{
    USER_CLASS_IS_VALID_CONST_9;

    if (const auto iter = std::ranges::find_if(input2, function);
        iter != input2.cend())
    {
        return *iter;
    }
