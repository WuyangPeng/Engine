...
// ◊˜’ﬂ£∫≈ÌŒ‰—Ù£¨≈ÌÍ ∂˜£¨≈ÌÍ ‘Û
// 
// “˝«Ê≤‚ ‘∞Ê±æ£∫0.3.0.1 (2020/05/29 11:33)
...
Framework::EnvironmentDirectoryTesting
	::EnvironmentDirectoryTesting(const OStreamShared& osPtr)
	:ParentType{ osPtr },
...
void Framework::EnvironmentDirectoryTesting
	::DoRunUnitTest()
{
	ASSERT_NOT_THROW_EXCEPTION_0(MainTest);
}

System::String Framework::EnvironmentDirectoryTesting
	::GetDescription(Description description, bool isFile) const
{
	...
	{
		THROW_EXCEPTION(SYSTEM_TEXT("Œ¥’“µΩœ‡πÿ√Ë ˆ"s));
	}
}

System::String Framework::EnvironmentDirectoryTesting
	::GetPrefix(Description description) const
{
	const auto iter = m_Description.find(description);
	if (iter != m_Description.cend())
	{
...
bool Framework::EnvironmentDirectoryTesting
	::IsDirectory(Description description) noexcept
{
...
bool Framework::EnvironmentDirectoryTesting
	::IsRendering(Description description) noexcept
{
...
bool Framework::EnvironmentDirectoryTesting
	::IsLittleEndian(Description description) noexcept
{
...
void Framework::EnvironmentDirectoryTesting
	::EngineEnvironmentTest(const TestingType& environmentDirectory)
{
	ASSERT_EQUAL(GetDescription(Description::EngineEnvironment), environmentDirectory.GetEngineEnvironment());
}

void Framework::EnvironmentDirectoryTesting
	::EngineDirectoryTest(const TestingType& environmentDirectory)
{
...
void Framework::EnvironmentDirectoryTesting
	::DirectoryTest(bool isFile, UpperDirectory upperDirectory)
{
...
void Framework::EnvironmentDirectoryTesting
	::DefaultPathTest(bool isFile, RenderingAnalysisDirectory renderingAnalysisDirectory)
{
	const auto& environmentDirectory = isFile ? m_FileEnvironmentDirectory : m_DefaultEnvironmentDirectory;
...
void Framework::EnvironmentDirectoryTesting
	::LittleEndianDefaultTest(bool isFile, RenderingAnalysisDirectory renderingAnalysisDirectory)
{
	PathTest(isFile, renderingAnalysisDirectory, EndianDirectory::LittleEndian, RenderingDirectory::Default);
}

void Framework::EnvironmentDirectoryTesting
	::LittleEndianOpenGLTest(bool isFile, RenderingAnalysisDirectory renderingAnalysisDirectory)
{
	PathTest(isFile, renderingAnalysisDirectory, EndianDirectory::LittleEndian, RenderingDirectory::OpenGL);
}

void Framework::EnvironmentDirectoryTesting
	::LittleEndianDirectXTest(bool isFile, RenderingAnalysisDirectory renderingAnalysisDirectory)
{
	PathTest(isFile, renderingAnalysisDirectory, EndianDirectory::LittleEndian, RenderingDirectory::DirectX);
}

void Framework::EnvironmentDirectoryTesting
	::BigEndianDefaultTest(bool isFile, RenderingAnalysisDirectory renderingAnalysisDirectory)
{
	PathTest(isFile, renderingAnalysisDirectory, EndianDirectory::BigEndian, RenderingDirectory::Default);
}

void Framework::EnvironmentDirectoryTesting
	::BigEndianOpenGLTest(bool isFile, RenderingAnalysisDirectory renderingAnalysisDirectory)
{
	PathTest(isFile, renderingAnalysisDirectory, EndianDirectory::BigEndian, RenderingDirectory::OpenGL);
}

void Framework::EnvironmentDirectoryTesting
	::BigEndianDirectXTest(bool isFile, RenderingAnalysisDirectory renderingAnalysisDirectory)
{
	PathTest(isFile, renderingAnalysisDirectory, EndianDirectory::BigEndian, RenderingDirectory::DirectX);
}

void Framework::EnvironmentDirectoryTesting
	::PathTest(bool isFile, RenderingAnalysisDirectory renderingAnalysisDirectory, EndianDirectory endianDirectory, RenderingDirectory renderingDirectory)
{
	const auto& environmentDirectory = isFile ? m_FileEnvironmentDirectory : m_DefaultEnvironmentDirectory;
