...
Rendering::ShaderBase::ShaderBase(const std::string& programName,
                                  int numInputs,
                                  int numOutputs,
                                  int numConstants,
                                  int numSamplers)
...
void Rendering::ShaderBase::SetInput(int index, const std::string& name, ShaderFlags::VariableType type, ShaderFlags::VariableSemantic semantic)
{
...
void Rendering::ShaderBase::SetOutput(int index, const std::string& name, ShaderFlags::VariableType type, ShaderFlags::VariableSemantic semantic)
{
    RENDERING_CLASS_IS_VALID_1;
...
void Rendering::ShaderBase::SetConstant(int index, const std::string& name, int numRegistersUsed)
{
    RENDERING_CLASS_IS_VALID_1;
...
void Rendering::ShaderBase::SetSampler(int index, const std::string& name, ShaderFlags::SamplerType type)
{
    RENDERING_CLASS_IS_VALID_1;
...
IMPL_CONST_MEMBER_FUNCTION_DEFINE_1_V(Rendering, ShaderBase, GetInputName, int, std::string)
...
IMPL_CONST_MEMBER_FUNCTION_DEFINE_1_V(Rendering, ShaderBase, GetOutputName, int, std::string)
...
IMPL_CONST_MEMBER_FUNCTION_DEFINE_1_V(Rendering, ShaderBase, GetConstantName, int, std::string)
...
IMPL_CONST_MEMBER_FUNCTION_DEFINE_1_V(Rendering, ShaderBase, GetSamplerName, int, std::string)
