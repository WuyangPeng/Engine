...
Framework::MiddleLayerMacroTesting
	::MiddleLayerMacroTesting(const OStreamShared& stream)
	:ParentType{ stream } 
{
...
void Framework::MiddleLayerMacroTesting
	::DoRunUnitTest()
{
...
void Framework::MiddleLayerMacroTesting
	::HelperManagerNetworkExceptionTest()
{
	constexpr auto middleLayerPlatform = MiddleLayerPlatform::Windows;
	HelperManagerInterface helperManagerInterface{ middleLayerPlatform };
...
void Framework::MiddleLayerMacroTesting
	::HelperManagerPhysicalModellingExceptionTest()
{
	constexpr auto middleLayerPlatform = MiddleLayerPlatform::Windows;
	HelperManagerInterface helperManagerInterface{ middleLayerPlatform };
...
void Framework::MiddleLayerMacroTesting
	::HelperManagerSystemExceptionTest()
{
	constexpr auto middleLayerPlatform = MiddleLayerPlatform::Windows;
	HelperManagerInterface helperManagerInterface{ middleLayerPlatform };
...
void Framework::MiddleLayerMacroTesting
	::ChildHelperManagerNetworkExceptionTest()
{
	constexpr auto middleLayerPlatform = MiddleLayerPlatform::Windows;
	ChildHelperInterface childHelperManagerInterface{ middleLayerPlatform };
...
void Framework::MiddleLayerMacroTesting
	::ChildHelperManagerPhysicalModellingExceptionTest()
{
	constexpr auto middleLayerPlatform = MiddleLayerPlatform::Windows;
	ChildHelperInterface childHelperManagerInterface{ middleLayerPlatform };
...
void Framework::MiddleLayerMacroTesting
	::ChildHelperManagerSystemExceptionTest()
{
	constexpr auto middleLayerPlatform = MiddleLayerPlatform::Windows;
	ChildHelperInterface childHelperManagerInterface{ middleLayerPlatform };
...
void Framework::MiddleLayerMacroTesting
	::ChildHelperManagerGUIExceptionTest()
{
	constexpr auto middleLayerPlatform = MiddleLayerPlatform::Windows;
	ChildHelperInterface childHelperManagerInterface{ middleLayerPlatform };
