...
const Mathematics::Quaternion<Real> Mathematics::Quaternion<Real>::sm_Zero{};

template <typename Real>
const Mathematics::Quaternion<Real> Mathematics::Quaternion<Real>::sm_Identity{ Math::GetValue(1), Math::GetValue(0), Math::GetValue(0), Math::GetValue(0) };

template <typename Real>
Mathematics::Quaternion<Real>::Quaternion() noexcept
{
...
template <typename Real>
Mathematics::Quaternion<Real>::Quaternion(Real w, Real x, Real y, Real z) noexcept
{
    m_Tuple[0] = w;
    m_Tuple[1] = x;
    m_Tuple[2] = y;
...
template <typename Real>
Mathematics::Quaternion<Real>::Quaternion(const Quaternion& rhs) noexcept
{
...
template <typename Real>
Mathematics::Quaternion<Real>::Quaternion(const Vector3D& axis, Real angle)
    : m_Tuple{}
{
...
template <typename Real>
void Mathematics::Quaternion<Real>::FromAxisAngle(const Vector3D& axis, Real angle)
{
    MATHEMATICS_CLASS_IS_VALID_9;
    MATHEMATICS_ASSERTION_1(axis.IsNormalize(), "axis必须是单位向量！");
...
template <typename Real>
Mathematics::Quaternion<Real>::Quaternion(const std::vector<Vector3D>& rotationColumn)
    : m_Tuple{}
{
...
template <typename Real>
void Mathematics::Quaternion<Real>::FromRotationColumnVector3D(const std::vector<Vector3D>& rotationColumn)
{
    MATHEMATICS_CLASS_IS_VALID_9;
    MATHEMATICS_ASSERTION_1(rotationColumn.size() == 3, "数据大小错误！");
...
template <typename Real>
Mathematics::Quaternion<Real>& Mathematics::Quaternion<Real>::operator*=(const Quaternion& rhs)
{
    MATHEMATICS_CLASS_IS_VALID_9;
...
template <typename Real>
const std::vector<typename Mathematics::Quaternion<Real>::Vector3D> Mathematics::Quaternion<Real>::ToRotationColumnVector3D() const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
Real Mathematics::Quaternion<Real>::Length() const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
void Mathematics::Quaternion<Real>::Normalize(Real epsilon)
{
    MATHEMATICS_CLASS_IS_VALID_9;
...
template <typename Real>
const Mathematics::Quaternion<Real> Mathematics::Quaternion<Real>::Inverse() const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
const Mathematics::Quaternion<Real> Mathematics::Quaternion<Real>::Exp() const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
typename const Mathematics::Quaternion<Real>::Vector3D Mathematics::Quaternion<Real>::Rotate(const Vector3D& vector) const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
void Mathematics::Quaternion<Real>::Slerp(Real t, const Quaternion& firstQuaternion, const Quaternion& secondQuaternion)
{
    MATHEMATICS_CLASS_IS_VALID_9;
...
template <typename Real>
void Mathematics::Quaternion<Real>::SlerpExtraSpins(Real t, const Quaternion& firstQuaternion, const Quaternion& secondQuaternion, int extraSpins)
{
    MATHEMATICS_CLASS_IS_VALID_9;
...
template <typename Real>
bool Mathematics::Quaternion<Real>::IsNormalize(Real epsilon) const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
void Mathematics::Quaternion<Real>::Intermediate(const Quaternion& firstQuaternion, const Quaternion& secondQuaternion, const Quaternion& thirdQuaternion)
{
    MATHEMATICS_CLASS_IS_VALID_9;
...
template <typename Real>
void Mathematics::Quaternion<Real>::Align(const Vector3D& firstVector, const Vector3D& secondVector, Real epsilon)
{
    MATHEMATICS_CLASS_IS_VALID_9;
...
template <typename Real>
const Mathematics::Quaternion<Real> Mathematics::Quaternion<Real>::GetClosestXY() const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
const Mathematics::Quaternion<Real> Mathematics::Quaternion<Real>::GetClosestYX() const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
typename const Mathematics::Quaternion<Real>::QuaternionFactor Mathematics::Quaternion<Real>::FactorXYZ() const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
typename const Mathematics::Quaternion<Real>::QuaternionFactor Mathematics::Quaternion<Real>::FactorXZY() const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
typename const Mathematics::Quaternion<Real>::QuaternionFactor Mathematics::Quaternion<Real>::FactorYZX() const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
typename const Mathematics::Quaternion<Real>::QuaternionFactor Mathematics::Quaternion<Real>::FactorYXZ() const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
typename const Mathematics::Quaternion<Real>::QuaternionFactor Mathematics::Quaternion<Real>::FactorZXY() const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
typename const Mathematics::Quaternion<Real>::QuaternionFactor Mathematics::Quaternion<Real>::FactorZYX() const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename T>
void Mathematics::Quaternion<T>::Set(const ArrayType& coordinate) noexcept
{
    #include STSTEM_WARNING_PUSH
    #include SYSTEM_WARNING_DISABLE(26446)
    SetW(coordinate[0]);
...
template <typename Real>
const Mathematics::Quaternion<Real> Mathematics ::operator*(const Quaternion<Real>& lhs, const Quaternion<Real>& rhs)
{
...
template <typename Real>
Real Mathematics ::Dot(const Quaternion<Real>& lhs, const Quaternion<Real>& rhs)
{
...
template <typename Real>
bool Mathematics ::Approximate(const Quaternion<Real>& lhs, const Quaternion<Real>& rhs)
{
