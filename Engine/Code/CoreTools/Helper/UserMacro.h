...
#define CLOSE_USE_CORE_TOOLS_TEMPLATE_TEST (CORE_TOOLS_ClOSE_BEGIN)
#define CLOSE_USE_MEMORY_MANAGER (CORE_TOOLS_ClOSE_BEGIN << 1)
#define CLOSE_ASSERT (CORE_TOOLS_ClOSE_BEGIN << 2)
#define CLOSE_CLASS_INVARIANT (CORE_TOOLS_ClOSE_BEGIN << 3)
#define CLOSE_USE_IMPORTANT_EXCPTION_ASSERT (CORE_TOOLS_ClOSE_BEGIN << 4)

#define CORE_TOOLS_ClOSE_END CLOSE_USE_IMPORTANT_EXCPTION_ASSERT
...
#if !defined(COMPILE_CORE_TOOLS_CLOSE) || (COMPILE_CORE_TOOLS_CLOSE & CLOSE_USE_CORE_TOOLS_TEMPLATE_TEST) != CLOSE_USE_CORE_TOOLS_TEMPLATE_TEST
    #define CORE_TOOLS_TEMPLATE_TEST static_cast<void>(0)
#endif  // !defined(COMPILE_CORE_TOOLS_CLOSE) || (COMPILE_CORE_TOOLS_CLOSE & CLOSE_USE_CORE_TOOLS_TEMPLATE_TEST) != CLOSE_USE_CORE_TOOLS_TEMPLATE_TEST
