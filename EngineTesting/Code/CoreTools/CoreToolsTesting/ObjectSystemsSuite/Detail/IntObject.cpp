...
CoreTools::IntObject
	::IntObject()
	:ParentType{}, m_IntValue{ 5 }, m_IntArray1{ NEW1<int>(bufferSize) }, m_IntArray2{ NEW1<int>(bufferSize) }
{
...
CoreTools::IntObject
	::IntObject(LoadConstructor value)
	:ParentType{ value }, m_IntValue{ 0 }, m_IntArray1{ nullptr }, m_IntArray2{ NEW1<int>(bufferSize) }
{
...
// private
void CoreTools::IntObject
	::AllocationFirstArray(int value)
{
...
void CoreTools::IntObject
	::AllocationSecondArray(int value)
{
	for (auto i = 0; i < bufferSize; ++i)
	{
		m_IntArray2[i] = value;
...
CoreTools::IntObject
	...
	:ParentType{}, m_IntValue{ rhs.m_IntValue }, m_IntArray1{ NEW1<int>(bufferSize) }, m_IntArray2{ NEW1<int>(bufferSize) }
{
	for (auto i = 0; i < bufferSize; ++i)
	{
		m_IntArray1[i] = rhs.m_IntArray1[i];
		m_IntArray2[i] = rhs.m_IntArray2[i];
	}
...
CoreTools::IntObject& CoreTools::IntObject
	::operator=(const IntObject& rhs)
{
	CLASS_IS_VALID_1;
...
void CoreTools::IntObject
	::Release()
{
	DELETE1<int>(m_IntArray1);
	DELETE1<int>(m_IntArray2);
}

#ifdef OPEN_CLASS_INVARIANT
bool CoreTools::IntObject
...
void CoreTools::IntObject
	::Link(const ObjectLinkSharedPtr& source)
{
...
void CoreTools::IntObject
	::Load(const BufferSourceSharedPtr& source)
{
	CORE_TOOLS_CLASS_IS_VALID_1;
