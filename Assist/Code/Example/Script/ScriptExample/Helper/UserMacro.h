...
#define SCRIPT_EXAMPLE_ClOSE_BEGIN (0x01)

#define CLOSE_USE_SCRIPT_EXAMPLE (SCRIPT_EXAMPLE_ClOSE_BEGIN)

#define SCRIPT_EXAMPLE_ClOSE_END CLOSE_USE_SCRIPT_EXAMPLE

#define CLOSE_SCRIPT_EXAMPLE_MAX (((SCRIPT_EXAMPLE_ClOSE_END) << 1) - 1)
...
#if !defined(COMPILE_SCRIPT_EXAMPLE_CLOSE) || (COMPILE_SCRIPT_EXAMPLE_CLOSE & CLOSE_USE_SCRIPT_EXAMPLE) != CLOSE_USE_SCRIPT_EXAMPLE

#endif  // !defined(COMPILE_SCRIPT_EXAMPLE_CLOSE) || (COMPILE_SCRIPT_EXAMPLE_CLOSE & CLOSE_USE_SCRIPT_EXAMPLE) != CLOSE_USE_SCRIPT_EXAMPLE
