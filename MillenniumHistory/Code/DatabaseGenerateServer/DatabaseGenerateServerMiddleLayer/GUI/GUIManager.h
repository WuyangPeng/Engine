...
#ifndef DATABASE_GENERATE_SERVER_MIDDLE_LAYER_GUI_MANAGER_H
#define DATABASE_GENERATE_SERVER_MIDDLE_LAYER_GUI_MANAGER_H
...
#endif  // DATABASE_GENERATE_SERVER_MIDDLE_LAYER_GUI_MANAGER_H
