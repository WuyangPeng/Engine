...
namespace System
{
    auto g_ExistsGlExtABGR = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtABGR() noexcept
{
    return g_ExistsGlExtABGR;
}

void System::InitGlExtABGR()
{
...
namespace System
{
    auto g_ExistsGlExtBlendColor = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtBlendColor() noexcept
{
...
void System::GlBlendColorEXT(GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha) noexcept
{
    SYSTEM_BODY_4(gglBlendColorEXT, red, green, blue, alpha);
}

void System::InitGlExtBlendColor()
{
...
namespace System
{
    auto g_ExistsGlExtPolygonOffset = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtPolygonOffset() noexcept
{
...
void System::GlPolygonOffsetEXT(GLfloat scale, GLfloat bias) noexcept
{
    SYSTEM_BODY_2(gglPolygonOffsetEXT, scale, bias);
}

void System::InitGlExtPolygonOffset()
{
...
namespace System
{
    auto g_ExistsGlExtTexture = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTexture() noexcept
{
    return g_ExistsGlExtTexture;
}

void System::InitGlExtTexture()
{
...
namespace System
{
    auto g_ExistsGlExtTexture3D = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTexture3D() noexcept
{
...
void System::GlTexImage3DEXT(GLenum target, GLint level, GLint internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const GLvoid* data) noexcept
{
    SYSTEM_BODY_10(gglTexImage3DEXT, target, level, internalFormat, width, height, depth, border, format, type, data);
}

void System::GlTexSubImage3DEXT(GLenum target, GLint level, GLint xOffset, GLint yOffset, GLint zOffset, GLsizei width,
...
void System::InitGlExtTexture3D()
{
...
namespace System
{
    auto g_ExistsGlExtSubtexture = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtSubtexture() noexcept
{
...
void System::GlTexSubImage1DEXT(GLenum target, GLint level, GLint xOffset, GLsizei width, GLenum format, GLenum type, const GLvoid* data) noexcept
{
    SYSTEM_BODY_7(gglTexSubImage1DEXT, target, level, xOffset, width, format, type, data);
}

void System::GlTexSubImage2DEXT(GLenum target, GLint level, GLint xOffset, GLint yOffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid* data) noexcept
{
    SYSTEM_BODY_9(gglTexSubImage2DEXT, target, level, xOffset, yOffset, width, height, format, type, data);
}

void System::InitGlExtSubtexture()
{
...
namespace System
{
    auto g_ExistsGlExtCopyTexture = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtCopyTexture() noexcept
{
...
void System::GlCopyTexImage1DEXT(GLenum target, GLint level, GLenum internalFormat, GLint x, GLint y, GLsizei width, GLint border) noexcept
{
    SYSTEM_BODY_7(gglCopyTexImage1DEXT, target, level, internalFormat, x, y, width, border);
}

void System::GlCopyTexImage2DEXT(GLenum target, GLint level, GLenum internalFormat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border) noexcept
{
    SYSTEM_BODY_8(gglCopyTexImage2DEXT, target, level, internalFormat, x, y, width, height, border);
}

void System::GlCopyTexSubImage1DEXT(GLenum target, GLint level, GLint xOffset, GLint x, GLint y, GLsizei width) noexcept
{
    SYSTEM_BODY_6(gglCopyTexSubImage1DEXT, target, level, xOffset, x, y, width);
}

void System::GlCopyTexSubImage2DEXT(GLenum target, GLint level, GLint xOffset, GLint yOffset, GLint x, GLint y, GLsizei width, GLsizei height) noexcept
{
    SYSTEM_BODY_8(gglCopyTexSubImage2DEXT, target, level, xOffset, yOffset, x, y, width, height);
}

void System::GlCopyTexSubImage3DEXT(GLenum target, GLint level, GLint xOffset, GLint yOffset, GLint zOffset, GLint x, GLint y, GLsizei width, GLsizei height) noexcept
{
    SYSTEM_BODY_9(gglCopyTexSubImage3DEXT, target, level, xOffset, yOffset, zOffset, x, y, width, height);
}

void System::InitGlExtCopyTexture()
{
...
namespace System
{
    auto g_ExistsGlExtHistogram = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtHistogram() noexcept
{
...
void System::GlGetHistogramEXT(GLenum target, GLboolean reset, GLenum format, GLenum type, GLvoid* values) noexcept
{
    SYSTEM_BODY_5(gglGetHistogramEXT, target, reset, format, type, values);
}

void System::GlGetHistogramParameterfvEXT(GLenum target, GLenum name, GLfloat* param) noexcept
{
    SYSTEM_BODY_3(gglGetHistogramParameterfvEXT, target, name, param);
}

void System::GlGetHistogramParameterivEXT(GLenum target, GLenum name, GLint* param) noexcept
{
    SYSTEM_BODY_3(gglGetHistogramParameterivEXT, target, name, param);
}

void System::GlGetMinmaxEXT(GLenum target, GLboolean reset, GLenum format, GLenum type, GLvoid* values) noexcept
{
    SYSTEM_BODY_5(gglGetMinmaxEXT, target, reset, format, type, values);
}

void System::GlGetMinmaxParameterfvEXT(GLenum target, GLenum name, GLfloat* param) noexcept
{
    SYSTEM_BODY_3(gglGetMinmaxParameterfvEXT, target, name, param);
}

void System::GlGetMinmaxParameterivEXT(GLenum target, GLenum name, GLint* param) noexcept
{
    SYSTEM_BODY_3(gglGetMinmaxParameterivEXT, target, name, param);
}

void System::GlHistogramEXT(GLenum target, GLsizei width, GLenum internalFormat, GLboolean sink) noexcept
{
    SYSTEM_BODY_4(gglHistogramEXT, target, width, internalFormat, sink);
}

void System::GlMinmaxEXT(GLenum target, GLenum internalFormat, GLboolean sink) noexcept
{
    SYSTEM_BODY_3(gglMinmaxEXT, target, internalFormat, sink);
}

void System::GlResetHistogramEXT(GLenum target) noexcept
{
    SYSTEM_BODY_1(gglResetHistogramEXT, target);
}

void System::GlResetMinmaxEXT(GLenum target) noexcept
{
    SYSTEM_BODY_1(gglResetMinmaxEXT, target);
}

void System::InitGlExtHistogram()
{
...
namespace System
{
    auto g_ExistsGlExtConvolution = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtConvolution() noexcept
{
...
void System::GlConvolutionFilter1DEXT(GLenum target, GLenum internalFormat, GLsizei width, GLenum format, GLenum type, const GLvoid* image) noexcept
{
    SYSTEM_BODY_6(gglConvolutionFilter1DEXT, target, internalFormat, width, format, type, image);
}

void System::GlConvolutionFilter2DEXT(GLenum target, GLenum internalFormat, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid* image) noexcept
{
    SYSTEM_BODY_7(gglConvolutionFilter2DEXT, target, internalFormat, width, height, format, type, image);
}

void System::GlConvolutionParameterfEXT(GLenum target, GLenum name, GLfloat param) noexcept
{
    SYSTEM_BODY_3(gglConvolutionParameterfEXT, target, name, param);
}

void System::GlConvolutionParameterfvEXT(GLenum target, GLenum name, const GLfloat* param) noexcept
{
    SYSTEM_BODY_3(gglConvolutionParameterfvEXT, target, name, param);
}

void System::GlConvolutionParameteriEXT(GLenum target, GLenum name, GLint param) noexcept
{
    SYSTEM_BODY_3(gglConvolutionParameteriEXT, target, name, param);
}

void System::GlConvolutionParameterivEXT(GLenum target, GLenum name, const GLint* param) noexcept
{
    SYSTEM_BODY_3(gglConvolutionParameterivEXT, target, name, param);
}

void System::GlCopyConvolutionFilter1DEXT(GLenum target, GLenum internalFormat, GLint x, GLint y, GLsizei width) noexcept
{
    SYSTEM_BODY_5(gglCopyConvolutionFilter1DEXT, target, internalFormat, x, y, width);
}

void System::GlCopyConvolutionFilter2DEXT(GLenum target, GLenum internalFormat, GLint x, GLint y, GLsizei width, GLsizei height) noexcept
{
    SYSTEM_BODY_6(gglCopyConvolutionFilter2DEXT, target, internalFormat, x, y, width, height);
}

void System::GlGetConvolutionFilterEXT(GLenum target, GLenum format, GLenum type, GLvoid* image) noexcept
{
    SYSTEM_BODY_4(gglGetConvolutionFilterEXT, target, format, type, image);
}

void System::GlGetConvolutionParameterfvEXT(GLenum target, GLenum name, GLfloat* param) noexcept
{
    SYSTEM_BODY_3(gglGetConvolutionParameterfvEXT, target, name, param);
}

void System::GlGetConvolutionParameterivEXT(GLenum target, GLenum name, GLint* param) noexcept
{
    SYSTEM_BODY_3(gglGetConvolutionParameterivEXT, target, name, param);
}

void System::GlGetSeparableFilterEXT(GLenum target, GLenum format, GLenum type, GLvoid* row, GLvoid* column, GLvoid* span) noexcept
{
    SYSTEM_BODY_6(gglGetSeparableFilterEXT, target, format, type, row, column, span);
}

void System::GlSeparableFilter2DEXT(GLenum target, GLenum internalFormat, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid* row, const GLvoid* column) noexcept
{
    SYSTEM_BODY_8(gglSeparableFilter2DEXT, target, internalFormat, width, height, format, type, row, column);
}

void System::InitGlExtConvolution()
{
...
namespace System
{
    auto g_ExistsGlExtCMYKA = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtCMYKA() noexcept
{
    return g_ExistsGlExtCMYKA;
}

void System::InitGlExtCMYKA()
{
...
namespace System
{
    auto g_ExistsGlExtTextureObject = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureObject() noexcept
{
...
GLboolean System::GlAreTexturesResidentEXT(GLsizei numTextures, const GLuint* textures, GLboolean* residences) noexcept
{
    SYSTEM_BODY_3_RESULT(gglAreTexturesResidentEXT, numTextures, textures, residences, GLboolean, GL_FALSE);
}

void System::GlBindTextureEXT(GLenum target, GLuint texture) noexcept
{
    SYSTEM_BODY_2(gglBindTextureEXT, target, texture);
}

void System::GlDeleteTexturesEXT(GLsizei numTextures, const GLuint* textures) noexcept
{
    SYSTEM_BODY_2(gglDeleteTexturesEXT, numTextures, textures);
}

void System::GlGenTexturesEXT(GLsizei numTextures, GLuint* texture) noexcept
{
    SYSTEM_BODY_2(gglGenTexturesEXT, numTextures, texture);
}

GLboolean System::GlIsTextureEXT(GLuint texture) noexcept
{
    SYSTEM_BODY_1_RESULT(gglIsTextureEXT, texture, GLboolean, 0);
}

void System::GlPrioritizeTexturesEXT(GLsizei numTextures, const GLuint* textures, const GLclampf* priorities) noexcept
{
    SYSTEM_BODY_3(gglPrioritizeTexturesEXT, numTextures, textures, priorities);
}

void System::InitGlExtTextureObject()
{
...
namespace System
{
    auto g_ExistsGlExtPackedPixels = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtPackedPixels() noexcept
{
    return g_ExistsGlExtPackedPixels;
}

void System::InitGlExtPackedPixels()
{
...
namespace System
{
    auto g_ExistsGlExtRescaleNormal = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtRescaleNormal() noexcept
{
    return g_ExistsGlExtRescaleNormal;
}

void System::InitGlExtRescaleNormal()
{
...
namespace System
{
    auto g_ExistsGlExtVertexArray = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtVertexArray() noexcept
{
...
void System::GlArrayElementEXT(GLint i) noexcept
{
    SYSTEM_BODY_1(gglArrayElementEXT, i);
}

void System::GlColorPointerEXT(GLint size, GLenum type, GLsizei stride, GLsizei count, const GLvoid* pointer) noexcept
{
    SYSTEM_BODY_5(gglColorPointerEXT, size, type, stride, count, pointer);
}

void System::GlDrawArraysEXT(GLenum mode, GLint first, GLsizei count) noexcept
{
    SYSTEM_BODY_3(gglDrawArraysEXT, mode, first, count);
}

void System::GlEdgeFlagPointerEXT(GLsizei stride, GLsizei count, const GLboolean* pointer) noexcept
{
    SYSTEM_BODY_3(gglEdgeFlagPointerEXT, stride, count, pointer);
}

void System::GlGetPointervEXT(GLenum name, GLvoid** param) noexcept
{
    SYSTEM_BODY_2(gglGetPointervEXT, name, param);
}

void System::GlIndexPointerEXT(GLenum type, GLsizei stride, GLsizei count, const GLvoid* pointer) noexcept
{
    SYSTEM_BODY_4(gglIndexPointerEXT, type, stride, count, pointer);
}

void System::GlNormalPointerEXT(GLenum type, GLsizei stride, GLsizei count, const GLvoid* pointer) noexcept
{
    SYSTEM_BODY_4(gglNormalPointerEXT, type, stride, count, pointer);
}

void System::GlTexCoordPointerEXT(GLint size, GLenum type, GLsizei stride, GLsizei count, const GLvoid* pointer) noexcept
{
    SYSTEM_BODY_5(gglTexCoordPointerEXT, size, type, stride, count, pointer);
}

void System::GlVertexPointerEXT(GLint size, GLenum type, GLsizei stride, GLsizei count, const GLvoid* pointer) noexcept
{
    SYSTEM_BODY_5(gglVertexPointerEXT, size, type, stride, count, pointer);
}

void System::InitGlExtVertexArray()
{
...
namespace System
{
    auto g_ExistsGlExtMiscAttribute = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtMiscAttribute() noexcept
{
    return g_ExistsGlExtMiscAttribute;
}

void System::InitGlExtMiscAttribute()
{
...
namespace System
{
    auto g_ExistsGlExtTextureEdgeClamp = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureEdgeClamp() noexcept
{
    return g_ExistsGlExtTextureEdgeClamp;
}

void System::InitGlExtTextureEdgeClamp()
{
...
namespace System
{
    auto g_ExistsGlExtBlendMinMax = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtBlendMinMax() noexcept
{
...
void System::GlBlendEquationEXT(GLenum mode) noexcept
{
    SYSTEM_BODY_1(gglBlendEquationEXT, mode);
}

void System::InitGlExtBlendMinMax()
{
...
namespace System
{
    auto g_ExistsGlExtBlendSubtract = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtBlendSubtract() noexcept
{
    return g_ExistsGlExtBlendSubtract;
}

void System::InitGlExtBlendSubtract()
{
...
namespace System
{
    auto g_ExistsGlExtBlendLogicOp = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtBlendLogicOp() noexcept
{
    return g_ExistsGlExtBlendLogicOp;
}

void System::InitGlExtBlendLogicOp()
{
...
namespace System
{
    auto g_ExistsGlExtPointParameters = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtPointParameters() noexcept
{
...
void System::GlPointParameterfEXT(GLenum name, GLfloat param) noexcept
{
    SYSTEM_BODY_2(gglPointParameterfEXT, name, param);
}

void System::GlPointParameterfvEXT(GLenum name, const GLfloat* param) noexcept
{
    SYSTEM_BODY_2(gglPointParameterfvEXT, name, param);
}

void System::InitGlExtPointParameters()
{
...
namespace System
{
    auto g_ExistsGlExtColorSubtable = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtColorSubtable() noexcept
{
...
void System::GlColorSubTableEXT(GLenum target, GLsizei start, GLsizei count, GLenum format, GLenum type, const GLvoid* data) noexcept
{
    SYSTEM_BODY_6(gglColorSubTableEXT, target, start, count, format, type, data);
}

void System::GlCopyColorSubTableEXT(GLenum target, GLsizei start, GLint x, GLint y, GLsizei width) noexcept
{
    SYSTEM_BODY_5(gglCopyColorSubTableEXT, target, start, x, y, width);
}

void System::InitGlExtColorSubtable()
{
...
namespace System
{
    auto g_ExistsGlExtPalettedTexture = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtPalettedTexture() noexcept
{
...
void System::GlColorTableEXT(GLenum target, GLenum internalFormat, GLsizei width, GLenum format, GLenum type, const GLvoid* table) noexcept
{
    SYSTEM_BODY_6(gglColorTableEXT, target, internalFormat, width, format, type, table);
}

void System::GlGetColorTableEXT(GLenum target, GLenum format, GLenum type, GLvoid* table) noexcept
{
    SYSTEM_BODY_4(gglGetColorTableEXT, target, format, type, table);
}

void System::GlGetColorTableParameterfvEXT(GLenum target, GLenum name, GLfloat* param) noexcept
{
    SYSTEM_BODY_3(gglGetColorTableParameterfvEXT, target, name, param);
}

void System::GlGetColorTableParameterivEXT(GLenum target, GLenum name, GLint* param) noexcept
{
    SYSTEM_BODY_3(gglGetColorTableParameterivEXT, target, name, param);
}

void System::InitGlExtPalettedTexture()
{
...
namespace System
{
    auto g_ExistsGlExtClipVolumeHint = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtClipVolumeHint() noexcept
{
    return g_ExistsGlExtClipVolumeHint;
}

void System::InitGlExtClipVolumeHint()
{
...
namespace System
{
    auto g_ExistsGlExtIndexTexture = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtIndexTexture() noexcept
{
    return g_ExistsGlExtIndexTexture;
}

void System::InitGlExtIndexTexture()
{
...
namespace System
{
    auto g_ExistsGlExtIndexMaterial = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtIndexMaterial() noexcept
{
...
void System::GlIndexMaterialEXT(GLenum face, GLenum mode) noexcept
{
    SYSTEM_BODY_2(gglIndexMaterialEXT, face, mode);
}

void System::InitGlExtIndexMaterial()
{
...
namespace System
{
    auto g_ExistsGlExtIndexFunc = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtIndexFunc() noexcept
{
...
void System::GlIndexFuncEXT(GLenum eFunction, GLclampf fReference) noexcept
{
    SYSTEM_BODY_2(gglIndexFuncEXT, eFunction, fReference);
}

void System::InitGlExtIndexFunc()
{
...
namespace System
{
    auto g_ExistsGlExtIndexArrayFormats = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtIndexArrayFormats() noexcept
{
    return g_ExistsGlExtIndexArrayFormats;
}

void System::InitGlExtIndexArrayFormats()
{
...
namespace System
{
    auto g_ExistsGlExtCompiledVertexArray = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtCompiledVertexArray() noexcept
{
...
void System::GlLockArraysEXT(GLint first, GLsizei count) noexcept
{
    SYSTEM_BODY_2(gglLockArraysEXT, first, count);
}

void System::GlUnlockArraysEXT() noexcept
{
    SYSTEM_BODY_0(gglUnlockArraysEXT);
}

void System::InitGlExtCompiledVertexArray()
{
...
namespace System
{
    auto g_ExistsGlExtCullVertex = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtCullVertex() noexcept
{
...
void System::GlCullParameterdvEXT(GLenum name, GLdouble* param) noexcept
{
    SYSTEM_BODY_2(gglCullParameterdvEXT, name, param);
}

void System::GlCullParameterfvEXT(GLenum name, GLfloat* param) noexcept
{
    SYSTEM_BODY_2(gglCullParameterfvEXT, name, param);
}

void System::InitGlExtCullVertex()
{
...
namespace System
{
    auto g_ExistsGlExtFragmentLighting = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtFragmentLighting() noexcept
{
...
void System::GlFragmentColorMaterialEXT(GLenum face, GLenum mode) noexcept
{
    SYSTEM_BODY_2(gglFragmentColorMaterialEXT, face, mode);
}

void System::GlFragmentLightModelfEXT(GLenum parameterName, GLfloat param) noexcept
{
    SYSTEM_BODY_2(gglFragmentLightModelfEXT, parameterName, param);
}

void System::GlFragmentLightModelfvEXT(GLenum parameterName, GLfloat* params) noexcept
{
    SYSTEM_BODY_2(gglFragmentLightModelfvEXT, parameterName, params);
}

void System::GlFragmentLightModeliEXT(GLenum parameterName, GLint param) noexcept
{
    SYSTEM_BODY_2(gglFragmentLightModeliEXT, parameterName, param);
}

void System::GlFragmentLightModelivEXT(GLenum parameterName, GLint* params) noexcept
{
    SYSTEM_BODY_2(gglFragmentLightModelivEXT, parameterName, params);
}

void System::GlFragmentLightfEXT(GLenum light, GLenum parameterName, GLfloat param) noexcept
{
    SYSTEM_BODY_3(gglFragmentLightfEXT, light, parameterName, param);
}

void System::GlFragmentLightfvEXT(GLenum light, GLenum parameterName, GLfloat* params) noexcept
{
    SYSTEM_BODY_3(gglFragmentLightfvEXT, light, parameterName, params);
}

void System::GlFragmentLightiEXT(GLenum light, GLenum parameterName, GLint param) noexcept
{
    SYSTEM_BODY_3(gglFragmentLightiEXT, light, parameterName, param);
}

void System::GlFragmentLightivEXT(GLenum light, GLenum parameterName, GLint* params) noexcept
{
    SYSTEM_BODY_3(gglFragmentLightivEXT, light, parameterName, params);
}

void System::GlFragmentMaterialfEXT(GLenum face, GLenum parameterName, const GLfloat param) noexcept
{
    SYSTEM_BODY_3(gglFragmentMaterialfEXT, face, parameterName, param);
}

void System::GlFragmentMaterialfvEXT(GLenum face, GLenum parameterName, const GLfloat* params) noexcept
{
    SYSTEM_BODY_3(gglFragmentMaterialfvEXT, face, parameterName, params);
}

void System::GlFragmentMaterialiEXT(GLenum face, GLenum parameterName, const GLint param) noexcept
{
    SYSTEM_BODY_3(gglFragmentMaterialiEXT, face, parameterName, param);
}

void System::GlFragmentMaterialivEXT(GLenum face, GLenum parameterName, const GLint* params) noexcept
{
    SYSTEM_BODY_3(gglFragmentMaterialivEXT, face, parameterName, params);
}

void System::GlGetFragmentLightfvEXT(GLenum light, GLenum parameterName, GLfloat* params) noexcept
{
    SYSTEM_BODY_3(gglGetFragmentLightfvEXT, light, parameterName, params);
}

void System::GlGetFragmentLightivEXT(GLenum light, GLenum parameterName, GLint* params) noexcept
{
    SYSTEM_BODY_3(gglGetFragmentLightivEXT, light, parameterName, params);
}

void System::GlGetFragmentMaterialfvEXT(GLenum face, GLenum parameterName, const GLfloat* params) noexcept
{
    SYSTEM_BODY_3(gglGetFragmentMaterialfvEXT, face, parameterName, params);
}

void System::GlGetFragmentMaterialivEXT(GLenum face, GLenum parameterName, const GLint* params) noexcept
{
    SYSTEM_BODY_3(gglGetFragmentMaterialivEXT, face, parameterName, params);
}

void System::GlLightEnviEXT(GLenum parameterName, GLint param) noexcept
{
    SYSTEM_BODY_2(gglLightEnviEXT, parameterName, param);
}

void System::InitGlExtFragmentLighting()
{
...
namespace System
{
    auto g_ExistsGlExtDrawRangeElements = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtDrawRangeElements() noexcept
{
...
void System::GlDrawRangeElementsEXT(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid* indices) noexcept
{
    SYSTEM_BODY_6(gglDrawRangeElementsEXT, mode, start, end, count, type, indices);
}

void System::InitGlExtDrawRangeElements()
{
...
namespace System
{
    auto g_ExistsGlExtLightTexture = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtLightTexture() noexcept
{
...
void System::GlApplyTextureEXT(GLenum mode) noexcept
{
    SYSTEM_BODY_1(gglApplyTextureEXT, mode);
}

void System::GlTextureLightEXT(GLenum name) noexcept
{
    SYSTEM_BODY_1(gglTextureLightEXT, name);
}

void System::GlTextureMaterialEXT(GLenum face, GLenum mode) noexcept
{
    SYSTEM_BODY_2(gglTextureMaterialEXT, face, mode);
}

void System::InitGlExtLightTexture()
{
...
namespace System
{
    auto g_ExistsGlExtSceneMarker = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtSceneMarker() noexcept
{
...
void System::GlBeginSceneEXT(void) noexcept
{
    SYSTEM_BODY_0(gglBeginSceneEXT);
}

void System::GlEndSceneEXT(void) noexcept
{
    SYSTEM_BODY_0(gglEndSceneEXT);
}

void System::InitGlExtSceneMarker()
{
...
namespace System
{
    auto g_ExistsGlExtBGRA = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtBGRA() noexcept
{
    return g_ExistsGlExtBGRA;
}

void System::InitGlExtBGRA()
{
...
namespace System
{
    auto g_ExistsGlExtPixelTransform = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtPixelTransform() noexcept
{
...
void System::GlPixelTransformParameteriEXT(GLenum target, GLenum name, GLint param) noexcept
{
    SYSTEM_BODY_3(gglPixelTransformParameteriEXT, target, name, param);
}

void System::GlPixelTransformParameterfEXT(GLenum target, GLenum name, GLfloat param) noexcept
{
    SYSTEM_BODY_3(gglPixelTransformParameterfEXT, target, name, param);
}

void System::GlPixelTransformParameterivEXT(GLenum target, GLenum name, const GLint* param) noexcept
{
    SYSTEM_BODY_3(gglPixelTransformParameterivEXT, target, name, param);
}

void System::GlPixelTransformParameterfvEXT(GLenum target, GLenum name, const GLfloat* param) noexcept
{
    SYSTEM_BODY_3(gglPixelTransformParameterfvEXT, target, name, param);
}

void System::InitGlExtPixelTransform()
{
...
namespace System
{
    auto g_ExistsGlExtPixelTransformColorTable = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtPixelTransformColorTable() noexcept
{
    return g_ExistsGlExtPixelTransformColorTable;
}

void System::InitGlExtPixelTransformColorTable()
{
...
namespace System
{
    auto g_ExistsGlExtSharedTexturePalette = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtSharedTexturePalette() noexcept
{
    return g_ExistsGlExtSharedTexturePalette;
}

void System::InitGlExtSharedTexturePalette()
{
...
namespace System
{
    auto g_ExistsGlExtSeparateSpecularColor = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtSeparateSpecularColor() noexcept
{
    return g_ExistsGlExtSeparateSpecularColor;
}

void System::InitGlExtSeparateSpecularColor()
{
...
namespace System
{
    auto g_ExistsGlExtSecondaryColor = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtSecondaryColor() noexcept
{
...
void System::GlSecondaryColor3bEXT(GLbyte red, GLbyte green, GLbyte blue) noexcept
{
    SYSTEM_BODY_3(gglSecondaryColor3bEXT, red, green, blue);
}

void System::GlSecondaryColor3bvEXT(const GLbyte* rgb) noexcept
{
    SYSTEM_BODY_1(gglSecondaryColor3bvEXT, rgb);
}

void System::GlSecondaryColor3dEXT(GLdouble red, GLdouble green, GLdouble blue) noexcept
{
    SYSTEM_BODY_3(gglSecondaryColor3dEXT, red, green, blue);
}

void System::GlSecondaryColor3dvEXT(const GLdouble* rgb) noexcept
{
    SYSTEM_BODY_1(gglSecondaryColor3dvEXT, rgb);
}

void System::GlSecondaryColor3fEXT(GLfloat red, GLfloat green, GLfloat blue) noexcept
{
    SYSTEM_BODY_3(gglSecondaryColor3fEXT, red, green, blue);
}

void System::GlSecondaryColor3fvEXT(const GLfloat* rgb) noexcept
{
    SYSTEM_BODY_1(gglSecondaryColor3fvEXT, rgb);
}

void System::GlSecondaryColor3iEXT(GLint red, GLint green, GLint blue) noexcept
{
    SYSTEM_BODY_3(gglSecondaryColor3iEXT, red, green, blue);
}

void System::GlSecondaryColor3ivEXT(const GLint* rgb) noexcept
{
    SYSTEM_BODY_1(gglSecondaryColor3ivEXT, rgb);
}

void System::GlSecondaryColor3sEXT(GLshort red, GLshort green, GLshort blue) noexcept
{
    SYSTEM_BODY_3(gglSecondaryColor3sEXT, red, green, blue);
}

void System::GlSecondaryColor3svEXT(const GLshort* rgb) noexcept
{
    SYSTEM_BODY_1(gglSecondaryColor3svEXT, rgb);
}

void System::GlSecondaryColor3ubEXT(GLubyte red, GLubyte green, GLubyte blue) noexcept
{
    SYSTEM_BODY_3(gglSecondaryColor3ubEXT, red, green, blue);
}

void System::GlSecondaryColor3ubvEXT(const GLubyte* rgb) noexcept
{
    SYSTEM_BODY_1(gglSecondaryColor3ubvEXT, rgb);
}

void System::GlSecondaryColor3uiEXT(GLuint red, GLuint green, GLuint blue) noexcept
{
    SYSTEM_BODY_3(gglSecondaryColor3uiEXT, red, green, blue);
}

void System::GlSecondaryColor3uivEXT(const GLuint* rgb) noexcept
{
    SYSTEM_BODY_1(gglSecondaryColor3uivEXT, rgb);
}

void System::GlSecondaryColor3usEXT(GLushort red, GLushort green, GLushort blue) noexcept
{
    SYSTEM_BODY_3(gglSecondaryColor3usEXT, red, green, blue);
}

void System::GlSecondaryColor3usvEXT(const GLushort* rgb) noexcept
{
    SYSTEM_BODY_1(gglSecondaryColor3usvEXT, rgb);
}

void System::GlSecondaryColorPointerEXT(GLint size, GLenum type, GLsizei stride, const GLvoid* pointer) noexcept
{
    SYSTEM_BODY_4(gglSecondaryColorPointerEXT, size, type, stride, pointer);
}

void System::InitGlExtSecondaryColor()
{
...
namespace System
{
    auto g_ExistsGlExtTextureEnv = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureEnv() noexcept
{
    return g_ExistsGlExtTextureEnv;
}

void System::InitGlExtTextureEnv()
{
...
namespace System
{
    auto g_ExistsGlExtTexturePerturbNormal = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTexturePerturbNormal() noexcept
{
...
void System::GlTextureNormalEXT(GLenum mode) noexcept
{
    SYSTEM_BODY_1(gglTextureNormalEXT, mode);
}

void System::InitGlExtTexturePerturbNormal()
{
...
namespace System
{
    auto g_ExistsGlExtMultidrawArrays = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtMultidrawArrays() noexcept
{
...
void System::GlMultiDrawArraysEXT(GLenum mode, GLint* first, GLsizei* count, GLsizei primitiveCount) noexcept
{
    SYSTEM_BODY_4(gglMultiDrawArraysEXT, mode, first, count, primitiveCount);
}

void System::GlMultiDrawElementsEXT(GLenum mode, const GLsizei* count, GLenum type, const GLvoid** indices, GLsizei primitiveCount) noexcept
{
    SYSTEM_BODY_5(gglMultiDrawElementsEXT, mode, count, type, indices, primitiveCount);
}

void System::InitGlExtMultidrawArrays()
{
...
namespace System
{
    auto g_ExistsGlExtFogCoord = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtFogCoord() noexcept
{
...
void System::GlFogCoorddEXT(GLdouble coord) noexcept
{
    SYSTEM_BODY_1(gglFogCoorddEXT, coord);
}

void System::GlFogCoorddvEXT(const GLdouble* coord) noexcept
{
    SYSTEM_BODY_1(gglFogCoorddvEXT, coord);
}

void System::GlFogCoordfEXT(GLfloat coord) noexcept
{
    SYSTEM_BODY_1(gglFogCoordfEXT, coord);
}

void System::GlFogCoordfvEXT(const GLfloat* coord) noexcept
{
    SYSTEM_BODY_1(gglFogCoordfvEXT, coord);
}

void System::GlFogCoordPointerEXT(GLenum type, GLsizei stride, const GLvoid* pointer) noexcept
{
    SYSTEM_BODY_3(gglFogCoordPointerEXT, type, stride, pointer);
}

void System::InitGlExtFogCoord()
{
...
namespace System
{
    auto g_ExistsGlExtCoordinateFrame = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtCoordinateFrame() noexcept
{
...
void System::GlTangent3bEXT(GLbyte x, GLbyte y, GLbyte z) noexcept
{
    SYSTEM_BODY_3(gglTangent3bEXT, x, y, z);
}

void System::GlTangent3bvEXT(const GLbyte* xyz) noexcept
{
    SYSTEM_BODY_1(gglTangent3bvEXT, xyz);
}

void System::GlTangent3dEXT(GLdouble x, GLdouble y, GLdouble z) noexcept
{
    SYSTEM_BODY_3(gglTangent3dEXT, x, y, z);
}

void System::GlTangent3dvEXT(const GLdouble* xyz) noexcept
{
    SYSTEM_BODY_1(gglTangent3dvEXT, xyz);
}

void System::GlTangent3fEXT(GLfloat x, GLfloat y, GLfloat z) noexcept
{
    SYSTEM_BODY_3(gglTangent3fEXT, x, y, z);
}

void System::GlTangent3fvEXT(const GLfloat* xyz) noexcept
{
    SYSTEM_BODY_1(gglTangent3fvEXT, xyz);
}

void System::GlTangent3iEXT(GLint x, GLint y, GLint z) noexcept
{
    SYSTEM_BODY_3(gglTangent3iEXT, x, y, z);
}

void System::GlTangent3ivEXT(const GLint* xyz) noexcept
{
    SYSTEM_BODY_1(gglTangent3ivEXT, xyz);
}

void System::GlTangent3sEXT(GLshort x, GLshort y, GLshort z) noexcept
{
    SYSTEM_BODY_3(gglTangent3sEXT, x, y, z);
}

void System::GlTangent3svEXT(const GLshort* xyz) noexcept
{
    SYSTEM_BODY_1(gglTangent3svEXT, xyz);
}

void System::GlBinormal3bEXT(GLbyte x, GLbyte y, GLbyte z) noexcept
{
    SYSTEM_BODY_3(gglBinormal3bEXT, x, y, z);
}

void System::GlBinormal3bvEXT(const GLbyte* xyz) noexcept
{
    SYSTEM_BODY_1(gglBinormal3bvEXT, xyz);
}

void System::GlBinormal3dEXT(GLdouble x, GLdouble y, GLdouble z) noexcept
{
    SYSTEM_BODY_3(gglBinormal3dEXT, x, y, z);
}

void System::GlBinormal3dvEXT(const GLdouble* xyz) noexcept
{
    SYSTEM_BODY_1(gglBinormal3dvEXT, xyz);
}

void System::GlBinormal3fEXT(GLfloat x, GLfloat y, GLfloat z) noexcept
{
    SYSTEM_BODY_3(gglBinormal3fEXT, x, y, z);
}

void System::GlBinormal3fvEXT(const GLfloat* xyz) noexcept
{
    SYSTEM_BODY_1(gglBinormal3fvEXT, xyz);
}

void System::GlBinormal3iEXT(GLint x, GLint y, GLint z) noexcept
{
    SYSTEM_BODY_3(gglBinormal3iEXT, x, y, z);
}

void System::GlBinormal3ivEXT(const GLint* xyz) noexcept
{
    SYSTEM_BODY_1(gglBinormal3ivEXT, xyz);
}

void System::GlBinormal3sEXT(GLshort x, GLshort y, GLshort z) noexcept
{
    SYSTEM_BODY_3(gglBinormal3sEXT, x, y, z);
}

void System::GlBinormal3svEXT(const GLshort* xyz) noexcept
{
    SYSTEM_BODY_1(gglBinormal3svEXT, xyz);
}

void System::GlTangentPointerEXT(GLenum type, GLsizei stride, const GLvoid* pointer) noexcept
{
    SYSTEM_BODY_3(gglTangentPointerEXT, type, stride, pointer);
}

void System::GlBinormalPointerEXT(GLenum type, GLsizei stride, const GLvoid* pointer) noexcept
{
    SYSTEM_BODY_3(gglBinormalPointerEXT, type, stride, pointer);
}

void System::InitGlExtCoordinateFrame()
{
...
namespace System
{
    auto g_ExistsGlExtTextureEnvCombine = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureEnvCombine() noexcept
{
    return g_ExistsGlExtTextureEnvCombine;
}

void System::InitGlExtTextureEnvCombine()
{
...
namespace System
{
    auto g_ExistsGlExtBlendFuncSeparate = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtBlendFuncSeparate() noexcept
{
...
void System::GlBlendFuncSeparateEXT(GLenum srcFactorRGB, GLenum dstFactorRGB, GLenum srcFactorA, GLenum dstFactorA) noexcept
{
    SYSTEM_BODY_4(gglBlendFuncSeparateEXT, srcFactorRGB, dstFactorRGB, srcFactorA, dstFactorA);
}

void System::InitGlExtBlendFuncSeparate()
{
...
namespace System
{
    auto g_ExistsGlExtStencilWrap = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtStencilWrap() noexcept
{
    return g_ExistsGlExtStencilWrap;
}

void System::InitGlExtStencilWrap()
{
...
namespace System
{
    auto g_ExistsGlExt422Pixels = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExt422Pixels() noexcept
{
    return g_ExistsGlExt422Pixels;
}

void System::InitGlExt422Pixels()
{
...
namespace System
{
    auto g_ExistsGlExtTextureCubeMap = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureCubeMap() noexcept
{
    return g_ExistsGlExtTextureCubeMap;
}

void System::InitGlExtTextureCubeMap()
{
...
namespace System
{
    auto g_ExistsGlExtTextureEnvAdd = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureEnvAdd() noexcept
{
    return g_ExistsGlExtTextureEnvAdd;
}

void System::InitGlExtTextureEnvAdd()
{
...
namespace System
{
    auto g_ExistsGlExtTextureLodBias = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureLodBias() noexcept
{
    return g_ExistsGlExtTextureLodBias;
}

void System::InitGlExtTextureLodBias()
{
...
namespace System
{
    auto g_ExistsGlExtTextureFilterAnisotropic = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureFilterAnisotropic() noexcept
{
    return g_ExistsGlExtTextureFilterAnisotropic;
}

void System::InitGlExtTextureFilterAnisotropic()
{
...
namespace System
{
    auto g_ExistsGlExtVertexWeighting = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtVertexWeighting() noexcept
{
...
void System::GlVertexWeightfEXT(GLfloat weight) noexcept
{
    SYSTEM_BODY_1(gglVertexWeightfEXT, weight);
}

void System::GlVertexWeightfvEXT(const GLfloat* weight) noexcept
{
    SYSTEM_BODY_1(gglVertexWeightfvEXT, weight);
}

void System::GlVertexWeightPointerEXT(GLsizei size, GLenum type, GLsizei stride, const GLvoid* pointer) noexcept
{
    SYSTEM_BODY_4(gglVertexWeightPointerEXT, size, type, stride, pointer);
}

void System::InitGlExtVertexWeighting()
{
...
namespace System
{
    auto g_ExistsGlExtTextureCompressionS3TC = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureCompressionS3TC() noexcept
{
    return g_ExistsGlExtTextureCompressionS3TC;
}

void System::InitGlExtTextureCompressionS3TC()
{
...
namespace System
{
    auto g_ExistsGlExtMultisample = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtMultisample() noexcept
{
...
void System::GlSampleMaskEXT(GLclampf value, GLboolean invert) noexcept
{
    SYSTEM_BODY_2(gglSampleMaskEXT, value, invert);
}

void System::GlSamplePatternEXT(GLenum pattern) noexcept
{
    SYSTEM_BODY_1(gglSamplePatternEXT, pattern);
}

void System::InitGlExtMultisample()
{
...
namespace System
{
    auto g_ExistsGlExtTextureEnvDot3 = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureEnvDot3() noexcept
{
    return g_ExistsGlExtTextureEnvDot3;
}

void System::InitGlExtTextureEnvDot3()
{
...
namespace System
{
    auto g_ExistsGlExtTextureRectangle = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureRectangle() noexcept
{
    return g_ExistsGlExtTextureRectangle;
}

void System::InitGlExtTextureRectangle()
{
...
namespace System
{
    auto g_ExistsGlExtVertexShader = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtVertexShader() noexcept
{
...
void System::GlBeginVertexShaderEXT(void) noexcept
{
    SYSTEM_BODY_0(gglBeginVertexShaderEXT);
}

GLuint System::GlBindLightParameterEXT(GLenum light, GLenum value) noexcept
{
    SYSTEM_BODY_2_RESULT(gglBindLightParameterEXT, light, value, GLuint, 0);
}

GLuint System::GlBindMaterialParameterEXT(GLenum face, GLenum value) noexcept
{
    SYSTEM_BODY_2_RESULT(gglBindMaterialParameterEXT, face, value, GLuint, 0);
}

GLuint System::GlBindParameterEXT(GLenum value) noexcept
{
    SYSTEM_BODY_1_RESULT(gglBindParameterEXT, value, GLuint, 0);
}

GLuint System::GlBindTexGenParameterEXT(GLenum unit, GLenum coord, GLenum value) noexcept
{
    SYSTEM_BODY_3_RESULT(gglBindTexGenParameterEXT, unit, coord, value, GLuint, 0);
}

GLuint System::GlBindTextureUnitParameterEXT(GLenum unit, GLenum value) noexcept
{
    SYSTEM_BODY_2_RESULT(gglBindTextureUnitParameterEXT, unit, value, GLuint, 0);
}

void System::GlBindVertexShaderEXT(GLuint id) noexcept
{
    SYSTEM_BODY_1(gglBindVertexShaderEXT, id);
}

void System::GlDeleteVertexShaderEXT(GLuint id) noexcept
{
    SYSTEM_BODY_1(gglDeleteVertexShaderEXT, id);
}

void System::GlDisableVariantClientStateEXT(GLuint id) noexcept
{
    SYSTEM_BODY_1(gglDisableVariantClientStateEXT, id);
}

void System::GlEnableVariantClientStateEXT(GLuint id) noexcept
{
    SYSTEM_BODY_1(gglEnableVariantClientStateEXT, id);
}

void System::GlEndVertexShaderEXT(void) noexcept
{
    SYSTEM_BODY_0(gglEndVertexShaderEXT);
}

void System::GlExtractComponentEXT(GLuint res, GLuint src, GLuint num) noexcept
{
    SYSTEM_BODY_3(gglExtractComponentEXT, res, src, num);
}

GLuint System::GlGenSymbolsEXT(GLenum dataType, GLenum storageType, GLenum range, GLuint components) noexcept
{
    SYSTEM_BODY_4_RESULT(gglGenSymbolsEXT, dataType, storageType, range, components, GLuint, 0);
}

GLuint System::GlGenVertexShadersEXT(GLuint range) noexcept
{
    SYSTEM_BODY_1_RESULT(gglGenVertexShadersEXT, range, GLuint, 0);
}

void System::GlGetInvariantBooleanvEXT(GLuint id, GLenum value, GLboolean* data) noexcept
{
    SYSTEM_BODY_3(gglGetInvariantBooleanvEXT, id, value, data);
}

void System::GlGetInvariantFloatvEXT(GLuint id, GLenum value, GLfloat* data) noexcept
{
    SYSTEM_BODY_3(gglGetInvariantFloatvEXT, id, value, data);
}

void System::GlGetInvariantIntegervEXT(GLuint id, GLenum value, GLint* data) noexcept
{
    SYSTEM_BODY_3(gglGetInvariantIntegervEXT, id, value, data);
}

void System::GlGetLocalConstantBooleanvEXT(GLuint id, GLenum value, GLboolean* data) noexcept
{
    SYSTEM_BODY_3(gglGetLocalConstantBooleanvEXT, id, value, data);
}

void System::GlGetLocalConstantFloatvEXT(GLuint id, GLenum value, GLfloat* data) noexcept
{
    SYSTEM_BODY_3(gglGetLocalConstantFloatvEXT, id, value, data);
}

void System::GlGetLocalConstantIntegervEXT(GLuint id, GLenum value, GLint* data) noexcept
{
    SYSTEM_BODY_3(gglGetLocalConstantIntegervEXT, id, value, data);
}

void System::GlGetVariantBooleanvEXT(GLuint id, GLenum value, GLboolean* data) noexcept
{
    SYSTEM_BODY_3(gglGetVariantBooleanvEXT, id, value, data);
}

void System::GlGetVariantFloatvEXT(GLuint id, GLenum value, GLfloat* data) noexcept
{
    SYSTEM_BODY_3(gglGetVariantFloatvEXT, id, value, data);
}

void System::GlGetVariantIntegervEXT(GLuint id, GLenum value, GLint* data) noexcept
{
    SYSTEM_BODY_3(gglGetVariantIntegervEXT, id, value, data);
}

void System::GlGetVariantPointervEXT(GLuint id, GLenum value, void** data) noexcept
{
    SYSTEM_BODY_3(gglGetVariantPointervEXT, id, value, data);
}

void System::GlInsertComponentEXT(GLuint res, GLuint src, GLuint num) noexcept
{
    SYSTEM_BODY_3(gglInsertComponentEXT, res, src, num);
}

GLboolean System::GlIsVariantEnabledEXT(GLuint id, GLenum cap) noexcept
{
    SYSTEM_BODY_2_RESULT(gglIsVariantEnabledEXT, id, cap, GLboolean, GL_FALSE);
}

void System::GlSetInvariantEXT(GLuint id, GLenum type, void* addr) noexcept
{
    SYSTEM_BODY_3(gglSetInvariantEXT, id, type, addr);
}

void System::GlSetLocalConstantEXT(GLuint id, GLenum type, void* addr) noexcept
{
    SYSTEM_BODY_3(gglSetLocalConstantEXT, id, type, addr);
}

void System::GlShaderOp1EXT(GLenum op, GLuint res, GLuint arg1) noexcept
{
    SYSTEM_BODY_3(gglShaderOp1EXT, op, res, arg1);
}

void System::GlShaderOp2EXT(GLenum op, GLuint res, GLuint arg1, GLuint arg2) noexcept
{
    SYSTEM_BODY_4(gglShaderOp2EXT, op, res, arg1, arg2);
}

void System::GlShaderOp3EXT(GLenum op, GLuint res, GLuint arg1, GLuint arg2, GLuint arg3) noexcept
{
    SYSTEM_BODY_5(gglShaderOp3EXT, op, res, arg1, arg2, arg3);
}

void System::GlSwizzleEXT(GLuint res, GLuint in, GLenum outX, GLenum outY, GLenum outZ, GLenum outW) noexcept
{
    SYSTEM_BODY_6(gglSwizzleEXT, res, in, outX, outY, outZ, outW);
}

void System::GlVariantPointerEXT(GLuint id, GLenum type, GLuint stride, void* addr) noexcept
{
    SYSTEM_BODY_4(gglVariantPointerEXT, id, type, stride, addr);
}

void System::GlVariantbvEXT(GLuint id, GLbyte* addr) noexcept
{
    SYSTEM_BODY_2(gglVariantbvEXT, id, addr);
}

void System::GlVariantdvEXT(GLuint id, GLdouble* addr) noexcept
{
    SYSTEM_BODY_2(gglVariantdvEXT, id, addr);
}

void System::GlVariantfvEXT(GLuint id, GLfloat* addr) noexcept
{
    SYSTEM_BODY_2(gglVariantfvEXT, id, addr);
}

void System::GlVariantivEXT(GLuint id, GLint* addr) noexcept
{
    SYSTEM_BODY_2(gglVariantivEXT, id, addr);
}

void System::GlVariantsvEXT(GLuint id, GLshort* addr) noexcept
{
    SYSTEM_BODY_2(gglVariantsvEXT, id, addr);
}

void System::GlVariantubvEXT(GLuint id, GLubyte* addr) noexcept
{
    SYSTEM_BODY_2(gglVariantubvEXT, id, addr);
}

void System::GlVariantuivEXT(GLuint id, GLuint* addr) noexcept
{
    SYSTEM_BODY_2(gglVariantuivEXT, id, addr);
}

void System::GlVariantusvEXT(GLuint id, GLushort* addr) noexcept
{
    SYSTEM_BODY_2(gglVariantusvEXT, id, addr);
}

void System::GlWriteMaskEXT(GLuint res, GLuint in, GLenum outX, GLenum outY, GLenum outZ, GLenum outW) noexcept
{
    SYSTEM_BODY_6(gglWriteMaskEXT, res, in, outX, outY, outZ, outW);
}

void System::InitGlExtVertexShader()
{
...
namespace System
{
    auto g_ExistsGlExtShadowFuncs = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtShadowFuncs() noexcept
{
    return g_ExistsGlExtShadowFuncs;
}

void System::InitGlExtShadowFuncs()
{
...
namespace System
{
    auto g_ExistsGlExtStencilTwoSide = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtStencilTwoSide() noexcept
{
...
void System::GlActiveStencilFaceEXT(GLenum face) noexcept
{
    SYSTEM_BODY_1(gglActiveStencilFaceEXT, face);
}

void System::InitGlExtStencilTwoSide()
{
...
namespace System
{
    auto g_ExistsGlExtDepthBoundsTest = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtDepthBoundsTest() noexcept
{
...
void System::GlDepthBoundsEXT(GLclampd min, GLclampd max) noexcept
{
    SYSTEM_BODY_2(gglDepthBoundsEXT, min, max);
}

void System::InitGlExtDepthBoundsTest()
{
...
namespace System
{
    auto g_ExistsGlExtTextureMirrorClamp = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureMirrorClamp() noexcept
{
    return g_ExistsGlExtTextureMirrorClamp;
}

void System::InitGlExtTextureMirrorClamp()
{
...
namespace System
{
    auto g_ExistsGlExtBlendEquationSeparate = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtBlendEquationSeparate() noexcept
{
...
void System::GlBlendEquationSeparateEXT(GLenum modeRGB, GLenum modeAlpha) noexcept
{
    SYSTEM_BODY_2(gglBlendEquationSeparateEXT, modeRGB, modeAlpha);
}

void System::InitGlExtBlendEquationSeparate()
{
...
namespace System
{
    auto g_ExistsGlExtPixelBufferObject = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtPixelBufferObject() noexcept
{
    return g_ExistsGlExtPixelBufferObject;
}

void System::InitGlExtPixelBufferObject()
{
...
namespace System
{
    auto g_ExistsGlExtTextureCompressionDXT1 = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureCompressionDXT1() noexcept
{
    return g_ExistsGlExtTextureCompressionDXT1;
}

void System::InitGlExtTextureCompressionDXT1()
{
...
namespace System
{
    auto g_ExistsGlExtFrameBufferObject = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtFrameBufferObject() noexcept
{
...
GLboolean System::GlIsRenderbufferEXT(GLuint renderBuffer) noexcept
{
    SYSTEM_BODY_1_RESULT(gglIsRenderbufferEXT, renderBuffer, GLboolean, GL_FALSE);
}

void System::GlBindRenderbufferEXT(GLenum target, GLuint renderBuffer) noexcept
{
    SYSTEM_BODY_2(gglBindRenderbufferEXT, target, renderBuffer);
}

void System::GlDeleteRenderbuffersEXT(GLsizei numBuffers, const GLuint* renderBuffer) noexcept
{
    SYSTEM_BODY_2(gglDeleteRenderbuffersEXT, numBuffers, renderBuffer);
}

void System::GlGenRenderbuffersEXT(GLsizei numBuffers, GLuint* renderBuffer) noexcept
{
    SYSTEM_BODY_2(gglGenRenderbuffersEXT, numBuffers, renderBuffer);
}

void System::GlRenderbufferStorageEXT(GLenum target, GLenum internalFormat, GLsizei width, GLsizei height) noexcept
{
    SYSTEM_BODY_4(gglRenderbufferStorageEXT, target, internalFormat, width, height);
}

void System::GlGetRenderbufferParameterivEXT(GLenum target, GLenum name, GLint* param) noexcept
{
    SYSTEM_BODY_3(gglGetRenderbufferParameterivEXT, target, name, param);
}

GLboolean System::GlIsFramebufferEXT(GLuint frameBuffer) noexcept
{
    SYSTEM_BODY_1_RESULT(gglIsFramebufferEXT, frameBuffer, GLboolean, GL_FALSE);
}

void System::GlBindFramebufferEXT(GLenum target, GLuint frameBuffer) noexcept
{
    SYSTEM_BODY_2(gglBindFramebufferEXT, target, frameBuffer);
}

void System::GlDeleteFramebuffersEXT(GLsizei numBuffers, const GLuint* frameBuffer) noexcept
{
    SYSTEM_BODY_2(gglDeleteFramebuffersEXT, numBuffers, frameBuffer);
}

void System::GlGenFramebuffersEXT(GLsizei numBuffers, GLuint* frameBuffer) noexcept
{
    SYSTEM_BODY_2(gglGenFramebuffersEXT, numBuffers, frameBuffer);
}

GLenum System::GlCheckFramebufferStatusEXT(GLenum target) noexcept
{
    SYSTEM_BODY_1_RESULT(gglCheckFramebufferStatusEXT, target, GLenum, GL_FRAMEBUFFER_UNSUPPORTED_EXT);
}

void System::GlFramebufferTexture1DEXT(GLenum target, GLenum attachment, GLenum textureTarget, GLuint texture, GLint level) noexcept
{
    SYSTEM_BODY_5(gglFramebufferTexture1DEXT, target, attachment, textureTarget, texture, level);
}

void System::GlFramebufferTexture2DEXT(GLenum target, GLenum attachment, GLenum textureTarget, GLuint texture, GLint level) noexcept
{
    SYSTEM_BODY_5(gglFramebufferTexture2DEXT, target, attachment, textureTarget, texture, level);
}

void System::GlFramebufferTexture3DEXT(GLenum target, GLenum attachment, GLenum textureTarget, GLuint texture, GLint level, GLint zOffset) noexcept
{
    SYSTEM_BODY_6(gglFramebufferTexture3DEXT, target, attachment, textureTarget, texture, level, zOffset);
}

void System::GlFramebufferRenderbufferEXT(GLenum target, GLenum attachment, GLenum renderBufferTarget, GLuint renderBuffer) noexcept
{
    SYSTEM_BODY_4(gglFramebufferRenderbufferEXT, target, attachment, renderBufferTarget, renderBuffer);
}

void System::GlGetFramebufferAttachmentParameterivEXT(GLenum target, GLenum attachment, GLenum name, GLint* param) noexcept
{
    SYSTEM_BODY_4(gglGetFramebufferAttachmentParameterivEXT, target, attachment, name, param);
}

void System::GlGenerateMipmapEXT(GLenum target) noexcept
{
    SYSTEM_BODY_1(gglGenerateMipmapEXT, target);
}

void System::InitGlExtFrameBufferObject()
{
...
namespace System
{
    auto g_ExistsGlExtPackedDepthStencil = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtPackedDepthStencil() noexcept
{
    return g_ExistsGlExtPackedDepthStencil;
}

void System::InitGlExtPackedDepthStencil()
{
...
namespace System
{
    auto g_ExistsGlExtStencilClearTag = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtStencilClearTag() noexcept
{
...
void System::GlStencilClearTagEXT(GLsizei stencilTagBits, GLuint stencilClearTag) noexcept
{
    SYSTEM_BODY_2(gglStencilClearTagEXT, stencilTagBits, stencilClearTag);
}

void System::InitGlExtStencilClearTag()
{
...
namespace System
{
    auto g_ExistsGlExtTextureSRGB = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureSRGB() noexcept
{
    return g_ExistsGlExtTextureSRGB;
}

void System::InitGlExtTextureSRGB()
{
...
namespace System
{
    auto g_ExistsGlExtFrameBufferBlit = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtFrameBufferBlit() noexcept
{
...
void System::GlBlitFramebufferEXT(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter) noexcept
{
    SYSTEM_BODY_10(gglBlitFramebufferEXT, srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter);
}

void System::InitGlExtFrameBufferBlit()
{
...
namespace System
{
    auto g_ExistsGlExtFrameBufferMultisample = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtFrameBufferMultisample() noexcept
{
...
void System::GlRenderbufferStorageMultisampleEXT(GLenum target, GLsizei samples, GLenum internalFormat, GLsizei width, GLsizei height) noexcept
{
    SYSTEM_BODY_5(gglRenderbufferStorageMultisampleEXT, target, samples, internalFormat, width, height);
}

void System::InitGlExtFrameBufferMultisample()
{
...
namespace System
{
    auto g_ExistsGlExtTimerQuery = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTimerQuery() noexcept
{
...
void System::GlGetQueryObjecti64vEXT(GLuint id, GLenum parameterName, GLint64* params) noexcept
{
    SYSTEM_BODY_3(gglGetQueryObjecti64vEXT, id, parameterName, params);
}

void System::GlGetQueryObjectui64vEXT(GLuint id, GLenum parameterName, GLuint64* params) noexcept
{
    SYSTEM_BODY_3(gglGetQueryObjectui64vEXT, id, parameterName, params);
}

void System::InitGlExtTimerQuery()
{
...
namespace System
{
    auto g_ExistsGlExtGpuProgramParameters = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtGpuProgramParameters() noexcept
{
...
void System::GlProgramEnvParameters4fvEXT(GLenum target, GLuint index, GLsizei count, const GLfloat* params) noexcept
{
    SYSTEM_BODY_4(gglProgramEnvParameters4fvEXT, target, index, count, params);
}

void System::GlProgramLocalParameters4fvEXT(GLenum target, GLuint index, GLsizei count, const GLfloat* params) noexcept
{
    SYSTEM_BODY_4(gglProgramLocalParameters4fvEXT, target, index, count, params);
}

void System::InitGlExtGpuProgramParameters()
{
...
namespace System
{
    auto g_ExistsGlExtGeometryShader4 = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtGeometryShader4() noexcept
{
...
void System::GlFramebufferTextureEXT(GLenum target, GLenum attachment, GLuint texture, GLint level) noexcept
{
    SYSTEM_BODY_4(gglFramebufferTextureEXT, target, attachment, texture, level);
}

void System::GlFramebufferTextureFaceEXT(GLenum target, GLenum attachment, GLuint texture, GLint level, GLenum face) noexcept
{
    SYSTEM_BODY_5(gglFramebufferTextureFaceEXT, target, attachment, texture, level, face);
}

void System::GlProgramParameteriEXT(GLuint program, GLenum parameterName, GLint value) noexcept
{
    SYSTEM_BODY_3(gglProgramParameteriEXT, program, parameterName, value);
}

void System::InitGlExtGeometryShader4()
{
...
namespace System
{
    auto g_ExistsGlExtGpuShader4 = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtGpuShader4() noexcept
{
...
void System::GlBindFragDataLocationEXT(GLuint program, GLuint color, const GLchar* name) noexcept
{
    SYSTEM_BODY_3(gglBindFragDataLocationEXT, program, color, name);
}

GLint System::GlGetFragDataLocationEXT(GLuint program, const GLchar* name) noexcept
{
    SYSTEM_BODY_2_RESULT(gglGetFragDataLocationEXT, program, name, GLint, 0);
}

void System::GlGetUniformuivEXT(GLuint program, GLint location, GLuint* params) noexcept
{
    SYSTEM_BODY_3(gglGetUniformuivEXT, program, location, params);
}

void System::GlGetVertexAttribIivEXT(GLuint index, GLenum parameterName, GLint* params) noexcept
{
    SYSTEM_BODY_3(gglGetVertexAttribIivEXT, index, parameterName, params);
}

void System::GlGetVertexAttribIuivEXT(GLuint index, GLenum parameterName, GLuint* params) noexcept
{
    SYSTEM_BODY_3(gglGetVertexAttribIuivEXT, index, parameterName, params);
}

void System::GlUniform1uiEXT(GLint location, GLuint v0) noexcept
{
    SYSTEM_BODY_2(gglUniform1uiEXT, location, v0);
}

void System::GlUniform1uivEXT(GLint location, GLsizei count, const GLuint* value) noexcept
{
    SYSTEM_BODY_3(gglUniform1uivEXT, location, count, value);
}

void System::GlUniform2uiEXT(GLint location, GLuint v0, GLuint v1) noexcept
{
    SYSTEM_BODY_3(gglUniform2uiEXT, location, v0, v1);
}

void System::GlUniform2uivEXT(GLint location, GLsizei count, const GLuint* value) noexcept
{
    SYSTEM_BODY_3(gglUniform2uivEXT, location, count, value);
}

void System::GlUniform3uiEXT(GLint location, GLuint v0, GLuint v1, GLuint v2) noexcept
{
    SYSTEM_BODY_4(gglUniform3uiEXT, location, v0, v1, v2);
}

void System::GlUniform3uivEXT(GLint location, GLsizei count, const GLuint* value) noexcept
{
    SYSTEM_BODY_3(gglUniform3uivEXT, location, count, value);
}

void System::GlUniform4uiEXT(GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3) noexcept
{
    SYSTEM_BODY_5(gglUniform4uiEXT, location, v0, v1, v2, v3);
}

void System::GlUniform4uivEXT(GLint location, GLsizei count, const GLuint* value) noexcept
{
    SYSTEM_BODY_3(gglUniform4uivEXT, location, count, value);
}

void System::GlVertexAttribI1iEXT(GLuint index, GLint x) noexcept
{
    SYSTEM_BODY_2(gglVertexAttribI1iEXT, index, x);
}

void System::GlVertexAttribI1ivEXT(GLuint index, const GLint* v) noexcept
{
    SYSTEM_BODY_2(gglVertexAttribI1ivEXT, index, v);
}

void System::GlVertexAttribI1uiEXT(GLuint index, GLuint x) noexcept
{
    SYSTEM_BODY_2(gglVertexAttribI1uiEXT, index, x);
}

void System::GlVertexAttribI1uivEXT(GLuint index, const GLuint* v) noexcept
{
    SYSTEM_BODY_2(gglVertexAttribI1uivEXT, index, v);
}

void System::GlVertexAttribI2iEXT(GLuint index, GLint x, GLint y) noexcept
{
    SYSTEM_BODY_3(gglVertexAttribI2iEXT, index, x, y);
}

void System::GlVertexAttribI2ivEXT(GLuint index, const GLint* v) noexcept
{
    SYSTEM_BODY_2(gglVertexAttribI2ivEXT, index, v);
}

void System::GlVertexAttribI2uiEXT(GLuint index, GLuint x, GLuint y) noexcept
{
    SYSTEM_BODY_3(gglVertexAttribI2uiEXT, index, x, y);
}

void System::GlVertexAttribI2uivEXT(GLuint index, const GLuint* v) noexcept
{
    SYSTEM_BODY_2(gglVertexAttribI2uivEXT, index, v);
}

void System::GlVertexAttribI3iEXT(GLuint index, GLint x, GLint y, GLint z) noexcept
{
    SYSTEM_BODY_4(gglVertexAttribI3iEXT, index, x, y, z);
}

void System::GlVertexAttribI3ivEXT(GLuint index, const GLint* v) noexcept
{
    SYSTEM_BODY_2(gglVertexAttribI3ivEXT, index, v);
}

void System::GlVertexAttribI3uiEXT(GLuint index, GLuint x, GLuint y, GLuint z) noexcept
{
    SYSTEM_BODY_4(gglVertexAttribI3uiEXT, index, x, y, z);
}

void System::GlVertexAttribI3uivEXT(GLuint index, const GLuint* v) noexcept
{
    SYSTEM_BODY_2(gglVertexAttribI3uivEXT, index, v);
}

void System::GlVertexAttribI4bvEXT(GLuint index, const GLbyte* v) noexcept
{
    SYSTEM_BODY_2(gglVertexAttribI4bvEXT, index, v);
}

void System::GlVertexAttribI4iEXT(GLuint index, GLint x, GLint y, GLint z, GLint w) noexcept
{
    SYSTEM_BODY_5(gglVertexAttribI4iEXT, index, x, y, z, w);
}

void System::GlVertexAttribI4ivEXT(GLuint index, const GLint* v) noexcept
{
    SYSTEM_BODY_2(gglVertexAttribI4ivEXT, index, v);
}

void System::GlVertexAttribI4svEXT(GLuint index, const GLshort* v) noexcept
{
    SYSTEM_BODY_2(gglVertexAttribI4svEXT, index, v);
}

void System::GlVertexAttribI4ubvEXT(GLuint index, const GLubyte* v) noexcept
{
    SYSTEM_BODY_2(gglVertexAttribI4ubvEXT, index, v);
}

void System::GlVertexAttribI4uiEXT(GLuint index, GLuint x, GLuint y, GLuint z, GLuint w) noexcept
{
    SYSTEM_BODY_5(gglVertexAttribI4uiEXT, index, x, y, z, w);
}

void System::GlVertexAttribI4uivEXT(GLuint index, const GLuint* v) noexcept
{
    SYSTEM_BODY_2(gglVertexAttribI4uivEXT, index, v);
}

void System::GlVertexAttribI4usvEXT(GLuint index, const GLushort* v) noexcept
{
    SYSTEM_BODY_2(gglVertexAttribI4usvEXT, index, v);
}

void System::GlVertexAttribIPointerEXT(GLuint index, GLint size, GLenum type, GLsizei stride, const void* pointer) noexcept
{
    SYSTEM_BODY_5(gglVertexAttribIPointerEXT, index, size, type, stride, pointer);
}

void System::InitGlExtGpuShader4()
{
...
namespace System
{
    auto g_ExistsGlExtDrawInstanced = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtDrawInstanced() noexcept
{
...
void System::GlDrawArraysInstancedEXT(GLenum mode, GLint start, GLsizei count, GLsizei primcount) noexcept
{
    SYSTEM_BODY_4(gglDrawArraysInstancedEXT, mode, start, count, primcount);
}

void System::GlDrawElementsInstancedEXT(GLenum mode, GLsizei count, GLenum type, const void* indices, GLsizei primcount) noexcept
{
    SYSTEM_BODY_5(gglDrawElementsInstancedEXT, mode, count, type, indices, primcount);
}

void System::InitGlExtDrawInstanced()
{
...
namespace System
{
    auto g_ExistsGlExtPackedFloat = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtPackedFloat() noexcept
{
    return g_ExistsGlExtPackedFloat;
}

void System::InitGlExtPackedFloat()
{
...
namespace System
{
    auto g_ExistsGlExtTextureArray = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureArray() noexcept
{
...
void System::GlFramebufferTextureLayerEXT(GLenum target, GLenum attachment, GLuint texture, GLint level, GLint layer) noexcept
{
    SYSTEM_BODY_5(gglFramebufferTextureLayerEXT, target, attachment, texture, level, layer);
}

void System::InitGlExtTextureArray()
{
...
namespace System
{
    auto g_ExistsGlExtTextureBufferObject = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureBufferObject() noexcept
{
...
void System::GlTexBufferEXT(GLenum target, GLenum internalformat, GLuint buffer) noexcept
{
    SYSTEM_BODY_3(gglTexBufferEXT, target, internalformat, buffer);
}

void System::InitGlExtTextureBufferObject()
{
...
namespace System
{
    auto g_ExistsGlExtTextureCompressionLatc = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureCompressionLatc() noexcept
{
    return g_ExistsGlExtTextureCompressionLatc;
}

void System::InitGlExtTextureCompressionLatc()
{
...
namespace System
{
    auto g_ExistsGlExtTextureCompressionRgtc = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureCompressionRgtc() noexcept
{
    return g_ExistsGlExtTextureCompressionRgtc;
}

void System::InitGlExtTextureCompressionRgtc()
{
...
namespace System
{
    auto g_ExistsGlExtTextureSharedExponent = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureSharedExponent() noexcept
{
    return g_ExistsGlExtTextureSharedExponent;
}

void System::InitGlExtTextureSharedExponent()
{
...
namespace System
{
    auto g_ExistsGlExtFramebufferSRGB = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtFramebufferSRGB() noexcept
{
    return g_ExistsGlExtFramebufferSRGB;
}

void System::InitGlExtFramebufferSRGB()
{
...
namespace System
{
    auto g_ExistsGlExtDrawBuffers2 = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtDrawBuffers2() noexcept
{
...
void System::GlColorMaskIndexedEXT(GLuint buf, GLboolean r, GLboolean g, GLboolean b, GLboolean a) noexcept
{
    SYSTEM_BODY_5(gglColorMaskIndexedEXT, buf, r, g, b, a);
}

void System::GlDisableIndexedEXT(GLenum target, GLuint index) noexcept
{
    SYSTEM_BODY_2(gglDisableIndexedEXT, target, index);
}

void System::GlEnableIndexedEXT(GLenum target, GLuint index) noexcept
{
    SYSTEM_BODY_2(gglEnableIndexedEXT, target, index);
}

void System::GlGetBooleanIndexedvEXT(GLenum value, GLuint index, GLboolean* data) noexcept
{
    SYSTEM_BODY_3(gglGetBooleanIndexedvEXT, value, index, data);
}

void System::GlGetIntegerIndexedvEXT(GLenum value, GLuint index, GLint* data) noexcept
{
    SYSTEM_BODY_3(gglGetIntegerIndexedvEXT, value, index, data);
}

GLboolean System::GlIsEnabledIndexedEXT(GLenum target, GLuint index) noexcept
{
    SYSTEM_BODY_2_RESULT(gglIsEnabledIndexedEXT, target, index, GLboolean, GL_FALSE);
}

void System::InitGlExtDrawBuffers2()
{
...
namespace System
{
    auto g_ExistsGlExtBindableUniform = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtBindableUniform() noexcept
{
...
GLint System::GlGetUniformBufferSizeEXT(GLuint program, GLint location) noexcept
{
    SYSTEM_BODY_2_RESULT(gglGetUniformBufferSizeEXT, program, location, GLint, -1);
}

GLintptr System::GlGetUniformOffsetEXT(GLuint program, GLint location) noexcept
{
    SYSTEM_BODY_2_RESULT(gglGetUniformOffsetEXT, program, location, GLintptr, -1);
}

void System::GlUniformBufferEXT(GLuint program, GLint location, GLuint buffer) noexcept
{
    SYSTEM_BODY_3(gglUniformBufferEXT, program, location, buffer);
}

void System::InitGlExtBindableUniform()
{
...
namespace System
{
    auto g_ExistsGlExtTextureInteger = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureInteger() noexcept
{
...
void System::GlClearColorIiEXT(GLint red, GLint green, GLint blue, GLint alpha) noexcept
{
    SYSTEM_BODY_4(gglClearColorIiEXT, red, green, blue, alpha);
}

void System::GlClearColorIuiEXT(GLuint red, GLuint green, GLuint blue, GLuint alpha) noexcept
{
    SYSTEM_BODY_4(gglClearColorIuiEXT, red, green, blue, alpha);
}

void System::GlGetTexParameterIivEXT(GLenum target, GLenum parameterName, GLint* params) noexcept
{
    SYSTEM_BODY_3(gglGetTexParameterIivEXT, target, parameterName, params);
}

void System::GlGetTexParameterIuivEXT(GLenum target, GLenum parameterName, GLuint* params) noexcept
{
    SYSTEM_BODY_3(gglGetTexParameterIuivEXT, target, parameterName, params);
}

void System::GlTexParameterIivEXT(GLenum target, GLenum parameterName, const GLint* params) noexcept
{
    SYSTEM_BODY_3(gglTexParameterIivEXT, target, parameterName, params);
}

void System::GlTexParameterIuivEXT(GLenum target, GLenum parameterName, const GLuint* params) noexcept
{
    SYSTEM_BODY_3(gglTexParameterIuivEXT, target, parameterName, params);
}

void System::InitGlExtTextureInteger()
{
...
namespace System
{
    auto g_ExistsGlExtTransformFeedback = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTransformFeedback() noexcept
{
...
void System::GlBeginTransformFeedbackEXT(GLenum primitiveMode) noexcept
{
    SYSTEM_BODY_1(gglBeginTransformFeedbackEXT, primitiveMode);
}

void System::GlBindBufferBaseEXT(GLenum target, GLuint index, GLuint buffer) noexcept
{
    SYSTEM_BODY_3(gglBindBufferBaseEXT, target, index, buffer);
}

void System::GlBindBufferOffsetEXT(GLenum target, GLuint index, GLuint buffer, GLintptr offset) noexcept
{
    SYSTEM_BODY_4(gglBindBufferOffsetEXT, target, index, buffer, offset);
}

void System::GlBindBufferRangeEXT(GLenum target, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size) noexcept
{
    SYSTEM_BODY_5(gglBindBufferRangeEXT, target, index, buffer, offset, size);
}

void System::GlEndTransformFeedbackEXT(void) noexcept
{
    SYSTEM_BODY_0(gglEndTransformFeedbackEXT);
}

void System::GlGetTransformFeedbackVaryingEXT(GLuint program, GLuint index, GLsizei bufSize, GLsizei* length, GLsizei* size, GLenum* type, GLchar* name) noexcept
{
    SYSTEM_BODY_7(gglGetTransformFeedbackVaryingEXT, program, index, bufSize, length, size, type, name);
}

void System::GlTransformFeedbackVaryingsEXT(GLuint program, GLsizei count, const GLchar* const* varyings, GLenum bufferMode) noexcept
{
    SYSTEM_BODY_4(gglTransformFeedbackVaryingsEXT, program, count, varyings, bufferMode);
}

void System::InitGlExtTransformFeedback()
{
...
namespace System
{
    auto g_ExistsGlExtDirectStateAccess = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtDirectStateAccess() noexcept
{
...
void System::GlBindMultiTextureEXT(GLenum texunit, GLenum target, GLuint texture) noexcept
{
    SYSTEM_BODY_3(gglBindMultiTextureEXT, texunit, target, texture);
}

GLenum System::GlCheckNamedFramebufferStatusEXT(GLuint framebuffer, GLenum target) noexcept
{
    SYSTEM_BODY_2_RESULT(gglCheckNamedFramebufferStatusEXT, framebuffer, target, GLenum, 0);
}

void System::GlClientAttribDefaultEXT(GLbitfield mask) noexcept
{
    SYSTEM_BODY_1(gglClientAttribDefaultEXT, mask);
}

void System::GlCompressedMultiTexImage1DEXT(GLenum texunit, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const void* data) noexcept
{
    SYSTEM_BODY_8(gglCompressedMultiTexImage1DEXT, texunit, target, level, internalformat, width, border, imageSize, data);
}

void System::GlCompressedMultiTexImage2DEXT(GLenum texunit, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const void* data) noexcept
{
    SYSTEM_BODY_9(gglCompressedMultiTexImage2DEXT, texunit, target, level, internalformat, width, height, border, imageSize, data);
}

void System::GlCompressedMultiTexImage3DEXT(GLenum texunit, GLenum target, GLint level, GLenum internalformat, GLsizei width,
...
void System::GlCompressedMultiTexSubImage1DEXT(GLenum texunit, GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const void* data) noexcept
{
    SYSTEM_BODY_8(gglCompressedMultiTexSubImage1DEXT, texunit, target, level, xoffset, width, format, imageSize, data);
}

void System::GlCompressedMultiTexSubImage2DEXT(GLenum texunit, GLenum target, GLint level, GLint xoffset, GLint yoffset,
...
void System::GlCompressedMultiTexSubImage3DEXT(GLenum texunit, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset,
...
void System::GlCompressedTextureImage1DEXT(GLuint texture, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const void* data) noexcept
{
    SYSTEM_BODY_8(gglCompressedTextureImage1DEXT, texture, target, level, internalformat, width, border, imageSize, data);
}

void System::GlCompressedTextureImage2DEXT(GLuint texture, GLenum target, GLint level, GLenum internalformat, GLsizei width,
...
void System::GlCompressedTextureImage3DEXT(GLuint texture, GLenum target, GLint level, GLenum internalformat, GLsizei width,
                                           GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const void* data) noexcept
{
...
void System::GlCompressedTextureSubImage1DEXT(GLuint texture, GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const void* data) noexcept
{
    SYSTEM_BODY_8(gglCompressedTextureSubImage1DEXT, texture, target, level, xoffset, width, format, imageSize, data);
}

void System::GlCompressedTextureSubImage2DEXT(GLuint texture, GLenum target, GLint level, GLint xoffset, GLint yoffset,
                                              GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const void* data) noexcept
{
    SYSTEM_BODY_10(gglCompressedTextureSubImage2DEXT, texture, target, level, xoffset, yoffset, width, height, format, imageSize, data);
}

void System::GlCompressedTextureSubImage3DEXT(GLuint texture, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset,
                                              GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const void* data) noexcept
{
...
void System::GlCopyMultiTexImage1DEXT(GLenum texunit, GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLint border) noexcept
{
    SYSTEM_BODY_8(gglCopyMultiTexImage1DEXT, texunit, target, level, internalformat, x, y, width, border);
}

void System::GlCopyMultiTexImage2DEXT(GLenum texunit, GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border) noexcept
{
    SYSTEM_BODY_9(gglCopyMultiTexImage2DEXT, texunit, target, level, internalformat, x, y, width, height, border);
}

void System::GlCopyMultiTexSubImage1DEXT(GLenum texunit, GLenum target, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width) noexcept
{
    SYSTEM_BODY_7(gglCopyMultiTexSubImage1DEXT, texunit, target, level, xoffset, x, y, width);
}

void System::GlCopyMultiTexSubImage2DEXT(GLenum texunit, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height) noexcept
{
    SYSTEM_BODY_9(gglCopyMultiTexSubImage2DEXT, texunit, target, level, xoffset, yoffset, x, y, width, height);
}

void System::GlCopyMultiTexSubImage3DEXT(GLenum texunit, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height) noexcept
{
    SYSTEM_BODY_10(gglCopyMultiTexSubImage3DEXT, texunit, target, level, xoffset, yoffset, zoffset, x, y, width, height);
}

void System::GlCopyTextureImage1DEXT(GLuint texture, GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLint border) noexcept
{
    SYSTEM_BODY_8(gglCopyTextureImage1DEXT, texture, target, level, internalformat, x, y, width, border);
}

void System::GlCopyTextureImage2DEXT(GLuint texture, GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border) noexcept
{
    SYSTEM_BODY_9(gglCopyTextureImage2DEXT, texture, target, level, internalformat, x, y, width, height, border);
}

void System::GlCopyTextureSubImage1DEXT(GLuint texture, GLenum target, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width) noexcept
{
    SYSTEM_BODY_7(gglCopyTextureSubImage1DEXT, texture, target, level, xoffset, x, y, width);
}

void System::GlCopyTextureSubImage2DEXT(GLuint texture, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height) noexcept
{
    SYSTEM_BODY_9(gglCopyTextureSubImage2DEXT, texture, target, level, xoffset, yoffset, x, y, width, height);
}

void System::GlCopyTextureSubImage3DEXT(GLuint texture, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height) noexcept
{
    SYSTEM_BODY_10(gglCopyTextureSubImage3DEXT, texture, target, level, xoffset, yoffset, zoffset, x, y, width, height);
}

void System::GlDisableClientStateIndexedEXT(GLenum array, GLuint index) noexcept
{
    SYSTEM_BODY_2(gglDisableClientStateIndexedEXT, array, index);
}

void System::GlDisableClientStateiEXT(GLenum array, GLuint index) noexcept
{
    SYSTEM_BODY_2(gglDisableClientStateiEXT, array, index);
}

void System::GlDisableVertexArrayAttribEXT(GLuint vaobj, GLuint index) noexcept
{
    SYSTEM_BODY_2(gglDisableVertexArrayAttribEXT, vaobj, index);
}

void System::GlDisableVertexArrayEXT(GLuint vaobj, GLenum array) noexcept
{
    SYSTEM_BODY_2(gglDisableVertexArrayEXT, vaobj, array);
}

void System::GlEnableClientStateIndexedEXT(GLenum array, GLuint index) noexcept
{
    SYSTEM_BODY_2(gglEnableClientStateIndexedEXT, array, index);
}

void System::GlEnableClientStateiEXT(GLenum array, GLuint index) noexcept
{
    SYSTEM_BODY_2(gglEnableClientStateiEXT, array, index);
}

void System::GlEnableVertexArrayAttribEXT(GLuint vaobj, GLuint index) noexcept
{
    SYSTEM_BODY_2(gglEnableVertexArrayAttribEXT, vaobj, index);
}

void System::GlEnableVertexArrayEXT(GLuint vaobj, GLenum array) noexcept
{
    SYSTEM_BODY_2(gglEnableVertexArrayEXT, vaobj, array);
}

void System::GlFlushMappedNamedBufferRangeEXT(GLuint buffer, GLintptr offset, GLsizeiptr length) noexcept
{
    SYSTEM_BODY_3(gglFlushMappedNamedBufferRangeEXT, buffer, offset, length);
}

void System::GlFramebufferDrawBufferEXT(GLuint framebuffer, GLenum mode) noexcept
{
    SYSTEM_BODY_2(gglFramebufferDrawBufferEXT, framebuffer, mode);
}

void System::GlFramebufferDrawBuffersEXT(GLuint framebuffer, GLsizei n, const GLenum* bufs) noexcept
{
    SYSTEM_BODY_3(gglFramebufferDrawBuffersEXT, framebuffer, n, bufs);
}

void System::GlFramebufferReadBufferEXT(GLuint framebuffer, GLenum mode) noexcept
{
    SYSTEM_BODY_2(gglFramebufferReadBufferEXT, framebuffer, mode);
}

void System::GlGenerateMultiTexMipmapEXT(GLenum texunit, GLenum target) noexcept
{
    SYSTEM_BODY_2(gglGenerateMultiTexMipmapEXT, texunit, target);
}

void System::GlGenerateTextureMipmapEXT(GLuint texture, GLenum target) noexcept
{
    SYSTEM_BODY_2(gglGenerateTextureMipmapEXT, texture, target);
}

void System::GlGetCompressedMultiTexImageEXT(GLenum texunit, GLenum target, GLint level, void* img) noexcept
{
    SYSTEM_BODY_4(gglGetCompressedMultiTexImageEXT, texunit, target, level, img);
}

void System::GlGetCompressedTextureImageEXT(GLuint texture, GLenum target, GLint level, void* img) noexcept
{
    SYSTEM_BODY_4(gglGetCompressedTextureImageEXT, texture, target, level, img);
}

void System::GlGetDoubleIndexedvEXT(GLenum target, GLuint index, GLdouble* params) noexcept
{
    SYSTEM_BODY_3(gglGetDoubleIndexedvEXT, target, index, params);
}

void System::GlGetDoublei_vEXT(GLenum parameterName, GLuint index, GLdouble* params) noexcept
{
    SYSTEM_BODY_3(gglGetDoublei_vEXT, parameterName, index, params);
}

void System::GlGetFloatIndexedvEXT(GLenum target, GLuint index, GLfloat* params) noexcept
{
    SYSTEM_BODY_3(gglGetFloatIndexedvEXT, target, index, params);
}

void System::GlGetFloati_vEXT(GLenum parameterName, GLuint index, GLfloat* params) noexcept
{
    SYSTEM_BODY_3(gglGetFloati_vEXT, parameterName, index, params);
}

void System::GlGetFramebufferParameterivEXT(GLuint framebuffer, GLenum parameterName, GLint* param) noexcept
{
    SYSTEM_BODY_3(gglGetFramebufferParameterivEXT, framebuffer, parameterName, param);
}

void System::GlGetMultiTexEnvfvEXT(GLenum texunit, GLenum target, GLenum parameterName, GLfloat* params) noexcept
{
    SYSTEM_BODY_4(gglGetMultiTexEnvfvEXT, texunit, target, parameterName, params);
}

void System::GlGetMultiTexEnvivEXT(GLenum texunit, GLenum target, GLenum parameterName, GLint* params) noexcept
{
    SYSTEM_BODY_4(gglGetMultiTexEnvivEXT, texunit, target, parameterName, params);
}

void System::GlGetMultiTexGendvEXT(GLenum texunit, GLenum coord, GLenum parameterName, GLdouble* params) noexcept
{
    SYSTEM_BODY_4(gglGetMultiTexGendvEXT, texunit, coord, parameterName, params);
}

void System::GlGetMultiTexGenfvEXT(GLenum texunit, GLenum coord, GLenum parameterName, GLfloat* params) noexcept
{
    SYSTEM_BODY_4(gglGetMultiTexGenfvEXT, texunit, coord, parameterName, params);
}

void System::GlGetMultiTexGenivEXT(GLenum texunit, GLenum coord, GLenum parameterName, GLint* params) noexcept
{
    SYSTEM_BODY_4(gglGetMultiTexGenivEXT, texunit, coord, parameterName, params);
}

void System::GlGetMultiTexImageEXT(GLenum texunit, GLenum target, GLint level, GLenum format, GLenum type, void* pixels) noexcept
{
    SYSTEM_BODY_6(gglGetMultiTexImageEXT, texunit, target, level, format, type, pixels);
}

void System::GlGetMultiTexLevelParameterfvEXT(GLenum texunit, GLenum target, GLint level, GLenum parameterName, GLfloat* params) noexcept
{
    SYSTEM_BODY_5(gglGetMultiTexLevelParameterfvEXT, texunit, target, level, parameterName, params);
}

void System::GlGetMultiTexLevelParameterivEXT(GLenum texunit, GLenum target, GLint level, GLenum parameterName, GLint* params) noexcept
{
    SYSTEM_BODY_5(gglGetMultiTexLevelParameterivEXT, texunit, target, level, parameterName, params);
}

void System::GlGetMultiTexParameterIivEXT(GLenum texunit, GLenum target, GLenum parameterName, GLint* params) noexcept
{
    SYSTEM_BODY_4(gglGetMultiTexParameterIivEXT, texunit, target, parameterName, params);
}

void System::GlGetMultiTexParameterIuivEXT(GLenum texunit, GLenum target, GLenum parameterName, GLuint* params) noexcept
{
    SYSTEM_BODY_4(gglGetMultiTexParameterIuivEXT, texunit, target, parameterName, params);
}

void System::GlGetMultiTexParameterfvEXT(GLenum texunit, GLenum target, GLenum parameterName, GLfloat* params) noexcept
{
    SYSTEM_BODY_4(gglGetMultiTexParameterfvEXT, texunit, target, parameterName, params);
}

void System::GlGetMultiTexParameterivEXT(GLenum texunit, GLenum target, GLenum parameterName, GLint* params) noexcept
{
    SYSTEM_BODY_4(gglGetMultiTexParameterivEXT, texunit, target, parameterName, params);
}

void System::GlGetNamedBufferParameterivEXT(GLuint buffer, GLenum parameterName, GLint* params) noexcept
{
    SYSTEM_BODY_3(gglGetNamedBufferParameterivEXT, buffer, parameterName, params);
}

void System::GlGetNamedBufferPointervEXT(GLuint buffer, GLenum parameterName, void** params) noexcept
{
    SYSTEM_BODY_3(gglGetNamedBufferPointervEXT, buffer, parameterName, params);
}

void System::GlGetNamedBufferSubDataEXT(GLuint buffer, GLintptr offset, GLsizeiptr size, void* data) noexcept
{
    SYSTEM_BODY_4(gglGetNamedBufferSubDataEXT, buffer, offset, size, data);
}

void System::GlGetNamedFramebufferAttachmentParameterivEXT(GLuint framebuffer, GLenum attachment, GLenum parameterName, GLint* params) noexcept
{
    SYSTEM_BODY_4(gglGetNamedFramebufferAttachmentParameterivEXT, framebuffer, attachment, parameterName, params);
}

void System::GlGetNamedProgramLocalParameterIivEXT(GLuint program, GLenum target, GLuint index, GLint* params) noexcept
{
    SYSTEM_BODY_4(gglGetNamedProgramLocalParameterIivEXT, program, target, index, params);
}

void System::GlGetNamedProgramLocalParameterIuivEXT(GLuint program, GLenum target, GLuint index, GLuint* params) noexcept
{
    SYSTEM_BODY_4(gglGetNamedProgramLocalParameterIuivEXT, program, target, index, params);
}

void System::GlGetNamedProgramLocalParameterdvEXT(GLuint program, GLenum target, GLuint index, GLdouble* params) noexcept
{
    SYSTEM_BODY_4(gglGetNamedProgramLocalParameterdvEXT, program, target, index, params);
}

void System::GlGetNamedProgramLocalParameterfvEXT(GLuint program, GLenum target, GLuint index, GLfloat* params) noexcept
{
    SYSTEM_BODY_4(gglGetNamedProgramLocalParameterfvEXT, program, target, index, params);
}

void System::GlGetNamedProgramStringEXT(GLuint program, GLenum target, GLenum parameterName, void* programString) noexcept
{
    SYSTEM_BODY_4(gglGetNamedProgramStringEXT, program, target, parameterName, programString);
}

void System::GlGetNamedProgramivEXT(GLuint program, GLenum target, GLenum parameterName, GLint* params) noexcept
{
    SYSTEM_BODY_4(gglGetNamedProgramivEXT, program, target, parameterName, params);
}

void System::GlGetNamedRenderbufferParameterivEXT(GLuint renderbuffer, GLenum parameterName, GLint* params) noexcept
{
    SYSTEM_BODY_3(gglGetNamedRenderbufferParameterivEXT, renderbuffer, parameterName, params);
}

void System::GlGetPointerIndexedvEXT(GLenum target, GLuint index, void** params) noexcept
{
    SYSTEM_BODY_3(gglGetPointerIndexedvEXT, target, index, params);
}

void System::GlGetPointeri_vEXT(GLenum parameterName, GLuint index, void** params) noexcept
{
    SYSTEM_BODY_3(gglGetPointeri_vEXT, parameterName, index, params);
}

void System::GlGetTextureImageEXT(GLuint texture, GLenum target, GLint level, GLenum format, GLenum type, void* pixels) noexcept
{
    SYSTEM_BODY_6(gglGetTextureImageEXT, texture, target, level, format, type, pixels);
}

void System::GlGetTextureLevelParameterfvEXT(GLuint texture, GLenum target, GLint level, GLenum parameterName, GLfloat* params) noexcept
{
    SYSTEM_BODY_5(gglGetTextureLevelParameterfvEXT, texture, target, level, parameterName, params);
}

void System::GlGetTextureLevelParameterivEXT(GLuint texture, GLenum target, GLint level, GLenum parameterName, GLint* params) noexcept
{
    SYSTEM_BODY_5(gglGetTextureLevelParameterivEXT, texture, target, level, parameterName, params);
}

void System::GlGetTextureParameterIivEXT(GLuint texture, GLenum target, GLenum parameterName, GLint* params) noexcept
{
    SYSTEM_BODY_4(gglGetTextureParameterIivEXT, texture, target, parameterName, params);
}

void System::GlGetTextureParameterIuivEXT(GLuint texture, GLenum target, GLenum parameterName, GLuint* params) noexcept
{
    SYSTEM_BODY_4(gglGetTextureParameterIuivEXT, texture, target, parameterName, params);
}

void System::GlGetTextureParameterfvEXT(GLuint texture, GLenum target, GLenum parameterName, GLfloat* params) noexcept
{
    SYSTEM_BODY_4(gglGetTextureParameterfvEXT, texture, target, parameterName, params);
}

void System::GlGetTextureParameterivEXT(GLuint texture, GLenum target, GLenum parameterName, GLint* params) noexcept
{
    SYSTEM_BODY_4(gglGetTextureParameterivEXT, texture, target, parameterName, params);
}

void System::GlGetVertexArrayIntegeri_vEXT(GLuint vaobj, GLuint index, GLenum parameterName, GLint* param) noexcept
{
    SYSTEM_BODY_4(gglGetVertexArrayIntegeri_vEXT, vaobj, index, parameterName, param);
}

void System::GlGetVertexArrayIntegervEXT(GLuint vaobj, GLenum parameterName, GLint* param) noexcept
{
    SYSTEM_BODY_3(gglGetVertexArrayIntegervEXT, vaobj, parameterName, param);
}

void System::GlGetVertexArrayPointeri_vEXT(GLuint vaobj, GLuint index, GLenum parameterName, void** param) noexcept
{
    SYSTEM_BODY_4(gglGetVertexArrayPointeri_vEXT, vaobj, index, parameterName, param);
}

void System::GlGetVertexArrayPointervEXT(GLuint vaobj, GLenum parameterName, void** param) noexcept
{
    SYSTEM_BODY_3(gglGetVertexArrayPointervEXT, vaobj, parameterName, param);
}

void System::GlMapNamedBufferEXT(GLuint buffer, GLenum access) noexcept
{
    SYSTEM_BODY_2(gglMapNamedBufferEXT, buffer, access);
}

void System::GlMapNamedBufferRangeEXT(GLuint buffer, GLintptr offset, GLsizeiptr length, GLbitfield access) noexcept
{
    SYSTEM_BODY_4(gglMapNamedBufferRangeEXT, buffer, offset, length, access);
}

void System::GlMatrixFrustumEXT(GLenum matrixMode, GLdouble l, GLdouble r, GLdouble b, GLdouble t, GLdouble n, GLdouble f) noexcept
{
    SYSTEM_BODY_7(gglMatrixFrustumEXT, matrixMode, l, r, b, t, n, f);
}

void System::GlMatrixLoadIdentityEXT(GLenum matrixMode) noexcept
{
    SYSTEM_BODY_1(gglMatrixLoadIdentityEXT, matrixMode);
}

void System::GlMatrixLoadTransposedEXT(GLenum matrixMode, const GLdouble* m) noexcept
{
    SYSTEM_BODY_2(gglMatrixLoadTransposedEXT, matrixMode, m);
}

void System::GlMatrixLoadTransposefEXT(GLenum matrixMode, const GLfloat* m) noexcept
{
    SYSTEM_BODY_2(gglMatrixLoadTransposefEXT, matrixMode, m);
}

void System::GlMatrixLoaddEXT(GLenum matrixMode, const GLdouble* m) noexcept
{
    SYSTEM_BODY_2(gglMatrixLoaddEXT, matrixMode, m);
}

void System::GlMatrixLoadfEXT(GLenum matrixMode, const GLfloat* m) noexcept
{
    SYSTEM_BODY_2(gglMatrixLoadfEXT, matrixMode, m);
}

void System::GlMatrixMultTransposedEXT(GLenum matrixMode, const GLdouble* m) noexcept
{
    SYSTEM_BODY_2(gglMatrixMultTransposedEXT, matrixMode, m);
}

void System::GlMatrixMultTransposefEXT(GLenum matrixMode, const GLfloat* m) noexcept
{
    SYSTEM_BODY_2(gglMatrixMultTransposefEXT, matrixMode, m);
}

void System::GlMatrixMultdEXT(GLenum matrixMode, const GLdouble* m) noexcept
{
    SYSTEM_BODY_2(gglMatrixMultdEXT, matrixMode, m);
}

void System::GlMatrixMultfEXT(GLenum matrixMode, const GLfloat* m) noexcept
{
    SYSTEM_BODY_2(gglMatrixMultfEXT, matrixMode, m);
}

void System::GlMatrixOrthoEXT(GLenum matrixMode, GLdouble l, GLdouble r, GLdouble b, GLdouble t, GLdouble n, GLdouble f) noexcept
{
    SYSTEM_BODY_7(gglMatrixOrthoEXT, matrixMode, l, r, b, t, n, f);
}

void System::GlMatrixPopEXT(GLenum matrixMode) noexcept
{
    SYSTEM_BODY_1(gglMatrixPopEXT, matrixMode);
}

void System::GlMatrixPushEXT(GLenum matrixMode) noexcept
{
    SYSTEM_BODY_1(gglMatrixPushEXT, matrixMode);
}

void System::GlMatrixRotatedEXT(GLenum matrixMode, GLdouble angle, GLdouble x, GLdouble y, GLdouble z) noexcept
{
    SYSTEM_BODY_5(gglMatrixRotatedEXT, matrixMode, angle, x, y, z);
}

void System::GlMatrixRotatefEXT(GLenum matrixMode, GLfloat angle, GLfloat x, GLfloat y, GLfloat z) noexcept
{
    SYSTEM_BODY_5(gglMatrixRotatefEXT, matrixMode, angle, x, y, z);
}

void System::GlMatrixScaledEXT(GLenum matrixMode, GLdouble x, GLdouble y, GLdouble z) noexcept
{
    SYSTEM_BODY_4(gglMatrixScaledEXT, matrixMode, x, y, z);
}

void System::GlMatrixScalefEXT(GLenum matrixMode, GLfloat x, GLfloat y, GLfloat z) noexcept
{
    SYSTEM_BODY_4(gglMatrixScalefEXT, matrixMode, x, y, z);
}

void System::GlMatrixTranslatedEXT(GLenum matrixMode, GLdouble x, GLdouble y, GLdouble z) noexcept
{
    SYSTEM_BODY_4(gglMatrixTranslatedEXT, matrixMode, x, y, z);
}

void System::GlMatrixTranslatefEXT(GLenum matrixMode, GLfloat x, GLfloat y, GLfloat z) noexcept
{
    SYSTEM_BODY_4(gglMatrixTranslatefEXT, matrixMode, x, y, z);
}

void System::GlMultiTexBufferEXT(GLenum texunit, GLenum target, GLenum internalformat, GLuint buffer) noexcept
{
    SYSTEM_BODY_4(gglMultiTexBufferEXT, texunit, target, internalformat, buffer);
}

void System::GlMultiTexCoordPointerEXT(GLenum texunit, GLint size, GLenum type, GLsizei stride, const void* pointer) noexcept
{
    SYSTEM_BODY_5(gglMultiTexCoordPointerEXT, texunit, size, type, stride, pointer);
}

void System::GlMultiTexEnvfEXT(GLenum texunit, GLenum target, GLenum parameterName, GLfloat param) noexcept
{
    SYSTEM_BODY_4(gglMultiTexEnvfEXT, texunit, target, parameterName, param);
}

void System::GlMultiTexEnvfvEXT(GLenum texunit, GLenum target, GLenum parameterName, const GLfloat* params) noexcept
{
    SYSTEM_BODY_4(gglMultiTexEnvfvEXT, texunit, target, parameterName, params);
}

void System::GlMultiTexEnviEXT(GLenum texunit, GLenum target, GLenum parameterName, GLint param) noexcept
{
    SYSTEM_BODY_4(gglMultiTexEnviEXT, texunit, target, parameterName, param);
}

void System::GlMultiTexEnvivEXT(GLenum texunit, GLenum target, GLenum parameterName, const GLint* params) noexcept
{
    SYSTEM_BODY_4(gglMultiTexEnvivEXT, texunit, target, parameterName, params);
}

void System::GlMultiTexGendEXT(GLenum texunit, GLenum coord, GLenum parameterName, GLdouble param) noexcept
{
    SYSTEM_BODY_4(gglMultiTexGendEXT, texunit, coord, parameterName, param);
}

void System::GlMultiTexGendvEXT(GLenum texunit, GLenum coord, GLenum parameterName, const GLdouble* params) noexcept
{
    SYSTEM_BODY_4(gglMultiTexGendvEXT, texunit, coord, parameterName, params);
}

void System::GlMultiTexGenfEXT(GLenum texunit, GLenum coord, GLenum parameterName, GLfloat param) noexcept
{
    SYSTEM_BODY_4(gglMultiTexGenfEXT, texunit, coord, parameterName, param);
}

void System::GlMultiTexGenfvEXT(GLenum texunit, GLenum coord, GLenum parameterName, const GLfloat* params) noexcept
{
    SYSTEM_BODY_4(gglMultiTexGenfvEXT, texunit, coord, parameterName, params);
}

void System::GlMultiTexGeniEXT(GLenum texunit, GLenum coord, GLenum parameterName, GLint param) noexcept
{
    SYSTEM_BODY_4(gglMultiTexGeniEXT, texunit, coord, parameterName, param);
}

void System::GlMultiTexGenivEXT(GLenum texunit, GLenum coord, GLenum parameterName, const GLint* params) noexcept
{
    SYSTEM_BODY_4(gglMultiTexGenivEXT, texunit, coord, parameterName, params);
}

void System::GlMultiTexImage1DEXT(GLenum texunit, GLenum target, GLint level, GLint internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const void* pixels) noexcept
{
    SYSTEM_BODY_9(gglMultiTexImage1DEXT, texunit, target, level, internalformat, width, border, format, type, pixels);
}

void System::GlMultiTexImage2DEXT(GLenum texunit, GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const void* pixels) noexcept
{
    SYSTEM_BODY_10(gglMultiTexImage2DEXT, texunit, target, level, internalformat, width, height, border, format, type, pixels);
}

void System::GlMultiTexImage3DEXT(GLenum texunit, GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height,
...
void System::GlMultiTexParameterIivEXT(GLenum texunit, GLenum target, GLenum parameterName, const GLint* params) noexcept
{
    SYSTEM_BODY_4(gglMultiTexParameterIivEXT, texunit, target, parameterName, params);
}

void System::GlMultiTexParameterIuivEXT(GLenum texunit, GLenum target, GLenum parameterName, const GLuint* params) noexcept
{
    SYSTEM_BODY_4(gglMultiTexParameterIuivEXT, texunit, target, parameterName, params);
}

void System::GlMultiTexParameterfEXT(GLenum texunit, GLenum target, GLenum parameterName, GLfloat param) noexcept
{
    SYSTEM_BODY_4(gglMultiTexParameterfEXT, texunit, target, parameterName, param);
}

void System::GlMultiTexParameterfvEXT(GLenum texunit, GLenum target, GLenum parameterName, const GLfloat* param) noexcept
{
    SYSTEM_BODY_4(gglMultiTexParameterfvEXT, texunit, target, parameterName, param);
}

void System::GlMultiTexParameteriEXT(GLenum texunit, GLenum target, GLenum parameterName, GLint param) noexcept
{
    SYSTEM_BODY_4(gglMultiTexParameteriEXT, texunit, target, parameterName, param);
}

void System::GlMultiTexParameterivEXT(GLenum texunit, GLenum target, GLenum parameterName, const GLint* param) noexcept
{
    SYSTEM_BODY_4(gglMultiTexParameterivEXT, texunit, target, parameterName, param);
}

void System::GlMultiTexRenderbufferEXT(GLenum texunit, GLenum target, GLuint renderbuffer) noexcept
{
    SYSTEM_BODY_3(gglMultiTexRenderbufferEXT, texunit, target, renderbuffer);
}

void System::GlMultiTexSubImage1DEXT(GLenum texunit, GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const void* pixels) noexcept
{
    SYSTEM_BODY_8(gglMultiTexSubImage1DEXT, texunit, target, level, xoffset, width, format, type, pixels);
}

void System::GlMultiTexSubImage2DEXT(GLenum texunit, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const void* pixels) noexcept
{
    SYSTEM_BODY_10(gglMultiTexSubImage2DEXT, texunit, target, level, xoffset, yoffset, width, height, format, type, pixels);
}

void System::GlMultiTexSubImage3DEXT(GLenum texunit, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset,
...
void System::GlNamedBufferDataEXT(GLuint buffer, GLsizeiptr size, const void* data, GLenum usage) noexcept
{
    SYSTEM_BODY_4(gglNamedBufferDataEXT, buffer, size, data, usage);
}

void System::GlNamedBufferSubDataEXT(GLuint buffer, GLintptr offset, GLsizeiptr size, const void* data) noexcept
{
    SYSTEM_BODY_4(gglNamedBufferSubDataEXT, buffer, offset, size, data);
}

void System::GlNamedCopyBufferSubDataEXT(GLuint readBuffer, GLuint writeBuffer, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size) noexcept
{
    SYSTEM_BODY_5(gglNamedCopyBufferSubDataEXT, readBuffer, writeBuffer, readOffset, writeOffset, size);
}

void System::GlNamedFramebufferRenderbufferEXT(GLuint framebuffer, GLenum attachment, GLenum renderbuffertarget, GLuint renderbuffer) noexcept
{
    SYSTEM_BODY_4(gglNamedFramebufferRenderbufferEXT, framebuffer, attachment, renderbuffertarget, renderbuffer);
}

void System::GlNamedFramebufferTexture1DEXT(GLuint framebuffer, GLenum attachment, GLenum textarget, GLuint texture, GLint level) noexcept
{
    SYSTEM_BODY_5(gglNamedFramebufferTexture1DEXT, framebuffer, attachment, textarget, texture, level);
}

void System::GlNamedFramebufferTexture2DEXT(GLuint framebuffer, GLenum attachment, GLenum textarget, GLuint texture, GLint level) noexcept
{
    SYSTEM_BODY_5(gglNamedFramebufferTexture2DEXT, framebuffer, attachment, textarget, texture, level);
}

void System::GlNamedFramebufferTexture3DEXT(GLuint framebuffer, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLint zoffset) noexcept
{
    SYSTEM_BODY_6(gglNamedFramebufferTexture3DEXT, framebuffer, attachment, textarget, texture, level, zoffset);
}

void System::GlNamedFramebufferTextureEXT(GLuint framebuffer, GLenum attachment, GLuint texture, GLint level) noexcept
{
    SYSTEM_BODY_4(gglNamedFramebufferTextureEXT, framebuffer, attachment, texture, level);
}

void System::GlNamedFramebufferTextureFaceEXT(GLuint framebuffer, GLenum attachment, GLuint texture, GLint level, GLenum face) noexcept
{
    SYSTEM_BODY_5(gglNamedFramebufferTextureFaceEXT, framebuffer, attachment, texture, level, face);
}

void System::GlNamedFramebufferTextureLayerEXT(GLuint framebuffer, GLenum attachment, GLuint texture, GLint level, GLint layer) noexcept
{
    SYSTEM_BODY_5(gglNamedFramebufferTextureLayerEXT, framebuffer, attachment, texture, level, layer);
}

void System::GlNamedProgramLocalParameter4dEXT(GLuint program, GLenum target, GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w) noexcept
{
    SYSTEM_BODY_7(gglNamedProgramLocalParameter4dEXT, program, target, index, x, y, z, w);
}

void System::GlNamedProgramLocalParameter4dvEXT(GLuint program, GLenum target, GLuint index, const GLdouble* params) noexcept
{
    SYSTEM_BODY_4(gglNamedProgramLocalParameter4dvEXT, program, target, index, params);
}

void System::GlNamedProgramLocalParameter4fEXT(GLuint program, GLenum target, GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w) noexcept
{
    SYSTEM_BODY_7(gglNamedProgramLocalParameter4fEXT, program, target, index, x, y, z, w);
}

void System::GlNamedProgramLocalParameter4fvEXT(GLuint program, GLenum target, GLuint index, const GLfloat* params) noexcept
{
    SYSTEM_BODY_4(gglNamedProgramLocalParameter4fvEXT, program, target, index, params);
}

void System::GlNamedProgramLocalParameterI4iEXT(GLuint program, GLenum target, GLuint index, GLint x, GLint y, GLint z, GLint w) noexcept
{
    SYSTEM_BODY_7(gglNamedProgramLocalParameterI4iEXT, program, target, index, x, y, z, w);
}

void System::GlNamedProgramLocalParameterI4ivEXT(GLuint program, GLenum target, GLuint index, const GLint* params) noexcept
{
    SYSTEM_BODY_4(gglNamedProgramLocalParameterI4ivEXT, program, target, index, params);
}

void System::GlNamedProgramLocalParameterI4uiEXT(GLuint program, GLenum target, GLuint index, GLuint x, GLuint y, GLuint z, GLuint w) noexcept
{
    SYSTEM_BODY_7(gglNamedProgramLocalParameterI4uiEXT, program, target, index, x, y, z, w);
}

void System::GlNamedProgramLocalParameterI4uivEXT(GLuint program, GLenum target, GLuint index, const GLuint* params) noexcept
{
    SYSTEM_BODY_4(gglNamedProgramLocalParameterI4uivEXT, program, target, index, params);
}

void System::GlNamedProgramLocalParameters4fvEXT(GLuint program, GLenum target, GLuint index, GLsizei count, const GLfloat* params) noexcept
{
    SYSTEM_BODY_5(gglNamedProgramLocalParameters4fvEXT, program, target, index, count, params);
}

void System::GlNamedProgramLocalParametersI4ivEXT(GLuint program, GLenum target, GLuint index, GLsizei count, const GLint* params) noexcept
{
    SYSTEM_BODY_5(gglNamedProgramLocalParametersI4ivEXT, program, target, index, count, params);
}

void System::GlNamedProgramLocalParametersI4uivEXT(GLuint program, GLenum target, GLuint index, GLsizei count, const GLuint* params) noexcept
{
    SYSTEM_BODY_5(gglNamedProgramLocalParametersI4uivEXT, program, target, index, count, params);
}

void System::GlNamedProgramStringEXT(GLuint program, GLenum target, GLenum format, GLsizei len, const void* programString) noexcept
{
    SYSTEM_BODY_5(gglNamedProgramStringEXT, program, target, format, len, programString);
}

void System::GlNamedRenderbufferStorageEXT(GLuint renderbuffer, GLenum internalformat, GLsizei width, GLsizei height) noexcept
{
    SYSTEM_BODY_4(gglNamedRenderbufferStorageEXT, renderbuffer, internalformat, width, height);
}

void System::GlNamedRenderbufferStorageMultisampleCoverageEXT(GLuint renderbuffer, GLsizei coverageSamples, GLsizei colorSamples, GLenum internalformat, GLsizei width, GLsizei height) noexcept
{
...
void System::GlNamedRenderbufferStorageMultisampleEXT(GLuint renderbuffer, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height) noexcept
{
    SYSTEM_BODY_5(gglNamedRenderbufferStorageMultisampleEXT, renderbuffer, samples, internalformat, width, height);
}

void System::GlProgramUniform1fEXT(GLuint program, GLint location, GLfloat v0) noexcept
{
    SYSTEM_BODY_3(gglProgramUniform1fEXT, program, location, v0);
}

void System::GlProgramUniform1fvEXT(GLuint program, GLint location, GLsizei count, const GLfloat* value) noexcept
{
    SYSTEM_BODY_4(gglProgramUniform1fvEXT, program, location, count, value);
}

void System::GlProgramUniform1iEXT(GLuint program, GLint location, GLint v0) noexcept
{
    SYSTEM_BODY_3(gglProgramUniform1iEXT, program, location, v0);
}

void System::GlProgramUniform1ivEXT(GLuint program, GLint location, GLsizei count, const GLint* value) noexcept
{
    SYSTEM_BODY_4(gglProgramUniform1ivEXT, program, location, count, value);
}

void System::GlProgramUniform1uiEXT(GLuint program, GLint location, GLuint v0) noexcept
{
    SYSTEM_BODY_3(gglProgramUniform1uiEXT, program, location, v0);
}

void System::GlProgramUniform1uivEXT(GLuint program, GLint location, GLsizei count, const GLuint* value) noexcept
{
    SYSTEM_BODY_4(gglProgramUniform1uivEXT, program, location, count, value);
}

void System::GlProgramUniform2fEXT(GLuint program, GLint location, GLfloat v0, GLfloat v1) noexcept
{
    SYSTEM_BODY_4(gglProgramUniform2fEXT, program, location, v0, v1);
}

void System::GlProgramUniform2fvEXT(GLuint program, GLint location, GLsizei count, const GLfloat* value) noexcept
{
    SYSTEM_BODY_4(gglProgramUniform2fvEXT, program, location, count, value);
}

void System::GlProgramUniform2iEXT(GLuint program, GLint location, GLint v0, GLint v1) noexcept
{
    SYSTEM_BODY_4(gglProgramUniform2iEXT, program, location, v0, v1);
}

void System::GlProgramUniform2ivEXT(GLuint program, GLint location, GLsizei count, const GLint* value) noexcept
{
    SYSTEM_BODY_4(gglProgramUniform2ivEXT, program, location, count, value);
}

void System::GlProgramUniform2uiEXT(GLuint program, GLint location, GLuint v0, GLuint v1) noexcept
{
    SYSTEM_BODY_4(gglProgramUniform2uiEXT, program, location, v0, v1);
}

void System::GlProgramUniform2uivEXT(GLuint program, GLint location, GLsizei count, const GLuint* value) noexcept
{
    SYSTEM_BODY_4(gglProgramUniform2uivEXT, program, location, count, value);
}

void System::GlProgramUniform3fEXT(GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2) noexcept
{
    SYSTEM_BODY_5(gglProgramUniform3fEXT, program, location, v0, v1, v2);
}

void System::GlProgramUniform3fvEXT(GLuint program, GLint location, GLsizei count, const GLfloat* value) noexcept
{
    SYSTEM_BODY_4(gglProgramUniform3fvEXT, program, location, count, value);
}

void System::GlProgramUniform3iEXT(GLuint program, GLint location, GLint v0, GLint v1, GLint v2) noexcept
{
    SYSTEM_BODY_5(gglProgramUniform3iEXT, program, location, v0, v1, v2);
}

void System::GlProgramUniform3ivEXT(GLuint program, GLint location, GLsizei count, const GLint* value) noexcept
{
    SYSTEM_BODY_4(gglProgramUniform3ivEXT, program, location, count, value);
}

void System::GlProgramUniform3uiEXT(GLuint program, GLint location, GLuint v0, GLuint v1, GLuint v2) noexcept
{
    SYSTEM_BODY_5(gglProgramUniform3uiEXT, program, location, v0, v1, v2);
}

void System::GlProgramUniform3uivEXT(GLuint program, GLint location, GLsizei count, const GLuint* value) noexcept
{
    SYSTEM_BODY_4(gglProgramUniform3uivEXT, program, location, count, value);
}

void System::GlProgramUniform4fEXT(GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3) noexcept
{
    SYSTEM_BODY_6(gglProgramUniform4fEXT, program, location, v0, v1, v2, v3);
}

void System::GlProgramUniform4fvEXT(GLuint program, GLint location, GLsizei count, const GLfloat* value) noexcept
{
    SYSTEM_BODY_4(gglProgramUniform4fvEXT, program, location, count, value);
}

void System::GlProgramUniform4iEXT(GLuint program, GLint location, GLint v0, GLint v1, GLint v2, GLint v3) noexcept
{
    SYSTEM_BODY_6(gglProgramUniform4iEXT, program, location, v0, v1, v2, v3);
}

void System::GlProgramUniform4ivEXT(GLuint program, GLint location, GLsizei count, const GLint* value) noexcept
{
    SYSTEM_BODY_4(gglProgramUniform4ivEXT, program, location, count, value);
}

void System::GlProgramUniform4uiEXT(GLuint program, GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3) noexcept
{
    SYSTEM_BODY_6(gglProgramUniform4iEXT, program, location, v0, v1, v2, v3);
}

void System::GlProgramUniform4uivEXT(GLuint program, GLint location, GLsizei count, const GLuint* value) noexcept
{
    SYSTEM_BODY_4(gglProgramUniform4uivEXT, program, location, count, value);
}

void System::GlProgramUniformMatrix2fvEXT(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) noexcept
{
    SYSTEM_BODY_5(gglProgramUniformMatrix2fvEXT, program, location, count, transpose, value);
}

void System::GlProgramUniformMatrix2x3fvEXT(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) noexcept
{
    SYSTEM_BODY_5(gglProgramUniformMatrix2x3fvEXT, program, location, count, transpose, value);
}

void System::GlProgramUniformMatrix2x4fvEXT(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) noexcept
{
    SYSTEM_BODY_5(gglProgramUniformMatrix2x4fvEXT, program, location, count, transpose, value);
}

void System::GlProgramUniformMatrix3fvEXT(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) noexcept
{
    SYSTEM_BODY_5(gglProgramUniformMatrix3fvEXT, program, location, count, transpose, value);
}

void System::GlProgramUniformMatrix3x2fvEXT(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) noexcept
{
    SYSTEM_BODY_5(gglProgramUniformMatrix3x2fvEXT, program, location, count, transpose, value);
}

void System::GlProgramUniformMatrix3x4fvEXT(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) noexcept
{
    SYSTEM_BODY_5(gglProgramUniformMatrix3x4fvEXT, program, location, count, transpose, value);
}

void System::GlProgramUniformMatrix4fvEXT(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) noexcept
{
    SYSTEM_BODY_5(gglProgramUniformMatrix4fvEXT, program, location, count, transpose, value);
}

void System::GlProgramUniformMatrix4x2fvEXT(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) noexcept
{
    SYSTEM_BODY_5(gglProgramUniformMatrix4x2fvEXT, program, location, count, transpose, value);
}

void System::GlProgramUniformMatrix4x3fvEXT(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) noexcept
{
    SYSTEM_BODY_5(gglProgramUniformMatrix4x3fvEXT, program, location, count, transpose, value);
}

void System::GlPushClientAttribDefaultEXT(GLbitfield mask) noexcept
{
    SYSTEM_BODY_1(gglPushClientAttribDefaultEXT, mask);
}

void System::GlTextureBufferEXT(GLuint texture, GLenum target, GLenum internalformat, GLuint buffer) noexcept
{
    SYSTEM_BODY_4(gglTextureBufferEXT, texture, target, internalformat, buffer);
}

void System::GlTextureImage1DEXT(GLuint texture, GLenum target, GLint level, GLint internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const void* pixels) noexcept
{
    SYSTEM_BODY_9(gglTextureImage1DEXT, texture, target, level, internalformat, width, border, format, type, pixels);
}

void System::GlTextureImage2DEXT(GLuint texture, GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const void* pixels) noexcept
{
    SYSTEM_BODY_10(gglTextureImage2DEXT, texture, target, level, internalformat, width, height, border, format, type, pixels);
}

void System::GlTextureImage3DEXT(GLuint texture, GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const void* pixels) noexcept
{
    SYSTEM_BODY_11(gglTextureImage3DEXT, texture, target, level, internalformat, width, height, depth, border, format, type, pixels);
}

void System::GlTextureParameterIivEXT(GLuint texture, GLenum target, GLenum parameterName, const GLint* params) noexcept
{
    SYSTEM_BODY_4(gglTextureParameterIivEXT, texture, target, parameterName, params);
}

void System::GlTextureParameterIuivEXT(GLuint texture, GLenum target, GLenum parameterName, const GLuint* params) noexcept
{
    SYSTEM_BODY_4(gglTextureParameterIuivEXT, texture, target, parameterName, params);
}

void System::GlTextureParameterfEXT(GLuint texture, GLenum target, GLenum parameterName, GLfloat param) noexcept
{
    SYSTEM_BODY_4(gglTextureParameterfEXT, texture, target, parameterName, param);
}

void System::GlTextureParameterfvEXT(GLuint texture, GLenum target, GLenum parameterName, const GLfloat* param) noexcept
{
    SYSTEM_BODY_4(gglTextureParameterfvEXT, texture, target, parameterName, param);
}

void System::GlTextureParameteriEXT(GLuint texture, GLenum target, GLenum parameterName, GLint param) noexcept
{
    SYSTEM_BODY_4(gglTextureParameteriEXT, texture, target, parameterName, param);
}

void System::GlTextureParameterivEXT(GLuint texture, GLenum target, GLenum parameterName, const GLint* param) noexcept
{
    SYSTEM_BODY_4(gglTextureParameterivEXT, texture, target, parameterName, param);
}

void System::GlTextureRenderbufferEXT(GLuint texture, GLenum target, GLuint renderbuffer) noexcept
{
    SYSTEM_BODY_3(gglTextureRenderbufferEXT, texture, target, renderbuffer);
}

void System::GlTextureSubImage1DEXT(GLuint texture, GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const void* pixels) noexcept
{
    SYSTEM_BODY_8(gglTextureSubImage1DEXT, texture, target, level, xoffset, width, format, type, pixels);
}

void System::GlTextureSubImage2DEXT(GLuint texture, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const void* pixels) noexcept
{
    SYSTEM_BODY_10(gglTextureSubImage2DEXT, texture, target, level, xoffset, yoffset, width, height, format, type, pixels);
}

void System::GlTextureSubImage3DEXT(GLuint texture, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset,
                                    GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const void* pixels) noexcept
{
...
GLboolean System::GlUnmapNamedBufferEXT(GLuint buffer) noexcept
{
    SYSTEM_BODY_1_RESULT(gglUnmapNamedBufferEXT, buffer, GLboolean, GL_FALSE);
}

void System::GlVertexArrayColorOffsetEXT(GLuint vaobj, GLuint buffer, GLint size, GLenum type, GLsizei stride, GLintptr offset) noexcept
{
    SYSTEM_BODY_6(gglVertexArrayColorOffsetEXT, vaobj, buffer, size, type, stride, offset);
}

void System::GlVertexArrayEdgeFlagOffsetEXT(GLuint vaobj, GLuint buffer, GLsizei stride, GLintptr offset) noexcept
{
    SYSTEM_BODY_4(gglVertexArrayEdgeFlagOffsetEXT, vaobj, buffer, stride, offset);
}

void System::GlVertexArrayFogCoordOffsetEXT(GLuint vaobj, GLuint buffer, GLenum type, GLsizei stride, GLintptr offset) noexcept
{
    SYSTEM_BODY_5(gglVertexArrayFogCoordOffsetEXT, vaobj, buffer, type, stride, offset);
}

void System::GlVertexArrayIndexOffsetEXT(GLuint vaobj, GLuint buffer, GLenum type, GLsizei stride, GLintptr offset) noexcept
{
    SYSTEM_BODY_5(gglVertexArrayIndexOffsetEXT, vaobj, buffer, type, stride, offset);
}

void System::GlVertexArrayMultiTexCoordOffsetEXT(GLuint vaobj, GLuint buffer, GLenum texunit, GLint size, GLenum type, GLsizei stride, GLintptr offset) noexcept
{
    SYSTEM_BODY_7(gglVertexArrayMultiTexCoordOffsetEXT, vaobj, buffer, texunit, size, type, stride, offset);
}

void System::GlVertexArrayNormalOffsetEXT(GLuint vaobj, GLuint buffer, GLenum type, GLsizei stride, GLintptr offset) noexcept
{
    SYSTEM_BODY_5(gglVertexArrayNormalOffsetEXT, vaobj, buffer, type, stride, offset);
}

void System::GlVertexArraySecondaryColorOffsetEXT(GLuint vaobj, GLuint buffer, GLint size, GLenum type, GLsizei stride, GLintptr offset) noexcept
{
    SYSTEM_BODY_6(gglVertexArraySecondaryColorOffsetEXT, vaobj, buffer, size, type, stride, offset);
}

void System::GlVertexArrayTexCoordOffsetEXT(GLuint vaobj, GLuint buffer, GLint size, GLenum type, GLsizei stride, GLintptr offset) noexcept
{
    SYSTEM_BODY_6(gglVertexArrayTexCoordOffsetEXT, vaobj, buffer, size, type, stride, offset);
}

void System::GlVertexArrayVertexAttribDivisorEXT(GLuint vaobj, GLuint index, GLuint divisor) noexcept
{
    SYSTEM_BODY_3(gglVertexArrayVertexAttribDivisorEXT, vaobj, index, divisor);
}

void System::GlVertexArrayVertexAttribIOffsetEXT(GLuint vaobj, GLuint buffer, GLuint index, GLint size, GLenum type, GLsizei stride, GLintptr offset) noexcept
{
    SYSTEM_BODY_7(gglVertexArrayVertexAttribIOffsetEXT, vaobj, buffer, index, size, type, stride, offset);
}

void System::GlVertexArrayVertexAttribOffsetEXT(GLuint vaobj, GLuint buffer, GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, GLintptr offset) noexcept
{
    SYSTEM_BODY_8(gglVertexArrayVertexAttribOffsetEXT, vaobj, buffer, index, size, type, normalized, stride, offset);
}
void System::GlVertexArrayVertexOffsetEXT(GLuint vaobj, GLuint buffer, GLint size, GLenum type, GLsizei stride, GLintptr offset) noexcept
{
    SYSTEM_BODY_6(gglVertexArrayVertexOffsetEXT, vaobj, buffer, size, type, stride, offset);
}

void System::InitGlExtDirectStateAccess()
{
...
namespace System
{
    auto g_ExistsGlExtVertexArrayBgra = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtVertexArrayBgra() noexcept
{
    return g_ExistsGlExtVertexArrayBgra;
}

void System::InitGlExtVertexArrayBgra()
{
...
namespace System
{
    auto g_ExistsGlExtTextureSwizzle = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureSwizzle() noexcept
{
    return g_ExistsGlExtTextureSwizzle;
}

void System::InitGlExtTextureSwizzle()
{
...
namespace System
{
    auto g_ExistsGlExtProvokingVertex = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtProvokingVertex() noexcept
{
...
void System::GlProvokingVertexEXT(GLenum mode) noexcept
{
    SYSTEM_BODY_1(gglProvokingVertexEXT, mode);
}

void System::InitGlExtProvokingVertex()
{
...
namespace System
{
    auto g_ExistsGlExtTextureSnorm = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureSnorm() noexcept
{
    return g_ExistsGlExtTextureSnorm;
}

void System::InitGlExtTextureSnorm()
{
...
namespace System
{
    auto g_ExistsGlExtSeparateShaderObjects = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtSeparateShaderObjects() noexcept
{
...
void System::GlActiveProgramEXT(GLuint program) noexcept
{
    SYSTEM_BODY_1(gglActiveProgramEXT, program);
}

GLuint System::GlCreateShaderProgramEXT(GLenum type, const GLchar* programString) noexcept
{
    SYSTEM_BODY_2_RESULT(gglCreateShaderProgramEXT, type, programString, GLuint, 0);
}

void System::GlUseShaderProgramEXT(GLenum type, GLuint program) noexcept
{
    SYSTEM_BODY_2(gglUseShaderProgramEXT, type, program);
}

void System::InitGlExtSeparateShaderObjects()
{
...
namespace System
{
    auto g_ExistsGlExtShaderImageLoadStore = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtShaderImageLoadStore() noexcept
{
...
void System::GlBindImageTextureEXT(GLuint index, GLuint texture, GLint level, GLboolean layered, GLint layer, GLenum access, GLint format) noexcept
{
    SYSTEM_BODY_7(gglBindImageTextureEXT, index, texture, level, layered, layer, access, format);
}

void System::GlMemoryBarrierEXT(GLbitfield barriers) noexcept
{
    SYSTEM_BODY_1(gglMemoryBarrierEXT, barriers);
}

void System::InitGlExtShaderImageLoadStore()
{
...
namespace System
{
    auto g_ExistsGlExtVertexAttrib64bit = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtVertexAttrib64bit() noexcept
{
...
void System::GlGetVertexAttribLdvEXT(GLuint index, GLenum parameterName, GLdouble* params) noexcept
{
    SYSTEM_BODY_3(gglGetVertexAttribLdvEXT, index, parameterName, params);
}

void System::GlVertexArrayVertexAttribLOffsetEXT(GLuint vaobj, GLuint buffer, GLuint index, GLint size, GLenum type, GLsizei stride, GLintptr offset) noexcept
{
    SYSTEM_BODY_7(gglVertexArrayVertexAttribLOffsetEXT, vaobj, buffer, index, size, type, stride, offset);
}

void System::GlVertexAttribL1dEXT(GLuint index, GLdouble x) noexcept
{
    SYSTEM_BODY_2(gglVertexAttribL1dEXT, index, x);
}

void System::GlVertexAttribL1dvEXT(GLuint index, const GLdouble* v) noexcept
{
    SYSTEM_BODY_2(gglVertexAttribL1dvEXT, index, v);
}

void System::GlVertexAttribL2dEXT(GLuint index, GLdouble x, GLdouble y) noexcept
{
    SYSTEM_BODY_3(gglVertexAttribL2dEXT, index, x, y);
}

void System::GlVertexAttribL2dvEXT(GLuint index, const GLdouble* v) noexcept
{
    SYSTEM_BODY_2(gglVertexAttribL2dvEXT, index, v);
}

void System::GlVertexAttribL3dEXT(GLuint index, GLdouble x, GLdouble y, GLdouble z) noexcept
{
    SYSTEM_BODY_4(gglVertexAttribL3dEXT, index, x, y, z);
}

void System::GlVertexAttribL3dvEXT(GLuint index, const GLdouble* v) noexcept
{
    SYSTEM_BODY_2(gglVertexAttribL3dvEXT, index, v);
}

void System::GlVertexAttribL4dEXT(GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w) noexcept
{
    SYSTEM_BODY_5(gglVertexAttribL4dEXT, index, x, y, z, w);
}

void System::GlVertexAttribL4dvEXT(GLuint index, const GLdouble* v) noexcept
{
    SYSTEM_BODY_2(gglVertexAttribL4dvEXT, index, v);
}

void System::GlVertexAttribLPointerEXT(GLuint index, GLint size, GLenum type, GLsizei stride, const void* pointer) noexcept
{
    SYSTEM_BODY_5(gglVertexAttribLPointerEXT, index, size, type, stride, pointer);
}

void System::InitGlExtVertexAttrib64bit()
{
...
namespace System
{
    auto g_ExistsGlExtTextureSRGBDecode = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureSRGBDecode() noexcept
{
    return g_ExistsGlExtTextureSRGBDecode;
}

void System::InitGlExtTextureSRGBDecode()
{
...
namespace System
{
    auto g_ExistsGlExtX11SynObject = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtX11SynObject() noexcept
{
...
GLsync System::GlImportSyncEXT(GLenum externalSyncType, GLintptr externalSync, GLbitfield flags) noexcept
{
    SYSTEM_BODY_3_RESULT(gglImportSyncEXT, externalSyncType, externalSync, flags, GLsync, nullptr);
}

void System::InitGlExtX11SynObject()
{
...
namespace System
{
    auto g_ExistsGlExtFramebufferMultisampleBlitScaled = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtFramebufferMultisampleBlitScaled() noexcept
{
    return g_ExistsGlExtFramebufferMultisampleBlitScaled;
}

void System::InitGlExtFramebufferMultisampleBlitScaled()
{
...
namespace System
{
    auto g_ExistsGlExtShaderIntegerMix = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtShaderIntegerMix() noexcept
{
    return g_ExistsGlExtShaderIntegerMix;
}

void System::InitGlExtShaderIntegerMix()
{
...
namespace System
{
    auto g_ExistsGlExtDebugLabel = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtDebugLabel() noexcept
{
...
void System::GlGetObjectLabelEXT(GLenum type, GLuint object, GLsizei bufSize, GLsizei* length, GLchar* label) noexcept
{
    SYSTEM_BODY_5(gglGetObjectLabelEXT, type, object, bufSize, length, label);
}

void System::GlLabelObjectEXT(GLenum type, GLuint object, GLsizei length, const GLchar* label) noexcept
{
    SYSTEM_BODY_4(gglLabelObjectEXT, type, object, length, label);
}

void System::InitGlExtDebugLabel()
{
...
namespace System
{
    auto g_ExistsGlExtDebugMarker = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtDebugMarker() noexcept
{
...
void System::GlInsertEventMarkerEXT(GLsizei length, const GLchar* marker) noexcept
{
    SYSTEM_BODY_2(gglInsertEventMarkerEXT, length, marker);
}

void System::GlPopGroupMarkerEXT(void) noexcept
{
    SYSTEM_BODY_0(gglPopGroupMarkerEXT);
}

void System::GlPushGroupMarkerEXT(GLsizei length, const GLchar* marker) noexcept
{
    SYSTEM_BODY_2(gglPushGroupMarkerEXT, length, marker);
}

void System::InitGlExtDebugMarker()
{
...
namespace System
{
    auto g_ExistsGlExtShaderImageLoadFormatted = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtShaderImageLoadFormatted() noexcept
{
    return g_ExistsGlExtShaderImageLoadFormatted;
}

void System::InitGlExtShaderImageLoadFormatted()
{
...
namespace System
{
    auto g_ExistsGlExtPolygonOffsetClamp = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtPolygonOffsetClamp() noexcept
{
...
void System::GlPolygonOffsetClampEXT(GLfloat factor, GLfloat units, GLfloat clamp) noexcept
{
    SYSTEM_BODY_3(gglPolygonOffsetClampEXT, factor, units, clamp);
}

void System::InitGlExtPolygonOffsetClamp()
{
...
namespace System
{
    auto g_ExistsGlExtPostDepthCoverage = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtPostDepthCoverage() noexcept
{
    return g_ExistsGlExtPostDepthCoverage;
}

void System::InitGlExtPostDepthCoverage()
{
...
namespace System
{
    auto g_ExistsGlExtRasterMultisample = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtRasterMultisample() noexcept
{
...
void System::GlCoverageModulationNV(GLenum components) noexcept
{
    SYSTEM_BODY_1(gglCoverageModulationNV, components);
}

void System::GlCoverageModulationTableNV(GLsizei n, const GLfloat* v) noexcept
{
    SYSTEM_BODY_2(gglCoverageModulationTableNV, n, v);
}

void System::GlGetCoverageModulationTableNV(GLsizei bufsize, GLfloat* v) noexcept
{
    SYSTEM_BODY_2(gglGetCoverageModulationTableNV, bufsize, v);
}

void System::GlRasterSamplesEXT(GLuint samples, GLboolean fixedsamplelocations) noexcept
{
    SYSTEM_BODY_2(gglRasterSamplesEXT, samples, fixedsamplelocations);
}

void System::InitGlExtRasterMultisample()
{
...
namespace System
{
    auto g_ExistsGlExtSparseTexture2 = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtSparseTexture2() noexcept
{
    return g_ExistsGlExtSparseTexture2;
}

void System::InitGlExtSparseTexture2()
{
...
namespace System
{
    auto g_ExistsGlExtTextureFilterMinmax = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtTextureFilterMinmax() noexcept
{
    return g_ExistsGlExtTextureFilterMinmax;
}

void System::InitGlExtFilterMinmax()
{
...
namespace System
{
    auto g_ExistsGlExtCgShader = ExistsOpenGLExtensions::Unknown;
}

System::ExistsOpenGLExtensions System::IsExistsGlExtCgShader() noexcept
{
    return g_ExistsGlExtCgShader;
}

void System::InitGlExtCgShader()
{
