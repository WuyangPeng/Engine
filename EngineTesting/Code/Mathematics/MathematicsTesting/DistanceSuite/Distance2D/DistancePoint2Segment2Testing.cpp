...
///
///	标准：std:c++20
///	引擎测试版本：0.9.0.12 (2023/06/09 15:38)
...
Mathematics::DistancePoint2Segment2Testing::DistancePoint2Segment2Testing(const OStreamShared& streamShared)
    : ParentType{ streamShared }
{
    MATHEMATICS_SELF_CLASS_IS_VALID_1;
}

CLASS_INVARIANT_PARENT_IS_VALID_DEFINE(Mathematics, DistancePoint2Segment2Testing)

void Mathematics::DistancePoint2Segment2Testing::DoRunUnitTest()
{
