...
1. C++ 代码整洁之道：C++17可持续软件开发模式实践（Clean C++: Sustainable Software Development）
...
2. C++ 语言的设计和演化（The Design and Evolution of C++）
...
3. C++ 跨平台开发技术指南（Cross-Platform Development in C++）

官方网站：
http://www.trixul.com、 http://sourceforge.net/projects/trixul、 http://www.crossplatformbook.com

★
作者：Syd Logan

4. C++ API设计（API Design for C++）
...
5. 深度探索C++14（Discovering Modern C++）
...
官方网站：
http://www.trolltech.com/ 、https://www.informit.com/store/c-plus-plus-gui-programming-with-qt4-9780132354165
