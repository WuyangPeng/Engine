...
#ifndef UPDATE_SERVER_MIDDLE_LAYER_HELPER_EXPORT_MACRO_H
#define UPDATE_SERVER_MIDDLE_LAYER_HELPER_EXPORT_MACRO_H
...
#endif  // UPDATE_SERVER_MIDDLE_LAYER_HELPER_EXPORT_MACRO_H