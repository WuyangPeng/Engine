...
AssistTools::GenerateTestingTemplateEngineDirectoryTesting::GenerateTestingTemplateEngineDirectoryTesting(const OStreamShared& stream)
    : ParentType{ stream }
{
    ASSIST_TOOLS_SELF_CLASS_IS_VALID_1;
}

CLASS_INVARIANT_PARENT_IS_VALID_DEFINE(AssistTools, GenerateTestingTemplateEngineDirectoryTesting)

void AssistTools::GenerateTestingTemplateEngineDirectoryTesting::DoRunUnitTest()
{
...
void AssistTools::GenerateTestingTemplateEngineDirectoryTesting::GenerateToTest()
{
    ...
    GenerateTestingTemplateEngineDirectory generateTestingTemplateEngineDirectory(GetResourceDirectory(), "Configuration/StringReplacing.json");
