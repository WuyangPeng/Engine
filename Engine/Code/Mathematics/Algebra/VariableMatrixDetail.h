...
Mathematics::VariableMatrix<Real>
...
template <typename Real>
Mathematics::VariableMatrix<Real>
	::VariableMatrix( const Matrix3& rhs )
...
template <typename Real>
Mathematics::VariableMatrix<Real>
	::VariableMatrix( const Matrix2& rhs )
...
template <typename Real>
Mathematics::VariableMatrix<Real>& Mathematics::VariableMatrix<Real>
...
template <typename Real>
void Mathematics::VariableMatrix<Real>
	::Swap( VariableMatrix& rhs )
{
...
template <typename Real>
bool Mathematics::VariableMatrix<Real>
	...
	::SetIdentity()
{
	...
	{
		m_Entry[i][i] = static_cast<Real>(1);
	}
}

template <typename Real>
void Mathematics::VariableMatrix<Real>
	::ResetSize( int rowsNumber, int columnsNumber )
{
	MATHEMATICS_CLASS_IS_VALID_1;
...
template <typename Real>
int Mathematics::VariableMatrix<Real>
...
template <typename Real>
const Real* Mathematics::VariableMatrix<Real>
	::GetElements() const
{
	MATHEMATICS_CLASS_IS_VALID_CONST_1;
...
template <typename Real>
Real* Mathematics::VariableMatrix<Real>
	::GetElements()
{
	MATHEMATICS_CLASS_IS_VALID_CONST_1;
	MATHEMATICS_ASSERTION_0(m_Entry != nullptr,"矩阵大小为零！");
...
template <typename Real>
void Mathematics::VariableMatrix<Real>
	::SetRow( int row, const VariableLengthVector& vector )
{
	MATHEMATICS_CLASS_IS_VALID_1;
	MATHEMATICS_ASSERTION_0(0 <= row && row < m_RowsNumber,"索引错误！");
...
template <typename Real>
void Mathematics::VariableMatrix<Real>
	::SetColumn( int column, const VariableLengthVector& vector )
{
	MATHEMATICS_CLASS_IS_VALID_1;
...
template <typename Real>
void Mathematics::VariableMatrix<Real>
	::ResetMatrix( int rowsNumber, int columnsNumber,  const std::vector<Real>& entry )
{
	MATHEMATICS_CLASS_IS_VALID_1;
...
template <typename Real>
void Mathematics::VariableMatrix<Real>
	::ResetMatrix( int rowsNumber, int columnsNumber,const std::vector<std::vector<Real> >& matrix )
{
	MATHEMATICS_CLASS_IS_VALID_1;
...
template <typename Real>
void Mathematics::VariableMatrix<Real>
	::SwapRows( int firstRow, int secondRow )
{
	MATHEMATICS_CLASS_IS_VALID_1;
...
template <typename Real>
void Mathematics::VariableMatrix<Real>
	::SwapColumns( int firstColumns, int secondColumns )
{
	MATHEMATICS_CLASS_IS_VALID_1;
...
template <typename Real>
const Mathematics::VariableMatrix<Real> Mathematics::VariableMatrix<Real>
	::operator-() const
{
	MATHEMATICS_CLASS_IS_VALID_CONST_1;
...
template <typename Real>
Real Mathematics::VariableMatrix<Real>
	::QuadraticForm( const VariableLengthVector& firstVector,const VariableLengthVector& secondVector ) const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_1;
...
template <typename Real>
typename const Mathematics::VariableMatrix<Real>::Matrix3 Mathematics::VariableMatrix<Real>
	::GetMatrix3() const
{
...
template <typename Real>
bool Mathematics
	::operator==( const VariableMatrix<Real>& lhs,const VariableMatrix<Real>& rhs )
{
...
template <typename Real>
const Mathematics::VariableMatrix<Real>	Mathematics
	::operator*( const VariableMatrix<Real>& lhs, const VariableMatrix<Real>& rhs )
{
...
const Mathematics::VariableLengthVector<Real> Mathematics
	::operator*( const VariableMatrix<Real>& matrix,const VariableLengthVector<Real>& vector )
{
...
template <typename Real>
const Mathematics::VariableLengthVector<Real> Mathematics
	::operator*( const VariableLengthVector<Real>& vector,const VariableMatrix<Real>& matrix )
{
...
template <typename Real>
const Mathematics::VariableMatrix<Real>	Mathematics
	::TransposeTimes( const VariableMatrix<Real>& lhs,const VariableMatrix<Real>& rhs )
{
...
template <typename Real>
const Mathematics::VariableMatrix<Real>	Mathematics
	::TimesTranspose( const VariableMatrix<Real>& lhs, const VariableMatrix<Real>& rhs )
{
...
const Mathematics::VariableMatrix<Real>
	Mathematics
	::TransposeTimesTranspose( const VariableMatrix<Real>& lhs,const VariableMatrix<Real>& rhs )
{
...
template <typename Real>
bool Mathematics	
	::Approximate( const VariableMatrix<Real>& lhs, const VariableMatrix<Real>& rhs,const Real epsilon )
{
...
template <typename Real>
bool Mathematics
	::Approximate( const VariableMatrix<Real>& lhs, const VariableMatrix<Real>& rhs )
{
...
std::ostream&  Mathematics
	::operator<<(std::ostream& outFile,const VariableMatrix<Real>& matrix)
{
