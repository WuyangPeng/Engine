...
#if !defined(MATHEMATICS_EXPORT_TEMPLATE) || defined(MATHEMATICS_INCLUDED_STATIC_FIND_INTERSECTOR_ELLIPSE2_ELLIPSE2_ACHIEVE)

    #include "StaticFindIntersectorEllipse2Ellipse2Achieve.h"

#endif  // !defined(MATHEMATICS_EXPORT_TEMPLATE) || defined(MATHEMATICS_INCLUDED_STATIC_FIND_INTERSECTOR_ELLIPSE2_ELLIPSE2_ACHIEVE)
