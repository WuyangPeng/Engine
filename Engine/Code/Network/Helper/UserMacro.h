...
#define CLOSE_USE_PROTOBUF (NETWORK_ClOSE_BEGIN << 3)

#define NETWORK_ClOSE_END CLOSE_USE_PROTOBUF

#define CLOSE_NETWORK_MAX (((NETWORK_ClOSE_END) << 1) - 1)

// 编译测试（默认为0x04，最大值为0x0F）
...
#if !defined(COMPILE_NETWORK_CLOSE) || (COMPILE_NETWORK_CLOSE & CLOSE_USE_PROTOBUF) != CLOSE_USE_PROTOBUF
    #define NETWORK_USE_PROTOBUF static_cast<void>(0)
#endif  // !defined(COMPILE_NETWORK_CLOSE) || (COMPILE_NETWORK_CLOSE & CLOSE_USE_PROTOBUF) != CLOSE_USE_PROTOBUF
