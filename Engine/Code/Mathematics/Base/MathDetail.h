...
template <typename Real>
Real Mathematics::Math<Real>
	::Clamp (Real value, Real minValue, Real maxValue)
{
    if (value <= minValue)    
         return minValue;
...
bool Mathematics::Math<Real>
	::Approximate( Real lhs, Real rhs, const Real epsilon ) noexcept
{
...
template <typename Real>
Real Mathematics::Math<Real>
	::GetNumericalRoundOffNonnegative(Real value)
{
	if (value < Real{})
	{
		return Real{};
...
template <typename Real>
Real Mathematics::Math<Real>
	::GetNumericalRoundOff(Real value, Real minValue, Real maxValue)
{
	if (value < minValue)	
		return minValue;		
	else if (maxValue < value)
