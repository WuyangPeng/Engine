...
void Rendering::CameraNodeTesting ::InitTest()
{
...
void Rendering::CameraNodeTesting ::CopyTest()
{
    // 	CameraSharedPtr firstCamera(new Camera(true, 1e-5f));
    // 	CameraNode firstNode(firstCamera);
    //
...
void Rendering::CameraNodeTesting ::TransformTest()
{
    // 	CameraSharedPtr firstCamera(new Camera(true, 1e-5f));
    // 	CameraNode firstNode(firstCamera);
    // 	ControllerInterfaceSharedPtr secondNode(new Node);
...
void Rendering::CameraNodeTesting ::ChildTest()
{
...
void Rendering::CameraNodeTesting ::StreamTest()
{
    // 	CoreTools::OutTopLevel outTopLevel;
    //
