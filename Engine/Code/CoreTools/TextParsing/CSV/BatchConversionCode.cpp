...
///
/// 标准：std:c++20
/// 版本：1.0.0.8 (2024/04/03 00:07)

#include "CoreTools/CoreToolsExport.h"

#include "BatchConversionCode.h"
#include "CoreTools/Helper/ClassInvariant/CoreToolsClassInvariantMacro.h"
#include "CoreTools/TextParsing/Detail/CSV/BatchConversionCodeImpl.h"
...
{
    const BatchConversionCodeImpl impl{ inputDirectory, codeDirectory, outputDirectory };
