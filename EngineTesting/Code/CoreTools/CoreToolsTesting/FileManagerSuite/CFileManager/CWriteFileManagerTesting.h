...
namespace CoreTools
{
    ...
    private:
        ...
        void ReadBufferTest(CReadFileManager& manager, size_t size, const std::string& content);
        void DoPositionTest(CWriteFileManager& manager);
        void MiscellaneousTest(CWriteFileManager& manager);
