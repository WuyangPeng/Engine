...
void CoreTools::CSVTypeConversionTesting::MainTest()
{
    ...
    ASSERT_NOT_THROW_EXCEPTION_0(GetAbbreviationTest);
}

void CoreTools::CSVTypeConversionTesting::CSVDataTypeTest()
{
    ASSERT_NOT_THROW_EXCEPTION_0(GetTypeDescribe0Test);
    ASSERT_NOT_THROW_EXCEPTION_0(GetTypeDescribe1Test);
    ASSERT_NOT_THROW_EXCEPTION_0(GetDataType0Test);
    ASSERT_NOT_THROW_EXCEPTION_0(GetDataType1Test);
}

void CoreTools::CSVTypeConversionTesting::GetTypeDescribe0Test()
{
...
void CoreTools::CSVTypeConversionTesting::GetTypeDescribe1Test()
{
...
void CoreTools::CSVTypeConversionTesting::GetDataType0Test()
{
    ASSERT_EQUAL(CSVDataType::String, CSVTypeConversion::GetDataType(SYSTEM_TEXT("string"s)));
    ASSERT_EQUAL(CSVDataType::Bool, CSVTypeConversion::GetDataType(SYSTEM_TEXT("bool"s)));
    ASSERT_EQUAL(CSVDataType::Char, CSVTypeConversion::GetDataType(SYSTEM_TEXT("char"s)));
    ASSERT_EQUAL(CSVDataType::Int, CSVTypeConversion::GetDataType(SYSTEM_TEXT("int"s)));
    ASSERT_EQUAL(CSVDataType::Int64, CSVTypeConversion::GetDataType(SYSTEM_TEXT("int64"s)));
    ASSERT_EQUAL(CSVDataType::Double, CSVTypeConversion::GetDataType(SYSTEM_TEXT("double"s)));
    ASSERT_EQUAL(CSVDataType::Enum, CSVTypeConversion::GetDataType(SYSTEM_TEXT("enum"s)));
    ASSERT_EQUAL(CSVDataType::Enum, CSVTypeConversion::GetDataType(SYSTEM_TEXT("enum|CSVType"s)));
    ASSERT_EQUAL(CSVDataType::Bit, CSVTypeConversion::GetDataType(SYSTEM_TEXT("bit"s)));
    ASSERT_EQUAL(CSVDataType::Vector2, CSVTypeConversion::GetDataType(SYSTEM_TEXT("vector2"s)));
    ASSERT_EQUAL(CSVDataType::Vector3, CSVTypeConversion::GetDataType(SYSTEM_TEXT("vector3"s)));
    ASSERT_EQUAL(CSVDataType::Vector4, CSVTypeConversion::GetDataType(SYSTEM_TEXT("vector4"s)));
    ASSERT_EQUAL(CSVDataType::IntVector2, CSVTypeConversion::GetDataType(SYSTEM_TEXT("intVector2"s)));
    ASSERT_EQUAL(CSVDataType::IntVector3, CSVTypeConversion::GetDataType(SYSTEM_TEXT("intVector3"s)));
    ASSERT_EQUAL(CSVDataType::IntVector4, CSVTypeConversion::GetDataType(SYSTEM_TEXT("intVector4"s)));
}

void CoreTools::CSVTypeConversionTesting::GetDataType1Test()
{
    ASSERT_EQUAL(CSVDataType::BoolArray, CSVTypeConversion::GetDataType(SYSTEM_TEXT("bool[]"s)));
    ASSERT_EQUAL(CSVDataType::CharArray, CSVTypeConversion::GetDataType(SYSTEM_TEXT("char[]"s)));
    ASSERT_EQUAL(CSVDataType::IntArray, CSVTypeConversion::GetDataType(SYSTEM_TEXT("int[]"s)));
    ASSERT_EQUAL(CSVDataType::Int64Array, CSVTypeConversion::GetDataType(SYSTEM_TEXT("int64[]"s)));
    ASSERT_EQUAL(CSVDataType::DoubleArray, CSVTypeConversion::GetDataType(SYSTEM_TEXT("double[]"s)));
    ASSERT_EQUAL(CSVDataType::EnumArray, CSVTypeConversion::GetDataType(SYSTEM_TEXT("enum[]"s)));
    ASSERT_EQUAL(CSVDataType::EnumArray, CSVTypeConversion::GetDataType(SYSTEM_TEXT("enum[]|CSVType"s)));
    ASSERT_EQUAL(CSVDataType::BitArray, CSVTypeConversion::GetDataType(SYSTEM_TEXT("bit[]"s)));
    ASSERT_EQUAL(CSVDataType::Vector2Array, CSVTypeConversion::GetDataType(SYSTEM_TEXT("vector2[]"s)));
    ASSERT_EQUAL(CSVDataType::Vector3Array, CSVTypeConversion::GetDataType(SYSTEM_TEXT("vector3[]"s)));
    ASSERT_EQUAL(CSVDataType::Vector4Array, CSVTypeConversion::GetDataType(SYSTEM_TEXT("vector4[]"s)));
    ASSERT_EQUAL(CSVDataType::IntVector2Array, CSVTypeConversion::GetDataType(SYSTEM_TEXT("intVector2[]"s)));
    ASSERT_EQUAL(CSVDataType::IntVector3Array, CSVTypeConversion::GetDataType(SYSTEM_TEXT("intVector3[]"s)));
    ASSERT_EQUAL(CSVDataType::IntVector4Array, CSVTypeConversion::GetDataType(SYSTEM_TEXT("intVector4[]"s)));
}

void CoreTools::CSVTypeConversionTesting::CSVFormatTypeTest()
{
    ASSERT_NOT_THROW_EXCEPTION_0(GetTypeDescribe2Test);
    ASSERT_NOT_THROW_EXCEPTION_0(GetFormatType0Test);
}

void CoreTools::CSVTypeConversionTesting::GetTypeDescribe2Test()
{
...
void CoreTools::CSVTypeConversionTesting::GetFormatType0Test()
{
    ASSERT_EQUAL(CSVFormatType::Default, CSVTypeConversion::GetFormatType(SYSTEM_TEXT("@default"s)));
    ASSERT_EQUAL(CSVFormatType::Ignore, CSVTypeConversion::GetFormatType(SYSTEM_TEXT("@ignore"s)));
    ASSERT_EQUAL(CSVFormatType::Vector, CSVTypeConversion::GetFormatType(SYSTEM_TEXT("@vector"s)));
    ASSERT_EQUAL(CSVFormatType::TreeMap, CSVTypeConversion::GetFormatType(SYSTEM_TEXT("@treeMap"s)));
    ASSERT_EQUAL(CSVFormatType::HashMap, CSVTypeConversion::GetFormatType(SYSTEM_TEXT("@hashMap"s)));
    ASSERT_EQUAL(CSVFormatType::Key, CSVTypeConversion::GetFormatType(SYSTEM_TEXT("@key"s)));
    ASSERT_EQUAL(CSVFormatType::Enum, CSVTypeConversion::GetFormatType(SYSTEM_TEXT("@enum"s)));
    ASSERT_EQUAL(CSVFormatType::Unique, CSVTypeConversion::GetFormatType(SYSTEM_TEXT("@unique"s)));
}

void CoreTools::CSVTypeConversionTesting::ActualTypeTest()
{
    ASSERT_NOT_THROW_EXCEPTION_0(GetActualType0Test);
    ASSERT_NOT_THROW_EXCEPTION_0(GetActualType1Test);
}

void CoreTools::CSVTypeConversionTesting::GetActualType0Test()
{
...
void CoreTools::CSVTypeConversionTesting::GetActualType1Test()
{
...
{
    ASSERT_NOT_THROW_EXCEPTION_0(GetFunctionName0Test);
    ASSERT_NOT_THROW_EXCEPTION_0(GetFunctionName1Test);
}

void CoreTools::CSVTypeConversionTesting::GetFunctionName0Test()
{
...
void CoreTools::CSVTypeConversionTesting::GetFunctionName1Test()
{
...
{
    ASSERT_NOT_THROW_EXCEPTION_0(GetValueType0Test);
    ASSERT_NOT_THROW_EXCEPTION_0(GetValueType1Test);
}

void CoreTools::CSVTypeConversionTesting::GetValueType0Test()
{
...
void CoreTools::CSVTypeConversionTesting::GetValueType1Test()
{
...
void CoreTools::CSVTypeConversionTesting::GetAbbreviationTest()
{
    ASSERT_NOT_THROW_EXCEPTION_0(GetAbbreviation0Test);
    ASSERT_NOT_THROW_EXCEPTION_0(GetAbbreviation1Test);
}

void CoreTools::CSVTypeConversionTesting::GetAbbreviation0Test()
{
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::String), SYSTEM_TEXT("String"s));
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::Bool), SYSTEM_TEXT("bool"s));
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::Char), SYSTEM_TEXT("Char"s));
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::Int), SYSTEM_TEXT("int"s));
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::Int64), SYSTEM_TEXT("int64_t"s));
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::Double), SYSTEM_TEXT("double"s));
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::Vector2), SYSTEM_TEXT("CoreTools::Vector2"s));
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::Vector3), SYSTEM_TEXT("CoreTools::Vector3"s));
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::Vector4), SYSTEM_TEXT("CoreTools::Vector4"s));
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::IntVector2), SYSTEM_TEXT("CoreTools::IntVector2"s));
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::IntVector3), SYSTEM_TEXT("CoreTools::IntVector3"s));
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::IntVector4), SYSTEM_TEXT("CoreTools::IntVector4"s));
}

void CoreTools::CSVTypeConversionTesting::GetAbbreviation1Test()
{
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::BoolArray), SYSTEM_TEXT("BoolContainer"s));
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::CharArray), SYSTEM_TEXT("CharContainer"s));
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::IntArray), SYSTEM_TEXT("IntContainer"s));
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::Int64Array), SYSTEM_TEXT("Int64Container"s));
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::DoubleArray), SYSTEM_TEXT("std::vector<double>"s));
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::Vector2Array), SYSTEM_TEXT("std::vector<CoreTools::Vector2>"s));
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::Vector3Array), SYSTEM_TEXT("std::vector<CoreTools::Vector3>"s));
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::Vector4Array), SYSTEM_TEXT("std::vector<CoreTools::Vector4>"s));
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::IntVector2Array), SYSTEM_TEXT("std::vector<CoreTools::IntVector2>"s));
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::IntVector3Array), SYSTEM_TEXT("std::vector<CoreTools::IntVector3>"s));
    ASSERT_EQUAL(CSVTypeConversion::GetAbbreviation(CSVDataType::IntVector4Array), SYSTEM_TEXT("std::vector<CoreTools::IntVector4>"s));
}
