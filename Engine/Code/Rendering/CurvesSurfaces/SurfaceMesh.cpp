	...
	::SetLevel(int level)
{
	...
	SetIndexBuffer(IndexBufferSmartPointer(NEW0 IndexBuffer(numTotalIndices, sizeof(int))));
	...
	RENDERER_MANAGE_SINGLETON.UpdateAll(GetIndexBuffer().GetData());
...
void Rendering::SurfaceMesh
	::Allocate(int& numTotalVertices, int& numTotalEdges, EdgeMap& edgeMap, int& numTotalTriangles, Triangle*& triangles)
{	
	...
	char* origData = (char*) mOrigVBuffer->GetReadOnlyData();
...
void Rendering::SurfaceMesh
	::Subdivide(int& numVertices, int& numEdges, EdgeMap& edgeMap, int& numTriangles, Triangle* triangles)
{
	numVertices; numEdges; numTriangles; triangles;
...
void Rendering::SurfaceMesh
	::InsertInto(EdgeMap& edgeMap, SurfacePatchSmartPointer patch, int v0, int v1, const Mathematics::Float2& param0, const Mathematics::Float2& param1, int newReferences)
{
...
bool Rendering::SurfaceMesh::Edge
...
Rendering::SurfaceMesh::Triangle
	::Triangle()
	:Patch(nullptr)
{
	for (int i = 0; i < 3; ++i)
...
Rendering::SurfaceMesh::SurfaceInfo
	::SurfaceInfo()
...
const CoreTools::ObjectSmartPointer Rendering::SurfaceMesh
...
const std::vector<CoreTools::ObjectSmartPointer> Rendering::SurfaceMesh
...
const CoreTools::ConstObjectSmartPointer Rendering::SurfaceMesh
...
const std::vector<CoreTools::ConstObjectSmartPointer> Rendering::SurfaceMesh
...
Rendering::SurfaceMesh
	::SurfaceMesh(LoadConstructor value)
...
uint64_t Rendering::SurfaceMesh
	::Register(CoreTools::ObjectRegister& target) const
{
	uint64_t id = ParentType::Register(target);
	if (0 < id)
	{
