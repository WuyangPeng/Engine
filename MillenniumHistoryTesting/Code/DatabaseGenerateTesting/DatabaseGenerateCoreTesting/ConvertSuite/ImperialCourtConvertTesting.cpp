...
DatabaseGenerateCoreTesting::ImperialCourtConvertTesting::ImperialCourtConvertTesting(const OStreamShared& stream, ImperialCourtContainer imperialCourtContainer)
    : ParentType{ stream }, imperialCourtContainer{ std::move(imperialCourtContainer) }
{
