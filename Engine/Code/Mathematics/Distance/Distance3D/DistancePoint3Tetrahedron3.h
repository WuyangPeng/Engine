...
namespace Mathematics
{
	...
	class DistancePoint3Tetrahedron3 : public DistanceBase<Real, Vector3D<Real> >
	{
	public:
	...
	using DistPoint3Tetrahedron3f = DistancePoint3Tetrahedron3<float>;
	using DistPoint3Tetrahedron3d = DistancePoint3Tetrahedron3<double>;
}
