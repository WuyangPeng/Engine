...
Mathematics::BezierCurve2<Real>::BezierCurve2(int degree, const std::vector<Vector2<Real>>& ctrlPoint)
...
template <typename Real>
bool Mathematics::BezierCurve2<Real>::IsValid() const noexcept
{
...
template <typename Real>
int Mathematics::BezierCurve2<Real>::GetDegree() const noexcept
{
...
template <typename Real>
std::vector<Mathematics::Vector2<Real>> Mathematics::BezierCurve2<Real>::GetControlPoints() const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
Mathematics::Vector2<Real> Mathematics::BezierCurve2<Real>::GetPosition(Real t) const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
Mathematics::Vector2<Real> Mathematics::BezierCurve2<Real>::GetFirstDerivative(Real t) const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
Mathematics::Vector2<Real> Mathematics::BezierCurve2<Real>::GetSecondDerivative(Real t) const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
Mathematics::Vector2<Real> Mathematics::BezierCurve2<Real>::GetThirdDerivative(Real t) const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
    ...
    const auto degreeM3 = degree - 3;
    for (auto i = 1; i < degreeM3; ++i)
    {
        auto coeff = choose.at(degreeM3).at(i) * powT;
        result = (result + der3CtrlPoint.at(i) * coeff) * oneMinusT;
        powT *= t;
    }

    result += der3CtrlPoint.at(degreeM3) * powT;
