...
void Rendering::LightWorldDirectionVectorConstantTesting
	::MainTest()
{ 
...
// 		LightWorldDirectionVectorConstantSharedPtr firstShaderFloat(new LightWorldDirectionVectorConstant(firstLight));
// 		
// 		for (int i = 0; i < 4;++i)
// 		{	 
...
// 		
// 		LightWorldDirectionVectorConstantSharedPtr secondShaderFloat =
// 			inTopLevel[0].PolymorphicDowncastObjectSharedPtr<LightWorldDirectionVectorConstantSharedPtr>();
// 		
...
//  
// 		const Mathematics::AVectorf& worldDirectionVector = firstLight->GetDirectionVector();
