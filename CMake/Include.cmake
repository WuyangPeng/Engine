...
if (CMAKE_SYSTEM_NAME STREQUAL "Linux")
    ...
    link_directories(/data/coding/External/protobuf/build/_deps/absl-build/absl/log/)
    ...
    link_libraries(libprotobuf.so)
    link_libraries(libabsl_log_internal_check_op.so)
    link_libraries(libabsl_log_internal_message.so)
	link_libraries(libabsl_log_internal_nullguard.so)
...
elseif (CMAKE_SYSTEM_NAME STREQUAL "Windows")
    ...
    include_directories(${CMAKE_CURRENT_SOURCE_DIR}/../../Libs/ACE/ACE_wrappers/)
    include_directories(${CMAKE_CURRENT_SOURCE_DIR}/../../Libs/openssl/x64/Release/include/)
    include_directories(${CMAKE_CURRENT_SOURCE_DIR}/../../Libs/mysql/include/)
    include_directories(${CMAKE_CURRENT_SOURCE_DIR}/../../Libs/mysql-connector-c++/include/)
    include_directories(${CMAKE_CURRENT_SOURCE_DIR}/../../Libs/protobuf/src/)
    include_directories(${CMAKE_CURRENT_SOURCE_DIR}/../../Libs/freeglut/include/)
    include_directories(${CMAKE_CURRENT_SOURCE_DIR}/../../Libs/vld/src/)
    include_directories(${CMAKE_CURRENT_SOURCE_DIR}/../../Libs/OpenXLSX/OpenXLSX/)
    ...
    include_directories(${CMAKE_CURRENT_SOURCE_DIR}/../../Libs/mongo-cxx-driver/BuildX64/src/mongocxx/lib/)
    include_directories(${CMAKE_CURRENT_SOURCE_DIR}/../../Libs/mongo-cxx-driver/src/mongocxx/include/)
    include_directories(${CMAKE_CURRENT_SOURCE_DIR}/../../Libs/mongo-cxx-driver/src/bsoncxx/include/bsoncxx/v_noabi/)
    include_directories(${CMAKE_CURRENT_SOURCE_DIR}/../../Libs/mongo-cxx-driver/BuildX64/src/bsoncxx/lib/)
    include_directories(${CMAKE_CURRENT_SOURCE_DIR}/../../Libs/mongo-cxx-driver/src/bsoncxx/include/)
    ...
    link_directories(${CMAKE_CURRENT_SOURCE_DIR}/../../Libs/openssl/x64/Release/lib/)
    ...
    link_directories(${CMAKE_CURRENT_SOURCE_DIR}/../../Libs/activemq/activemq-cpp/vs2010-build/x64/${SYSTEM_BUILD_DIRECTORIES}DLL/)
