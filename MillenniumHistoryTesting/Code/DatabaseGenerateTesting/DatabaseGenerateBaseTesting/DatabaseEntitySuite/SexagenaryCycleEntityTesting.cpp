...
DatabaseGenerateBaseTesting::SexagenaryCycleEntityTesting::SexagenaryCycleEntityTesting(const OStreamShared& stream, const SexagenaryCycleContainer& sexagenaryCycleContainer)
