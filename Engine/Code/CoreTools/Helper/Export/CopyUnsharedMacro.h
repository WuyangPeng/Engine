...
#define ARTIFICIAL_INTELLEGENCE_COPY_UNSHARED_EXPORT_IMPL(className, implClassName) \
    COPY_UNSHARED_EXPORT_IMPL(className, implClassName, ARTIFICIAL_INTELLEGENCE)
