...
const string Network::MessageTargetTesting ::sm_StringValue{ "StringValue" };
#include STSTEM_WARNING_PUSH
#include SYSTEM_WARNING_DISABLE(26446)
Network::MessageTargetTesting ::MessageTargetTesting(const OStreamShared& osPtr)
...
void Network::MessageTargetTesting ::MainTest() noexcept
{
