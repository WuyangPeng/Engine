...
#if !defined(MATHEMATICS_EXPORT_TEMPLATE) || defined(MATHEMATICS_INCLUDED_DISTANCE_POINT3_ELLIPSOID3_ACHIEVE)

    #include "DistancePoint3Ellipsoid3Achieve.h"

#endif  // !defined(MATHEMATICS_EXPORT_TEMPLATE) || defined(MATHEMATICS_INCLUDED_DISTANCE_POINT3_ELLIPSOID3_ACHIEVE)
