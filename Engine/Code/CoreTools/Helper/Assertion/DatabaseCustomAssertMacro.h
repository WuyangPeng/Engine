...
static_assert(DATABASE_ASSERT_LEVEL <= ASSERT_LEVEL, "Database assert level definition error.");
	...
	#define DATABASE_ASSERTION_0(condition, format, ...) ((void)0)
	#define DATABASE_ASSERTION_USE_FUNCTION_DESCRIBED_0(condition,functionDescribed,format, ...) ((void)0)

	#define DATABASE_ASSERTION_DEBUG(condition, format, ...) ((void)0)
	#define DATABASE_ASSERTION_DEBUG_USE_FUNCTION_DESCRIBED(condition,functionDescribed,format, ...) ((void)0)
	...
	#define DATABASE_ASSERTION_1(condition, format, ...) ((void)0)
	#define DATABASE_ASSERTION_USE_FUNCTION_DESCRIBED_1(condition,functionDescribed,format, ...) ((void)0)
	...
	#define DATABASE_ASSERTION_2(condition, format, ...) ((void)0)
	#define DATABASE_ASSERTION_USE_FUNCTION_DESCRIBED_2(condition,functionDescribed,format, ...) ((void)0)
	...
	#define DATABASE_ASSERTION_3(condition, format, ...) ((void)0)
	#define DATABASE_ASSERTION_USE_FUNCTION_DESCRIBED_3(condition,functionDescribed,format, ...) ((void)0)
	...
	#define DATABASE_ASSERTION_4(condition, format, ...) ((void)0)
	#define DATABASE_ASSERTION_USE_FUNCTION_DESCRIBED_4(condition,functionDescribed,format, ...) ((void)0)
