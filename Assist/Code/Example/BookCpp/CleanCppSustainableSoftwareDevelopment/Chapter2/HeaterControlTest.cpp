...
CLASS_INVARIANT_STUB_DEFINE(BookAdvanced::CleanCppSustainableSoftwareDevelopment, HeaterControlTest)

void BookAdvanced::CleanCppSustainableSoftwareDevelopment::HeaterControlTest::IfWaterTemperatureIsGreaterThan92DegTurnHeaterOff() const noexcept
{
