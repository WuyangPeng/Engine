...
namespace Network
{
	...
	public:
		...
		explicit MessageBuffer(const ImplTypeSharedPtr& messageBuffer);

		CLASS_INVARIANT_DECLARE;

		// 读
		int GetCurrentReadIndex() const noexcept;
		int GetRemainingReadCount() const;
		void ClearCurrentReadIndex();
		...
		// 接收数量
		int GetReceiveCount() const noexcept;
