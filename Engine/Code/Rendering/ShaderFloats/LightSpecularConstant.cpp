...
Rendering::LightSpecularConstant::LightSpecularConstant(const LightSharedPtr& light)
    : ParentType{ light }
{
...
Rendering::ShaderFloatSharedPtr Rendering::LightSpecularConstant::Clone() const
{
