...
///
///	标准：std:c++17
///	引擎版本：0.5.2.4 (2020/11/19 14:27)

#ifndef MATHEMATICS_NUMERICAL_ANALYSIS_BANDED_MATRIX_INVERT_ACHIEVE_H
#define MATHEMATICS_NUMERICAL_ANALYSIS_BANDED_MATRIX_INVERT_ACHIEVE_H
...
template <typename Real>
typename const Mathematics::BandedMatrixInvert<Real>::VariableMatrix Mathematics::BandedMatrixInvert<Real>::GetInvert() const
{
...
#endif  // MATHEMATICS_NUMERICAL_ANALYSIS_BANDED_MATRIX_INVERT_ACHIEVE_H
