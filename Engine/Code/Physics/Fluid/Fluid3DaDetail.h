...
// ◊˜’ﬂ£∫≈ÌŒ‰—Ù£¨≈ÌÍ ∂˜£¨≈ÌÍ ‘Û
//
// “˝«Ê∞Ê±æ£∫0.0.0.3 (2019/07/29 16:24)
...
//             DELETE3(mPoisson);
    ...
    template <typename Real>
    void Fluid3Da<Real>::UpdateDensityDiffusion() noexcept
    {
        ...
        for (int iter = 0; iter < mNumGaussSeidelIterations; ++iter)
        {
            for (int k = 1; k < mKMax; ++k)
            {
                for (int j = 1; j < mJMax; ++j)
                {
                    for (int i = 1; i < mIMax; ++i)
                    {
                        const Vector3D sumX = mVelocity1[k][j][i + 1] + mVelocity1[k][j][i - 1];

                        const Vector3D sumY = mVelocity1[k][j + 1][i] + mVelocity1[k][j - 1][i];

                        const Vector3D sumZ = mVelocity1[k + 1][j][i] + mVelocity1[k - 1][j][i];
    ...
    template <typename Real>
    void Fluid3Da<Real>::DirichletBoundaryZero(Real*** data) noexcept
    {
        int i = 0, j = 0, k = 0;
    ...
    template <typename Real>
    void Fluid3Da<Real>::NeumannBoundaryZero(Real*** data) noexcept
    {
        int i = 0, j = 0, k = 0;
    ...
    template <typename Real>
    void Fluid3Da<Real>::UpdateDensityBoundary() noexcept
    {
    ...
    template <typename Real>
    void Fluid3Da<Real>::SwapDensityBuffers() noexcept
    {
        Real*** save = mDensity0;
        mDensity0 = mDensity1;
        mDensity1 = save;
    ...
    template <typename Real>
    void Fluid3Da<Real>::SwapVelocityBuffers() noexcept
    {
    ...
    template <typename Real>
    Real Fluid3Da<Real>::GetX0() const noexcept
    {
        return mX0;
    }

    template <typename Real>
    Real Fluid3Da<Real>::GetY0() const noexcept
    {
        return mY0;
    }

    template <typename Real>
    Real Fluid3Da<Real>::GetZ0() const noexcept
    {
        return mZ0;
    }

    template <typename Real>
    Real Fluid3Da<Real>::GetX1() const noexcept
    {
        return mX1;
    }

    template <typename Real>
    Real Fluid3Da<Real>::GetY1() const noexcept
    {
        return mY1;
    }

    template <typename Real>
    Real Fluid3Da<Real>::GetZ1() const noexcept
    {
        return mZ1;
    }

    template <typename Real>
    Real Fluid3Da<Real>::GetDt() const noexcept
    {
        return mDt;
    }

    template <typename Real>
    Real Fluid3Da<Real>::GetDx() const noexcept
    {
        return mDx;
    }

    template <typename Real>
    Real Fluid3Da<Real>::GetDy() const noexcept
    {
        return mDy;
    }

    template <typename Real>
    Real Fluid3Da<Real>::GetDz() const noexcept
    {
        return mDz;
    }

    template <typename Real>
    Real Fluid3Da<Real>::GetTime() const noexcept
    {
        return mTime;
    }

    template <typename Real>
    int Fluid3Da<Real>::GetIMax() const noexcept
    {
        return mIMax;
    }

    template <typename Real>
    int Fluid3Da<Real>::GetJMax() const noexcept
    {
        return mJMax;
    }

    template <typename Real>
    int Fluid3Da<Real>::GetKMax() const noexcept
    {
        return mKMax;
    }

    template <typename Real>
    const Real* Fluid3Da<Real>::GetX() const noexcept
    {
        return mX;
    }

    template <typename Real>
    const Real* Fluid3Da<Real>::GetY() const noexcept
    {
        return mY;
    }

    template <typename Real>
    const Real* Fluid3Da<Real>::GetZ() const noexcept
    {
        return mZ;
    }

    template <typename Real>
    Real*** Fluid3Da<Real>::GetDensity() const noexcept
    {
        return mDensity0;
    }

    template <typename Real>
    Mathematics::Vector3D<Real>*** Fluid3Da<Real>::GetVelocity() const noexcept
    {
        return mVelocity0;
    }
}
