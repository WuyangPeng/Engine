...
// ◊˜’ﬂ£∫≈ÌŒ‰—Ù£¨≈ÌÍ ∂˜£¨≈ÌÍ ‘Û
// 
// “˝«Ê∞Ê±æ£∫0.0.0.2 (2019/07/10 10:24)
...
{
	MATHEMATICS_CLASS_IS_VALID_CONST_1;
	MATHEMATICS_ASSERTION_0(0 <= v0 && v0 < GetNumVertices(), "À˜“˝¥ÌŒÛ£°");
	MATHEMATICS_ASSERTION_0(0 <= v1 && v1 < GetNumVertices(), "À˜“˝¥ÌŒÛ£°");
	MATHEMATICS_ASSERTION_0(0 <= v2 && v2 < GetNumVertices(), "À˜“˝¥ÌŒÛ£°");
	...
	::ToCircumsphere(const Vector3D& testVector, int v0, int v1, int v2, int v3) const
{
	...
	MATHEMATICS_ASSERTION_0(0 <= v1 && v1 < GetNumVertices(), "À˜“˝¥ÌŒÛ£°");
	MATHEMATICS_ASSERTION_0(0 <= v2 && v2 < GetNumVertices(), "À˜“˝¥ÌŒÛ£°");
	MATHEMATICS_ASSERTION_0(0 <= v3 && v3 < GetNumVertices(), "À˜“˝¥ÌŒÛ£°");
