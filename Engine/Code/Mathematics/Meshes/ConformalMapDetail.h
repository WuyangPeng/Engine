...
Mathematics::ConformalMap<Real>
	::ConformalMap(int numPoints, const Vector3D<Real>* points, int numTriangles, const int* indices, int punctureTriangle)
{
	...
	mPlanes = NEW1<Vector2D<Real> >(numPoints);
...
template <typename Real>
const Mathematics::Vector2D<Real>* Mathematics::ConformalMap<Real>
	::GetPlaneCoordinates() const
{
	return mPlanes;
}
...
template <typename Real>
const Mathematics::Vector3D<Real>* Mathematics::ConformalMap<Real>
	::GetSphereCoordinates() const
{
	return mSpheres;
}

template <typename Real>
Real Mathematics::ConformalMap<Real>
...
template <typename Real>
Real Mathematics::ConformalMap<Real>
	::ComputeRadius(const Vector2D<Real>& V0, const Vector2D<Real>& V1, const Vector2D<Real>& V2, Real areaFraction) const
{
