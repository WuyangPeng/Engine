...
void Mathematics::StaticTestIntersectorLine2Ray2Testing
	::MainTest()
{
	...
	::RayTest()
{
	...
	for (auto loop = 0; loop < testLoopCount; ++loop)
	{
		...
		FloatStaticTestIntersectorLine2Ray2 firstClassify(FloatLine2(lhsOrigin, lhsDirection), FloatRay2(lhsOrigin, lhsDirection));

		ASSERT_ENUM_EQUAL(firstClassify.GetIntersectionType(), IntersectionType::Ray);
		ASSERT_EQUAL(firstClassify.GetQuantity(), INT_MAX);

		FloatStaticTestIntersectorLine2Ray2 secondClassify(FloatLine2(lhsOrigin, lhsDirection), FloatRay2(rhsOrigin, lhsDirection));

		ASSERT_ENUM_EQUAL(secondClassify.GetIntersectionType(), IntersectionType::Empty);
		ASSERT_EQUAL(secondClassify.GetQuantity(), 0);

		FloatStaticTestIntersectorLine2Ray2 thirdClassify(FloatLine2(lhsOrigin, lhsDirection), FloatRay2(lhsOrigin, -lhsDirection));

		ASSERT_ENUM_EQUAL(thirdClassify.GetIntersectionType(), IntersectionType::Ray);
		ASSERT_EQUAL(thirdClassify.GetQuantity(), INT_MAX);

		FloatStaticTestIntersectorLine2Ray2 fourthClassify(FloatLine2(lhsOrigin, lhsDirection), FloatRay2(lhsOrigin + lhsDirection, -lhsDirection));

		ASSERT_ENUM_EQUAL(fourthClassify.GetIntersectionType(), IntersectionType::Ray);
		ASSERT_EQUAL(fourthClassify.GetQuantity(), INT_MAX);

		FloatStaticTestIntersectorLine2Ray2 fifthClassify(FloatLine2(lhsOrigin, lhsDirection), FloatRay2(lhsOrigin - lhsDirection, -lhsDirection));

		ASSERT_ENUM_EQUAL(fifthClassify.GetIntersectionType(), IntersectionType::Ray);
		ASSERT_EQUAL(fifthClassify.GetQuantity(), INT_MAX);

		FloatStaticTestIntersectorLine2Ray2 sixthClassify(FloatLine2(lhsOrigin, lhsDirection), FloatRay2(rhsOrigin, rhsDirection));
