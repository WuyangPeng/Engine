...
namespace Network
{
    ...
    public:
        ...
        SockStreamImpl(const SockStreamImpl&) = default;
        SockStreamImpl& operator=(const SockStreamImpl&) = default;
        SockStreamImpl(SockStreamImpl&&) noexcept = default;
        SockStreamImpl& operator=(SockStreamImpl&&) noexcept = default;
