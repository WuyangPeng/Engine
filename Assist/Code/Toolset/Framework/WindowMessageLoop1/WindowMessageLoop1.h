...
namespace Framework
{
	...
	public:
		WindowMessageLoop1(HInstance instance, const char* commandLine, const WindowApplicationInformation& information,
	...
	private:
		static void DisplayFunction(HWnd hwnd, int64_t timeDelta) noexcept;
