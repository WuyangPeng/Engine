...
namespace Network
{
	...
	public:
		...
		virtual ~NullSocketManager();

		CLASS_INVARIANT_OVERRIDE_DECLARE;

		virtual bool EventFunction(const CallbackParameters& callbackParameters) override;

		int GetValue() const;

	private:
		virtual void InitEvent(uint64_t socketID) override;
