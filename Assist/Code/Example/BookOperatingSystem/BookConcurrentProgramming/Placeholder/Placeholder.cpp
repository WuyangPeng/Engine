...
BookConcurrentProgramming::Placeholder::Placeholder() noexcept
{
    BOOK_CONCURRENT_PROGRAMMING_SELF_CLASS_IS_VALID_9;
}

CLASS_INVARIANT_STUB_DEFINE(BookConcurrentProgramming, Placeholder)
