...
void Rendering::ShaderBaseData::SetData(int index, const std::string& name, ShaderFlags::VariableType type, ShaderFlags::VariableSemantic semantic)
{
...
void Rendering::ShaderBaseData::InsertData(const std::string& name, ShaderFlags::VariableType type,
...
IMPL_CONST_MEMBER_FUNCTION_DEFINE_1_V(Rendering, ShaderBaseData, GetName, int, std::string)
