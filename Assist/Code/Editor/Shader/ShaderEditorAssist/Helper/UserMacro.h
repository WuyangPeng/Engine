...
#define SHADER_EDITOR_ClOSE_BEGIN (0x01)

#define CLOSE_USE_SHADER_EDITOR (SHADER_EDITOR_ClOSE_BEGIN)

#define SHADER_EDITOR_ClOSE_END CLOSE_USE_SHADER_EDITOR

#define CLOSE_SHADER_EDITOR_MAX (((SHADER_EDITOR_ClOSE_END) << 1) - 1)
...
#if !defined(COMPILE_SHADER_EDITOR_CLOSE) || (COMPILE_SHADER_EDITOR_CLOSE & CLOSE_USE_SHADER_EDITOR) != CLOSE_USE_SHADER_EDITOR

#endif  // !defined(COMPILE_SHADER_EDITOR_CLOSE) || (COMPILE_SHADER_EDITOR_CLOSE & CLOSE_USE_SHADER_EDITOR) != CLOSE_USE_SHADER_EDITOR
