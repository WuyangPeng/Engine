...
void Mathematics::Query3RationalTesting
	::MainTest()
{
	...
	::VerticesTest()
{
	...
	for (auto loop = 0; loop < testLoopCount; ++loop)
	{
		...
		DoubleQuery3Rational query(vertices);
	...
	::PlaneTest()
{
	...
	for (auto loop = 0; loop < testLoopCount; ++loop)
	{
		...
		if (firstIndex != secondIndex && secondIndex != thirdIndex && firstIndex != thirdIndex && thirdIndex != fourthIndex && secondIndex != fourthIndex && firstIndex != fourthIndex)
		{
			...
			DoubleVector3D secondVector = vertices[secondIndex];
			DoubleVector3D thirdVector = vertices[thirdIndex];
			DoubleVector3D fourthVector = vertices[fourthIndex];
	...
	::CircumspherTest()
{
	...
	for (auto loop = 0; loop < testLoopCount; ++loop)
	{
			...
			fifthIndex != fourthIndex)
		{
			...
			DoubleVector3D thirdVector = vertices[thirdIndex];
			DoubleVector3D fourthVector = vertices[fourthIndex];
			DoubleVector3D fifthVector = vertices[fifthIndex];
