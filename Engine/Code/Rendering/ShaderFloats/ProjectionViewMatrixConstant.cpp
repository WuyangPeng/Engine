...
Rendering::ProjectionViewMatrixConstant::ProjectionViewMatrixConstant(MAYBE_UNUSED CoreTools::DisableNotThrow disableNotThrow)
...
void Rendering::ProjectionViewMatrixConstant::SetNumRegisters(int aNumRegisters)
{
    RENDERING_CLASS_IS_VALID_1;
    RENDERING_ASSERTION_2(aNumRegisters == numRegisters, "ProjectionViewMatrixConstant寄存器的数量必须为4");

    ParentType::SetNumRegisters(aNumRegisters);
}

Rendering::ShaderFloatSharedPtr Rendering::ProjectionViewMatrixConstant::Clone() const
{
