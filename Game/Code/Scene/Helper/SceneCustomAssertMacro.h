...
#ifndef SCENE_MACRO_CUSTOM_ASSERT_MACRO_H
#define SCENE_MACRO_CUSTOM_ASSERT_MACRO_H
...
#define SCENE_ASSERTION_0(condition, format, ...) ((void)0)
#define SCENE_ASSERTION_USE_FUNCTION_DESCRIBED_0(condition,functionDescribed,format, ...) ((void)0)
...
#define SCENE_ASSERTION_1(condition, format, ...) ((void)0)
#define SCENE_ASSERTION_USE_FUNCTION_DESCRIBED_1(condition,functionDescribed,format, ...) ((void)0)
...
#define SCENE_ASSERTION_2(condition, format, ...) ((void)0)
#define SCENE_ASSERTION_USE_FUNCTION_DESCRIBED_2(condition,functionDescribed,format, ...) ((void)0)
...
#define SCENE_ASSERTION_3(condition, format, ...) ((void)0)
#define SCENE_ASSERTION_USE_FUNCTION_DESCRIBED_3(condition,functionDescribed,format, ...) ((void)0)
...
#define SCENE_ASSERTION_4(condition, format, ...) ((void)0)
#define SCENE_ASSERTION_USE_FUNCTION_DESCRIBED_4(condition,functionDescribed,format, ...) ((void)0)

#endif // 4 <= SCENE_ASSERT_LEVEL

#endif // SCENE_MACRO_CUSTOM_ASSERT_MACRO_H
