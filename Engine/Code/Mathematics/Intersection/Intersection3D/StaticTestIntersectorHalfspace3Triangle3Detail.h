...
Mathematics::StaticTestIntersectorHalfspace3Triangle3<Real>::StaticTestIntersectorHalfspace3Triangle3(const Plane3Type& halfspace, const Triangle3Type& triangle, const Real epsilon)
