...
void Mathematics::StaticTestIntersectorBox2Box2<Real>::Test()
{
    ...
    auto absLhs0DotDifference = MathType::FAbs(Vector2ToolsType::DotProduct(lhsBox.GetAxis0(), boxCentersDifference));
    ...
    auto absLhs1DotDifference = MathType::FAbs(Vector2ToolsType::DotProduct(lhsBox.GetAxis1(), boxCentersDifference));
