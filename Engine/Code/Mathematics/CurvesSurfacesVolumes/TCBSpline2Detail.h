...
Mathematics::TCBSpline2<Real>::TCBSpline2(int numSegments,
...
template <typename Real>
bool Mathematics::TCBSpline2<Real>::IsValid() const noexcept
{
...
template <typename Real>
std::vector<Mathematics::Vector2<Real>> Mathematics::TCBSpline2<Real>::GetPoints() const
{
...
template <typename Real>
std::vector<Real> Mathematics::TCBSpline2<Real>::GetTensions() const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
std::vector<Real> Mathematics::TCBSpline2<Real>::GetContinuities() const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
std::vector<Real> Mathematics::TCBSpline2<Real>::GetBiases() const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
void Mathematics::TCBSpline2<Real>::ComputePoly(int i0, int i1, int i2, int i3)
{
...
template <typename Real>
Mathematics::Vector2<Real> Mathematics::TCBSpline2<Real>::GetPosition(Real t) const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
Mathematics::Vector2<Real> Mathematics::TCBSpline2<Real>::GetFirstDerivative(Real t) const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
Mathematics::Vector2<Real> Mathematics::TCBSpline2<Real>::GetSecondDerivative(Real t) const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
Mathematics::Vector2<Real> Mathematics::TCBSpline2<Real>::GetThirdDerivative(Real t) const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
Real Mathematics::TCBSpline2<Real>::GetSpeedKey(int key, Real t) const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
Real Mathematics::TCBSpline2<Real>::GetLengthKey(int key, Real t0, Real t1) const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
Mathematics::TCBSpline2<Real>::SplineKey::SplineKey(const TCBSpline2* spline, int key) noexcept
