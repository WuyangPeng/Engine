...
Mathematics::DistanceTest<Real, Vector>
...
template <typename Real, typename Vector>
bool Mathematics::DistanceTest<Real, Vector>
...
template <typename Real, typename Vector>
const typename Mathematics::DistanceTest<Real, Vector>::DistanceResult Mathematics::DistanceTest<Real, Vector>
	::GetSquared() const
{
...
template <typename Real, typename Vector>
const typename Mathematics::DistanceTest<Real, Vector>::DistanceResult Mathematics::DistanceTest<Real, Vector>
	::GetSquared(Real t, const Vector& lhsVelocity, const Vector& rhsVelocity) const
{
	MATHEMATICS_CLASS_IS_VALID_CONST_1;
...
template <typename Real, typename Vector>
const  Vector Mathematics::DistanceTest<Real, Vector>
	::GetLhs() const
{
	MATHEMATICS_CLASS_IS_VALID_CONST_1;
