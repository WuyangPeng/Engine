...
// 		LightModelPositionConstantSharedPtr firstShaderFloat(new LightModelPositionConstant(firstLight));
// 		
// 		for (int i = 0; i < 4;++i)
// 		{	 
...
// 		
// 		LightModelPositionConstantSharedPtr secondShaderFloat =
// 			inTopLevel[0].PolymorphicDowncastObjectSharedPtr<LightModelPositionConstantSharedPtr>();
// 		
...
//  
// 		const Mathematics::APointf worldPosition = firstLight->GetPosition();
// 		const Mathematics::Matrixf worldInverseMatrix = firstTrianglesMesh->GetWorldTransform().GetInverseMatrix();
// 		Mathematics::APointf modelPosition = worldInverseMatrix * worldPosition;
// 
// 		ASSERT_APPROXIMATE(modelPosition[0], firstShaderFloat[0], 1e-8f);
// 		ASSERT_APPROXIMATE(modelPosition[1], firstShaderFloat[1], 1e-8f);
// 		ASSERT_APPROXIMATE(modelPosition[2], firstShaderFloat[2], 1e-8f);
