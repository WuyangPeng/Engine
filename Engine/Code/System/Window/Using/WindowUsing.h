...
namespace System
{
	...
	constexpr int g_MaxModuleName32{ MAX_MODULE_NAME32 };
	constexpr int g_WindowExceptionMaximumParameters{ EXCEPTION_MAXIMUM_PARAMETERS };
	...
	constexpr int g_WindowMaximumSupportedExtension{ 512 };
	constexpr int g_WindowSizeOf80387Registers{ 80 };
