...
#define DATABASE_GENERATE_SERVER_MIDDLE_LAYER_EXPORT_NON_COPY(implClassName) \
    DATABASE_GENERATE_SERVER_MIDDLE_LAYER_EXPORT_SHARED_PTR(implClassName);  \
    EXPORT_NON_COPY(DatabaseGenerateServerMiddleLayer, implClassName, DATABASE_GENERATE_SERVER_MIDDLE_LAYER_DEFAULT_DECLARE);
