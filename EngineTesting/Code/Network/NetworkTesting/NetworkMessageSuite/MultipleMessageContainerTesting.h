...
namespace Network
{
    class MultipleMessageContainerTesting final : public CoreTools::UnitTest
    {
    public:
        using ClassType = MultipleMessageContainerTesting;
        using ParentType = UnitTest;

    public:
        explicit MultipleMessageContainerTesting(const OStreamShared& stream);
