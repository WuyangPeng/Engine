...
namespace Rendering
{
    class RENDERING_HIDDEN_DECLARE TextureBufferData
    {
    public:
        using ClassType = TextureBufferData;
    ...
    public:
        explicit TextureBufferData(int itemSize) noexcept;
        ~TextureBufferData() noexcept = default;
        TextureBufferData(const TextureBufferData& rhs);
        TextureBufferData& operator=(const TextureBufferData& rhs);
        TextureBufferData(TextureBufferData&& rhs) noexcept;
        TextureBufferData& operator=(TextureBufferData&& rhs) noexcept;
