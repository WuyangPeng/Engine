...
///
///	标准：std:c++20
///	最后的霸王版本：0.8.0.12 (2022/07/24 1:00)
...
LoginServer::LoginServerMessage::LoginServerMessage(int64_t delta, const Framework::EnvironmentDirectory& environmentDirectory)
