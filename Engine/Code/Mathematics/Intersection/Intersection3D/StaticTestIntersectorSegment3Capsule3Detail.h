...
Mathematics::StaticTestIntersectorSegment3Capsule3<Real>::StaticTestIntersectorSegment3Capsule3(const Segment3Type& segment, const Capsule3Type& capsule, const Real epsilon)
