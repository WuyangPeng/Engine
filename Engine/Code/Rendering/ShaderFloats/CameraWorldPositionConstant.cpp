...
Rendering::CameraWorldPositionConstant::CameraWorldPositionConstant(MAYBE_UNUSED CoreTools::DisableNotThrow disableNotThrow)
...
void Rendering::CameraWorldPositionConstant::SetNumRegisters(int aNumRegisters)
{
    RENDERING_CLASS_IS_VALID_1;
    RENDERING_ASSERTION_2(aNumRegisters == numRegisters, "CameraWorldPositionConstant寄存器的数量必须为1");

    ParentType::SetNumRegisters(aNumRegisters);
}

Rendering::ShaderFloatSharedPtr Rendering::CameraWorldPositionConstant::Clone() const
{
