...
DatabaseGenerateServerBaseTesting::CategoryEntityTesting::CategoryEntityTesting(const OStreamShared& stream, const AncientBooksContainer& ancientBooksContainer)
...
void DatabaseGenerateServerBaseTesting::CategoryEntityTesting::DoRunUnitTest()
{
...
void DatabaseGenerateServerBaseTesting::CategoryEntityTesting::MainTest()
{
    ASSERT_NOT_THROW_EXCEPTION_0(InitEnvironmentTest);
    ASSERT_NOT_THROW_EXCEPTION_0(DatabaseFlushTest);
}

void DatabaseGenerateServerBaseTesting::CategoryEntityTesting::InitEnvironmentTest()
{
...
void DatabaseGenerateServerBaseTesting::CategoryEntityTesting::DatabaseFlushTest()
{
