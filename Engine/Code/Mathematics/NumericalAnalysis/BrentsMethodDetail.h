...
{
    MATHEMATICS_CLASS_IS_VALID_1;
	MATHEMATICS_ASSERTION_1(negativeFTolerance <= Real{},"无效 negativeFTolerance。\n");
...
{
    MATHEMATICS_CLASS_IS_VALID_1;
	MATHEMATICS_ASSERTION_1(Real{} <= positiveFTolerance,"无效 positiveFTolerance。\n");
...
{
    MATHEMATICS_CLASS_IS_VALID_1;
	MATHEMATICS_ASSERTION_1(Real{} <= stepXTolerance,"无效 stepXTolerance。\n");
...
{
    MATHEMATICS_CLASS_IS_VALID_1;
	MATHEMATICS_ASSERTION_1(Real{} <= convXTolerance,"无效 convXTolerance。\n");
