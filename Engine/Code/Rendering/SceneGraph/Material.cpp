...
Rendering::Material::Material(MAYBE_UNUSED MaterialCreate materialCreate)
    : ParentType{ "Material" }, impl{ CoreTools::ImplCreateUseDefaultConstruction::Default }
{
    RENDERING_SELF_CLASS_IS_VALID_1;
}

Rendering::Material::Material(MAYBE_UNUSED MaterialCreate materialCreate, const Colour& emissive, const Colour& ambient, const Colour& diffuse, const Colour& specular)
    : ParentType{ "Material" },
...
Rendering::Material::Material(LoadConstructor value)
