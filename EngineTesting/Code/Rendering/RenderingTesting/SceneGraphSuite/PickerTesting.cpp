...
void Rendering::PickerTesting::BaseTest()
{
    ...
    for (int loop = 0; loop < GetTestLoopCount(); ++loop)
    {
        ...
        // 		direction.Normalize();
        //
        // 		float tMin = -Mathematics::MathF::maxReal;
        // 		float tMax = Mathematics::MathF::maxReal;
        //
        ...
        // 		{
        // 			// 最近值测试
        // 			float closest = Mathematics::MathF::FAbs(container.GetPickRecord(0).GetParameter());
        // 			int index = 0;
        // 			const int numRecords = container.GetSize();
        // 			for (int i = 1; i < numRecords; ++i)
        // 			{
        // 				float parameter = Mathematics::MathF::FAbs(container.GetPickRecord(i).GetParameter());
        ...
        //
        // 			closest = Mathematics::MathF::maxReal;
        //
        // 			int findIndex = -1;
