...
void Mathematics::BandedMatrixTesting
	::MainTest()
{
	...
	::ConstructionTest()
{
	...
	FloatBandedMatrix firstBandedMatrix(size,lowerBoundNumber,upperBoundNumber);
	...
	const FloatBandedMatrix secondBandedMatrix(firstBandedMatrix);
	...
	FloatVariableMatrix variableMatrix = secondBandedMatrix.ToVariableMatrix();
	...
	FloatBandedMatrix thirdBandedMatrix(5,1,1);
	...
	FloatBandedMatrix fourthBandedMatrix(secondBandedMatrix);
