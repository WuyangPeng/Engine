...
{
    ASSERT_EQUAL(CLOSE_USE_MEMORY_MANAGER | CLOSE_ASSERT | CLOSE_CLASS_INVARIANT | CLOSE_USE_IMPORTANT_EXCPTION_ASSERT | CLOSE_USE_USE_SAFETY_LIMIT, CLOSE_CORE_TOOLS_MAX);
}
