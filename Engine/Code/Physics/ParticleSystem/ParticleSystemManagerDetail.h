...
namespace Physics
{
    ...
    ParticleSystemManager<Real, TVector>::ParticleSystemManager(int numParticles, Real step)
    {
        ...
        mMasses = nullptr;  //NEW1<Real>(mNumParticles);
        mInvMasses = nullptr;  // NEW1<Real>(mNumParticles);
        mPositions = nullptr;  // NEW1<TVector>(mNumParticles);
        mVelocities = nullptr;  // NEW1<TVector>(mNumParticles);
        ...
        mPTmp = nullptr;  //NEW1<TVector>(mNumParticles);
        mDPTmp1 = nullptr;  // NEW1<TVector>(mNumParticles);
        mDPTmp2 = nullptr;  //NEW1<TVector>(mNumParticles);
        mDPTmp3 = nullptr;  //NEW1<TVector>(mNumParticles);
        mDPTmp4 = nullptr;  //NEW1<TVector>(mNumParticles);
        mVTmp = nullptr;  //NEW1<TVector>(mNumParticles);
        mDVTmp1 = nullptr;  // NEW1<TVector>(mNumParticles);
        mDVTmp2 = nullptr;  // NEW1<TVector>(mNumParticles);
        mDVTmp3 = nullptr;  // NEW1<TVector>(mNumParticles);
        mDVTmp4 = nullptr;  // NEW1<TVector>(mNumParticles);
    }
