...
///
///	标准：std:c++20
///	引擎测试版本：0.8.0.8 (2022/05/12 19:16)
...
bool System::AddAccessDeniedAceTesting::RandomShuffleFlags()
{
    ...
    ASSERT_NOT_THROW_EXCEPTION_0(AddAccessDeniedAceTest);

    return true;
}

void System::AddAccessDeniedAceTesting::AddAccessDeniedAceTest()
{
...
#include STSTEM_WARNING_POP
    ...
    for (auto index = 0u; index < maxSize; ++index)
    {
        ...
        ASSERT_TRUE(AddAccessDeniedAccessControlEntries(acl, AccessControlListRevision::Revision, specificAccess, &sid));
        ASSERT_TRUE(AddAccessDeniedAccessControlEntries(acl, AccessControlListRevision::Revision, controlACEInheritance, specificAccess, &sid));
    }
}
