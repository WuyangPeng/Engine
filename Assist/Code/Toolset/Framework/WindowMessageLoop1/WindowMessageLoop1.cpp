...
int Framework::WindowMessageLoop1::EnterMessageLoop()
{
    ...
    {
        LOG_SINGLETON_ENGINE_APPENDER(Info, Framework, SYSTEM_TEXT("GetSystemClassName 失败。"));
    }
...
void Framework::WindowMessageLoop1::EnterOldMessageLoop(const String& className)
{
    ...
    {
        LOG_SINGLETON_ENGINE_APPENDER(Info, Framework, SYSTEM_TEXT("EnterMessageLoop 失败。"));
    }
}
