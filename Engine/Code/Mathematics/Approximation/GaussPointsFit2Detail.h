...
#if !defined(MATHEMATICS_EXPORT_TEMPLATE) || defined(MATHEMATICS_INCLUDED_GAUSS_POINTS_FIT2_ACHIEVE)

    #include "GaussPointsFit2Achieve.h"

#endif  //  !defined(MATHEMATICS_EXPORT_TEMPLATE) || defined(MATHEMATICS_INCLUDED_GAUSS_POINTS_FIT2_ACHIEVE)
