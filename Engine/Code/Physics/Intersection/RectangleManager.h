...
namespace Physics
{
    ...
    public:
        ...
        RectangleManager(std::vector<Mathematics::AxesAlignBoundingBox2<Real>>& rectangles);
        ~RectangleManager();
        ...
        void SetRectangle(int i, const Mathematics::AxesAlignBoundingBox2<Real>& rectangle);
        void GetRectangle(int i, Mathematics::AxesAlignBoundingBox2<Real>& rectangle) const;
    ...
    private:
        ...
        std::vector<Mathematics::AxesAlignBoundingBox2<Real>>* mRectangles;
