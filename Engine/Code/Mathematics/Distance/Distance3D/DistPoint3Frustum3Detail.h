...
// ◊˜’ﬂ£∫≈ÌŒ‰—Ù£¨≈ÌÍ ∂˜£¨≈ÌÍ ‘Û
// 
// “˝«Ê∞Ê±æ£∫0.0.0.2 (2019/07/11 13:44)
	...
	::GetSquared () const
{
	...
	return DistanceResult{ Vector3DTools::VectorMagnitudeSquared(diff), Real{}, mClosestPoint0, mClosestPoint1 };
}
