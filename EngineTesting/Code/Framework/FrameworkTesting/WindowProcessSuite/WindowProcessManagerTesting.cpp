...
Framework::WindowProcessManagerTesting::WindowProcessManagerTesting(const OStreamShared& stream)
    : ParentType{ stream }
{
...
void Framework::WindowProcessManagerTesting::MainTest() noexcept
{
