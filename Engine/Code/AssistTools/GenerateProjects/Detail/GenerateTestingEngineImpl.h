...
{
    class ASSIST_TOOLS_HIDDEN_DECLARE GenerateTestingEngineImpl
    {
    public:
    ...
    public:
        GenerateTestingEngineImpl(const String& input, String output);
    ...
    private:
        ...
        void GenerateCodeVersion() const;
        void GenerateCodeEngine() const;
        ...
        void GenerateWindowsProjectModuleCoreConfiguration(const GameModule& gameModule) const;
        void GenerateWindowsProjectModuleMiddleLayerConfiguration(const GameModule& gameModule) const;
