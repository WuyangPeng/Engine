	...
	::MoveObject (float rotationSpeed)
{
	...
	else
	{
		...
		Transform transform = objectMotionMove.GetIncr();
	...
	::RotateTrackBall (const ConstCameraSmartPointer& camera)
{
    ...
    {
        ObjectMotionRotateTrackBall rotateTrackBall(m_MotionObject, camera,m_BeginXTrack,m_BeginYTrack,
													m_EndXTrack,m_EndYTrack,m_SaveRotate);
		
		Transform transform = rotateTrackBall.GetTransform();
