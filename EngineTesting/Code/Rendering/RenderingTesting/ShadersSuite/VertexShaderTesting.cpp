...
void Rendering::VertexShaderTesting::InitTest()
{
    ShaderBaseSharedPtr shader(std::make_shared<VertexShader>("Shader", 4, 5, 6, 7));
...
void Rendering::VertexShaderTesting::CopyTest()
{
    VertexShaderSharedPtr shader{ std::make_shared<VertexShader>("Shader", 4, 5, 6, 7) };
    ...
    ShaderBaseSharedPtr secondShader(std::make_shared<VertexShader>(*shader));
