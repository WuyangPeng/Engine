...
namespace Mathematics
{
	...
	class DistanceRay3Triangle3 : public DistanceBase<Real, Vector3D<Real> >
	{
	public:
	...
	using DistRay3Triangle3f = DistanceRay3Triangle3<float>;
	using DistRay3Triangle3d = DistanceRay3Triangle3<double>;
}
