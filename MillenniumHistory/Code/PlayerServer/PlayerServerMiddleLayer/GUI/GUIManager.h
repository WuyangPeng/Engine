...
#ifndef PLAYER_SERVER_MIDDLE_LAYER_GUI_MIDDLE_LAYER_GUI_H
#define PLAYER_SERVER_MIDDLE_LAYER_GUI_MIDDLE_LAYER_GUI_H
...
{
    class PLAYER_SERVER_MIDDLE_LAYER_DEFAULT_DECLARE GUIManager final : public Framework::GUIManagerInterface
    {
    public:
...
#endif  // PLAYER_SERVER_MIDDLE_LAYER_GUI_MIDDLE_LAYER_GUI_H
