...
Network::OnlySendingClientTesting
	::OnlySendingClientTesting(const OStreamShared& osPtr)
...
void Network::OnlySendingClientTesting
	::MainTest()
{
...
void Network::OnlySendingClientTesting
	::BoostAsyncOnlySendingClientTest()
{
	ConfigurationSubStrategy configurationSubStrategy{};
...
void Network::OnlySendingClientTesting
	::NullAsyncOnlySendingClientTest()
{
	ConfigurationSubStrategy configurationSubStrategy{};
