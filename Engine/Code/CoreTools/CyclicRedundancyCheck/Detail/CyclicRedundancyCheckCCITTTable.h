...
namespace CoreTools
{
	...
	class CORE_TOOLS_DEFAULT_DECLARE CyclicRedundancyCheckCCITTTable
	{
	public:
	...
	private:
		static constexpr uint32_t sm_TableSize{ 256 };
...
#endif // CORE_TOOLS_CYCLIC_REDUNDANCY_CHECK_CYCLIC_REDUNDANCY_CHECK_CCITT_TABLE_H
