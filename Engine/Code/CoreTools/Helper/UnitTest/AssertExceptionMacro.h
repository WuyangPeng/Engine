...
#define ASSERT_NOT_THROW_EXCEPTION_2(function, parameter0, parameter1) \
    AssertNotThrowException(this, &ClassType::function, (parameter0), (parameter1), (CORE_TOOLS_FUNCTION_DESCRIBED))
...
#define ASSERT_THROW_EXCEPTION_2(function, parameter0, parameter1) \
    AssertThrowException(this, &ClassType::function, (parameter0), (parameter1), (CORE_TOOLS_FUNCTION_DESCRIBED))
...
#define ASSERT_NOT_THROW_EXCEPTION_USE_MESSAGE_2(function, parameter0, parameter1, message) \
    AssertNotThrowException(this, &ClassType::function, (parameter0), (parameter1), (CORE_TOOLS_FUNCTION_DESCRIBED), (message))
...
#define ASSERT_THROW_EXCEPTION_USE_MESSAGE_2(function, parameter0, parameter1, message) \
    AssertThrowException(this, &ClassType::function, (parameter0), (parameter1), (CORE_TOOLS_FUNCTION_DESCRIBED), (message))
