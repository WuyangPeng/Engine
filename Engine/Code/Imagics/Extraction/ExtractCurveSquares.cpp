...
Imagics::ExtractCurveSquares ::ExtractCurveSquares(int xBound, int yBound, int* data) noexcept
...
void Imagics::ExtractCurveSquares ::AddVertex(std::vector<Vertex>& vertices, int xNumer, int xDenom, int yNumer, int yDenom)
{
    vertices.push_back(Vertex(xNumer, xDenom, yNumer, yDenom));
}

void Imagics::ExtractCurveSquares ::AddEdge(std::vector<Vertex>& vertices, std::vector<Mathematics::EdgeKey>& edges, int xNumer0, int xDenom0, int yNumer0,
...
void Imagics::ExtractCurveSquares ::ProcessSquare(std::vector<Vertex>& vertices, std::vector<Mathematics::EdgeKey>& edges, int x, int xp, int y, int yp, int f00,
...
Imagics::ExtractCurveSquares::Vertex ::Vertex(int xNumer, int xDenom, int yNumer, int yDenom) noexcept
{
    if (xDenom > 0)
    {
        XNumer = xNumer;
