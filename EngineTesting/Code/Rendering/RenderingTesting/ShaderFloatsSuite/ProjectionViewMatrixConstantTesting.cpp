...
void Rendering::ProjectionViewMatrixConstantTesting::InitTest()
{
    constexpr int numRegisters = 4;
    ProjectionViewMatrixConstant firstShaderFloat{ CoreTools::DisableNotThrow::Disable };
    ...
    const ProjectionViewMatrixConstant secondShaderFloat{ CoreTools::DisableNotThrow::Disable };
    ...
    ProjectionViewMatrixConstant thirdShaderFloat{ CoreTools::DisableNotThrow::Disable };
...
void Rendering::ProjectionViewMatrixConstantTesting::CopyTest()
{
    ProjectionViewMatrixConstant firstShaderFloat{ CoreTools::DisableNotThrow::Disable };
...
void Rendering::ProjectionViewMatrixConstantTesting::StreamTest() noexcept
{
}

void Rendering::ProjectionViewMatrixConstantTesting::UpdateTest() noexcept
{
}
