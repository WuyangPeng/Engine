...
// ◊˜’ﬂ£∫≈ÌŒ‰—Ù£¨≈ÌÍ ∂˜£¨≈ÌÍ ‘Û
// 
// “˝«Ê∞Ê±æ£∫0.0.2.1 (2020/01/21 11:54)
...
template <typename T>
CoreTools::SmartPointer3DArray<T>
	::SmartPointer3DArray(T*** data)
	:m_Data{ data }
{
...
template <typename T>
CoreTools::SmartPointer3DArray<T>& CoreTools::SmartPointer3DArray<T>
...
// private
template <typename T>
void CoreTools::SmartPointer3DArray<T>
...
template <typename T>
bool CoreTools::SmartPointer3DArray<T>
...
template <typename T>
T*** const CoreTools::SmartPointer3DArray<T>
...
template <typename T>
T*** CoreTools::SmartPointer3DArray<T>
	::GetData() noexcept
{
	CORE_TOOLS_CLASS_IS_VALID_9;
...
template <typename T>
bool CoreTools
	::operator==(const SmartPointer3DArray<T>& lhs, T*** data) noexcept
{
	if (lhs.GetData() == data)
		return true;
	else
...
template <typename T>
bool CoreTools
	::operator==(const SmartPointer3DArray<T>& lhs, const SmartPointer3DArray<T>& rhs) noexcept
{
