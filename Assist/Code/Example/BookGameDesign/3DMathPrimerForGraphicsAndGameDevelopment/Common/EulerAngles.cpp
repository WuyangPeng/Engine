...
namespace ThreeDMathPrimerForGraphicsAndGameDevelopment
{
	...
	void EulerAngles::canonize() noexcept
	{
	...
	void EulerAngles::fromObjectToInertialQuaternion(const Quaternion& q) noexcept
	{
	...
	void EulerAngles::fromInertialToObjectQuaternion(const Quaternion& q) noexcept
	{
	...
	void EulerAngles::fromObjectToWorldMatrix(const Matrix4x3& m) noexcept
	{
	...
	void EulerAngles::fromWorldToObjectMatrix(const Matrix4x3& m) noexcept
	{
	...
	void EulerAngles::fromRotationMatrix(const RotationMatrix& m) noexcept
	{
