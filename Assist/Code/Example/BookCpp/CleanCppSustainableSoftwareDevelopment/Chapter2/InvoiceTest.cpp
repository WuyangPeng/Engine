...
CLASS_INVARIANT_STUB_DEFINE(BookAdvanced::CleanCppSustainableSoftwareDevelopment, InvoiceTest)

void BookAdvanced::CleanCppSustainableSoftwareDevelopment::InvoiceTest::InvoiceIsReadyForAccounting_GetInvoiceDate_ReturnsToday() const noexcept
{
