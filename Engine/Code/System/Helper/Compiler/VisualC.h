...
#define SYSTEM_HELPER_VISUAL_C_H
    ...
    /// 版本检查：我们不支持版本7.1之前的Visual C++：
        ...
        #define SYSTEM_CPP_STANDARD 14
        ...
        #if 202000 < _MSVC_LANG

            #define SYSTEM_CPP_STANDARD 20

        #else  // _MSVC_LANG <= 202000

            #define SYSTEM_CPP_STANDARD 17

        #endif  // 202000 < _MSVC_LANG
            ...
            /// MSVC 14.3是版本19.30（MSVS 2022）
                ...
                #define MSVC_COMPILER_VERSION 14.3
                #define SYSTEM_USING_VC143 static_cast<void>(0)
...
#endif  // SYSTEM_HELPER_VISUAL_C_H
