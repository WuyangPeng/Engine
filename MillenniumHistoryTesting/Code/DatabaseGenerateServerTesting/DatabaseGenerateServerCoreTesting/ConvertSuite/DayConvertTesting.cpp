...
DatabaseGenerateServerCoreTesting::DayConvertTesting::DayConvertTesting(const OStreamShared& stream, const AncientBooksContainer& ancientBooksContainer)
...
void DatabaseGenerateServerCoreTesting::DayConvertTesting::DoRunUnitTest()
{
...
void DatabaseGenerateServerCoreTesting::DayConvertTesting::MainTest()
{
    ASSERT_NOT_THROW_EXCEPTION_0(InitEnvironmentTest);
    ASSERT_NOT_THROW_EXCEPTION_0(DatabaseFlushTest);
}

void DatabaseGenerateServerCoreTesting::DayConvertTesting::InitEnvironmentTest()
{
...
void DatabaseGenerateServerCoreTesting::DayConvertTesting::DatabaseFlushTest()
{
