...
Rendering::LightDiffuseConstant::LightDiffuseConstant(const LightSharedPtr& light)
    : ParentType{ light }
{
...
Rendering::ShaderFloatSharedPtr Rendering::LightDiffuseConstant::Clone() const
{
