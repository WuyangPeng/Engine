...
DatabaseGenerateCoreTesting::ReignTitleConvertTesting::ReignTitleConvertTesting(const OStreamShared& stream, const ReignTitleContainer& reignTitleContainer)
