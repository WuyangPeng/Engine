...
// ◊˜’ﬂ£∫≈ÌŒ‰—Ù£¨≈ÌÍ ∂˜£¨≈ÌÍ ‘Û
// 
// “˝«Ê∞Ê±æ£∫0.0.0.2 (2019/07/11 14:05)
...
Mathematics::DistTriangle3Triangle3<Real>
...
template <typename Real>
const Mathematics::Triangle3<Real>& Mathematics::DistTriangle3Triangle3<Real>
	::GetTriangle0 () const
{
    return mTriangle0;
}
...
template <typename Real>
typename const Mathematics::DistTriangle3Triangle3<Real>::DistanceResult Mathematics::DistTriangle3Triangle3<Real>
	::GetSquared() const
{
    ...
    {
		auto center =(Real{0.5})*(mTriangle0.GetVertex(i0) + mTriangle0.GetVertex(i1));
		auto direction =  mTriangle0.GetVertex(i1) - mTriangle0.GetVertex(i0);
		auto extent =(Real{0.5})* Vector3DTools::VectorMagnitude(direction);
        ...
        if (sqrDistTmp.GetDistance() < sqrDist)
        {
            ...
            {
				DistanceResult{ Real{}, Real{}, mClosestPoint0, mClosestPoint1 };
            }
        }
    }
    ...
    for (i0 = 2, i1 = 0; i1 < 3; i0 = i1++)
    {
		auto center =(Real{0.5})*(mTriangle1.GetVertex(i0) + mTriangle1.GetVertex(i1));
        ...
        if (sqrDistTmp.GetDistance() < sqrDist)
        {
            ...
            if (sqrDist <= Math::sm_ZeroTolerance)
            {
				return DistanceResult{ Real{}, Real{}, mClosestPoint0, mClosestPoint1 };
            }
        }
    }
...
template <typename Real>
Real Mathematics::DistTriangle3Triangle3<Real>
