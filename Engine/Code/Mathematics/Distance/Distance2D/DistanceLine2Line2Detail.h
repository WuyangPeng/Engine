	...
	::GetSquared() const
{
	...
	if (this->GetZeroThreshold() <= det)
	{
		...
		return DistanceResult{ Real{}, Real{}, m_LhsLine.GetOrigin() + lhsT * m_LhsLine.GetDirection(),m_RhsLine.GetOrigin() + rhsT * m_RhsLine.GetDirection() };
	}
	else
	{	
		// 线是平行的,选择任何最近点。	
		...
		return DistanceResult{ squaredDistance, Real{}, m_LhsLine.GetOrigin() - originDifferenceDotLhsDirection * m_LhsLine.GetDirection(),m_RhsLine.GetOrigin() };
	}	
}
