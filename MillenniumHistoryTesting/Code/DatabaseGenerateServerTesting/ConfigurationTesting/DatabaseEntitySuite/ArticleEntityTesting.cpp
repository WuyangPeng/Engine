...
DatabaseGenerateServerBaseTesting::ArticleEntityTesting::ArticleEntityTesting(const OStreamShared& stream, const AncientBooksContainer& ancientBooksContainer)
...
void DatabaseGenerateServerBaseTesting::ArticleEntityTesting::DoRunUnitTest()
{
...
void DatabaseGenerateServerBaseTesting::ArticleEntityTesting::MainTest()
{
    ASSERT_NOT_THROW_EXCEPTION_0(InitEnvironmentTest);
    ASSERT_NOT_THROW_EXCEPTION_0(DatabaseFlushTest);
}

void DatabaseGenerateServerBaseTesting::ArticleEntityTesting::InitEnvironmentTest()
{
...
void DatabaseGenerateServerBaseTesting::ArticleEntityTesting::DatabaseFlushTest()
{
