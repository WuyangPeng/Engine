...
// ◊˜’ﬂ£∫≈ÌŒ‰—Ù£¨≈ÌÍ ∂˜£¨≈ÌÍ ‘Û
// 
// “˝«Ê∞Ê±æ£∫0.0.0.2 (2019/07/09 15:12)
...
{
    if(m_FirstFunction != nullptr && m_SecondFunction != nullptr && m_ThirdFunction != nullptr && 0 < m_MaxLevel && Real{} <= m_Tolerance)
	{
        return true;
	}
    else
...
template <typename Real>
typename const Mathematics::Bisect3<Real>::Bisect3Root
Mathematics::Bisect3<Real>
