...
///
///	标准：std:c++20
///	最后的霸王版本：0.8.0.12 (2022/07/29 18:42)
...
BackgroundServerMiddleLayer::InputManager<ApplicationTrait>::InputManager(Framework::MiddleLayerPlatform middleLayerPlatform, const Framework::EnvironmentDirectory& environmentDirectory)
...
template <typename ApplicationTrait>
bool BackgroundServerMiddleLayer::InputManager<ApplicationTrait>::IsValid() const noexcept
{
