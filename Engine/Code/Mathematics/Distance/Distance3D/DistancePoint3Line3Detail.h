...
// ◊˜’ﬂ£∫≈ÌŒ‰—Ù£¨≈ÌÍ ∂˜£¨≈ÌÍ ‘Û
// 
// “˝«Ê∞Ê±æ£∫0.0.2.5 (2020/03/24 10:20)
	...
	::GetSquared() const
{
	...
	return DistanceResult{ Vector3DTools::VectorMagnitudeSquared(difference),Math<Real>::GetValue(0),m_Point,rhsClosestPoint,Math<Real>::GetValue(0),param };
}
