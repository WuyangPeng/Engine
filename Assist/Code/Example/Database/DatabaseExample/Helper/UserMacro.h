...
#define DATABASE_EXAMPLE_ClOSE_BEGIN (0x01)

#define CLOSE_USE_DATABASE_EXAMPLE (DATABASE_EXAMPLE_ClOSE_BEGIN)

#define DATABASE_EXAMPLE_ClOSE_END CLOSE_USE_DATABASE_EXAMPLE

#define CLOSE_DATABASE_EXAMPLE_MAX (((DATABASE_EXAMPLE_ClOSE_END) << 1) - 1)
...
#if !defined(COMPILE_DATABASE_EXAMPLE_CLOSE) || (COMPILE_DATABASE_EXAMPLE_CLOSE & CLOSE_USE_DATABASE_EXAMPLE) != CLOSE_USE_DATABASE_EXAMPLE

#endif  // !defined(COMPILE_DATABASE_EXAMPLE_CLOSE) || (COMPILE_DATABASE_EXAMPLE_CLOSE & CLOSE_USE_DATABASE_EXAMPLE) != CLOSE_USE_DATABASE_EXAMPLE
