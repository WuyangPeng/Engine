...
namespace Mathematics
{
    ...
    {
//         mB = nullptr;  // NEW1<Real>(mNumSegments);
//         mC = nullptr;  // NEW1<Real>(mNumSegments + 1);
//         mD = nullptr;  // NEW1<Real>(mNumSegments);
// 
//         auto delta = nullptr;  // NEW1<Real>(mNumSamples);
//         auto invDelta = nullptr;  // NEW1<Real>(mNumSamples);
//         auto fDeriv = nullptr;  // NEW1<Real>(mNumSamples);
//         int i;
...
//         auto diagonal = nullptr;  // NEW1<Real>(numSegmentsM1);
//         auto rhs = nullptr;  // NEW1<Real>(numSegmentsM1);
...
//         }
    ...
    {
//         mB = nullptr;  //  NEW1<Real>(mNumSegments + 1);
//         mC = nullptr;  // NEW1<Real>(mNumSegments);
//         mD = nullptr;  // NEW1<Real>(mNumSegments);
// 
//         auto delta = nullptr;  //  NEW1<Real>(mNumSamples);
//         auto invDelta = nullptr;  //  NEW1<Real>(mNumSamples);
