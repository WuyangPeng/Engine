...
DatabaseGenerateCoreTesting::GeographicConvertTesting::GeographicConvertTesting(const OStreamShared& stream, const GeographicContainer& geographicContainer)
