...
DatabaseGenerateServerBaseTesting::GeographicEntityTesting::GeographicEntityTesting(const OStreamShared& stream, const AncientBooksContainer& ancientBooksContainer)
...
void DatabaseGenerateServerBaseTesting::GeographicEntityTesting::DoRunUnitTest()
{
...
void DatabaseGenerateServerBaseTesting::GeographicEntityTesting::MainTest()
{
    ASSERT_NOT_THROW_EXCEPTION_0(InitEnvironmentTest);
    ASSERT_NOT_THROW_EXCEPTION_0(DatabaseFlushTest);
}

void DatabaseGenerateServerBaseTesting::GeographicEntityTesting::InitEnvironmentTest()
{
...
void DatabaseGenerateServerBaseTesting::GeographicEntityTesting::DatabaseFlushTest()
{
