...
namespace System
{
	...
	void InitGlExtABGR() noexcept;
	void InitGlExtBlendColor() noexcept;
	void InitGlExtPolygonOffset() noexcept;
	void InitGlExtTexture() noexcept;
	void InitGlExtTexture3D() noexcept;
	void InitGlExtSubtexture() noexcept;
	void InitGlExtCopyTexture() noexcept;
	void InitGlExtHistogram() noexcept;
	void InitGlExtConvolution() noexcept;
	void InitGlExtCMYKA() noexcept;
	void InitGlExtTextureObject() noexcept;
	void InitGlExtPackedPixels() noexcept;
	void InitGlExtRescaleNormal() noexcept;
	void InitGlExtVertexArray() noexcept;
	void InitGlExtMiscAttribute() noexcept;
	void InitGlExtTextureEdgeClamp() noexcept;
	void InitGlExtBlendMinMax() noexcept;
	void InitGlExtBlendSubtract() noexcept;
	void InitGlExtBlendLogicOp() noexcept;
	void InitGlExtPointParameters() noexcept;
	void InitGlExtColorSubtable() noexcept;
	void InitGlExtPalettedTexture() noexcept;
	void InitGlExtClipVolumeHint() noexcept;
	void InitGlExtIndexTexture() noexcept;
	void InitGlExtIndexMaterial() noexcept;
	void InitGlExtIndexFunc() noexcept;
	void InitGlExtIndexArrayFormats() noexcept;
	void InitGlExtCompiledVertexArray() noexcept;
	void InitGlExtCullVertex() noexcept;
	void InitGlExtFragmentLighting() noexcept;
	void InitGlExtDrawRangeElements() noexcept;
	void InitGlExtLightTexture() noexcept;
	void InitGlExtSceneMarker() noexcept;
	void InitGlExtBGRA() noexcept;
	void InitGlExtPixelTransform() noexcept;
	void InitGlExtPixelTransformColorTable() noexcept;
	void InitGlExtSharedTexturePalette() noexcept;
	void InitGlExtSeparateSpecularColor() noexcept;
	void InitGlExtSecondaryColor() noexcept;
	void InitGlExtTextureEnv() noexcept;
	void InitGlExtTexturePerturbNormal() noexcept;
	void InitGlExtMultidrawArrays() noexcept;
	void InitGlExtFogCoord() noexcept;
	void InitGlExtCoordinateFrame() noexcept;
	void InitGlExtTextureEnvCombine() noexcept;
	void InitGlExtBlendFuncSeparate() noexcept;
	void InitGlExtStencilWrap() noexcept;
	void InitGlExt422Pixels() noexcept;
	void InitGlExtTextureCubeMap() noexcept;
	void InitGlExtTextureEnvAdd() noexcept;
	void InitGlExtTextureLodBias() noexcept;
	void InitGlExtTextureFilterAnisotropic() noexcept;
	void InitGlExtVertexWeighting() noexcept;
	void InitGlExtTextureCompressionS3TC() noexcept;
	void InitGlExtMultisample() noexcept;
	void InitGlExtTextureEnvDot3() noexcept;
	void InitGlExtTextureRectangle() noexcept;
	void InitGlExtVertexShader() noexcept;
	void InitGlExtShadowFuncs() noexcept;
	void InitGlExtStencilTwoSide() noexcept;
	void InitGlExtDepthBoundsTest() noexcept;
	void InitGlExtTextureMirrorClamp() noexcept;
	void InitGlExtBlendEquationSeparate() noexcept;
	void InitGlExtPixelBufferObject() noexcept;
	void InitGlExtTextureCompressionDXT1() noexcept;
	void InitGlExtFrameBufferObject() noexcept;
	void InitGlExtPackedDepthStencil() noexcept;
	void InitGlExtStencilClearTag() noexcept;
	void InitGlExtTextureSRGB() noexcept;
	void InitGlExtFrameBufferBlit() noexcept;
	void InitGlExtFrameBufferMultisample() noexcept;
	void InitGlExtTimerQuery() noexcept;
	void InitGlExtGpuProgramParameters() noexcept;
	void InitGlExtGeometryShader4() noexcept;
	void InitGlExtGpuShader4() noexcept;
	void InitGlExtDrawInstanced() noexcept;
	void InitGlExtPackedFloat() noexcept;
	void InitGlExtTextureArray() noexcept;
	void InitGlExtTextureBufferObject() noexcept;
	void InitGlExtTextureCompressionLatc() noexcept;
	void InitGlExtTextureCompressionRgtc() noexcept;
	void InitGlExtTextureSharedExponent() noexcept;
	void InitGlExtFramebufferSRGB() noexcept;
	void InitGlExtDrawBuffers2() noexcept;
	void InitGlExtBindableUniform() noexcept;
	void InitGlExtTextureInteger() noexcept;
	void InitGlExtTransformFeedback() noexcept;
	void InitGlExtDirectStateAccess() noexcept;
	void InitGlExtVertexArrayBgra() noexcept;
	void InitGlExtTextureSwizzle() noexcept;
	void InitGlExtProvokingVertex() noexcept;
	void InitGlExtTextureSnorm() noexcept;
	void InitGlExtSeparateShaderObjects() noexcept;
	void InitGlExtShaderImageLoadStore() noexcept;
	void InitGlExtVertexAttrib64bit() noexcept;
	void InitGlExtTextureSRGBDecode() noexcept;
	void InitGlExtX11SynObject() noexcept;
	void InitGlExtFramebufferMultisampleBlitScaled() noexcept;
	void InitGlExtShaderIntegerMix() noexcept;
	void InitGlExtDebugLabel() noexcept;
	void InitGlExtDebugMarker() noexcept;
	void InitGlExtShaderImageLoadFormatted() noexcept;
	void InitGlExtPolygonOffsetClamp() noexcept;
	void InitGlExtPostDepthCoverage() noexcept;
	void InitGlExtRasterMultisample() noexcept;
	void InitGlExtSparseTexture2() noexcept;
	void InitGlExtFilterMinmax() noexcept;
	void InitGlExtCgShader() noexcept;

	void InitGlExt() noexcept;
}
