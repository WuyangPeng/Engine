...
{
    RENDERING_CLASS_IS_VALID_CONST_9;
    RENDERING_ASSERTION_1(0 <= index && index < NumDimensions && 0 <= level && level < textureMaximumMipmapLevels, "索引错误！");
...
{
    RENDERING_CLASS_IS_VALID_CONST_9;
    RENDERING_ASSERTION_1(0 <= level && level < textureMaximumMipmapLevels, "索引错误！");
...
{
    RENDERING_CLASS_IS_VALID_CONST_9;
    RENDERING_ASSERTION_1(0 <= level && level < textureMaximumMipmapLevels && 0 <= item && item < numItems, "索引错误！");
