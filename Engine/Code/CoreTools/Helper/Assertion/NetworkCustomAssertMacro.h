...
static_assert(NETWORK_ASSERT_LEVEL <= ASSERT_LEVEL, "Network assert level definition error.");
	...
	#define NETWORK_ASSERTION_0(condition, format, ...) ((void)0)
	#define NETWORK_ASSERTION_USE_FUNCTION_DESCRIBED_0(condition,functionDescribed,format, ...) ((void)0)

	#define NETWORK_ASSERTION_DEBUG(condition, format, ...) ((void)0)
	#define NETWORK_ASSERTION_DEBUG_USE_FUNCTION_DESCRIBED(condition,functionDescribed,format, ...) ((void)0)
	...
	#define NETWORK_ASSERTION_1(condition, format, ...) ((void)0)
	#define NETWORK_ASSERTION_USE_FUNCTION_DESCRIBED_1(condition,functionDescribed,format, ...) ((void)0)
	...
	#define NETWORK_ASSERTION_2(condition, format, ...) ((void)0)
	#define NETWORK_ASSERTION_USE_FUNCTION_DESCRIBED_2(condition,functionDescribed,format, ...) ((void)0)
	...
	#define NETWORK_ASSERTION_3(condition, format, ...) ((void)0)
	#define NETWORK_ASSERTION_USE_FUNCTION_DESCRIBED_3(condition,functionDescribed,format, ...) ((void)0)
	...
	#define NETWORK_ASSERTION_4(condition, format, ...) ((void)0)
	#define NETWORK_ASSERTION_USE_FUNCTION_DESCRIBED_4(condition,functionDescribed,format, ...) ((void)0)
