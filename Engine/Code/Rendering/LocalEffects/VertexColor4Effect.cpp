...
// 
// ÒýÇæ°æ±¾£º0.0.0.3 (2019/07/25 15:02)
...
Rendering::VertexColor4Effect
	::VertexColor4Effect ()
{
	VertexShaderSmartPointer vshader{ NEW0 VertexShader{"Wm5.VertexColor4", 2, 2, 1, 0} };
	...
	PixelShaderSmartPointer pshader{ NEW0 PixelShader{ "Wm5.VertexColor4", 1, 1, 0, 0 } };
...
uint64_t Rendering::VertexColor4Effect
...
int* Rendering::VertexColor4Effect::msVRegisters[ShaderFlags::MaxProfiles]  
{
    0,
    msDx9VRegisters,
    msDx9VRegisters,
...
std::string Rendering::VertexColor4Effect::msVPrograms[ShaderFlags::MaxProfiles]  
{
    // VP_NONE
    "",
...
std::string Rendering::VertexColor4Effect::msPPrograms[ShaderFlags::MaxProfiles]  
{
    // PP_NONE
    "",
