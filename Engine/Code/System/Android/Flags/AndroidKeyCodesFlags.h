...
namespace System
{
    enum class AndroidKeyCodes
    {
        ...
        ProgramRed = AKEYCODE_PROG_RED,
        ProgramGreen = AKEYCODE_PROG_GREEN,
        ProgramYellow = AKEYCODE_PROG_YELLOW,
        ProgramBlue = AKEYCODE_PROG_BLUE,
