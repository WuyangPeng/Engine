...
namespace Mathematics
{
    ...
    public:
        ...
        virtual ~Polyhedron3();
        Polyhedron3(const Polyhedron3& rhs) = delete;
        Polyhedron3& operator=(const Polyhedron3& rhs) = delete;
        Polyhedron3(Polyhedron3&& rhs) = delete;
        Polyhedron3& operator=(Polyhedron3&& rhs) = delete;
