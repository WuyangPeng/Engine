...
OpenGLGlutCallBackUnitTestSuiteTesting::OpenGLGlutCallBackUnitTestSuiteTesting
	::OpenGLGlutCallBackUnitTestSuiteTesting(OpenGLGlutCallBackUnitTestSuiteTestingOpenGLGlutCallBack* message,const OStreamShared& osPtr)
...
OpenGLGlutCallBackUnitTestSuiteTesting::OpenGLGlutCallBackUnitTestSuiteTesting
	::~OpenGLGlutCallBackUnitTestSuiteTesting()
{
	FRAMEWORK_SELF_CLASS_IS_VALID_1;
}
...
void OpenGLGlutCallBackUnitTestSuiteTesting::OpenGLGlutCallBackUnitTestSuiteTesting
	::MainTest()
{
