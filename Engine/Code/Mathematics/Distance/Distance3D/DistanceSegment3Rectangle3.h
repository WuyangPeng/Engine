...
namespace Mathematics
{
	...
	class DistanceSegment3Rectangle3 : public DistanceBase<Real, Vector3D<Real> >
	{
	public:
	...
	using DistSegment3Rectangle3f = DistanceSegment3Rectangle3<float>;
	using DistSegment3Rectangle3d = DistanceSegment3Rectangle3<double>;
}
