...
namespace Mathematics
{
	...
	public:		
		...
		using typename ParentType::IntPtr;
		using typename ParentType::Vector3D;
		using typename ParentType::Vector3DPtr;
		using typename ParentType::Vector3DTools;

		using ParentType::GetNumTriangles;
		using ParentType::GetNumVertices;
		using ParentType::GetTriangle;
		using ParentType::GetIndices;
		using ParentType::ComputeVertexAverage;
