...
Framework::EventManagerInterfaceTesting::EventManagerInterfaceTesting(const OStreamShared& stream)
    : ParentType{ stream }
{
    FRAMEWORK_SELF_CLASS_IS_VALID_1;
}

CLASS_INVARIANT_PARENT_IS_VALID_DEFINE(Framework, EventManagerInterfaceTesting)

void Framework::EventManagerInterfaceTesting::DoRunUnitTest()
{
    ASSERT_NOT_THROW_EXCEPTION_0(MainTest);
}

void Framework::EventManagerInterfaceTesting::MainTest()
{
...
{
    EventManagerInterface middleLayer{ MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") } };
...
void Framework::EventManagerInterfaceTesting::SetMiddleLayerTest()
{
...
void Framework::EventManagerInterfaceTesting::SetNetworkManagerExceptionTest()
{
    ...
    const auto networkManager = std::make_shared<EventManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
...
void Framework::EventManagerInterfaceTesting::SetInputManagerExceptionTest()
{
    ...
    const auto inputManager = std::make_shared<EventManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
...
void Framework::EventManagerInterfaceTesting::SetObjectLogicManagerExceptionTest()
{
    ...
    const auto objectLogicManager = std::make_shared<EventManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
...
void Framework::EventManagerInterfaceTesting::SetPhysicalModellingManagerExceptionTest()
{
    ...
    const auto physicalModellingManager = std::make_shared<EventManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
...
void Framework::EventManagerInterfaceTesting::SetResourceManagerExceptionTest()
{
    ...
    const auto resourceManager = std::make_shared<EventManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
...
void Framework::EventManagerInterfaceTesting::SetAudioManagerExceptionTest()
{
    ...
    const auto audioManager = std::make_shared<EventManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
...
void Framework::EventManagerInterfaceTesting::SetCameraSystemsManagerExceptionTest()
{
    ...
    const auto cameraSystemsManager = std::make_shared<EventManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
...
void Framework::EventManagerInterfaceTesting::SetRenderingManagerExceptionTest()
{
    ...
    const auto renderingManager = std::make_shared<EventManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
...
void Framework::EventManagerInterfaceTesting::SetGUIManagerExceptionTest()
{
    ...
    const auto guiManager = std::make_shared<EventManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
