...
namespace Mathematics
{
	...
	class DistanceSegment3Box3 : public DistanceBase<Real, Vector3D<Real> >
	{
	public:
	...
	using DistSegment3Box3f = DistanceSegment3Box3<float>;
	using DistSegment3Box3d = DistanceSegment3Box3<double>;
}
