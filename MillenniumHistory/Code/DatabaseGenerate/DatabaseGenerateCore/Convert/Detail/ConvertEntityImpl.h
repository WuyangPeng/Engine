...
#ifndef DATABASE_GENERATE_CORE_CONVERT_CONVERT_ENTITY_IMPL_H
#define DATABASE_GENERATE_CORE_CONVERT_CONVERT_ENTITY_IMPL_H
...
namespace DatabaseGenerateCore
{
    ...
    class DATABASE_GENERATE_CORE_HIDDEN_DECLARE ConvertEntityImpl final
    {
    public:
...
#endif  // DATABASE_GENERATE_CORE_CONVERT_CONVERT_ENTITY_IMPL_H