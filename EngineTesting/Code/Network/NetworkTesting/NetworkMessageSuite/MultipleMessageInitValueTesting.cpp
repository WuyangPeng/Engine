...
void Network::MultipleMessageInitValueTesting
	::MainTest()
{
	...
	::BaseTest()
{
	...
	TestingType	multipleMessageInitValue{ multipleMessageContainer, int8Value, uint8Value, int16Value, uint16Value,
										  int32Value, uint32Value, int64Value, uint64Value, stringValue };
