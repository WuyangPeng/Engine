...
DatabaseGenerateServerBaseTesting::EmperorEntityTesting::EmperorEntityTesting(const OStreamShared& stream, const AncientBooksContainer& ancientBooksContainer)
...
void DatabaseGenerateServerBaseTesting::EmperorEntityTesting::DoRunUnitTest()
{
...
void DatabaseGenerateServerBaseTesting::EmperorEntityTesting::MainTest()
{
    ASSERT_NOT_THROW_EXCEPTION_0(InitEnvironmentTest);
    ASSERT_NOT_THROW_EXCEPTION_0(DatabaseFlushTest);
}

void DatabaseGenerateServerBaseTesting::EmperorEntityTesting::InitEnvironmentTest()
{
...
void DatabaseGenerateServerBaseTesting::EmperorEntityTesting::DatabaseFlushTest()
{
