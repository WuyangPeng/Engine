...
DatabaseGenerateBaseTesting::ImperialCourtEntityTesting::ImperialCourtEntityTesting(const OStreamShared& stream, ImperialCourtContainer imperialCourtContainer)
