...
Mathematics::DistanceTriangle3Rectangle3<Real>
	::DistanceTriangle3Rectangle3(const Triangle3& rkTriangle, const Rectangle3& rkRectangle)
	:ParentType{}, mTriangle{ rkTriangle }, mRectangle{ rkRectangle }
{
}

template <typename Real>
const Mathematics::Triangle3<Real>& Mathematics::DistanceTriangle3Rectangle3<Real>
	::GetTriangle() const
{
	return mTriangle;
}
...
template <typename Real>
const Mathematics::Rectangle3<Real>& Mathematics::DistanceTriangle3Rectangle3<Real>
	::GetRectangle() const
{
	return mRectangle;
}
...
template <typename Real>
typename const Mathematics::DistanceTriangle3Rectangle3<Real>::DistanceResult Mathematics::DistanceTriangle3Rectangle3<Real>
	::GetSquared() const
{
	...
	for (i0 = 2, i1 = 0; i1 < 3; i0 = i1++)
	{
		...
		DistanceSegment3Rectangle3<Real> querySR{ edge, mRectangle };
	...
	for (i1 = 0; i1 < 2; ++i1)
	{
		for (i0 = -1; i0 <= 1; i0 += 2)
		{
			...
			DistanceSegment3Triangle3<Real> queryST{ edge, mTriangle };
	...
	::GetSquared(Real t, const Vector3D& lhsVelocity, const Vector3D& rhsVelocity) const
{
	...
	return DistanceTriangle3Rectangle3<Real>{ movedTri, movedRect }.GetSquared();
}
