...
static_assert(TEAM_ASSERT_LEVEL <= ASSERT_LEVEL, "Assert level definition error.");
    ...
    #define TEAM_ASSERTION_0(condition, format, ...) (static_cast<void>(0))
    #define TEAM_ASSERTION_USE_FUNCTION_DESCRIBED_0(condition, functionDescribed, format, ...) (static_cast<void>(0))
    ...
    #define TEAM_ASSERTION_1(condition, format, ...) (static_cast<void>(0))
    #define TEAM_ASSERTION_USE_FUNCTION_DESCRIBED_1(condition, functionDescribed, format, ...) (static_cast<void>(0))
    ...
    #define TEAM_ASSERTION_2(condition, format, ...) (static_cast<void>(0))
    #define TEAM_ASSERTION_USE_FUNCTION_DESCRIBED_2(condition, functionDescribed, format, ...) (static_cast<void>(0))
    ...
    #define TEAM_ASSERTION_3(condition, format, ...) (static_cast<void>(0))
    #define TEAM_ASSERTION_USE_FUNCTION_DESCRIBED_3(condition, functionDescribed, format, ...) (static_cast<void>(0))
    ...
    #define TEAM_ASSERTION_4(condition, format, ...) (static_cast<void>(0))
    #define TEAM_ASSERTION_USE_FUNCTION_DESCRIBED_4(condition, functionDescribed, format, ...) (static_cast<void>(0))
