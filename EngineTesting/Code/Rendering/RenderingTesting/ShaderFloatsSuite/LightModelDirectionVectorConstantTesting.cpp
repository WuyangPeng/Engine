...
UNIT_TEST_SUBCLASS_COMPLETE_DEFINE(Rendering, LightModelDirectionVectorConstantTesting) 

void Rendering::LightModelDirectionVectorConstantTesting
	::MainTest()
{ 
...
// 		LightModelDirectionVectorConstantSharedPtr firstShaderFloat(new LightModelDirectionVectorConstant(firstLight));
// 		
// 		for (int i = 0; i < 4;++i)
// 		{	 
...
// 		
// 		LightModelDirectionVectorConstantSharedPtr secondShaderFloat =
// 			inTopLevel[0].PolymorphicDowncastObjectSharedPtr<LightModelDirectionVectorConstantSharedPtr>();
// 		
...
// 		Mathematics::AVectorf modelDirectionVector = worldInverseMatrix * firstLight->GetDirectionVector();
// 
