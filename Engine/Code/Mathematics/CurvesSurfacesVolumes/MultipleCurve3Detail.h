...
///
///	标准：std:c++17
///	引擎版本：0.8.0.4 (2022/03/16 15:03)

#ifndef MATHEMATICS_CURVES_SURFACES_VOLUMES_MULTIPLE_CURVE3_DETAIL_H
#define MATHEMATICS_CURVES_SURFACES_VOLUMES_MULTIPLE_CURVE3_DETAIL_H
...
Mathematics::MultipleCurve3<Real>::MultipleCurve3(int numSegments, const std::vector<Real>& times)
...
template <typename Real>
bool Mathematics::MultipleCurve3<Real>::IsValid() const noexcept
{
...
template <typename Real>
int Mathematics::MultipleCurve3<Real>::GetSegments() const noexcept
{
...
template <typename Real>
std::vector<Real> Mathematics::MultipleCurve3<Real>::GetTimes() const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
Real Mathematics::MultipleCurve3<Real>::GetTimes(int index) const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
void Mathematics::MultipleCurve3<Real>::GetKeyInfo(Real t, int& key, Real& dt) const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
void Mathematics::MultipleCurve3<Real>::InitializeLength() const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
Real Mathematics::MultipleCurve3<Real>::GetLength(Real t0, Real t1) const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
Real Mathematics::MultipleCurve3<Real>::GetTime(Real length, int iterations, Real tolerance) const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
#endif  // MATHEMATICS_CURVES_SURFACES_VOLUMES_MULTIPLE_CURVE3_DETAIL_H