...
void CoreTools::WindowsMutex::Delete() noexcept
{
    ...
    {
        LOG_SINGLETON_ENGINE_APPENDER(Error, CoreTools, SYSTEM_TEXT("销毁Mutex失败"), CoreTools::LogAppenderIOManageSign::TriggerAssert);
    }
}
...
void CoreTools::WindowsMutex::Leave() noexcept
{
    ...
    {
        LOG_SINGLETON_ENGINE_APPENDER(Error, CoreTools, SYSTEM_TEXT("释放互斥体失败"), CoreTools::LogAppenderIOManageSign::TriggerAssert);
    }
}
