...
///
///	标准：std:c++20
///	最后的霸王版本：0.8.0.12 (2022/07/28 22:22)
...
GameMasterServerMiddleLayer::PhysicalModellingManager::PhysicalModellingManager(Framework::MiddleLayerPlatform middleLayerPlatform)
