...
float Imagics::PdeFilter2
	::GetU (int x, int y) const
{
	return mSrc[y+1][x+1];
}

float Imagics::PdeFilter2
	::GetUx (int x, int y) const
{
	int iYp1 = y + 1;
