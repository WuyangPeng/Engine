...
{
	System::DialogBoxCommand type = System::MessageBoxSelectionWithTChar(message.c_str(), SYSTEM_TEXT("错误"));
...
{
	auto type = System::MessageBoxSelectionWithChar(message.c_str(), "错误");
