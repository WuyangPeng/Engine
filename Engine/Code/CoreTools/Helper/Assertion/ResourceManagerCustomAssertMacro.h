...
static_assert(RESOURCE_MANAGER_ASSERT_LEVEL <= ASSERT_LEVEL, "Resource Manager assert level definition error.");
	...
	#define RESOURCE_MANAGER_ASSERTION_1(condition, format, ...) ((void)0)
	#define RESOURCE_MANAGER_ASSERTION_USE_FUNCTION_DESCRIBED_1(condition,functionDescribed,format, ...) ((void)0)
	...
	#define RESOURCE_MANAGER_ASSERTION_2(condition, format, ...) ((void)0)
	#define RESOURCE_MANAGER_ASSERTION_USE_FUNCTION_DESCRIBED_2(condition,functionDescribed,format, ...) ((void)0)
	...
	#define RESOURCE_MANAGER_ASSERTION_3(condition, format, ...) ((void)0)
	#define RESOURCE_MANAGER_ASSERTION_USE_FUNCTION_DESCRIBED_3(condition,functionDescribed,format, ...) ((void)0)
	...
	#define RESOURCE_MANAGER_ASSERTION_4(condition, format, ...) ((void)0)
	#define RESOURCE_MANAGER_ASSERTION_USE_FUNCTION_DESCRIBED_4(condition,functionDescribed,format, ...) ((void)0)
