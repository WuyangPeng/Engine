...
namespace Rendering
{
	...
	private:
		void Init();
		void TransformData(const VertexBufferAccessor& vertexBufferAccessor,VertexBufferSmartPointer& vertexBuffer) const;
		void ReverseTriangleOrder(int numTriangles, int* indices) const;
		void CreatePlatonicNormals(const VertexBufferAccessor& vertexBufferAccessor,VertexBufferSmartPointer& vertexBuffer) const;
		void CreatePlatonicTextures(const VertexBufferAccessor& vertexBufferAccessor,VertexBufferSmartPointer& vertexBuffer) const;
