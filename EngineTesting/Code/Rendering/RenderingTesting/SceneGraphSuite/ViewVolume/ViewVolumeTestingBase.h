...
#ifndef RENDERING_SCENE_GRAPH_SUITE_VIEW_VOLUME_TESTING_BASE_H
#define RENDERING_SCENE_GRAPH_SUITE_VIEW_VOLUME_TESTING_BASE_H
...
namespace Rendering
{
    class ViewVolumeTestingBase : public CoreTools::UnitTest
    {
    public:
        using ClassType = ViewVolumeTestingBase;
        using ParentType = UnitTest;

    public:
        explicit ViewVolumeTestingBase(const OStreamShared& stream);
...
#endif  // RENDERING_SCENE_GRAPH_SUITE_VIEW_VOLUME_TESTING_BASE_H