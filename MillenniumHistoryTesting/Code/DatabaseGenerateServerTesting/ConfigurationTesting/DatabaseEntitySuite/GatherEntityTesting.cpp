...
DatabaseGenerateServerBaseTesting::GatherEntityTesting::GatherEntityTesting(const OStreamShared& stream, const AncientBooksContainer& ancientBooksContainer)
...
void DatabaseGenerateServerBaseTesting::GatherEntityTesting::DoRunUnitTest()
{
...
void DatabaseGenerateServerBaseTesting::GatherEntityTesting::MainTest()
{
    ASSERT_NOT_THROW_EXCEPTION_0(InitEnvironmentTest);
    ASSERT_NOT_THROW_EXCEPTION_0(DatabaseFlushTest);
}

void DatabaseGenerateServerBaseTesting::GatherEntityTesting::InitEnvironmentTest()
{
...
void DatabaseGenerateServerBaseTesting::GatherEntityTesting::DatabaseFlushTest()
{
