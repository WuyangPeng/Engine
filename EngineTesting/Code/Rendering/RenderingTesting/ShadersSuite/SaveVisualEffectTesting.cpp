...
void Rendering::SaveVisualEffectTesting
	::MainTest()
{ 
...
{ 
	...
	SaveVisualEffect saveVisualEffect(visualEffect, SYSTEM_TEXT("Resource/ShadersSuite/SecondSaveVisualEffect.trve"));
}
	...
	::SaveTest()
{
	...
	ASSERT_EQUAL_DO_NOT_USE_MESSAGE(firstFile.GetFileContent(), secondFile.GetFileContent());
}
