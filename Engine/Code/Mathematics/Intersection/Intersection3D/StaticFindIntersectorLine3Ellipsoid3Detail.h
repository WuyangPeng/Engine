...
Mathematics::StaticFindIntersectorLine3Ellipsoid3<Real>::StaticFindIntersectorLine3Ellipsoid3(const Line3Type& line, const Ellipsoid3Type& ellipsoid, const Real epsilon)
...
void Mathematics::StaticFindIntersectorLine3Ellipsoid3<Real>::Find()
{
    ...
    auto a2 = Vector3ToolsType::DotProduct(line.GetDirection(), matrixDirection);
    auto a1 = Vector3ToolsType::DotProduct(line.GetDirection(), matrixDiff);
