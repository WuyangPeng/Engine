...
#ifndef SHOP_HELPER_CLASS_INVARIANT_HELPER_H
#define SHOP_HELPER_CLASS_INVARIANT_HELPER_H
...
static_assert(SHOP_CLASS_INVARIANT_CONST_LEVEL <= CLASS_INVARIANT_CONST_LEVEL, "Class invariant level definition error.");
    ...
    #define SHOP_CLASS_IS_VALID_0 (static_cast<void>(0))
    #define SHOP_SELF_CLASS_IS_VALID_0 (static_cast<void>(0))
    ...
    #define SHOP_CLASS_IS_VALID_1 (static_cast<void>(0))
    #define SHOP_SELF_CLASS_IS_VALID_1 (static_cast<void>(0))
    ...
    #define SHOP_CLASS_IS_VALID_2 (static_cast<void>(0))
    #define SHOP_SELF_CLASS_IS_VALID_2 (static_cast<void>(0))
    ...
    #define SHOP_CLASS_IS_VALID_3 (static_cast<void>(0))
    #define SHOP_SELF_CLASS_IS_VALID_3 (static_cast<void>(0))
    ...
    #define SHOP_CLASS_IS_VALID_4 (static_cast<void>(0))
    #define SHOP_SELF_CLASS_IS_VALID_4 (static_cast<void>(0))
    ...
    #define SHOP_CLASS_IS_VALID_5 (static_cast<void>(0))
    #define SHOP_SELF_CLASS_IS_VALID_5 (static_cast<void>(0))
    ...
    #define SHOP_CLASS_IS_VALID_6 (static_cast<void>(0))
    #define SHOP_SELF_CLASS_IS_VALID_6 (static_cast<void>(0))
    ...
    #define SHOP_CLASS_IS_VALID_7 (static_cast<void>(0))
    #define SHOP_SELF_CLASS_IS_VALID_7 (static_cast<void>(0))
    ...
    #define SHOP_CLASS_IS_VALID_8 (static_cast<void>(0))
    #define SHOP_SELF_CLASS_IS_VALID_8 (static_cast<void>(0))
    ...
    #define SHOP_CLASS_IS_VALID_9 (static_cast<void>(0))
    #define SHOP_SELF_CLASS_IS_VALID_9 (static_cast<void>(0))
    ...
    #define SHOP_CLASS_IS_VALID_CONST_0 (static_cast<void>(0))
    ...
    #define SHOP_CLASS_IS_VALID_CONST_1 (static_cast<void>(0))
    ...
    #define SHOP_CLASS_IS_VALID_CONST_2 (static_cast<void>(0))
    ...
    #define SHOP_CLASS_IS_VALID_CONST_3 (static_cast<void>(0))
    ...
    #define SHOP_CLASS_IS_VALID_CONST_4 (static_cast<void>(0))
    ...
    #define SHOP_CLASS_IS_VALID_CONST_5 (static_cast<void>(0))
    ...
    #define SHOP_CLASS_IS_VALID_CONST_6 (static_cast<void>(0))
    ...
    #define SHOP_CLASS_IS_VALID_CONST_7 (static_cast<void>(0))
    ...
    #define SHOP_CLASS_IS_VALID_CONST_8 (static_cast<void>(0))
    ...
    #define SHOP_CLASS_IS_VALID_CONST_9 (static_cast<void>(0))

#endif  // 9 <= SHOP_CLASS_INVARIANT_CONST_LEVEL

#endif  // SHOP_HELPER_CLASS_INVARIANT_HELPER_H
