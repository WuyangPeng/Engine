...
void Rendering::HalfFloatTesting::BigFloatTest()
{
    ...
    std::uniform_real_distribution<float> floatRandomDistribution(-32768.0f, 32768.0f);  // 2的15次方
...
{
    std::default_random_engine generator;
    std::uniform_real_distribution<float> firstFloatRandomDistribution(-1.0f / 32768.0f, 1.0f / 32768.0f);  // 2的-15次方
