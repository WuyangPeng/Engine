...
Rendering::CameraModelPositionConstantTesting::CameraModelPositionConstantTesting(const OStreamShared& stream)
    : ParentType{ stream }
{
    RENDERING_SELF_CLASS_IS_VALID_1;
}

CLASS_INVARIANT_PARENT_IS_VALID_DEFINE(Rendering, CameraModelPositionConstantTesting)

void Rendering::CameraModelPositionConstantTesting::DoRunUnitTest()
{
