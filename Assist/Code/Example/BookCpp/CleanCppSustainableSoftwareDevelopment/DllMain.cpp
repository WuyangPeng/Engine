...
#include "CleanCppSustainableSoftwareDevelopmentFwd.h"

#include "CoreTools/Helper/MainFunctionMacro.h"

#ifndef BUILDING_CLEAN_CPP_SUSTAINABLE_SOFTWARE_DEVELOPMENT_STATIC

DLL_MAIN_FUNCTION(CleanCppSustainableSoftwareDevelopment);

#else  // BUILDING_CLEAN_CPP_SUSTAINABLE_SOFTWARE_DEVELOPMENT_STATIC

CORE_TOOLS_MUTEX_INIT(CleanCppSustainableSoftwareDevelopment);
