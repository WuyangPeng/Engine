...
Framework::PhysicalModellingManagerInterfaceTesting
::PhysicalModellingManagerInterfaceTesting(const OStreamShared& stream)
	:ParentType{ stream }
{
...
void Framework::PhysicalModellingManagerInterfaceTesting
::DoRunUnitTest()
{
