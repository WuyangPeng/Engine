...
DatabaseGenerateCoreTesting::CategoryConvertTesting::CategoryConvertTesting(const OStreamShared& stream, CategoryContainer categoryContainer)
    : ParentType{ stream }, categoryContainer{ std::move(categoryContainer) }
{
