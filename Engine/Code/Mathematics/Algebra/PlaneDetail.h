...
Mathematics::Plane<T>
	...
	:m_Tuple{ AlgebraTraits::UnitValue, AlgebraTraits::NullValue, AlgebraTraits::NullValue, AlgebraTraits::NullValue }, m_Epsilon{ epsilon }
{
...
Mathematics::Plane<T>
	...
	:m_Tuple{ normalX,normalY,normalZ,-constant },
	 m_Epsilon{ epsilon }
{
	Normalize();
...
{
	if(Math::Sqrt(m_Tuple[0] * m_Tuple[0] + m_Tuple[1] * m_Tuple[1] + m_Tuple[2] * m_Tuple[2]) - AlgebraTraits::UnitValue <= m_Epsilon)
	    return true;
	else		
		return false;	
}
