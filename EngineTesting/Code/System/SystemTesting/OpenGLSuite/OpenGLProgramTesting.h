...
#ifndef SYSTEM_OPENGL_SUITE_OPENGL_PROGRAM_TESTING_H
#define SYSTEM_OPENGL_SUITE_OPENGL_PROGRAM_TESTING_H
...
#endif  // SYSTEM_OPENGL_SUITE_OPENGL_PROGRAM_TESTING_H