...
#ifndef ASSIST_TOOLS_GENERATE_PROJECTS_TEMPLATE_VC110_H
#define ASSIST_TOOLS_GENERATE_PROJECTS_TEMPLATE_VC110_H

#include "AssistTools/AssistToolsDll.h"

namespace AssistTools
{
	class ASSIST_TOOLS_DEFAULT_DECLARE TemplateVC110
	{
	public:
...
#endif // ASSIST_TOOLS_GENERATE_PROJECTS_TEMPLATE_VC110_H
