...
// ◊˜’ﬂ£∫≈ÌŒ‰—Ù£¨≈ÌÍ ∂˜£¨≈ÌÍ ‘Û
//
// “˝«Ê≤‚ ‘∞Ê±æ£∫0.3.1.0 (2020/06/26 18:33)
...
Framework::ModelViewControllerMiddleLayerContainerTesting
	::ModelViewControllerMiddleLayerContainerTesting(const OStreamShared& stream)
	:ParentType{ stream }
{
...
void Framework::ModelViewControllerMiddleLayerContainerTesting
	::DoRunUnitTest()
{
