...
///
///	标准：std:c++20
///	引擎游戏版本：0.9.0.12 (2023/06/16 17:06)
...
static_assert(CHARACTER_INFORMATION_ASSERT_LEVEL <= ASSERT_LEVEL, "Assert level definition error.");
    ...
    #define CHARACTER_INFORMATION_ASSERTION_0(condition, format, ...) (static_cast<void>(0))
    #define CHARACTER_INFORMATION_ASSERTION_USE_FUNCTION_DESCRIBED_0(condition, functionDescribed, format, ...) (static_cast<void>(0))
    ...
    #define CHARACTER_INFORMATION_ASSERTION_1(condition, format, ...) (static_cast<void>(0))
    #define CHARACTER_INFORMATION_ASSERTION_USE_FUNCTION_DESCRIBED_1(condition, functionDescribed, format, ...) (static_cast<void>(0))
    ...
    #define CHARACTER_INFORMATION_ASSERTION_2(condition, format, ...) (static_cast<void>(0))
    #define CHARACTER_INFORMATION_ASSERTION_USE_FUNCTION_DESCRIBED_2(condition, functionDescribed, format, ...) (static_cast<void>(0))
    ...
    #define CHARACTER_INFORMATION_ASSERTION_3(condition, format, ...) (static_cast<void>(0))
    #define CHARACTER_INFORMATION_ASSERTION_USE_FUNCTION_DESCRIBED_3(condition, functionDescribed, format, ...) (static_cast<void>(0))
    ...
    #define CHARACTER_INFORMATION_ASSERTION_4(condition, format, ...) (static_cast<void>(0))
    #define CHARACTER_INFORMATION_ASSERTION_USE_FUNCTION_DESCRIBED_4(condition, functionDescribed, format, ...) (static_cast<void>(0))
