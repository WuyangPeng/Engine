...
void EllipsoidGeodesic<Real>::ComputeMetric(const VariableLengthVector<Real>& point)
{
	...
	Vector3D<Real> der0{ -mXExtent * sin0*sin1, mYExtent*cos0*sin1, Real{} };
...
void EllipsoidGeodesic<Real>::ComputeChristoffel1 (const VariableLengthVector<Real>& point)
{
	...
	Vector3D<Real> der00{ -mXExtent * cos0*sin1, -mYExtent * sin0*sin1, Real{} };

	Vector3D<Real> der01{ -mXExtent * sin0*cos1, mYExtent*cos0*cos1, Real{} };
