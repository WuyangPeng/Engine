...
wstring CoreTools::StringConversion
	::MultiByteConversionWideChar(const string& character)
{
...
string CoreTools::StringConversion
	::WideCharConversionMultiByte(const wstring& character)
{
...
wstring CoreTools::StringConversion
	::StandardConversionWideChar(const String& character)
{
#ifdef UNICODE
	return character;
#else // !UNICODE
...
string CoreTools::StringConversion
	::StandardConversionMultiByte(const String& character)
{
#ifdef UNICODE
...
System::String CoreTools::StringConversion
	::WideCharConversionStandard(const wstring& character)
{
#ifdef UNICODE
	return character;
#else // !UNICODE
...
System::String CoreTools::StringConversion
	::MultiByteConversionStandard(const string& character)
{
#ifdef UNICODE
	return MultiByteConversionWideChar(character);
#else // !UNICODE
...
System::DynamicLinkString CoreTools::StringConversion
	::StandardConversionDynamicLinkString(const String& character)
{
...
System::CFileString CoreTools::StringConversion
	::StandardConversionCFileString(const String& character)
{
...
string CoreTools::StringConversion
	::DynamicLinkStringConversionMultiByte(const DynamicLinkString& character)
{
#ifdef SYSTEM_PLATFORM_WIN32
	return StandardConversionMultiByte(character);
#else // !SYSTEM_PLATFORM_WIN32
...
System::String CoreTools::StringConversion
	::DynamicLinkStringConversionStandard(const DynamicLinkString& character)
{
#ifdef SYSTEM_PLATFORM_WIN32
	return character;
#else // !SYSTEM_PLATFORM_WIN32
...
wstring CoreTools::StringConversion
	::UTF8ConversionWideChar(const string& character)
{
...
string CoreTools::StringConversion
	::WideCharConversionUTF8(const wstring& character)
{
...
System::String CoreTools::StringConversion
	::UTF8ConversionStandard(const string& character)
{
...
string CoreTools::StringConversion
	::StandardConversionUTF8(const String& character)
{
...
string CoreTools::StringConversion
	::UTF8ConversionMultiByte(const string& character)
{
	auto wideChar = UTF8ConversionWideChar(character);
...
string CoreTools::StringConversion
	::MultiByteConversionUTF8(const string& character)
{
