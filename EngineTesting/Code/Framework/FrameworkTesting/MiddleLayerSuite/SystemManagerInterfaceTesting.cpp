...
void Framework::SystemManagerInterfaceTesting::SetEventManagerTest()
{
    ...
    MiddleLayerInterfaceSharedPtr eventManager(std::make_shared<EventManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") }));
...
void Framework::SystemManagerInterfaceTesting::SetAudioManagerTest()
{
    ...
    MiddleLayerInterfaceSharedPtr audioManager(std::make_shared<AudioManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") }));
...
void Framework::SystemManagerInterfaceTesting::SetRenderingManagerTest()
{
    ...
    MiddleLayerInterfaceSharedPtr renderingManager(RenderingManagerInterface::CreateMiddleLayer(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") }));
...
void Framework::SystemManagerInterfaceTesting::SetEngineManagerTest()
{
    ...
    MiddleLayerInterfaceSharedPtr engineManager(std::make_shared<EngineMiddleLayerContainer<WindowApplicationTrait>>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") }));
