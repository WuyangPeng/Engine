...
#include "AdjustTokenTestingBase.h"
...
System::AdjustTokenTestingBase::AdjustTokenTestingBase(const OStreamShared& stream)
    : ParentType{ stream },
...
CLASS_INVARIANT_PARENT_IS_VALID_DEFINE(System, AdjustTokenTestingBase)

void System::AdjustTokenTestingBase::DoRunUnitTest()
{
    ASSERT_NOT_THROW_EXCEPTION_0(MainTest);
}

void System::AdjustTokenTestingBase::MainTest()
{
    ASSERT_NOT_THROW_EXCEPTION_0(GetAdjustTokenPrivilegesTest);
    ASSERT_NOT_THROW_EXCEPTION_0(GetAdjustTokenGroupsTest);
}

void System::AdjustTokenTestingBase::GetAdjustTokenPrivilegesTest()
{
...
void System::AdjustTokenTestingBase::GetAdjustTokenGroupsTest()
{
    WindowsHandle tokenHandle{ nullptr };
    ASSERT_TRUE(OpenSysemProcessToken(GetCurrentProcessHandle(), TokenStandardAccess::Default, TokenSpecificAccess::AllAccess, &tokenHandle));
