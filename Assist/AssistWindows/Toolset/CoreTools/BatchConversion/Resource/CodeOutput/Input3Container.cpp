...
CsvOutput::Input3Container::Input3Container(const CoreTools::CSVContent& csvContent)
    : input3{}
{
    Parsing(csvContent);
...
void CsvOutput::Input3Container::Parsing(const CoreTools::CSVContent& csvContent)
{
