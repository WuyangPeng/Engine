...
Rendering::LightAttenuationConstant::LightAttenuationConstant(const LightSharedPtr& light)
    : ParentType{ light }
{
...
Rendering::ShaderFloatSharedPtr Rendering::LightAttenuationConstant::Clone() const
{
