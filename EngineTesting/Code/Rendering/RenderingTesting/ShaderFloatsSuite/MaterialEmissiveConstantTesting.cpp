...
///
///	标准：std:c++20
///	引擎测试版本：0.9.0.12 (2023/06/12 15:25)
...
Rendering::MaterialEmissiveConstantTesting::MaterialEmissiveConstantTesting(const OStreamShared& stream)
    : ParentType{ stream }
{
    RENDERING_SELF_CLASS_IS_VALID_1;
}

CLASS_INVARIANT_PARENT_IS_VALID_DEFINE(Rendering, MaterialEmissiveConstantTesting)

void Rendering::MaterialEmissiveConstantTesting::DoRunUnitTest()
{
...
void Rendering::MaterialEmissiveConstantTesting::StreamTest() noexcept
{
}

void Rendering::MaterialEmissiveConstantTesting::UpdateTest() noexcept
{
}
