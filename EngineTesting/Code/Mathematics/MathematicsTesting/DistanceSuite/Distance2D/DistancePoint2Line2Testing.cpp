...
// ◊˜’ﬂ£∫≈ÌŒ‰—Ù£¨≈ÌÍ ∂˜£¨≈ÌÍ ‘Û
// 
// “˝«Ê≤‚ ‘∞Ê±æ£∫0.0.0.2 (2019/08/30 12:44)
...
void Mathematics::DistancePoint2Line2Testing
	::MainTest()
{	
	...
	::BaseTest()
{
	...
	for (auto loop = 0; loop < testLoopCount; ++loop)
	{
		...
		DistancePoint2Line2<float> distance(point, FloatLine2(rhsOrigin, rhsDirection));
		...
		ASSERT_APPROXIMATE_USE_FUNCTION(Approximate<float>, distance.GetLine(), FloatLine2(rhsOrigin, rhsDirection), 1e-8f);
	}
}
	...
	::StaticTest()
{
	...
	for (auto loop = 0; loop < testLoopCount; ++loop)
	{
		...
		DoubleDistancePoint2Line2 distance(point, DoubleLine2(rhsOrigin, rhsDirection));
