...
namespace AncientBooks
{
    ...
    public:
        ...
        NODISCARD virtual std::shared_ptr<const SexagenaryCycleMappingType> GetSexagenaryCycle(MAYBE_UNUSED const AncientBooksContainer& csvContainer) const;
        ...
        NODISCARD virtual int GetUnorthodoxReignTitle(MAYBE_UNUSED int index) const;
        ...
        NODISCARD virtual int GetUnorthodoxYear(MAYBE_UNUSED int index) const;
