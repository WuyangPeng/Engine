...
template <typename Real>
const Mathematics::Line3<Real> Mathematics::IntersectorLine3Triangle3Data<Real>::GetLine() const
{
...
template <typename Real>
const Mathematics::Triangle3<Real> Mathematics::IntersectorLine3Triangle3Data<Real>::GetTriangle() const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
Mathematics::Vector3D<Real> Mathematics::IntersectorLine3Triangle3Data<Real>::GetOriginCrossEdge2() const noexcept
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
