...
#ifndef MATHEMATICS_NUMERICAL_ANALYSIS_SYMMETRIC_EIGENSOLVER_GTE_H
#define MATHEMATICS_NUMERICAL_ANALYSIS_SYMMETRIC_EIGENSOLVER_GTE_H
...
namespace Mathematics
{
	...
	private:
		...
		// replacement entries:  Real(index,index) = cs, Real(index,index+1) = sn,
		// Real(index+1,index) = -sn, and Real(index+1,index+1) = cs.  If N is the
	...
	using SymmetricEigensolverGTEf = SymmetricEigensolverGTE<float>;
	using SymmetricEigensolverGTEd = SymmetricEigensolverGTE<double>;
}

#endif // MATHEMATICS_NUMERICAL_ANALYSIS_SYMMETRIC_EIGENSOLVER_GTE_H
