...
#ifndef CORSS_SERVER_MIDDLE_LAYER_GUI_MIDDLE_LAYER_GUI_H
#define CORSS_SERVER_MIDDLE_LAYER_GUI_MIDDLE_LAYER_GUI_H
...
{
    class CORSS_SERVER_MIDDLE_LAYER_DEFAULT_DECLARE GUIManager final : public Framework::GUIManagerInterface
    {
    public:
...
#endif  // CORSS_SERVER_MIDDLE_LAYER_GUI_MIDDLE_LAYER_GUI_H
