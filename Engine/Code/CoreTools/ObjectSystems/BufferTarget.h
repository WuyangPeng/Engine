...
namespace CoreTools
{
    ...
    public:
        BufferTarget(const FileBufferPtr& fileBuffer, ObjectRegister& objectRegister);
        ...
        template <typename T>
        void WriteWeakPtr(const WeakPtr<T>& object);
        template <typename T>
        void WriteWeakPtr(const std::vector<WeakPtr<T>>& datum);
        template <typename T,int size>
        void WriteWeakPtr(const std::array<WeakPtr<T>, size>& datum);
