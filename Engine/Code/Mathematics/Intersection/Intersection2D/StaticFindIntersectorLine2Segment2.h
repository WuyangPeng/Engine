...
namespace Mathematics
{
    ...
    public:
        StaticFindIntersectorLine2Segment2(const Line2& line, const Segment2& segment, const Real dotThreshold = MathType::GetZeroTolerance(), const Real intervalThreshold = MathType::GetValue(0));
