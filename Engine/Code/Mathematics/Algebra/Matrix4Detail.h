	...
	::MakeIdentity()
{
	...
	m_Entry(3,1) = Real{ };
	m_Entry(3,2) = Real{ };
	m_Entry(3,3) = AlgebraTraits::UnitValue;
}

template <typename Real>
const Real* Mathematics::Matrix4<Real>
...
template <typename Real>
Mathematics::Matrix4<Real>& Mathematics::Matrix4<Real>
...
template <typename Real>
Real Mathematics::Matrix4<Real>
	::QuadraticForm( const Vector4D& lhs, const Vector4D& rhs ) const
{
	MATHEMATICS_CLASS_IS_VALID_9;
...
template <typename Real>
void Mathematics::Matrix4<Real>
	::MakeObliqueProjection( const Vector3D& normal, const Vector3D& origin, const Vector3D& direction )
{
	MATHEMATICS_CLASS_IS_VALID_9;
...
template <typename Real>
void Mathematics::Matrix4<Real>
	::MakePerspectiveProjection( const Vector3D& normal,const Vector3D& origin,const Vector3D& eye )
{
	MATHEMATICS_CLASS_IS_VALID_9;
...
template <typename Real>
void Mathematics::Matrix4<Real>
	::MakeReflection( const Vector3D& normal, const Vector3D& origin )
{
	MATHEMATICS_CLASS_IS_VALID_9;
	MATHEMATICS_ASSERTION_1(normal.IsNormalize(), "normal必须是单位向量！");
	...
	m_Entry(0,0) = AlgebraTraits::UnitValue - static_cast<Real>(2) * normal[0] * normal[0];
	...
	m_Entry(1,1) = AlgebraTraits::UnitValue - static_cast<Real>(2) * normal[1] * normal[1];
	...
	m_Entry(2,2) = AlgebraTraits::UnitValue - static_cast<Real>(2) * normal[2] * normal[2];
...
template <typename Real>
const Mathematics::Vector4D<Real> Mathematics
	::operator*( const Matrix4<Real>& matrix,const Vector4D<Real>& vector )
{
...
template <typename Real>
const Mathematics::Vector4D<Real> Mathematics
	::operator*( const Vector4D<Real>& vector,const Matrix4<Real>& matrix )
{
...
template <typename Real>
const Mathematics::Matrix4<Real> Mathematics::
	operator* (const Matrix4<Real>& lhs,const Matrix4<Real>& rhs)
{
	// A * B
...
template <typename Real>
const Mathematics::Matrix4<Real> Mathematics
	::TransposeTimes( const Matrix4<Real>& lhs, const Matrix4<Real>& rhs )
{
	// A^T * B
...
template <typename Real>
const Mathematics::Matrix4<Real> Mathematics
	::TimesTranspose( const Matrix4<Real>& lhs, const Matrix4<Real>& rhs )
{
	// A * B^T
...
template <typename Real>
const Mathematics::Matrix4<Real> Mathematics
	::TransposeTimesTranspose( const Matrix4<Real>& lhs,const Matrix4<Real>& rhs )
{
	// A^T * B^T
...
template <typename Real>
void Mathematics::Matrix4<Real>
	::MakeFrustumMatrix44( Real left, Real right, Real bottom, Real top, Real nearDistance, Real farDistance )
{
	MATHEMATICS_CLASS_IS_VALID_9;
	...
	m_Entry(2,3) = -AlgebraTraits::UnitValue;
...
template <typename Real>
void Mathematics::Matrix4<Real>
	::MakePerspectiveMatrix44( Real fieldOfViewY, Real aspect,Real nearDistance, Real farDistance )
{
	MATHEMATICS_CLASS_IS_VALID_9;	

	auto angle = fieldOfViewY / static_cast<Real>(2);
	// 角度转换成弧度
	...
	m_Entry(3,0) = Real{ };
	m_Entry(3,1) = Real{ };
	m_Entry(3,2) = -(static_cast<Real>(2) * farDistance * nearDistance) /  (farDistance - nearDistance);
	m_Entry(3,3) = Real{ };
}
...
template <typename Real>
void Mathematics::Matrix4<Real>
	::MakeOrthoMatrix44( Real left, Real right, Real bottom, Real top, Real nearDistance, Real farDistance )
{
	MATHEMATICS_CLASS_IS_VALID_9;
	...
	m_Entry(0,0) = static_cast<Real>(2) / width;
	m_Entry(0,1) = Real{ };
	m_Entry(0,2) = Real{ };
	m_Entry(0,3) = Real{ };

	m_Entry(1,0) = Real{ };
	m_Entry(1,1) = static_cast<Real>(2) / height;
	m_Entry(1,2) = Real{ };
	m_Entry(1,3) = Real{ };

	m_Entry(2,0) = Real{ };
	m_Entry(2,1) = Real{ };
	m_Entry(2,2) = static_cast<Real>(-2) / depth;
	m_Entry(2,3) = Real{ };
...
template <typename Real>
void Mathematics::Matrix4<Real>
	::MakeOrthoNormalMatrix44( const Vector3D& xDirection, const Vector3D& yDirection, const Vector3D& zDirection )
{
	MATHEMATICS_CLASS_IS_VALID_9;
...
template <typename Real>
bool Mathematics	
	::Approximate( const Matrix4<Real>& lhs, const Matrix4<Real>& rhs,const Real epsilon )
{
