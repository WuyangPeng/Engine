...
namespace Physics
{
	...
	template <typename Real>
	const Mathematics::ConvexPolyhedron3<Real>* ExtremalQuery3<Real>::GetPolytope() const
	{
		return mPolytope;
	}

	template <typename Real>
	const Mathematics::Vector3D<Real>* ExtremalQuery3<Real>::GetFaceNormals() const
	{
		return mFaceNormals;
	}
