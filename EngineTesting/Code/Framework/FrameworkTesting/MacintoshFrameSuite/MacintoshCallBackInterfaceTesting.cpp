...
Framework::MacintoshCallBackInterfaceTesting
	::MacintoshCallBackInterfaceTesting(const OStreamShared& stream)
	:ParentType{ stream } 
{
...
void Framework::MacintoshCallBackInterfaceTesting
	::DoRunUnitTest()
{
