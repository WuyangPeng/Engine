...
#define SCENE_EDITOR_ClOSE_BEGIN (0x01)

#define CLOSE_USE_SCENE_EDITOR (SCENE_EDITOR_ClOSE_BEGIN)

#define SCENE_EDITOR_ClOSE_END CLOSE_USE_SCENE_EDITOR

#define CLOSE_SCENE_EDITOR_MAX (((SCENE_EDITOR_ClOSE_END) << 1) - 1)
...
#if !defined(COMPILE_SCENE_EDITOR_CLOSE) || (COMPILE_SCENE_EDITOR_CLOSE & CLOSE_USE_SCENE_EDITOR) != CLOSE_USE_SCENE_EDITOR

#endif  // !defined(COMPILE_SCENE_EDITOR_CLOSE) || (COMPILE_SCENE_EDITOR_CLOSE & CLOSE_USE_SCENE_EDITOR) != CLOSE_USE_SCENE_EDITOR
