...
Rendering::SceneGraphTestingBase::SceneGraphTestingBase(const OStreamShared& stream)
    : ParentType{ stream }
{
    RENDERING_SELF_CLASS_IS_VALID_1;
}

CLASS_INVARIANT_PARENT_IS_VALID_DEFINE(Rendering, SceneGraphTestingBase)

Rendering::SceneGraphTestingBase::Container Rendering::SceneGraphTestingBase::GetFrustum(float upFieldOfViewDegrees, float aspectRatio, float directionMin, float directionMax) noexcept
{
