...
Rendering::CameraWorldDirectionVectorConstant::CameraWorldDirectionVectorConstant(MAYBE_UNUSED CoreTools::DisableNotThrow disableNotThrow)
...
void Rendering::CameraWorldDirectionVectorConstant::SetNumRegisters(int aNumRegisters)
{
    RENDERING_CLASS_IS_VALID_1;
    RENDERING_ASSERTION_2(aNumRegisters == numRegisters, "CameraWorldDirectionVectorConstant寄存器的数量必须为1");

    ParentType::SetNumRegisters(aNumRegisters);
}

Rendering::ShaderFloatSharedPtr Rendering::CameraWorldDirectionVectorConstant::Clone() const
{
