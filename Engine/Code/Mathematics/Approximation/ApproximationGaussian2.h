...
#ifndef MATHEMATICS_APPROXIMATION_APPROXIMATION_GAUSSIAN2_H
#define MATHEMATICS_APPROXIMATION_APPROXIMATION_GAUSSIAN2_H
...
namespace Mathematics
{
    ...
    class ApproximationGaussian2 : public ApproximationQuery<Real, Algebra::Vector2<Real>>
    {
    public:
        using ClassType = ApproximationGaussian2<Real>;
        ...
        using ObservationTypeContainer = std::vector<Vector2>;
        using IndicesContainer = std::vector<int>;
        using Math = Math<Real>;

    public:
        ApproximationGaussian2() noexcept;
        ...
        /// 获取最适合的参数。
        NODISCARD OrientedBox2 GetParameters() const noexcept;
    ...
    private:
        OrientedBox2 parameters;
    };
}

#endif  // MATHEMATICS_APPROXIMATION_APPROXIMATION_GAUSSIAN2_H
