...
Network::BoostMainManagerUseThreadsTesting
	::BoostMainManagerUseThreadsTesting(const OStreamShared& osPtr)
...
void Network::BoostMainManagerUseThreadsTesting
	::MainTest()
{
...
void Network::BoostMainManagerUseThreadsTesting
	::IntSleepIncrement(IOContextType& ioContext, atomic_int& count)
{
	const auto endCount = GetTestLoopCount() + 1;
...
void Network::BoostMainManagerUseThreadsTesting
	::Int16SleepIncrement(IOContextType& ioContext, std::atomic_int16_t& count)
{
	const auto endCount = GetTestLoopCount() + 1;
