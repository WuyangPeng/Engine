...
///
///	标准：std:c++20
///	引擎版本：0.9.0.12 (2022/04/28 16:57)
...
namespace AssistTools
{
    ...
    public:
        ...
        void GenerateTo(const System::String& exportDirectory,
                        const System::String& newSolutionName,
                        const CopyrightData& copyrightData,
                        const System::String& projectCapital,
                        const System::String& aProjectName,
                        const System::String& newCoreName,
                        const System::String& CoreNameCapital) const;

    private:
        void GenerateToHeader(const System::String& exportDirectory,
                              const System::String& newSolutionName,
                              const CopyrightData& copyrightData,
                              const System::String& projectCapital) const;
        void GenerateToHelper(const System::String& exportDirectory,
                              const System::String& newSolutionName,
                              const CopyrightData& copyrightData,
                              const System::String& projectCapital) const;
        void GenerateToHelperHeader(const System::String& exportDirectory,
                                    const System::String& newSolutionName,
                                    const CopyrightData& copyrightData, const System::String& projectCapital) const;
        void GenerateToHelperSource(const System::String& exportDirectory,
                                    const System::String& newSolutionName,
                                    const CopyrightData& copyrightData,
                                    const System::String& projectCapital) const;
        void GenerateToMessage(const System::String& exportDirectory,
                               const System::String& newSolutionName,
                               const CopyrightData& copyrightData,
                               const System::String& projectCapital) const;
        void GenerateToMessageHeader(const System::String& exportDirectory,
                                     const System::String& newSolutionName,
                                     const CopyrightData& copyrightData,
                                     const System::String& projectCapital) const;
        void GenerateToMessageSource(const System::String& exportDirectory,
                                     const System::String& newSolutionName,
                                     const CopyrightData& copyrightData,
                                     const System::String& projectCapital) const;
        void GenerateToLib(const System::String& exportDirectory,
                           const System::String& newSolutionName,
                           const CopyrightData& copyrightData) const;
        void GenerateToMain(const System::String& exportDirectory,
                            const System::String& newSolutionName,
                            const CopyrightData& copyrightData,
                            const System::String& aProjectName) const;
        ...
        void GenerateToManagerMiddleLayer(const System::String& exportDirectory,
                                          const System::String& newSolutionName,
                                          const CopyrightData& copyrightData,
                                          const System::String& aManagerName,
                                          const System::String& projectCapital,
        ...
        void GenerateToManager(const System::String& exportDirectory,
                               ...
                               const CopyrightData& copyrightData,
                               const System::String& aManagerName,
                               const System::String& testFileName,
                               const System::String& resultSuffix,
                               const System::String& projectCapital,
                               const System::String& managerCapitalName) const;
        void GenerateToManagerLib(const System::String& exportDirectory,
                                  const System::String& newSolutionName,
                                  const CopyrightData& copyrightData,
                                  const System::String& aManagerName,
                                  const System::String& projectCapital,
        ...
        void GenerateToManagerMacro(const System::String& exportDirectory,
                                    ...
                                    const System::String& projectCapital,
                                    const System::String& managerCapitalName) const;
        void GenerateToManagerEngine(const System::String& exportDirectory,
                                     const System::String& newSolutionName,
                                     const CopyrightData& copyrightData,
                                     const System::String& projectCapital) const;
        void GenerateToManagerEngine(const System::String& exportDirectory,
                                     ...
                                     const CopyrightData& copyrightData,
                                     const System::String& aManagerName,
                                     const System::String& managerInterfaceName,
                                     const System::String& projectCapital,
                                     const System::String& managerCapitalName) const;
        void GenerateToMiddleLayerEngine(const System::String& exportDirectory,
                                         const System::String& newSolutionName,
                                         const CopyrightData& copyrightData,
                                         const System::String& aManagerName,
                                         const System::String& managerInterfaceName,
                                         const System::String& projectCapital,
                                         const System::String& managerCapitalName) const;
        void GenerateToInputManagerEngine(const System::String& exportDirectory,
                                          const System::String& newSolutionName,
                                          const CopyrightData& copyrightData,
                                          const System::String& aManagerName,
                                          const System::String& managerInterfaceName,
                                          const System::String& projectCapital,
                                          const System::String& managerCapitalName) const;
        void GenerateToCoreEngine(const System::String& exportDirectory,
                                  const System::String& newSolutionName,
                                  const CopyrightData& copyrightData,
                                  const System::String& aManagerName,
                                  const System::String& projectCapital,
