...
namespace Mathematics
{
    ...
    template <typename Real>
    NODISCARD bool Approximate(const Box2<Real>& lhs, const Box2<Real>& rhs, const Real epsilon) noexcept(g_Assert < 1 || g_MathematicsAssert < 1);
