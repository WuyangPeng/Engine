...
#ifndef PLAYER_SERVER_MIDDLE_LAYER_NETWORK_MIDDLE_LAYER_NETWORK_H
#define PLAYER_SERVER_MIDDLE_LAYER_NETWORK_MIDDLE_LAYER_NETWORK_H
...
{
    class PLAYER_SERVER_MIDDLE_LAYER_DEFAULT_DECLARE NetworkManager final : public Framework::NetworkManagerInterface
    {
    public:
...
#endif  // PLAYER_SERVER_MIDDLE_LAYER_NETWORK_MIDDLE_LAYER_NETWORK_H
