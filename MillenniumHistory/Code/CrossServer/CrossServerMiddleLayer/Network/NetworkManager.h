...
#ifndef CROSS_SERVER_MIDDLE_LAYER_NETWORK_MIDDLE_LAYER_NETWORK_H
#define CROSS_SERVER_MIDDLE_LAYER_NETWORK_MIDDLE_LAYER_NETWORK_H
...
{
    class CROSS_SERVER_MIDDLE_LAYER_DEFAULT_DECLARE NetworkManager final : public Framework::NetworkManagerInterface
    {
    public:
...
#endif  // CROSS_SERVER_MIDDLE_LAYER_NETWORK_MIDDLE_LAYER_NETWORK_H
