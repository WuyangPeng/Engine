...
CORE_TOOLS_STATIC_OBJECT_FACTORY_DEFINE(Rendering, PointLightEffect);
CORE_TOOLS_FACTORY_DEFINE(Rendering, PointLightEffect);

Rendering::PointLightEffect::PointLightEffect(ProgramFactory& factory,
...
CLASS_INVARIANT_PARENT_IS_VALID_DEFINE(Rendering, PointLightEffect)

Rendering::PointLightEffect::PointLightEffect(LoadConstructor loadConstructor)
    : ParentType{ loadConstructor }
{
    RENDERING_SELF_CLASS_IS_VALID_9;
}

void Rendering::PointLightEffect::UpdateMaterialConstant()
{
...
void Rendering::PointLightEffect::UpdateLightingConstant()
{
    RENDERING_CLASS_IS_VALID_9;
...
void Rendering::PointLightEffect::UpdateGeometryConstant()
{
    RENDERING_CLASS_IS_VALID_9;
