...
void CoreTools::AssertTestApproximateTesting::AssertApproximateMessageTest()
{
    ...
    ASSERT_APPROXIMATE_USE_MESSAGE(lhsExpression, lhsExpression, Mathematics::MathF::GetZeroTolerance(), "测试");
    ASSERT_APPROXIMATE_USE_FUNCTION_AND_MESSAGE(ClassType::Approximate, lhsExpression, rhsExpression, Mathematics::MathF::GetZeroTolerance(), "测试");
}
...
void CoreTools::AssertTestApproximateTesting::AssertApproximateFailureThrowTest()
{
    ...
    ASSERT_APPROXIMATE_FAILURE_THROW(lhsExpression, lhsExpression, Mathematics::MathF::GetZeroTolerance(), "测试");
    ASSERT_APPROXIMATE_USE_FUNCTION_FAILURE_THROW(ClassType::Approximate, lhsExpression, rhsExpression, Mathematics::MathF::GetZeroTolerance(), "测试");
}
...
void CoreTools::AssertTestApproximateTesting::AssertApproximateFloatZeroTest()
{
    ...
    ASSERT_APPROXIMATE_FLOAT_ZERO_USE_MESSAGE(0.0f, "测试");
    ASSERT_APPROXIMATE_FLOAT_ZERO_FAILURE_THROW(0.0f, "测试");
}

void CoreTools::AssertTestApproximateTesting::AssertApproximateDoubleZeroTest()
{
    ASSERT_APPROXIMATE_DOUBLE_ZERO(0.0);
    ASSERT_APPROXIMATE_DOUBLE_ZERO_USE_MESSAGE(0.0, "测试");
    ASSERT_APPROXIMATE_DOUBLE_ZERO_FAILURE_THROW(0.0, "测试");
}
