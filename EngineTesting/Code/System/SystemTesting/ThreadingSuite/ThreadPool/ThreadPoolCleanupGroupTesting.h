...
// ◊˜’ﬂ£∫≈ÌŒ‰—Ù£¨≈ÌÍ ∂˜£¨≈ÌÍ ‘Û
// 
// “˝«Ê≤‚ ‘∞Ê±æ£∫0.0.2.1 (2020/01/14 10:22)

#ifndef SYSTEM_THREADING_SUITE_THREAD_POOL_CLEANUP_GROUP_TESTING_H
#define SYSTEM_THREADING_SUITE_THREAD_POOL_CLEANUP_GROUP_TESTING_H
...
namespace System
{
	class ThreadPoolCleanupGroupTesting : public CoreTools::UnitTest
	{
	public:
		UNIT_TEST_SUBCLASS_COMPLETE_DECLARE(ThreadPoolCleanupGroupTesting);
...
#endif // SYSTEM_THREADING_SUITE_THREAD_POOL_CLEANUP_GROUP_TESTING_H