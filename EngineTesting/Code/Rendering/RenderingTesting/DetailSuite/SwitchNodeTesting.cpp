...
//
// ÒýÇæ²âÊÔ°æ±¾£º0.0.0.3 (2019/09/06 16:44)
...
void Rendering::SwitchNodeTesting::InitTest()
{
    auto firstNode = SwitchNode::Create();
...
void Rendering::SwitchNodeTesting::CopyTest()
{
...
void Rendering::SwitchNodeTesting::TransformTest()
{
    // 	SwitchNode firstNode;
    // 	ControllerInterfaceSharedPtr secondNode(new SwitchNode);
    // 	firstNode->AttachController(secondNode);
...
void Rendering::SwitchNodeTesting::ChildTest()
{
...
void Rendering::SwitchNodeTesting::StreamTest()
{
    // 	CoreTools::OutTopLevel outTopLevel;
    // 	CoreTools::ObjectInterfaceSharedPtr firstNode(new SwitchNode);
    //
