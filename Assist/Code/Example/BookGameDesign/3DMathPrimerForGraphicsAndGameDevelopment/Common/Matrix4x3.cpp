...
namespace ThreeDMathPrimerForGraphicsAndGameDevelopment
{
	...
	void Matrix4x3::identity() noexcept
	{
	...
	void Matrix4x3::zeroTranslation() noexcept
	{
		tx = ty = tz = 0.0f;
	}
	...
	void Matrix4x3::setTranslation(const Vector3& d) noexcept
	{
	...
	void Matrix4x3::setupTranslation(const Vector3& d) noexcept
	{
	...
	void Matrix4x3::setupLocalToParent(const Vector3& pos, const EulerAngles& orient) noexcept
	{
	...
	void Matrix4x3::setupLocalToParent(const Vector3& pos, const RotationMatrix& orient) noexcept
	{
	...
	void Matrix4x3::setupParentToLocal(const Vector3& pos, const EulerAngles& orient) noexcept
	{
	...
	void Matrix4x3::setupParentToLocal(const Vector3& pos, const RotationMatrix& orient) noexcept
	{
	...
	void Matrix4x3::setupRotate(int axis, float theta) noexcept
	{
	...
	void Matrix4x3::setupRotate(const Vector3& axis, float theta) noexcept
	{
	...
	void Matrix4x3::fromQuaternion(const Quaternion& q) noexcept
	{
	...
	void Matrix4x3::setupScale(const Vector3& s) noexcept
	{
	...
	void Matrix4x3::setupScaleAlongAxis(const Vector3& axis, float k) noexcept
	{
	...
	void Matrix4x3::setupShear(int axis, float s, float t) noexcept
	{
	...
	void Matrix4x3::setupProject(const Vector3& n) noexcept
	{
	...
	void Matrix4x3::setupReflect(int axis, float k) noexcept
	{
	...
	void Matrix4x3::setupReflect(const Vector3& n) noexcept
	{
	...
	Vector3	operator*(const Vector3& p, const Matrix4x3& m) noexcept
	{
	...
	Vector3& operator*=(Vector3& p, const Matrix4x3& m) noexcept
	{
		p = p * m;
		return p;
	}
	...
	Matrix4x3 operator*(const Matrix4x3& a, const Matrix4x3& b) noexcept
	{
	...
	Matrix4x3& operator*=(Matrix4x3& a, const Matrix4x3& b) noexcept
	{
		a = a * b;
		return a;
	}
	...
	float determinant(const Matrix4x3& m) noexcept
	{
		return
	...
	Matrix4x3 inverse(const Matrix4x3& m) noexcept
	{
	...
	Vector3	getTranslation(const Matrix4x3& m) noexcept
	{
	...
	Vector3	getPositionFromParentToLocalMatrix(const Matrix4x3& m) noexcept
	{
	...
	Vector3	getPositionFromLocalToParentMatrix(const Matrix4x3& m) noexcept
	{
