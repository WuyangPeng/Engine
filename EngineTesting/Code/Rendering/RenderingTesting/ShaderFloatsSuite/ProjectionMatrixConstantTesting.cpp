...
// 	ProjectionMatrixConstantSharedPtr firstShaderFloat(new ProjectionMatrixConstant);
// 
// 	for (int i = 0; i < 16;++i)
// 	{	 
...
// 
// 	ProjectionMatrixConstantSharedPtr secondShaderFloat =
// 		inTopLevel[0].PolymorphicDowncastObjectSharedPtr<ProjectionMatrixConstantSharedPtr>();
// 
...
// 
// 		const Mathematics::Matrixf projectionMatrix = firstCamera.GetProjectionMatrix();	
// 		
// 		for(int i = 0;i < 16;++i)
// 		{
// 			ASSERT_APPROXIMATE(projectionMatrix[i / 16][i % 16], firstShaderFloat[i], 1e-8f);
// 		}
// 	}
}
