...
DatabaseGenerateServerBaseTesting::GenusEntityTesting::GenusEntityTesting(const OStreamShared& stream, const GenusContainer& genusContainer)
...
void DatabaseGenerateServerBaseTesting::GenusEntityTesting::SelectOneTest(DatabaseFlush& databaseFlush)
{
    auto index = 0;
...
void DatabaseGenerateServerBaseTesting::GenusEntityTesting::SelectAllTest(DatabaseFlush& databaseFlush)
{
...
void DatabaseGenerateServerBaseTesting::GenusEntityTesting::SelectAllSizeTest(const DatabaseFlush& databaseFlush)
{
    const auto database = databaseFlush.SelectAll(GenusEntity::GetSelectAll(databaseFlush.GetWrappersStrategy()),
                                                  GenusEntity::GetDatabaseFieldContainer());
...
void DatabaseGenerateServerBaseTesting::GenusEntityTesting::SetEntity(GenusEntity& genusEntity, const Genus& genus)
{
...
void DatabaseGenerateServerBaseTesting::GenusEntityTesting::DoSelectOneTest(DatabaseFlush& databaseFlush, const Genus& genus)
{
...
void DatabaseGenerateServerBaseTesting::GenusEntityTesting::DoSelectAllTest(DatabaseFlush& databaseFlush, const Genus& genus, const EntityContainer& entityContainer)
{
...
void DatabaseGenerateServerBaseTesting::GenusEntityTesting::EqualTest(const Genus& genus, const EntityContainer& entityContainer)
{
    const auto result = entityContainer.find(genus.GetId());
