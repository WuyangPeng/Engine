...
bool AssistTools::MtlLoader
	::GetColor(const vector<string>& tokens, float color[3])
{
...
bool AssistTools::MtlLoader
	::GetTexture(const vector<string>& tokens, Texture& texture)
{
...
bool AssistTools::MtlLoader
	::GetBoolArg(const vector<string>& tokens, int imax, int& i,bool& value)
{
    if (++i > imax)
    {
        assert(false);
...
bool AssistTools::MtlLoader
	::GetFloatArg3Opt2(const vector<string>& tokens, int imax,
...
bool AssistTools::MtlLoader
	::GetNewMaterial(const vector<string>& tokens)
{
    // Syntax
    //
    // newmtl name
...
bool AssistTools::MtlLoader
	::GetIlluminationModel(const vector<string>& tokens)
{
    // Syntax
    //
    // illum modelNumber
...
bool AssistTools::MtlLoader
	::GetAmbientColor(const vector<string>& tokens)
{
...
bool AssistTools::MtlLoader
	::GetDiffuseColor(const vector<string>& tokens)
{
    // Syntax (only the first is implemented).
    //
    // Kd r [g] [b]
...
bool AssistTools::MtlLoader
	::GetSpecularColor(const vector<string>& tokens)
{
    // Syntax (only the first is implemented).
    //
    // Ks r [g] [b]
...
bool AssistTools::MtlLoader
	::GetTransmissionFilter(const vector<string>& tokens)
{
    // Syntax (only the first is implemented).
    //
    // Tf r [g] [b]
...
bool AssistTools::MtlLoader
	::GetOpticalDensity(const vector<string>& tokens)
{
    // Syntax
    //
    // Ni opticalDensity
...
bool AssistTools::MtlLoader
	::GetSpecularExponent(const vector<string>& tokens)
{
    // Syntax
    //
    // Ns exponent
...
bool AssistTools::MtlLoader
	::GetAmbientTexture(const vector<string>& tokens)
{
    // Syntax
    //
...
bool AssistTools::MtlLoader
	::GetDiffuseTexture(const vector<string>& tokens)
{
    // Syntax
    //
...
bool AssistTools::MtlLoader
	::GetSpecularTexture(const vector<string>& tokens)
{
    // Syntax
    //
    // map_Kd [options] filename
