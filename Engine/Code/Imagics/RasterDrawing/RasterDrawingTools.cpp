...
void Imagics ::Line2D(int x0, int y0, int x1, int y1, void (*callback)(int, int)) noexcept
{
...
void Imagics ::Line3D(int x0, int y0, int z0, int x1, int y1, int z1,
...
void Imagics ::Line4D(int x0, int y0, int z0, int w0, int x1, int y1, int z1,
...
void Imagics ::Circle2D(int xc, int yc, int radius, void (*callback)(int, int)) noexcept
{
...
void Imagics ::Ellipse2D(int xc, int yc, int A, int B, void (*callback)(int, int)) noexcept
{
...
void Imagics ::EllipseArc2D(int xc, int yc, int A, int B, float fx0,
...
void Imagics ::GeneralEllipse2D(int xc, int yc, int xa, int ya, int xb, int yb,
...
void Imagics ::RecursiveFill(int x, int y, int xMax, int yMax, int** image,
...
void Imagics ::NonrecursiveFill(int x, int y, int xMax, int yMax,
                                int** image, int foreColor, int backColor)
{
    ...
    int* xStack = nullptr;  //NEW1<int>(quantity);
    int* yStack = nullptr;  //NEW1<int>(quantity);
