...
#define CLOSE_USE_MIDDLE_LAYER_CORE (GAME_CLIENT_MIDDLE_LAYER_ClOSE_BEGIN)

#define GAME_CLIENT_MIDDLE_LAYER_ClOSE_END CLOSE_USE_MIDDLE_LAYER_CORE
...
#if !defined(COMPILE_GAME_CLIENT_MIDDLE_LAYER_CLOSE) || (COMPILE_GAME_CLIENT_MIDDLE_LAYER_CLOSE & CLOSE_USE_MIDDLE_LAYER_CORE) != CLOSE_USE_MIDDLE_LAYER_CORE

#endif  // !defined(COMPILE_GAME_CLIENT_MIDDLE_LAYER_CLOSE) || (COMPILE_GAME_CLIENT_MIDDLE_LAYER_CLOSE & CLOSE_USE_MIDDLE_LAYER_CORE) != CLOSE_USE_MIDDLE_LAYER_CORE
