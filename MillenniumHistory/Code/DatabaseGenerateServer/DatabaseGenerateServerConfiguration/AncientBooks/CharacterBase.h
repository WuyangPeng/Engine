...
namespace AncientBooks
{
    ...
    public:
        ...
        NODISCARD virtual std::shared_ptr<const IdentityMappingType> GetIdentity(MAYBE_UNUSED const AncientBooksContainer& csvContainer) const;
        ...
        NODISCARD virtual int GetFosterFather(MAYBE_UNUSED int index) const;
        ...
        NODISCARD virtual int GetFosterMother(MAYBE_UNUSED int index) const;
        ...
        NODISCARD virtual std::shared_ptr<const YearMappingType> GetBirthYear(MAYBE_UNUSED const AncientBooksContainer& csvContainer) const;

        NODISCARD virtual int GetBirthMonth() const noexcept;
        NODISCARD virtual std::shared_ptr<const MonthMappingType> GetBirthMonth(MAYBE_UNUSED const AncientBooksContainer& csvContainer) const;

        NODISCARD virtual int GetBirthSexagenaryCycle() const noexcept;
        NODISCARD virtual std::shared_ptr<const SexagenaryCycleMappingType> GetBirthSexagenaryCycle(MAYBE_UNUSED const AncientBooksContainer& csvContainer) const;

        NODISCARD virtual int GetBirthDay() const noexcept;
        NODISCARD virtual std::shared_ptr<const DayMappingType> GetBirthDay(MAYBE_UNUSED const AncientBooksContainer& csvContainer) const;

        NODISCARD virtual int GetDeathYear() const noexcept;
        NODISCARD virtual std::shared_ptr<const YearMappingType> GetDeathYear(MAYBE_UNUSED const AncientBooksContainer& csvContainer) const;

        NODISCARD virtual int GetDeathMonth() const noexcept;
        NODISCARD virtual std::shared_ptr<const MonthMappingType> GetDeathMonth(MAYBE_UNUSED const AncientBooksContainer& csvContainer) const;

        NODISCARD virtual int GetDeathSexagenaryCycle() const noexcept;
        NODISCARD virtual std::shared_ptr<const SexagenaryCycleMappingType> GetDeathSexagenaryCycle(MAYBE_UNUSED const AncientBooksContainer& csvContainer) const;

        NODISCARD virtual int GetDeathDay() const noexcept;
        NODISCARD virtual std::shared_ptr<const DayMappingType> GetDeathDay(MAYBE_UNUSED const AncientBooksContainer& csvContainer) const;
