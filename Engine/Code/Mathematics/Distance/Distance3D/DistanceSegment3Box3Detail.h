...
Mathematics::DistanceSegment3Box3<Real>
	::DistanceSegment3Box3(const Segment3& segment, const Box3& box)
	:ParentType{}, mSegment{ segment }, mBox{ box }
{
}

template <typename Real>
const Mathematics::Segment3<Real>& Mathematics::DistanceSegment3Box3<Real>
	::GetSegment() const
{
	return mSegment;
}
...
template <typename Real>
const Mathematics::Box3<Real>& Mathematics::DistanceSegment3Box3<Real>
	::GetBox() const
{
	return mBox;
}
...
template <typename Real>
typename const Mathematics::DistanceSegment3Box3<Real>::DistanceResult Mathematics::DistanceSegment3Box3<Real>
	::GetSquared() const
{
	...
	::GetSquared(Real t, const Vector3D& lhsVelocity, const Vector3D& rhsVelocity) const
{
	...
	Box3 movedBox{ movedCenter1,mBox.GetAxis0(),mBox.GetAxis1(),mBox.GetAxis2(),
				   mBox.GetExtent0(), mBox.GetExtent1(),mBox.GetExtent2() };
	return DistanceSegment3Box3<Real>{ movedSegment, movedBox }.GetSquared();
}
