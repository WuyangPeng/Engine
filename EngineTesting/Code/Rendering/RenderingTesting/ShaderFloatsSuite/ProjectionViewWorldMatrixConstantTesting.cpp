...
Rendering::ProjectionViewWorldMatrixConstantTesting::ProjectionViewWorldMatrixConstantTesting(const OStreamShared& stream)
    : ParentType{ stream }
{
    RENDERING_SELF_CLASS_IS_VALID_1;
}

CLASS_INVARIANT_PARENT_IS_VALID_DEFINE(Rendering, ProjectionViewWorldMatrixConstantTesting)

void Rendering::ProjectionViewWorldMatrixConstantTesting::DoRunUnitTest()
{
    ASSERT_NOT_THROW_EXCEPTION_0(MainTest);
}

void Rendering::ProjectionViewWorldMatrixConstantTesting::MainTest()
{
...
void Rendering::ProjectionViewWorldMatrixConstantTesting::InitTest()
{
    constexpr int numRegisters = 4;
    ProjectionViewWorldMatrixConstant firstShaderFloat{ CoreTools::DisableNotThrow::Disable };
    ...
    const ProjectionViewWorldMatrixConstant secondShaderFloat{ CoreTools::DisableNotThrow::Disable };
    ...
    ProjectionViewWorldMatrixConstant thirdShaderFloat{ CoreTools::DisableNotThrow::Disable };
...
void Rendering::ProjectionViewWorldMatrixConstantTesting::CopyTest()
{
    ProjectionViewWorldMatrixConstant firstShaderFloat{ CoreTools::DisableNotThrow::Disable };
...
void Rendering::ProjectionViewWorldMatrixConstantTesting::StreamTest() noexcept
{
}

void Rendering::ProjectionViewWorldMatrixConstantTesting::UpdateTest() noexcept
{
}
