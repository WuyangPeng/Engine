...
void Mathematics::RationalTesting
	::MainTest()
{
	...
	::AccessTest()
{
	...
	for (auto loop = 0; loop < testLoopCount; ++loop)
	{
		...
		ASSERT_EQUAL_DO_NOT_USE_MESSAGE(thirdInteger,firstRational.GetNumerator());
		ASSERT_EQUAL_DO_NOT_USE_MESSAGE(firstInteger, firstRational.GetDenominator());
