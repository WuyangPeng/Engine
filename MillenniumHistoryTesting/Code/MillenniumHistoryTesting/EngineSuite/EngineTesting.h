...
///
///	标准：std:c++20
///	千年史策测试版本：0.9.0.5 (2023/04/03 11:48)

#ifndef MILLENNIUM_HISTORY_TESTING_ENGINE_TESTING_H
#define MILLENNIUM_HISTORY_TESTING_ENGINE_TESTING_H
...
#endif  // MILLENNIUM_HISTORY_TESTING_ENGINE_TESTING_H