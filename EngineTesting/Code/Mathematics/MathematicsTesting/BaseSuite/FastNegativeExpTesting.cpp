...
void Mathematics::FastNegativeExpTesting::FloatFastExpTest()
{
    ...
    std::uniform_real_distribution<float> randomDistribution{ MathF::GetValue(0), MathF::GetExponent() };
...
void Mathematics::FastNegativeExpTesting::DoubleFastExpTest()
{
    // 随机值测试
    std::default_random_engine randomEngine{ GetEngineRandomSeed() };
    std::uniform_real_distribution<double> randomDistribution{ MathD::GetValue(0), MathD::GetExponent() };
...
void Mathematics::FastNegativeExpTesting::FloatFastExpBoundaryTest()
{
    // 随机值测试
    std::default_random_engine randomEngine{ GetEngineRandomSeed() };
    std::uniform_real_distribution<float> randomDistribution{ MathF::GetExponent(), MathF::maxReal };
...
void Mathematics::FastNegativeExpTesting::DoubleFastExpBoundaryTest()
{
    // 随机值测试
    std::default_random_engine randomEngine{ GetEngineRandomSeed() };
    std::uniform_real_distribution<double> randomDistribution{ MathD::GetExponent(), MathD::maxReal };
