...
namespace Mathematics
{
    ...
    public:
        ...
        Line2(const Vector2& origin, const Vector2& direction, const Real epsilon = Math::GetZeroTolerance()) noexcept;
    ...
    template <typename Real>
    NODISCARD bool Approximate(const Line2<Real>& lhs, const Line2<Real>& rhs, const Real epsilon) noexcept(g_Assert < 1 || g_MathematicsAssert < 1);
