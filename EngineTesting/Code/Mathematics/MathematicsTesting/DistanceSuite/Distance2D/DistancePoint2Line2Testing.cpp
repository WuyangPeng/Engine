...
#include "Mathematics/Distance/Distance2D/DistancePoint2Line2Detail.h"
...
Mathematics::DistancePoint2Line2Testing::DistancePoint2Line2Testing(const OStreamShared& streamShared)
    : ParentType{ streamShared }
{
    MATHEMATICS_SELF_CLASS_IS_VALID_1;
}

CLASS_INVARIANT_PARENT_IS_VALID_DEFINE(Mathematics, DistancePoint2Line2Testing)

void Mathematics::DistancePoint2Line2Testing::DoRunUnitTest()
{
...
void Mathematics::DistancePoint2Line2Testing::BaseTest()
{
    ...
    for (auto loop = 0; loop < aTestLoopCount; ++loop)
    {
        ...
        DistancePoint2Line2<float> distance(point, Line2F(rhsOrigin, rhsDirection));
        ...
        ASSERT_APPROXIMATE_USE_FUNCTION(Approximate<float>, distance.GetLine(), Line2F(rhsOrigin, rhsDirection), 1e-8f);
    }
}
