...
// 
// ÒýÇæ°æ±¾£º0.0.0.3 (2019/07/25 14:29)
...
{
	VertexShaderSmartPointer vshader{ NEW0 VertexShader{ "Wm5.Texture2ColorBlend",3, 3, 1, 0 } };
	...
	PixelShaderSmartPointer pshader{ NEW0 PixelShader("Wm5.Texture2ColorBlend",2, 1, 0, 2) };
...
{
    Texture2ColorBlendEffect* effect = CoreTools::New0 < Texture2ColorBlendEffect>();
...
int* Rendering::Texture2ColorBlendEffect::msVRegisters[ShaderFlags::MaxProfiles]  
{
    0,
    msDx9VRegisters,
    msDx9VRegisters,
...
std::string Rendering::Texture2ColorBlendEffect::msVPrograms[ShaderFlags::MaxProfiles]  
{ 
    // VP_NONE
    "",
...
int* Rendering::Texture2ColorBlendEffect::msPTextureUnits[ShaderFlags::MaxProfiles]  
{
    0,
    msAllPTextureUnits,
    msAllPTextureUnits,
...
std::string Rendering::Texture2ColorBlendEffect::msPPrograms[ShaderFlags::MaxProfiles]  
{
    // PP_NONE
    "",
