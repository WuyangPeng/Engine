...
Framework::WindowPictorialTesting
	::WindowPictorialTesting(const OStreamShared& stream, HInstance hInstance)
	:ParentType{ stream }, m_Instance{ hInstance },
	 ...
	 m_CursorContainer{ { 0, System::g_Arrow },
					    ...
					    { 32651, System::g_Help } },
	 m_BrushContainer{ System::WindowBrushTypes::WhiteBrush,
...
bool Framework::WindowPictorialTesting
	...
	::BrushTest()
{
	...
	TestingType nullPictorial{ System::WindowBrushTypes::Null };
...
void Framework::WindowPictorialTesting
	::RandomContainer(default_random_engine& generator)
{
...
void Framework::WindowPictorialTesting
	::NextIcon(default_random_engine& generator)
{
	++m_IconIter;
...
void Framework::WindowPictorialTesting
	::NextCursor(default_random_engine& generator)
{
	++m_CursorIter;
...
void Framework::WindowPictorialTesting
	::NextBrush(default_random_engine& generator)
{
	++m_BrushIter;
