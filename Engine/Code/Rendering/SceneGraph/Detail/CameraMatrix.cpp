...
Rendering::CameraMatrix
    ...
    : m_WorldCoordinateFrame{ worldCoordinateFrame }, m_CameraFrustum{ cameraFrustum }, m_PreViewMatrix{ Mathematics::FloatMatrix::GetIdentityMatrix() }, m_PreViewIsIdentity{ true },
      m_PostProjectionMatrix{ Mathematics::FloatMatrix::GetIdentityMatrix() }, m_PostProjectionIsIdentity{ true }, m_DepthType{ CAMERA_MANAGE_SINGLETON.GetDepthType() }, m_Epsilon{ epsilon }
{
    OnFrustumChange();
...
Rendering::CameraMatrix
    ...
    : m_WorldCoordinateFrame{ epsilon }, m_CameraFrustum{ true }, m_PreViewMatrix{ Mathematics::FloatMatrix::GetIdentityMatrix() }, m_PreViewIsIdentity{ true },
      m_PostProjectionMatrix{ Mathematics::FloatMatrix::GetIdentityMatrix() }, m_PostProjectionIsIdentity{ true }, m_DepthType{ CAMERA_MANAGE_SINGLETON.GetDepthType() }, m_Epsilon{ epsilon }
{
    OnFrustumChange();
    ...
    ::SetProjectionMatrix (const APoint& p00, const APoint& p10,const APoint& p11, const APoint& p01,float nearExtrude, float farExtrude)
{
    ...
    // 计算最近面的视图体积
    auto q000 = Mathematics::FloatAPoint::GetOrigin() + nearExtrude * (p00 - Mathematics::FloatAPoint::GetOrigin());
    auto q100 = Mathematics::FloatAPoint::GetOrigin() + nearExtrude * (p10 - Mathematics::FloatAPoint::GetOrigin());
    auto q110 = Mathematics::FloatAPoint::GetOrigin() + nearExtrude * (p11 - Mathematics::FloatAPoint::GetOrigin());
    auto q010 = Mathematics::FloatAPoint::GetOrigin() + nearExtrude * (p01 - Mathematics::FloatAPoint::GetOrigin());
    
    // 计算最远面的视图体积
    auto q001 = Mathematics::FloatAPoint::GetOrigin() + farExtrude * (p00 - Mathematics::FloatAPoint::GetOrigin());
    auto q101 = Mathematics::FloatAPoint::GetOrigin() + farExtrude * (p10 - Mathematics::FloatAPoint::GetOrigin());
    auto q111 = Mathematics::FloatAPoint::GetOrigin() + farExtrude * (p11 - Mathematics::FloatAPoint::GetOrigin());
    auto q011 = Mathematics::FloatAPoint::GetOrigin() + farExtrude * (p01 - Mathematics::FloatAPoint::GetOrigin());
    ...
    ::SetPreViewMatrix (const Matrix& preViewMatrix)
{
    ...
    m_PreViewIsIdentity = Approximate(m_PreViewMatrix, Mathematics::FloatMatrix::GetIdentityMatrix(), m_Epsilon);
    ...
    ::SetPostProjectionMatrix (const Matrix& postProjMatrix)
{
    ...
    m_PostProjectionIsIdentity = Approximate(m_PostProjectionMatrix, Mathematics::FloatMatrix::GetIdentityMatrix(), m_Epsilon);
