...
void CoreTools::AssertNotThrowExceptionTesting::AssertExceptionMacroTest()
{
    ...
    ASSERT_NOT_THROW_EXCEPTION_USE_MESSAGE_2(AssertNotThrowExceptionTestWith2Parameter, parameter0, parameter1, "测试AssertExceptionMacro");
    ASSERT_NOT_THROW_EXCEPTION_USE_MESSAGE_3(AssertNotThrowExceptionTestWith3Parameter, parameter0, parameter1, parameter2, "测试AssertExceptionMacro");
}
