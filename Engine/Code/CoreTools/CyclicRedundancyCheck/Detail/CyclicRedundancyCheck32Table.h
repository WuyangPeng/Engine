...
namespace CoreTools
{
    ...
    private:
        ...
        NODISCARD constexpr static uint32_t Calculate32(const uint32_t index) noexcept
        {
            auto value = index;
    ...
    private:
        ...
        using TableType = std::array<uint32_t, tableSize>;
...
#endif  // CORE_TOOLS_CYCLIC_REDUNDANCY_CHECK_CYCLIC_REDUNDANCY_CHECK_32_TABLE_H
