...
const Mathematics::Matrix2<Real> Mathematics::Matrix2<Real>::sm_Zero{ MatrixInitType::Zero };
...
template <typename Real>
Mathematics::Matrix2<Real>::Matrix2(const std::vector<Real>& entry, MatrixMajorFlags majorFlag)
    : m_Entry{}
{
...
template <typename Real>
Mathematics::Matrix2<Real>::Matrix2(const Vector2D& firstVector, const Vector2D& secondVector, MatrixMajorFlags majorFlag)
    : m_Entry{}
{
    if (majorFlag == MatrixMajorFlags::Row)
    {
...
template <typename Real>
Mathematics::Matrix2<Real>::Matrix2(const std::vector<Vector2D>& vectors, MatrixMajorFlags majorFlag)
    : m_Entry{}
{
...
template <typename Real>
Mathematics::Matrix2<Real>::Matrix2(Real member00, Real member11)
...
template <typename Real>
Mathematics::Matrix2<Real>::Matrix2(Real angle)
    : m_Entry{}
{
    MakeRotation(angle);
...
template <typename Real>
Mathematics::Matrix2<Real>::Matrix2(const Vector2D& firstVector, const Vector2D& secondVector)
    : m_Entry{}
{
...
template <typename Real>
void Mathematics::Matrix2<Real>::MakeZero()
{
...
template <typename Real>
void Mathematics::Matrix2<Real>::MakeDiagonal(Real member00, Real member11)
{
    MATHEMATICS_CLASS_IS_VALID_9;
...
template <typename Real>
void Mathematics::Matrix2<Real>::MakeRotation(Real angle)
{
    MATHEMATICS_CLASS_IS_VALID_9;
...
template <typename Real>
void Mathematics::Matrix2<Real>::MakeTensorProduct(const Vector2D& lhs, const Vector2D& rhs)
{
    MATHEMATICS_CLASS_IS_VALID_9;
...
template <typename Real>
const Mathematics::Matrix2<Real> Mathematics::Matrix2<Real>::operator-() const
{
...
template <typename Real>
const Real* Mathematics::Matrix2<Real>::operator[](int row) const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
Real* Mathematics::Matrix2<Real>::operator[](int row)
{
    MATHEMATICS_CLASS_IS_VALID_9;
    MATHEMATICS_ASSERTION_0(0 <= row && row < 2, "索引错误！");
...
template <typename Real>
Mathematics::Matrix2<Real>& Mathematics::Matrix2<Real>::operator+=(const Matrix2& rhs)
{
    MATHEMATICS_CLASS_IS_VALID_9;
...
template <typename Real>
Mathematics::Matrix2<Real>& Mathematics::Matrix2<Real>::operator*=(Real scalar)
{
    MATHEMATICS_CLASS_IS_VALID_9;
...
template <typename Real>
Real Mathematics::Matrix2<Real>::QuadraticForm(const Vector2D& lhs, const Vector2D& rhs) const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
const Mathematics::Matrix2<Real> Mathematics::Matrix2<Real>::Transpose() const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
const Mathematics::Matrix2<Real> Mathematics::Matrix2<Real>::Adjoint() const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
Real Mathematics::Matrix2<Real>::Determinant() const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
Real Mathematics::Matrix2<Real>::ExtractAngle() const
{
    // 矩阵必须是旋转矩阵！
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
template <typename Real>
typename const Mathematics::Matrix2<Real>::Matrix2EigenDecomposition Mathematics::Matrix2<Real>::EigenDecomposition(const Real epsilon) const
{
    MATHEMATICS_CLASS_IS_VALID_CONST_9;
...
void Mathematics::Matrix2<T>::Set(const ArrayType& coordinate) noexcept
{
    ...
    {
        m_Entry(i / 2, i % 2) = coordinate.at(i);
    }
}

template <typename Real>
const Mathematics::Matrix2<Real> Mathematics ::operator*(const Matrix2<Real>& lhs, const Matrix2<Real>& rhs)
{
    // A * B
...
template <typename Real>
const Mathematics::Vector2D<Real> Mathematics ::operator*(const Matrix2<Real>& matrix, const Vector2D<Real>& vector)
{
    return Vector2D<Real>{ matrix(0, 0) * vector[0] + matrix(0, 1) * vector[1], matrix(1, 0) * vector[0] + matrix(1, 1) * vector[1] };
}

template <typename Real>
const Mathematics::Vector2D<Real> Mathematics ::operator*(const Vector2D<Real>& vector, const Matrix2<Real>& matrix)
{
    return Vector2D<Real>{ vector[0] * matrix(0, 0) + vector[1] * matrix(1, 0), vector[0] * matrix(0, 1) + vector[1] * matrix(1, 1) };
}

template <typename Real>
const Mathematics::Matrix2<Real> Mathematics ::TransposeTimes(const Matrix2<Real>& lhs, const Matrix2<Real>& rhs)
{
    // lhs^T * rhs
...
template <typename Real>
const Mathematics::Matrix2<Real> Mathematics ::TimesTranspose(const Matrix2<Real>& lhs, const Matrix2<Real>& rhs)
{
    // lhs * rhs^T
...
template <typename Real>
const Mathematics::Matrix2<Real> Mathematics ::TransposeTimesTranspose(const Matrix2<Real>& lhs, const Matrix2<Real>& rhs)
{
    // lhs^T * rhs^T
...
template <typename Real>
bool Mathematics ::Approximate(const Matrix2<Real>& lhs, const Matrix2<Real>& rhs, const Real epsilon)
{
...
template <typename Real>
bool Mathematics ::Approximate(const Matrix2<Real>& lhs, const Matrix2<Real>& rhs)
{
