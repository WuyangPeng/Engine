...
DatabaseGenerateCoreTesting::DeleteInvalidDatabaseTesting::DeleteInvalidDatabaseTesting(const OStreamShared& stream, AncientBooksContainer ancientBooksContainer)
