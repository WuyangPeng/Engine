...
///
///	标准：std:c++17
///	引擎辅助版本：0.7.1.3 (2021/05/16 17:56)
...
MicrosoftWindowsInternalsFourthEdition::Placeholder::Placeholder() noexcept
{
    MICROSOFT_WINDOWS_INTERNALS_FOURTH_EDITION_SELF_CLASS_IS_VALID_9;
}

CLASS_INVARIANT_STUB_DEFINE(MicrosoftWindowsInternalsFourthEdition, Placeholder)
