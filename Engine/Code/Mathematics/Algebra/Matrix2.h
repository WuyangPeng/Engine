...
namespace Mathematics
{
	...
	class Matrix2 : private boost::additive<Matrix2<Real>, boost::multiplicative<Matrix2<Real>, Real>>
	{
	public:
	...
	public:
		...
		explicit Matrix2(MatrixTypeFlags flag = MatrixTypeFlags::Zero) noexcept;
