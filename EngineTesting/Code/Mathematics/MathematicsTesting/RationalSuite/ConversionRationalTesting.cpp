...
void Mathematics::ConversionRationalTesting
	::MainTest()
{
	...
	::ExponentTest()
{
	...
	for (auto loop = 0; loop < testLoopCount; ++loop)
	{
		...
		double eighthValue = DoubleMath::Pow(2, static_cast<double>(-fourthRealExponent));
	...
	::MantissaTest()
{
	...
	for (auto loop = 0; loop < testLoopCount; ++loop)
	{
		...
		float secondValue = static_cast<float>(firstMantissa) / firstDenominatorMantissa * FloatMath::Pow(2.0f, static_cast<float>(firstExponent));
		...
		double fourthValue = static_cast<double>(secondMantissa) / secondDenominatorMantissa * DoubleMath::Pow(2.0, static_cast<double>(secondExponent));
		...
		float sixthValue = firstNumeratorMantissa / static_cast<float>(firstMantissa) / FloatMath::Pow(2.0, static_cast<float>(firstExponent));
		...
		double eighthValue = secondNumeratorMantissa / static_cast<double>(secondMantissa) / DoubleMath::Pow(2.0, static_cast<double>(secondExponent));
