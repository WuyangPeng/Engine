...
// ◊˜’ﬂ£∫≈ÌŒ‰—Ù£¨≈ÌÍ ∂˜£¨≈ÌÍ ‘Û
// 
// “˝«Ê≤‚ ‘∞Ê±æ£∫0.0.0.3 (2019/09/09 15:30)
...
// 
// 		{
// 			TextureManagementLockEncapsulation<TextureManagement<PlatformTexture1D> > encapsulation(textureManagement);
// 			ASSERT_UNEQUAL_NULL_PTR(encapsulation.Lock(firstTexture1D,0,BufferLocking::ReadWrite));
// 		} 
// 
...
// 
// 		{
// 			TextureManagementLockEncapsulation<TextureManagement<PlatformTexture2D> > encapsulation(textureManagement);
// 			ASSERT_UNEQUAL_NULL_PTR(encapsulation.Lock(firstTexture2D,0,BufferLocking::ReadWrite));
// 		} 
// 
...
// 
// 		{
// 			TextureManagementLockEncapsulation<TextureManagement<PlatformTexture3D> > encapsulation(textureManagement);
// 			ASSERT_UNEQUAL_NULL_PTR(encapsulation.Lock(firstTexture3D,0,BufferLocking::ReadWrite));
// 		} 
// 
...
// 
// 		{
// 			TextureManagementLockEncapsulation<TextureManagement<PlatformTextureCube> >	encapsulation(textureManagement);
// 			ASSERT_UNEQUAL_NULL_PTR(encapsulation.LockCube(firstTextureCube,3,0,BufferLocking::ReadWrite));
// 		} 
// 
