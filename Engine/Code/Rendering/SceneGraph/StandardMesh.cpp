...
Rendering::StandardMesh ::StandardMesh(const VertexFormatSharedPtr& vertexFormat, bool isStatic, bool inside, const FloatTransform* transform)
...
IMPL_NON_CONST_MEMBER_FUNCTION_DEFINE_1_CR(Rendering, StandardMesh, SetTransform, FloatTransform, void)
