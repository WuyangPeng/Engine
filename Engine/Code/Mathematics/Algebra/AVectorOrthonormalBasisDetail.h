	...
	::GenerateOnXOrZIsMax()
{
	...
	m_UVector = AVector{ -m_WVector[2] * invLength,Math::sm_Zero,m_WVector[0] * invLength };
	...
	::GenerateOnYOrZIsMax()
{
	...
	m_UVector = AVector{ Math::sm_Zero,m_WVector[2] * invLength,-m_WVector[1] * invLength };
