...
#ifndef RENDERING_RENDERER_ENGINE_WINDOWS_PARAMETER_IMPL_H
#define RENDERING_RENDERER_ENGINE_WINDOWS_PARAMETER_IMPL_H
...
#endif  // RENDERING_RENDERER_ENGINE_WINDOWS_PARAMETER_IMPL_H
