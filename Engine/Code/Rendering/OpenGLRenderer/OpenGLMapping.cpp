...
Rendering::Enum Rendering::OpenGLConstant::g_OpenGLAlphaSrcBlend[System::EnumCastUnderlying(AlphaStateFlags::SourceBlendMode::Quantity)] = {
...
Rendering::Enum Rendering::OpenGLConstant::g_OpenGLAlphaDstBlend[System::EnumCastUnderlying(AlphaStateFlags::DestinationBlendMode::Quantity)] = {
...
Rendering::Enum Rendering::OpenGLConstant::g_OpenGLAlphaCompare[System::EnumCastUnderlying(AlphaStateFlags::CompareMode::Quantity)] = {
...
Rendering::Enum Rendering::OpenGLConstant::g_OpenGLDepthCompare[System::EnumCastUnderlying(DepthStateFlags::CompareMode::Quantity)] = {
    static_cast<GLenum>(System::CompareMode::Never),  // GL_NEVER,
    static_cast<GLenum>(System::CompareMode::Less),  // GL_LESS,
    static_cast<GLenum>(System::CompareMode::Equal),  // GL_EQUAL,
    static_cast<GLenum>(System::CompareMode::LEqual),  // GL_LEQUAL,
...
Rendering::Enum Rendering::OpenGLConstant::g_OpenGLStencilCompare[System::EnumCastUnderlying(StencilStateFlags::CompareMode::Quantity)] = {
    static_cast<GLenum>(System::CompareMode::Never),  // GL_NEVER,
    static_cast<GLenum>(System::CompareMode::Less),  // GL_LESS,
    static_cast<GLenum>(System::CompareMode::Equal),  // GL_EQUAL,
    static_cast<GLenum>(System::CompareMode::LEqual),  // GL_LEQUAL,
...
Rendering::Enum Rendering::OpenGLConstant::g_OpenGLStencilOperation[System::EnumCastUnderlying(StencilStateFlags::OperationType::Quantity)] = {
...
Rendering::Int Rendering::OpenGLConstant::g_OpenGLAttributeChannels[System::EnumCastUnderlying(VertexFormatFlags::AttributeType::Quantity)] = {
...
Rendering::UInt Rendering::OpenGLConstant::g_OpenGLAttributeType[System::EnumCastUnderlying(VertexFormatFlags::AttributeType::Quantity)] = {
    0,  // AttributeType::None (不支持的)
...
Rendering::UInt Rendering::OpenGLConstant::g_OpenGLBufferLocking[System::EnumCastUnderlying(BufferLocking::Quantity)] = {
...
Rendering::UInt Rendering::OpenGLConstant::g_OpenGLBufferUsage[System::EnumCastUnderlying(BufferUsage::Quantity)] = {
...
Rendering::Int Rendering::OpenGLConstant::g_OpenGLMinFilter[System::EnumCastUnderlying(ShaderFlags::SamplerFilter::Quantity)] = {
    0,
...
Rendering::UInt Rendering::OpenGLConstant::g_OpenGLTextureInternalFormat[System::EnumCastUnderlying(TextureFormat::Quantity)] = {
    0,
...
Rendering::UInt Rendering::OpenGLConstant::g_OpenGLTextureFormat[System::EnumCastUnderlying(TextureFormat::Quantity)] = {
    0,
...
Rendering::UInt Rendering::OpenGLConstant::g_OpenGLTextureTarget[System::EnumCastUnderlying(ShaderFlags::SamplerType::Quantity)] = {
    0,
...
Rendering::UInt Rendering::OpenGLConstant::g_OpenGLTextureTargetBinding[System::EnumCastUnderlying(ShaderFlags::SamplerType::Quantity)] = {
    0,
...
Rendering::UInt Rendering::OpenGLConstant::g_OpenGLTextureType[System::EnumCastUnderlying(TextureFormat::Quantity)] = {
...
Rendering::Int Rendering::OpenGLConstant::g_OpenGLWrapMode[System::EnumCastUnderlying(ShaderFlags::SamplerCoordinate::Quantity)] = {
    0,  // GL_CLAMP,
    0,  // GL_CLAMP,
...
Rendering::Enum Rendering::OpenGLConstant::g_OpenGLPrimitiveType[System::EnumCastUnderlying(VisualPrimitiveType::MaxQuantity)]{
