...
void CoreTools::AssertTestOperatorTesting::AssertOperatorMessageTest()
{
    ...
    ASSERT_EQUAL_USE_MESSAGE(lhsExpression, lhsExpression, "测试");
    ASSERT_UNEQUAL_USE_MESSAGE(lhsExpression, rhsExpression, "测试");
    ASSERT_LESS_USE_MESSAGE(lhsExpression, rhsExpression, "测试");
    ASSERT_LESS_EQUAL_USE_MESSAGE(lhsExpression, rhsExpression, "测试");
    ASSERT_GREATER_USE_MESSAGE(rhsExpression, lhsExpression, "测试");
    ASSERT_GREATER_EQUAL_USE_MESSAGE(rhsExpression, lhsExpression, "测试");
}
...
void CoreTools::AssertTestOperatorTesting::AssertOperatorFailureThrowTest()
{
    ...
    ASSERT_EQUAL_FAILURE_THROW(lhsExpression, lhsExpression, "测试");
    ASSERT_UNEQUAL_FAILURE_THROW(lhsExpression, rhsExpression, "测试");
    ASSERT_LESS_FAILURE_THROW(lhsExpression, rhsExpression, "测试");
    ASSERT_LESS_EQUAL_FAILURE_THROW(lhsExpression, rhsExpression, "测试");
    ASSERT_GREATER_FAILURE_THROW(rhsExpression, lhsExpression, "测试");
    ASSERT_GREATER_EQUAL_FAILURE_THROW(rhsExpression, lhsExpression, "测试");
}
...
void CoreTools::AssertTestOperatorTesting::AssertThreeOperatorMessageTest()
{
    ...
    ASSERT_THREE_EQUAL_USE_MESSAGE(lhsExpression, mhsExpression, rhsExpression, "测试");
}
...
void CoreTools::AssertTestOperatorTesting::AssertThreeOperatorFailureThrowTest()
{
    ...
    ASSERT_THREE_EQUAL_FAILURE_THROW(lhsExpression, mhsExpression, rhsExpression, "测试");
}
...
void CoreTools::AssertTestOperatorTesting::AssertFloatingPointCompleteOperatorMessageTest()
{
    ...
    ASSERT_FLOATING_POINT_COMPLETE_EQUAL_USE_MESSAGE(lhsExpression, lhsExpression, "测试");
    ASSERT_FLOATING_POINT_COMPLETE_EQUAL_USE_MESSAGE(rhsExpression, rhsExpression, "测试");
    ASSERT_FLOATING_POINT_COMPLETE_UNEQUAL_USE_MESSAGE(lhsExpression, rhsExpression, "测试");
}
...
void CoreTools::AssertTestOperatorTesting::AssertFloatingPointCompleteOperatorFailureThrowTest()
{
    ...
    ASSERT_FLOATING_POINT_COMPLETE_EQUAL_FAILURE_THROW(lhsExpression, lhsExpression, "测试");
    ASSERT_FLOATING_POINT_COMPLETE_EQUAL_FAILURE_THROW(rhsExpression, rhsExpression, "测试");
    ASSERT_FLOATING_POINT_COMPLETE_UNEQUAL_FAILURE_THROW(lhsExpression, rhsExpression, "测试");
}
