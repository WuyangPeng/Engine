...
void Mathematics::LinearSystemTesting::Solve2Test()
{
    ...
    const std::uniform_int_distribution<> integerRandomDistribution(1, 10);
...
void Mathematics::LinearSystemTesting::InverseTest()
{
    std::default_random_engine generator{ GetEngineRandomSeed() };
    std::uniform_real_distribution<double> floatRandomDistribution(-100.0, 100.0);
    std::uniform_int_distribution<> integerRandomDistribution(1, 10);
...
void Mathematics::LinearSystemTesting::SolveTridiagonalTest()
{
    std::default_random_engine generator{ GetEngineRandomSeed() };
    std::uniform_real_distribution<double> floatRandomDistribution(-100.0, 100.0);
    std::uniform_int_distribution<> integerRandomDistribution(3, 10);
