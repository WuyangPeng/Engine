...
Mathematics::MinimizeNData<Real>::MinimizeNData() noexcept
    : minLocation{}, minValue{ MathType::maxReal }
{
...
template <typename Real>
const typename Mathematics::MinimizeNData<Real>::Container& Mathematics::MinimizeNData<Real>::GetMinLocation() const noexcept
{
    MATHEMATICS_CLASS_IS_VALID_CONST_1;
