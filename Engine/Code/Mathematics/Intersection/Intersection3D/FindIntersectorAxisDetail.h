...
#if !defined(MATHEMATICS_EXPORT_TEMPLATE) || defined(MATHEMATICS_INCLUDED_FIND_INTERSECTOR_AXIS_ACHIEVE)

    #include "FindIntersectorAxisAchieve.h"

#endif  // !defined(MATHEMATICS_EXPORT_TEMPLATE) || defined(MATHEMATICS_INCLUDED_FIND_INTERSECTOR_AXIS_ACHIEVE)
