...
{
    MessageManagerInterface middleLayer{ MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") } };
...
void Framework::MessageManagerInterfaceTesting::SetNetworkManagerExceptionTest()
{
    ...
    const auto networkManager = std::make_shared<MessageManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
...
void Framework::MessageManagerInterfaceTesting::SetInputManagerExceptionTest()
{
    ...
    const auto inputManager = std::make_shared<MessageManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
...
void Framework::MessageManagerInterfaceTesting::SetPhysicalModellingManagerExceptionTest()
{
    ...
    const auto physicalModellingManager = std::make_shared<MessageManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
...
void Framework::MessageManagerInterfaceTesting::SetEventManagerExceptionTest()
{
    ...
    const auto eventManager = std::make_shared<MessageManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
...
void Framework::MessageManagerInterfaceTesting::SetResourceManagerExceptionTest()
{
    ...
    const auto resourceManager = std::make_shared<MessageManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
...
void Framework::MessageManagerInterfaceTesting::SetAudioManagerExceptionTest()
{
    ...
    const auto audioManager = std::make_shared<MessageManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
...
void Framework::MessageManagerInterfaceTesting::SetCameraSystemsManagerExceptionTest()
{
    ...
    const auto cameraSystemsManager = std::make_shared<MessageManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
...
void Framework::MessageManagerInterfaceTesting::SetRenderingManagerExceptionTest()
{
    ...
    const auto renderingManager = std::make_shared<MessageManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
...
void Framework::MessageManagerInterfaceTesting::SetGUIManagerExceptionTest()
{
    ...
    const auto guiManager = std::make_shared<MessageManagerInterface>(MiddleLayerPlatform::Windows, EnvironmentDirectory{ SYSTEM_TEXT("DefaultEnvironment"), SYSTEM_TEXT("") });
