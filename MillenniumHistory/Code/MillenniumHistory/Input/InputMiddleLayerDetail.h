...
#ifndef MILLENNIUM_HISTORY_INPUT_MIDDLE_LAYER_DETAIL_H
#define MILLENNIUM_HISTORY_INPUT_MIDDLE_LAYER_DETAIL_H

#include "InputMiddleLayer.h"
#include "MillenniumHistory/Helper/MillenniumHistoryClassInvariantMacro.h"
#include "MillenniumHistory/System/SystemMiddleLayer.h"
...
MillenniumHistory::InputMiddleLayer<ApplicationTrait>::InputMiddleLayer(MiddleLayerPlatform middleLayerPlatform, const EnvironmentDirectory& environmentDirectory)
...
template <typename ApplicationTrait>
bool MillenniumHistory::InputMiddleLayer<ApplicationTrait>::IsValid() const noexcept
{
...
template <typename ApplicationTrait>
bool MillenniumHistory::InputMiddleLayer<ApplicationTrait>::KeyDown(int key, [[maybe_unused]] const WindowPoint& point)
{
...
#endif  // MILLENNIUM_HISTORY_INPUT_MIDDLE_LAYER_DETAIL_H
