...
#ifndef CORSS_SERVER_MIDDLE_LAYER_AUDIO_MIDDLE_LAYER_AUDIO_H
#define CORSS_SERVER_MIDDLE_LAYER_AUDIO_MIDDLE_LAYER_AUDIO_H
...
{
    class CORSS_SERVER_MIDDLE_LAYER_DEFAULT_DECLARE AudioManager final : public Framework::AudioManagerInterface
    {
    public:
...
#endif  // CORSS_SERVER_MIDDLE_LAYER_AUDIO_MIDDLE_LAYER_AUDIO_H
