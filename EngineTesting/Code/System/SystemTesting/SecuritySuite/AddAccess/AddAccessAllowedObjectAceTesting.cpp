...
///
///	标准：std:c++17
///	引擎测试版本：0.7.1.4 (2021/06/02 16:53)
...
bool System::AddAccessAllowedObjectAceTesting::RandomShuffleFlags()
{
    ...
    ASSERT_NOT_THROW_EXCEPTION_0(AddAccessAllowedObjectAceTest);

    return true;
}

void System::AddAccessAllowedObjectAceTesting::AddAccessAllowedObjectAceTest()
{
...
#include STSTEM_WARNING_POP
    ...
    for (auto index = 0u; index < maxSize; ++index)
    {
        ...
        ASSERT_TRUE(AddAccessAllowedObjectAccessControlEntries(acl, AccessControlListRevision::Revision, controlACEInheritance, specificAccess, nullptr, nullptr, &sid));
    }
}
