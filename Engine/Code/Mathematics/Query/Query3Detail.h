...
{
    MATHEMATICS_CLASS_IS_VALID_CONST_1;
    MATHEMATICS_ASSERTION_0(0 <= v0 && v0 < GetNumVertices(), "索引错误！");
    MATHEMATICS_ASSERTION_0(0 <= v1 && v1 < GetNumVertices(), "索引错误！");
    MATHEMATICS_ASSERTION_0(0 <= v2 && v2 < GetNumVertices(), "索引错误！");
    MATHEMATICS_ASSERTION_0(0 <= v3 && v3 < GetNumVertices(), "索引错误！");
