...
namespace System
{
	...
	void InitGlArbMultitexture() noexcept;
	void InitGlArbTransposeMatrix() noexcept;
	void InitGlArbMultisample() noexcept;
	void InitGlArbTextureEnvAdd() noexcept;
	void InitGlArbTextureCubeMap() noexcept;
	void InitGlArbTextureCompression() noexcept;
	void InitGlArbTextureBorderClamp() noexcept;
	void InitGlArbPointParameters() noexcept;
	void InitGlArbVertexBlend() noexcept;
	void InitGlArbMatrixPalette() noexcept;
	void InitGlArbTextureEnvCombine() noexcept;
	void InitGlArbTextureEnvCrossbar() noexcept;
	void InitGlArbTextureEnvDot3() noexcept;
	void InitGlArbTextureMirroredRepeat() noexcept;
	void InitGlArbDepthTexture() noexcept;
	void InitGlArbShadow() noexcept;
	void InitGlArbShadowAmbient() noexcept;
	void InitGlArbWindowPos() noexcept;
	void InitGlArbVertexProgram() noexcept;
	void InitGlArbFragmentProgram() noexcept;
	void InitGlArbVertexBufferObject() noexcept;
	void InitGlArbOcclusionQuery() noexcept;
	void InitGlArbShaderObjects() noexcept;
	void InitGlArbVertexShader() noexcept;
	void InitGlArbFragmentShader() noexcept;
	void InitGlArbShadingLanguage100() noexcept;
	void InitGlArbTextureNonpowerOfTwo() noexcept;
	void InitGlArbPointSprite() noexcept;
	void InitGlArbFragmentProgramShadow() noexcept;
	void InitGlArbDrawBuffers() noexcept;
	void InitGlArbTextureRectangle() noexcept;
	void InitGlArbColorBufferFloat() noexcept;
	void InitGlArbHalfFloatPixel() noexcept;
	void InitGlArbTextureFloat() noexcept;
	void InitGlArbPixelBufferObject() noexcept;
	void InitGlArbDepthBufferFloat() noexcept;
	void InitGlArbDrawInstanced() noexcept;
	void InitGlArbFramebufferObject() noexcept;
	void InitGlArbFramebufferSRGB() noexcept;
	void InitGlArbGeometryShader4() noexcept;
	void InitGlArbHalfFloatVertex() noexcept;
	void InitGlArbInstancedArrays() noexcept;
	void InitGlArbMapBufferRange() noexcept;
	void InitGlArbTextureBufferObject() noexcept;
	void InitGlArbTextureCompressionRgtc() noexcept;
	void InitGlArbTextureRg() noexcept;
	void InitGlArbVertexArrayObject() noexcept;
	void InitGlArbUniformBufferObject() noexcept;
	void InitGlArbCompatibility() noexcept;
	void InitGlArbCopyBuffer() noexcept;
	void InitGlArbShaderTextureLod() noexcept;
	void InitGlArbDepthClamp() noexcept;
	void InitGlArbDrawElementsBaseVertex() noexcept;
	void InitGlArbFragmentCoordConventions() noexcept;
	void InitGlArbProvokingVertex() noexcept;
	void InitGlArbSeamlessCubeMap() noexcept;
	void InitGlArbSync() noexcept;
	void InitGlArbTextureMultisample() noexcept;
	void InitGlArbVertexArrayBgra() noexcept;
	void InitGlArbDrawBuffersBlend() noexcept;
	void InitGlArbSampleShading() noexcept;
	void InitGlArbTextureCubeMapArray() noexcept;
	void InitGlArbTextureGather() noexcept;
	void InitGlArbTextureQueryLod() noexcept;
	void InitGlArbShadingLanguageInclude() noexcept;
	void InitGlArbTextureCompressionBptc() noexcept;
	void InitGlArbBlendFuncExtended() noexcept;
	void InitGlArbExplicitAttribLocation() noexcept;
	void InitGlArbOcclusionQuery2() noexcept;
	void InitGlArbSamplerObjects() noexcept;
	void InitGlArbShaderBitEncoding() noexcept;
	void InitGlArbTextureRgb10A2ui() noexcept;
	void InitGlArbTextureSwizzle() noexcept;
	void InitGlArbTimerQuery() noexcept;
	void InitGlArbVertexType2_10_10_10Rev() noexcept;
	void InitGlArbDrawIndirect() noexcept;
	void InitGlArbGpuShader5() noexcept;
	void InitGlArbGpuShaderFp64() noexcept;
	void InitGlArbShaderSubroutin() noexcept;
	void InitGlArbTessellationShader() noexcept;
	void InitGlArbTextureBufferObjectRgb32() noexcept;
	void InitGlArbTransformFeedback2() noexcept;
	void InitGlArbTransformFeedback3() noexcept;
	void InitGlArbGetProgramBinary() noexcept;
	void InitGlArbSeparateShaderObjects() noexcept;
	void InitGlArbShaderPrecision() noexcept;
	void InitGlArbVertexAttrib64bit() noexcept;
	void InitGlArbViewportArray() noexcept;
	void InitGlArbClEvent() noexcept;
	void InitGlArbDebugOutput() noexcept;
	void InitGlArbRobustness() noexcept;
	void InitGlArbShaderStencilExport() noexcept;
	void InitGlArbBaseInstance() noexcept;
	void InitGlArbShadingLanguage420pack() noexcept;
	void InitGlArbTransformFeedbackInstanced() noexcept;
	void InitGlArbCompressedTexturePixelStorage() noexcept;
	void InitGlArbConservativeDepth() noexcept;
	void InitGlArbInternalformatQuery() noexcept;
	void InitGlArbMapBufferAlignment() noexcept;
	void InitGlArbShaderAtomicCounters() noexcept;
	void InitGlArbShaderImageLoadStore() noexcept;
	void InitGlArbShadingLanguagePacking() noexcept;
	void InitGlArbTextureStorage() noexcept;
	void InitGlArbArraysOfArrays() noexcept;
	void InitGlArbClearBufferObject() noexcept;
	void InitGlArbComputeShader() noexcept;
	void InitGlArbCopyImage() noexcept;
	void InitGlArbTextureView() noexcept;
	void InitGlArbVertexAttribBinding() noexcept;
	void InitGlArbExplicitUniformLocation() noexcept;
	void InitGlArbFragmentLayerViewport() noexcept;
	void InitGlArbFramebufferNoAttachments() noexcept;
	void InitGlArbInternalformatQuery2() noexcept;
	void InitGlArbInvalidateSubdata() noexcept;
	void InitGlArbMultiDrawIndirect() noexcept;
	void InitGlArbProgramInterfaceQuery() noexcept;
	void InitGlArbRobustBufferAccessBehavior() noexcept;
	void InitGlArbShaderImageSize() noexcept;
	void InitGlArbShaderStorageBufferObject() noexcept;
	void InitGlArbStencilTexturing() noexcept;
	void InitGlArbTextureBufferRange() noexcept;
	void InitGlArbTextureQueryLevels() noexcept;
	void InitGlArbTextureStorageMultisample() noexcept;
	void InitGlArbBufferStorage() noexcept;
	void InitGlArbClearTexture() noexcept;
	void InitGlArbEnhancedLayouts() noexcept;
	void InitGlArbMultiBind() noexcept;
	void InitGlArbQueryBufferObject() noexcept;
	void InitGlArbTextureMirrorClampToEdge() noexcept;
	void InitGlArbTextureStencil8() noexcept;
	void InitGlArbVertexType10f11f11fRev() noexcept;
	void InitGlArbBindlessTexture() noexcept;
	void InitGlArbComputeCariableGroupSize() noexcept;
	void InitGlArbIndirectParameters() noexcept;
	void InitGlArbSeamlessCubemapPerTexture() noexcept;
	void InitGlArbShaderDrawParameters() noexcept;
	void InitGlArbShaderGroupVote() noexcept;
	void InitGlArbSparseTexture() noexcept;
	void InitGlArbClipControl() noexcept;
	void InitGlArbConditionalRenderInverted() noexcept;
	void InitGlArbCullDistance() noexcept;
	void InitGlArbDerivativeControl() noexcept;
	void InitGlArbDirectStateAccess() noexcept;
	void InitGlArbGetTextureSubImage() noexcept;
	void InitGlArbShaderTextureImageSamples() noexcept;
	void InitGlArbTextureBarrier() noexcept;
	void InitGlArbPipelineStatisticsQuery() noexcept;
	void InitGlArbSparseBuffer() noexcept;
	void InitGlArbTransformFeedbackOverflowQuery() noexcept;

	void InitGlArb() noexcept;
}
