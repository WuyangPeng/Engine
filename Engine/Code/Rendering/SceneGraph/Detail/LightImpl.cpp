...
Rendering::LightImpl
   ::LightImpl(LightType type, float epsilon)
...
Rendering::LightType Rendering::LightImpl
    ::GetType() const
{
...
{
	RENDERING_CLASS_IS_VALID_1;
	RENDERING_ASSERTION_1(0.0f < angle && angle <= Math::sm_PI, "Angle≥¨≥ˆ∑∂Œß‘⁄SetAngle°£\n");
...
const Rendering::LightImpl::Colour Rendering::LightImpl
	::GetAmbient() const
{
	RENDERING_CLASS_IS_VALID_CONST_1;
...
void Rendering::LightImpl
	::SetPosition(const APoint& point)
{
	RENDERING_CLASS_IS_VALID_1;
...
const Rendering::LightImpl::AVector Rendering::LightImpl
...
void Rendering::LightImpl
	::SetDirection(const AVector& direction)
{
	RENDERING_CLASS_IS_VALID_1;
