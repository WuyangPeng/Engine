...
{
    // for convenience
	const Vector3D axes[] { mBox.GetFirstAxis(),mBox.GetSecondAxis(),mBox.GetThirdAxis() };
	const Real extents[]{ mBox.GetFirstExtent(),mBox.GetSecondExtent(),mBox.GetThirdExtent() };
