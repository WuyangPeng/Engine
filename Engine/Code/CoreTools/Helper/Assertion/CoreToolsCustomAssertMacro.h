...
static_assert(CORE_TOOLS_ASSERT_LEVEL <= ASSERT_LEVEL, "Core Tools assert level definition error.");
	...
	#define CORE_TOOLS_ASSERTION_0(condition, format, ...) ((void)0)
	#define CORE_TOOLS_ASSERTION_USE_FUNCTION_DESCRIBED_0(condition,functionDescribed,format, ...) ((void)0)

	#define CORE_TOOLS_ASSERTION_DEBUG(condition, format, ...) ((void)0)
	#define CORE_TOOLS_ASSERTION_DEBUG_USE_FUNCTION_DESCRIBED(condition,functionDescribed,format, ...) ((void)0)
	...
	#define CORE_TOOLS_ASSERTION_1(condition, format, ...) ((void)0)
	#define CORE_TOOLS_ASSERTION_USE_FUNCTION_DESCRIBED_1(condition,functionDescribed,format, ...) ((void)0)
	...
	#define CORE_TOOLS_ASSERTION_2(condition, format, ...) ((void)0)
	#define CORE_TOOLS_ASSERTION_USE_FUNCTION_DESCRIBED_2(condition,functionDescribed,format, ...) ((void)0)
	...
	#define CORE_TOOLS_ASSERTION_3(condition, format, ...) ((void)0)
	#define CORE_TOOLS_ASSERTION_USE_FUNCTION_DESCRIBED_3(condition,functionDescribed,format, ...) ((void)0)
	...
	#define CORE_TOOLS_ASSERTION_4(condition, format, ...) ((void)0)
	#define CORE_TOOLS_ASSERTION_USE_FUNCTION_DESCRIBED_4(condition,functionDescribed,format, ...) ((void)0)
