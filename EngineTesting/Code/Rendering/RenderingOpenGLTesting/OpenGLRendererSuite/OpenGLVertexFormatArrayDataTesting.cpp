...
void Rendering::OpenGLVertexFormatArrayDataTesting::AttributeUsageTextureCoordTest()
{
    ...
    OpenGLVertexFormatArrayData<VertexFormatFlags::AttributeUsage::TextureCoord,
                                VertexFormatFlags::MaximumNumber::TextureCoordinateUnits>
        data;
    ...
    ASSERT_EQUAL(boost::numeric_cast<int>(data.GetOffset(0)), firstVertexFormat->GetOffset(index));
    ...
    ASSERT_EQUAL(boost::numeric_cast<int>(data.GetOffset(1)), firstVertexFormat->GetOffset(index));
    ...
    ASSERT_EQUAL(boost::numeric_cast<int>(data.GetOffset(2)), firstVertexFormat->GetOffset(index));
...
void Rendering::OpenGLVertexFormatArrayDataTesting::AttributeUsageColorTest()
{
    vector<VertexFormatType> firstVertexFormatType{
        VertexFormatType(VertexFormatFlags::AttributeType::Float3,
                         VertexFormatFlags::AttributeUsage::Position, 0),
    ...
    OpenGLVertexFormatArrayData<VertexFormatFlags::AttributeUsage::Color,
                                VertexFormatFlags::MaximumNumber::ColorUnits>
        data;
