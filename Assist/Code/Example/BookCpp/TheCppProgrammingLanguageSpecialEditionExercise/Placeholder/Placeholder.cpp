...
TheCppProgrammingLanguageSpecialEditionExercise::Placeholder::Placeholder() noexcept
{
    THE_CPP_PROGRAMMING_LANGUAGE_SPECIAL_EDITION_EXERCISE_SELF_CLASS_IS_VALID_9;
}

CLASS_INVARIANT_STUB_DEFINE(TheCppProgrammingLanguageSpecialEditionExercise, Placeholder)
