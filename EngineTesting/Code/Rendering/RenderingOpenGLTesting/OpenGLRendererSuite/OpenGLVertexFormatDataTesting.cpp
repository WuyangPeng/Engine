...
void Rendering::OpenGLVertexFormatDataTesting
	::MainTest()
{ 
	...
	::AttributeUsagePositionTest()
{
	...
	int index = firstVertexFormat->GetIndex(VertexFormatFlags::AttributeUsage::Position);	
	ASSERT_EQUAL(data.GetOffset(), firstVertexFormat->GetOffset(index)); 
	...
	::AttributeUsageNormalTest() 
{
	...
	ASSERT_ENUM_EQUAL(data.GetType(), System::OpenGLData::Float);
	int index = firstVertexFormat->GetIndex(VertexFormatFlags::AttributeUsage::Normal);
	ASSERT_EQUAL(data.GetOffset(), firstVertexFormat->GetOffset(index)); 
	...
	::AttributeUsageTangentTest() 
{
	...
	ASSERT_EQUAL(data.GetChannels(), 3u);
	ASSERT_ENUM_EQUAL(data.GetType(),System::OpenGLData::Float);
	int index = firstVertexFormat->GetIndex(VertexFormatFlags::AttributeUsage::Tangent);
	ASSERT_EQUAL(data.GetOffset(), firstVertexFormat->GetOffset(index)); 
	...
	::AttributeUsageBinormalTest()
{
	...
	ASSERT_ENUM_EQUAL(data.GetType(), System::OpenGLData::Float);
	int index = firstVertexFormat->GetIndex(VertexFormatFlags::AttributeUsage::Binormal);
	ASSERT_EQUAL(data.GetOffset(), firstVertexFormat->GetOffset(index)); 
...
void Rendering::OpenGLVertexFormatDataTesting
	::AttributeUsageBlendIndicesTest()
{
	vector<VertexFormatType> firstVertexFormatType{
			VertexFormatType(VertexFormatFlags::AttributeType::Float3,
							 VertexFormatFlags::AttributeUsage::Position, 0),
	...
	int index = firstVertexFormat->GetIndex(VertexFormatFlags::AttributeUsage::BlendIndices);
	ASSERT_EQUAL(data.GetOffset(), firstVertexFormat->GetOffset(index)); 
	...
	::AttributeUsageBlendWeightTest() 
{
	...
	ASSERT_EQUAL(data.GetChannels(),4u);
	ASSERT_ENUM_EQUAL(data.GetType(), System::OpenGLData::HalfFloat);
	int index = firstVertexFormat->GetIndex(VertexFormatFlags::AttributeUsage::BlendWeight);
	ASSERT_EQUAL(data.GetOffset(), firstVertexFormat->GetOffset(index)); 
	...
	::AttributeUsageFogCoordTest()
{
	...
	int index = firstVertexFormat->GetIndex(VertexFormatFlags::AttributeUsage::FogCoord);
	ASSERT_EQUAL(data.GetOffset(), firstVertexFormat->GetOffset(index)); 
	...
	::AttributeUsagePsizeTest() 
{
	...
	int index = firstVertexFormat->GetIndex(VertexFormatFlags::AttributeUsage::Psize);
	ASSERT_EQUAL(data.GetOffset(), firstVertexFormat->GetOffset(index)); 
