...
// 作者：彭武阳，彭晔恩，彭晔泽
// 
// 引擎测试版本：0.0.2.4 (2020/03/12 14:25)
...
namespace Network
{
	...
	using TestingType = MultipleMessageContainerGroup<MultipleMessageField, MultipleMessageByteType::Int8, MultipleMessageByteType::Uint8,
													  MultipleMessageByteType::Int16, MultipleMessageByteType::Uint16, MultipleMessageByteType::Int32,
													  MultipleMessageByteType::Uint32, MultipleMessageByteType::Int64, MultipleMessageByteType::Uint64,
													  MultipleMessageByteType::String>;
}

void Network::MultipleMessageContainerGroupTesting
	::MainTest()
{
...
// 	{
// 		const auto multipleMessage = group[index];
// 
...
// 	TestingType multipleMessageContainerGroup{ group };
// 
// 	auto streamSize = multipleMessageContainer1.GetStreamingSize() + multipleMessageContainer2.GetStreamingSize() + multipleMessageContainer1.GetStreamingSize() +
