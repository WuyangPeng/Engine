...
#define ARTIFICIAL_INTELLEGENCE_DELAY_COPY_UNSHARED_EXPORT_IMPL(className, implClassName) \
    DELAY_COPY_UNSHARED_EXPORT_IMPL(className, implClassName, ARTIFICIAL_INTELLEGENCE)
