...
void Rendering::TrianglesStripTesting::CreateTrianglesStripFile()
{
    ...
    constexpr int type = System::EnumCastUnderlying(VisualPrimitiveType::TriangleStrip);
...
void Rendering::TrianglesStripTesting::InitTest()
{
...
void Rendering::TrianglesStripTesting::CopyTest()
{
    // 	VisualSharedPtr firstTrianglesStrip =
    // 		LoadVisual::CreateFromFile(SYSTEM_TEXT("Resource/SceneGraphSuite/TrianglesStrip.trv"));
    //
...
void Rendering::TrianglesStripTesting::TransformTest()
{
    // 	VisualSharedPtr firstTrianglesStrip =
    // 			LoadVisual::CreateFromFile(SYSTEM_TEXT("Resource/SceneGraphSuite/TrianglesStrip.trv"));
    //
...
void Rendering::TrianglesStripTesting::StreamTest()
{
    // 	VisualSharedPtr firstTrianglesStrip =
    // 			LoadVisual::CreateFromFile(SYSTEM_TEXT("Resource/SceneGraphSuite/TrianglesStrip.trv"));
    //
...
void Rendering::TrianglesStripTesting::FileTest()
{
    // 	VisualSharedPtr firstTrianglesStrip =
    // 			LoadVisual::CreateFromFile(SYSTEM_TEXT("Resource/SceneGraphSuite/TrianglesStrip.trv"));
    //
...
void Rendering::TrianglesStripTesting::UpdateModelSpaceTest()
{
    // 	VisualSharedPtr firstTrianglesStrip =
    // 		LoadVisual::CreateFromFile(SYSTEM_TEXT("Resource/SceneGraphSuite/TrianglesStrip.trv"));
    //
