...
///
///	标准：std:c++20
///	版本：0.9.1.0 (2023/06/19 21:35)

#ifndef DATABASE_GENERATE_SERVER_MIDDLE_LAYER_FWD_H
#define DATABASE_GENERATE_SERVER_MIDDLE_LAYER_FWD_H
...
#endif  // DATABASE_GENERATE_SERVER_MIDDLE_LAYER_FWD_H