...
void Mathematics::Query2IntegerTesting
	::MainTest()
{
	...
	::VerticesTest()
{
	...
	for (auto loop = 0; loop < testLoopCount; ++loop)
	{
		...
		DoubleQuery2Integer query(vertices);
	...
	::LineTest()
{
	...
	for (auto loop = 0; loop < testLoopCount; ++loop)
	{
		...
		{
// 			Vector2D<int> firstVector = vertices[firstIndex];
// 			Vector2D<int> secondVector = vertices[secondIndex];
// 			Vector2D<int> thirdVector = vertices[thirdIndex];
// 
