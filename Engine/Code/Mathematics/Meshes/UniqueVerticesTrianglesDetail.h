...
Mathematics::UniqueVerticesTriangles<N, Real>
...
template <int N, typename Real>
Mathematics::UniqueVerticesTriangles<N, Real>
	::UniqueVerticesTriangles(int numInVertices,const CoreTools::Tuple<N,Real>* inVertices, int numTriangles, const int* inIndices,
...
template <int N, typename Real>
int Mathematics::UniqueVerticesTriangles<N, Real>
	::GetOutputIndexFor(int inputIndex) const
{
...
template <int N, typename Real>
void Mathematics::UniqueVerticesTriangles<N, Real>
	::ConstructUniqueVertices(int numInVertices, const CoreTools::Tuple<N,Real>* inVertices, int& numOutVertices,CoreTools::Tuple<N,Real>*& outVertices)
{
    ...
    outVertices = NEW1<CoreTools::Tuple<N,Real> >(mNumOutVertices);
