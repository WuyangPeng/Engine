...
CoreTools::PropertyGetExternal<T, ConstReference, PF>::PropertyGetExternal(const T& object)
    : m_Object{ object }
{
...
template <typename T, typename ConstReference, ConstReference (T::*PF)() const>
CoreTools::PropertyGetExternal<T, ConstReference, PF>::operator ConstReferenceType() const
{
