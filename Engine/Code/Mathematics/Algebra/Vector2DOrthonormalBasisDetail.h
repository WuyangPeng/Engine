...
#if !defined(MATHEMATICS_EXPORT_TEMPLATE) || defined(MATHEMATICS_INCLUDED_VECTOR2D_ORTHONORMAL_BASIS_ACHIEVE)

    #include "Vector2DOrthonormalBasisAchieve.h"

#endif  // !defined(MATHEMATICS_EXPORT_TEMPLATE) || defined(MATHEMATICS_INCLUDED_VECTOR2D_ORTHONORMAL_BASIS_ACHIEVE)
