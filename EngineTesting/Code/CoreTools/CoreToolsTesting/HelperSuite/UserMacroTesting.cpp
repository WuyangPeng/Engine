...
///
///	标准：std:c++17
///	引擎测试版本：0.7.2.1 (2021/08/20 15:22)
...
{
    ASSERT_EQUAL(CLOSE_USE_MEMORY_MANAGER | CLOSE_ASSERT | CLOSE_CLASS_INVARIANT | CLOSE_USE_IMPORTANT_EXCPTION_ASSERT | CLOSE_USE_SAFETY_LIMIT | CLOSE_USE_OPENXLSX, CLOSE_CORE_TOOLS_MAX);
}
