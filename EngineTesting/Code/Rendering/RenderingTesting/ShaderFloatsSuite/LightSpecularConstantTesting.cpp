...
// 		LightSpecularConstantSharedPtr firstShaderFloat(new LightSpecularConstant(firstLight));
// 		
// 		for (int i = 0; i < 4;++i)
// 		{	 
...
// 		
// 		LightSpecularConstantSharedPtr secondShaderFloat =
// 			inTopLevel[0].PolymorphicDowncastObjectSharedPtr<LightSpecularConstantSharedPtr>();
// 		
...
//  
// 		 
// 		ASSERT_APPROXIMATE(firstLight->GetSpecular().GetRed(), firstShaderFloat[0], 1e-8f);
// 		ASSERT_APPROXIMATE(firstLight->GetSpecular().GetGreen(), firstShaderFloat[1], 1e-8f);
// 		ASSERT_APPROXIMATE(firstLight->GetSpecular().GetBlue(), firstShaderFloat[2], 1e-8f);
// 		ASSERT_APPROXIMATE(firstLight->GetSpecular().GetAlpha(), firstShaderFloat[3], 1e-8f);
// 	}
}
